  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        // Fetch activities
        const activitiesResponse = await fetch('https://backendactivity.plutotours.in/api/products');
        const activitiesData = await activitiesResponse.json();
        
        // Fetch images
        const imagesResponse = await fetch('https://backendactivity.plutotours.in/api/images');
