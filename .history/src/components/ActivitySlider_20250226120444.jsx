...
const ActivitySlider = ({ isOpen, onClose, selectedDay, onActivitySelect }) => {
  console.log("ActivitySlider props:", { isOpen, selectedDay, onActivitySelect });
  ...
  const handleActivitySelect = useCallback(
    (activity) => {
      ...
      console.log("onActivitySelect exists:", !!onActivitySelect);

      if (!selectedDay || !onActivitySelect) {
        console.log("Early return due to missing selectedDay or onActivitySelect");
        return;
      }
      ...
      console.log("Prepared activityWithDay:", activityWithDay);
