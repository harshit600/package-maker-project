...
const ActivitySlider = ({ isOpen, onClose, selectedDay, onActivitySelect }) => {
  ...
  const handleActivitySelect = useCallback(
    (activity) => {
      console.log('handleActivitySelect called with:', activity); // Debug log 1
      
      if (!selectedDay || !onActivitySelect) {
        console.log('Missing selectedDay or onActivitySelect:', { selectedDay, onActivitySelect }); // Debug log 2
        return;
      }
      ...
      console.log('Activity with day:', activityWithDay); // Debug log 3
