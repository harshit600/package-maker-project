    ...
    <div className="p-6 bg-white relative">
      ...
      {isEditPanelOpen && (
        <>
          ...
          {/* Side Panel */}
          <div
            className={`fixed inset-y-0 right-0 w-1/2 bg-white shadow-xl z-50 panel-slide ${
              isEditPanelOpen ? "slide-in" : "slide-out"
            }`}
          >
                      ...
                      <div className="bg-white rounded-lg shadow p-6">
                        ...
                        <div className="grid grid-cols-2 gap-6">
                          <div className="space-y-2">
                            ...
                            <div className={`text-sm inline-flex px-3 py-1 rounded-full ${
