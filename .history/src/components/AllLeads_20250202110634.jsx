...
const AllLeads = () => {
  ...
  const getFilteredPackages = () => {
    return packages.filter(pkg => {
      ...
      // Debug logs
      console.log('Package duration:', pkg.duration, typeof pkg.duration);
      console.log('Filter duration:', packageFilter.duration, typeof packageFilter.duration);
      
      const matchesDuration = !packageFilter.duration || 
                             pkg.duration === Number(packageFilter.duration);
