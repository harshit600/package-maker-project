                ...
                {activeTab === "leadDetails" && (
                  <div className="p-6 bg-white">
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-between items-center mb-6">
                        <div>
                          <h2 className="text-2xl font-semibold text-gray-900">{selectedLead?.name || 'N/A'}</h2>
                          <p className="text-gray-500">{selectedLead?.email || 'N/A'}</p>
                        </div>
                      ...
                      <div className="bg-white rounded-lg border border-gray-200 p-4 mb-4">
                        <div className="flex justify-between items-center">
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="font-medium text-gray-900">Active sequence</span>
                          </div>
                          <div className="flex items-center space-x-2">
                            <span className="text-gray-500">Next follow-up:</span>
                            <span className="font-medium">{selectedLead?.nextFollowUp || 'Not scheduled'}</span>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div className="space-y-1">
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <span className="text-gray-900">{selectedLead?.mobile || 'N/A'}</span>
                            </div>
                          </div>
                          <div className="space-y-1">
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <span className="text-gray-900">{selectedLead?.source || 'N/A'}</span>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white rounded-lg border border-gray-200 p-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div className="space-y-1">
                            ...
                            <p className="text-gray-900">{selectedLead?.from || 'N/A'}</p>
                          </div>
                          <div className="space-y-1">
                            <label className="text-sm text-gray-500">Destination</label>
                            <p className="text-gray-900">{selectedLead?.destination || 'N/A'}</p>
                          </div>
                          <div className="space-y-1">
                      ...
                      <div className="bg-white rounded-lg border border-gray-200 p-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div className="space-y-1">
                            <label className="text-sm text-gray-500">Package Category</label>
                            <p className="text-gray-900">{selectedLead?.packageCategory || 'N/A'}</p>
                          </div>
                          <div className="space-y-1">
                            <label className="text-sm text-gray-500">Package Type</label>
                            <p className="text-gray-900">{selectedLead?.packageType || 'N/A'}</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white rounded-lg border border-gray-200 p-4">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                          <div className="space-y-1">
                            ...
                            <p className="text-gray-900">{selectedLead?.adults || 'N/A'}</p>
                          </div>
                          <div className="space-y-1">
                            <label className="text-sm text-gray-500">Kids</label>
                            <p className="text-gray-900">{selectedLead?.kids || 'N/A'}</p>
                          </div>
                          <div className="space-y-1">
                            <label className="text-sm text-gray-500">Total Persons</label>
                            <p className="text-gray-900">{selectedLead?.persons || 'N/A'}</p>
                          </div>
                        </div>
                      </div>
                    </div>
