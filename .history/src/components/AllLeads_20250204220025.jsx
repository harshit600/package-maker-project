                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex justify-between items-start mb-4">
                        <div>
                          <div className="flex items-center gap-2 mb-1">
                            <span className="px-2 py-1 text-xs font-medium bg-pink-100 text-pink-800 rounded">HOT LEADS</span>
                            <span className="px-2 py-1 text-xs font-medium bg-gray-100 text-gray-800 rounded">REPEAT</span>
                          </div>
                          <h2 className="text-xl font-semibold text-gray-900">Deal #{selectedLead?._id || 'N/A'}</h2>
                          <h3 className="text-2xl font-semibold mt-2">{selectedLead?.name || 'N/A'}</h3>
                          <p className="text-gray-600 mt-1">{selectedLead?.destination || 'N/A'}</p>
                        </div>
                      ...
                      <div className="mb-8">
                        <div className="text-sm text-gray-600 mb-4">
                          Pipeline: <span className="font-medium text-gray-900">Deals Pipeline</span>
                          <span className="mx-2">|</span>
                          Stage: <span className="font-medium text-gray-900">Proposal Sent</span>
                        ...
                        <div className="flex gap-1">
                          <div className="flex-1 bg-[#7DE2D1] px-4 py-2 rounded text-center text-sm">New Leads</div>
                          <div className="flex-1 bg-[#7DE2D1] px-4 py-2 rounded text-center text-sm">Request Rec...</div>
                          <div className="flex-1 bg-[#7DE2D1] px-4 py-2 rounded text-center text-sm">In Draft</div>
                          <div className="flex-1 bg-[#7DE2D1] px-4 py-2 rounded text-center text-sm font-medium">Proposal Sent</div>
                          <div className="flex-1 bg-gray-200 px-4 py-2 rounded text-center text-sm">Approved</div>
                          <div className="flex-1 bg-gray-200 px-4 py-2 rounded text-center text-sm">Rejected</div>
                        </div>
                      </div>
                        ...
                        <div className="flex justify-between items-center">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <div className="text-sm text-gray-600">Proposals Sequence</div>
                            </div>
                          </div>
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <div className="text-sm text-gray-600">Next drip</div>
                              <div className="font-medium">Follow up proposal</div>
                              <div className="text-xs text-gray-500">Scheduled for Tomorrow 12:39 PM</div>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="border-b border-gray-200 mb-6">
                        <nav className="flex gap-8">
                          <button className="px-1 py-4 border-b-2 border-green-500 text-green-600 font-medium">
                            Activity
                          </button>
                          <button className="px-1 py-4 text-gray-500 hover:text-gray-700">
                            Appointments <span className="ml-2 bg-gray-100 px-2 py-1 rounded-full text-xs">1</span>
                          </button>
                          <button className="px-1 py-4 text-gray-500 hover:text-gray-700">
                            Proposals <span className="ml-2 bg-gray-100 px-2 py-1 rounded-full text-xs">1</span>
                          </button>
                          <button className="px-1 py-4 text-gray-500 hover:text-gray-700">Invoices</button>
                          <button className="px-1 py-4 text-gray-500 hover:text-gray-700">Notifications</button>
                          <button className="px-1 py-4 text-gray-500 hover:text-gray-700">Notes</button>
                          <button className="px-1 py-4 text-gray-500 hover:text-gray-700">Tasks</button>
                        </nav>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-4">
                          <div className="flex items-start gap-4">
                            ...
                            <div>
                              <div className="flex items-center justify-between">
                                <h4 className="font-medium">Email Delivered: Proposal Sent</h4>
                                <span className="text-sm text-gray-500">Today 9:49 AM</span>
                              </div>
                              <p className="text-gray-600 text-sm mt-1">Proposal has been sent to the customer's email.</p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-start gap-4">
                            ...
                            <div>
                              <div className="flex items-center justify-between">
                                <h4 className="font-medium">Stage: Request Received → Proposal Sent</h4>
                                <span className="text-sm text-gray-500">Today 9:48 AM</span>
                              </div>
                              <p className="text-gray-600 text-sm mt-1">Deal #{selectedLead?._id} has been moved to the Proposal Sent stage.</p>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="bg-white rounded-lg border border-gray-200 p-4">
                          <div className="flex justify-between items-start">
                            <div>
                              ...
                              <div className="font-medium">January 19, 2024</div>
                              <div className="text-sm text-gray-500 mt-1">10 AM - 10:30 AM</div>
                            </div>
                          ...
                          <div className="mt-4">
                            <div className="flex items-center gap-2 text-gray-600">
                              ...
                              <span>{selectedLead?.destination}, {selectedLead?.from}</span>
                            </div>
                        ...
                        <div className="bg-white rounded-lg border border-gray-200">
                          <div className="p-4 flex items-center justify-between">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                <div className="font-medium">#{selectedLead?._id} - {selectedLead?.name}</div>
                            ...
                            <div className="flex items-center gap-4">
                              <div className="text-right">
                                ...
                                <div className="font-medium">₹{selectedLead?.budget || '0.00'}</div>
                              </div>
