            ...
            <div className="h-full flex flex-col">
              ...
              <div className="border-b border-gray-200">
                <nav className="flex px-3" aria-label="Tabs">
                  ...
                  <button
                    onClick={() => setActiveTab("dropPackage")}
                    className={`${
                      activeTab === "dropPackage"
                        ? "bg-white text-black"
                        : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"
                    } whitespace-nowrap py-2 px-2 border-b border-b-1 font-medium text-sm ml-4`}
                  >
                  ...
                  <div className="p-6 bg-white">
                    <div className="max-w-2xl mx-auto">
                      <div className="bg-white shadow rounded-lg">
                        <div className="px-6 py-4 border-b border-gray-200">
                          <h3 className="text-lg font-medium text-gray-900">Drop Package</h3>
                          <p className="mt-1 text-sm text-gray-500">
                            Please provide the reason for dropping this package
                          </p>
                        </div>
                        <div className="p-6">
                          <form className="space-y-6">
                            <div>
                              ...
                              >
                                ...
                                <option value="timeline">Timeline Conflicts</option>
                                <option value="requirements">Changed Requirements</option>
