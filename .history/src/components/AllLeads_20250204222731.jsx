                      ...
                      <div className="bg-white shadow-lg rounded-xl overflow-hidden">
                        ...
                        <div className="px-8 py-6 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
                          ...
                          <p className="mt-2 text-blue-100">
                            Choose your preferred method to share the package details
                          </p>
                        </div>
                        ...
                        <div className="p-8">
                          ...
                          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 mb-8">
                            ...
                            <div className="space-y-3">
                              <div className="flex items-center justify-between py-2 border-b border-gray-100">
                                ...
                                <span className="font-medium text-gray-900">{selectedLead?.assignedPackage?.packageName || "N/A"}</span>
                              </div>
                              <div className="flex items-center justify-between py-2 border-b border-gray-100">
                                <span className="text-gray-600">Duration</span>
                                <span className="font-medium text-gray-900">{selectedLead?.assignedPackage?.duration || "N/A"} Days</span>
                              </div>
                              <div className="flex items-center justify-between py-2">
                                <span className="text-gray-600">Price</span>
                                <span className="font-medium text-gray-900">₹{selectedLead?.assignedPackage?.price || "N/A"}</span>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="grid grid-cols-3 gap-6">
                            ...
                            >
                              ...
                              <h3 className="text-lg font-semibold text-center text-gray-900 mb-2">WhatsApp</h3>
                              <p className="text-sm text-center text-gray-500">Share instantly via WhatsApp</p>
                            </button>
                            ...
                            >
                              ...
                              <h3 className="text-lg font-semibold text-center text-gray-900 mb-2">Email</h3>
                              <p className="text-sm text-center text-gray-500">Send via email</p>
                            </button>
                            ...
                            >
                              ...
                              <h3 className="text-lg font-semibold text-center text-gray-900 mb-2">SMS</h3>
                              <p className="text-sm text-center text-gray-500">Share via SMS</p>
                            </button>
                          </div>
                        </div>
                      </div>
