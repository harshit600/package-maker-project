                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-4">
                              ...
                              <div>
                                ...
                                <p className="text-blue-100">{selectedLead?.mobile}</p>
                              </div>
                            </div>
                            ...
                            <div>
                              ...
                              <div className="space-y-3">
                                <div>
                                  ...
                                  <span className="ml-2">{selectedLead?.from || "N/A"}</span>
                                </div>
                                <div>
                                  <span className="text-gray-500">To:</span>
                                  <span className="ml-2">{selectedLead?.destination || "N/A"}</span>
                                </div>
                                <div>
                            ...
                            <div>
                              ...
                              <div className="space-y-3">
                                <div>
                                  ...
                                  <span className="ml-2">₹{selectedLead?.budget || "N/A"}</span>
                                </div>
                                <div>
                                  <span className="text-gray-500">Duration:</span>
                                  <span className="ml-2">{selectedLead?.days || "0"} Days</span>
                                </div>
                                <div>
