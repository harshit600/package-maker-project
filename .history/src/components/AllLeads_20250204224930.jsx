...
const AllLeads = () => {
  ...
  const addDemoLead = () => {
    ...
    setLeads((prevLeads) => [...prevLeads, demoLead]);
                    ...
                    <div className="max-w-5xl mx-auto p-6">
                      ...
                      <div className="bg-white rounded-xl shadow-sm mb-6 overflow-hidden">
                        ...
                        <div className="grid grid-cols-4 divide-x divide-gray-100 border-t border-gray-100">
                          <div className="px-6 py-4">
                            <div className="text-sm font-medium text-gray-500">Package Category</div>
                            <div className="mt-1 text-lg font-semibold text-gray-900">{selectedLead?.packageCategory || "N/A"}</div>
                          </div>
                          <div className="px-6 py-4">
                            <div className="text-sm font-medium text-gray-500">Budget</div>
                            <div className="mt-1 text-lg font-semibold text-gray-900">₹{selectedLead?.budget || "N/A"}</div>
                          </div>
                          <div className="px-6 py-4">
                          ...
                          <div className="px-6 py-4">
                            ...
                            <div className="mt-1 text-lg font-semibold text-gray-900">{selectedLead?.days || "0"} Days</div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-3 gap-6">
                          ...
                          <div className="p-6 space-y-6">
                            <div className="grid grid-cols-2 gap-6">
                              <div>
                                ...
                                <div className="text-base text-gray-900">{selectedLead?.from || "N/A"}</div>
                              </div>
                              <div>
                                <div className="text-sm font-medium text-gray-500 mb-1">To</div>
                                <div className="text-base text-gray-900">{selectedLead?.destination || "N/A"}</div>
                              </div>
                              <div>
                                <div className="text-sm font-medium text-gray-500 mb-1">Adults</div>
                                <div className="text-base text-gray-900">{selectedLead?.adults || "0"}</div>
                              </div>
                              <div>
                                <div className="text-sm font-medium text-gray-500 mb-1">Children</div>
                                <div className="text-base text-gray-900">{selectedLead?.kids || "0"}</div>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className="p-6">
                            <div className="space-y-4">
                              <div>
                                ...
                                <div className="text-base text-gray-900">{selectedLead?.source || "N/A"}</div>
                              </div>
                              <div>
                                <div className="text-sm font-medium text-gray-500 mb-1">Assigned To</div>
                                <div className="text-base text-gray-900">{selectedLead?.assignedTo || "N/A"}</div>
                              </div>
                              <div>
                        ...
                        <div className="col-span-3 bg-white rounded-xl shadow-sm">
                          <div className="px-6 py-4 border-b border-gray-100">
                            <h2 className="text-lg font-semibold text-gray-900">Notes & Updates</h2>
                          </div>
                          <div className="p-6">
                            <div className="bg-gray-50 rounded-lg p-4">
                              <p className="text-gray-700">{selectedLead?.notes || "No notes available"}</p>
                            </div>
                          </div>
                        </div>
                      </div>
