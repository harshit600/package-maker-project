                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="col-span-2 bg-gray-50 p-4 rounded-lg">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                              ...
                              <p className="font-medium">{viewLead.mobile}</p>
                            </div>
                            <div>
                            ...
                            <div>
                              ...
                              <p className="font-medium">{viewLead.packageCategory || 'N/A'}</p>
                            </div>
                          </div>
                        </div>

                        <div className="col-span-2 bg-gray-50 p-4 rounded-lg">
                          <h4 className="text-sm font-medium text-gray-500 mb-2">Travel Details</h4>
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              <p className="text-sm text-gray-500">From</p>
                              <p className="font-medium">{viewLead.from || 'N/A'}</p>
                            </div>
                            <div>
                              <p className="text-sm text-gray-500">Destination</p>
                              <p className="font-medium">{viewLead.destination || 'N/A'}</p>
                            </div>
                            <div>
                              <p className="text-sm text-gray-500">Travel Date</p>
                              <p className="font-medium">
                                {viewLead.travelDate 
                                  ? new Date(viewLead.travelDate).toLocaleDateString()
                                  : 'N/A'}
                              </p>
                            </div>
                            <div>
                              ...
                              <p className="font-medium">
                                {viewLead.days ? `${viewLead.days} Days, ${viewLead.nights} Nights` : 'N/A'}
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="col-span-2 bg-gray-50 p-4 rounded-lg">
                          ...
                          <div className="grid grid-cols-3 gap-4">
                            <div>
                              ...
                              <p className="font-medium">{viewLead.adults || '0'}</p>
                            </div>
                            <div>
                              <p className="text-sm text-gray-500">Kids</p>
                              <p className="font-medium">{viewLead.kids || '0'}</p>
                            </div>
                            <div>
                              <p className="text-sm text-gray-500">Total Guests</p>
                              <p className="font-medium">{viewLead.persons || '0'}</p>
                            </div>
                          </div>
                        </div>
                        ...
                        {viewLead.assignedPackage && (
                          <div className="col-span-2 bg-gray-50 p-4 rounded-lg">
                            <h4 className="text-sm font-medium text-gray-500 mb-2">Assigned Package</h4>
                            <div className="grid grid-cols-2 gap-4">
                              <div>
                                <p className="text-sm text-gray-500">Package Name</p>
                                <p className="font-medium">{viewLead.assignedPackage.packageName}</p>
                              </div>
                              <div>
                                <p className="text-sm text-gray-500">Price</p>
                                <p className="font-medium">₹{viewLead.assignedPackage.price}</p>
                              </div>
                            </div>
                          </div>
                        )}
