...
const AllLeads = () => {
  ...
  // Update getFilteredLeads to include category filter
                        ...
                        <form className="space-y-2">
                          <div className="grid grid-cols-2 gap-2">
                            <div>
                              ...
                              <input
                                type="text"
                                value={editingPackageData?.packageName || ""}
                                onChange={(e) =>
                            ...
                            <div>
                              ...
                              <input
                                type="text"
                                value={
                                  editingPackageData?.packageCategory || ""
                                }
                                onChange={(e) =>
                                  setEditingPackageData({
                                    ...editingPackageData,
                          ...
                          <div className="flex flex-col space-y-2 md:flex-row md:space-y-0 md:space-x-2">
                            ...
                            <div className="flex-none self-end">
                              <button
                                ...
                                className="px-3 py-1 text-sm font-medium text-gray-700 bg-gray-100 border border-gray-300 rounded-md hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                              >
                                Clear Filters
                              </button>
                            </div>
        ...
        <>
          ...
          <div className="fixed inset-0 z-50 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4">
              <div className="relative transform overflow-hidden rounded-2xl bg-white text-left shadow-2xl transition-all w-full max-w-4xl">
                ...
                <div className="bg-gradient-to-r from-blue-600 to-blue-800 px-6 py-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <h2 className="text-xl font-bold text-white">{viewLead.name}</h2>
                        <p className="text-blue-100">{viewLead.email}</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setIsViewModalOpen(false)}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                      ...
                      <div className="p-5 space-y-4">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="text-sm font-medium text-gray-900">{viewLead.mobile}</p>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                      <div className="px-5 py-4 bg-gray-50 border-b border-gray-100">
                        <div className="flex items-center space-x-2">
                          <svg className="h-5 w-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 104 0 2 2 0 012-2v-1a2 2 0 002-2v-1a2 2 0 012-2h-1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                          </svg>
                          <h3 className="text-sm font-semibold text-gray-900">Travel Details</h3>
                        </div>
                      </div>
                      <div className="p-5 grid grid-cols-2 gap-4">
                        <div>
                          <p className="text-xs font-medium text-gray-500">From</p>
                          <p className="text-sm font-semibold text-gray-900">{viewLead.from || 'N/A'}</p>
                        </div>
                        <div>
                          <p className="text-xs font-medium text-gray-500">Destination</p>
                          <p className="text-sm font-semibold text-gray-900">{viewLead.destination || 'N/A'}</p>
                        </div>
                        <div>
                          <p className="text-xs font-medium text-gray-500">Travel Date</p>
                          <p className="text-sm font-semibold text-gray-900">
                            {viewLead.travelDate ? new Date(viewLead.travelDate).toLocaleDateString('en-US', {
                              day: 'numeric',
                              month: 'short',
                              year: 'numeric'
                            }) : 'N/A'}
                        ...
                        <div>
                          ...
                          <p className="text-sm font-semibold text-gray-900">
                            {viewLead.days ? `${viewLead.days}D/${viewLead.nights}N` : 'N/A'}
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="p-5">
                        <div className="grid grid-cols-3 gap-4">
                          <div className="bg-blue-50 rounded-lg p-3 text-center">
                            <p className="text-2xl font-bold text-blue-600">{viewLead.adults || '0'}</p>
                            <p className="text-xs font-medium text-blue-600">Adults</p>
                          </div>
                          <div className="bg-green-50 rounded-lg p-3 text-center">
                            <p className="text-2xl font-bold text-green-600">{viewLead.kids || '0'}</p>
                            <p className="text-xs font-medium text-green-600">Kids</p>
                          </div>
                          <div className="bg-purple-50 rounded-lg p-3 text-center">
                            <p className="text-2xl font-bold text-purple-600">{viewLead.persons || '0'}</p>
                        ...
                        <div className="p-5">
                          <div className="space-y-4">
                            <div>
                              ...
                              <p className="text-sm font-semibold text-gray-900">{viewLead.assignedPackage.packageName}</p>
                            </div>
                            <div>
                              <p className="text-xs font-medium text-gray-500">Category</p>
                              <p className="text-sm font-semibold text-gray-900">{viewLead.packageCategory || 'N/A'}</p>
                            </div>
                            <div className="bg-green-50 rounded-lg p-3">
                              <p className="text-xs font-medium text-green-600">Package Price</p>
                              <p className="text-2xl font-bold text-green-600">₹{viewLead.assignedPackage.price}</p>
                            </div>
                          </div>
                        </div>
                      </div>
