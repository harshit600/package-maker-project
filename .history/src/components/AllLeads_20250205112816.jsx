...
const AllLeads = () => {
  ...
  return (
    <div className="p-3 bg-white relative">
      ...
      {/* Premium View Modal with Reduced Spacing */}
                ...
                <div className="bg-gradient-to-r from-blue-600 to-blue-800 px-4 py-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h2 className="text-xl font-bold text-white mb-0.5">{viewLead.name}</h2>
                        <p className="text-sm text-blue-100">{viewLead.email}</p>
                      </div>
                    </div>
                    <button
                      onClick={() => setIsViewModalOpen(false)}
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
                      ...
                      <div className="p-3">
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <div>
                            <p className="text-xs font-medium text-gray-500 mb-0.5">Travel Date</p>
                      ...
                      <div className="p-3">
                        <div className="grid grid-cols-3 gap-3">
                          <div className="bg-blue-50 rounded-lg p-2 text-center">
                            <p className="text-xl font-bold text-blue-600 mb-0.5">{viewLead.adults || '0'}</p>
                            <p className="text-xs font-medium text-blue-600">Adults</p>
                          </div>
                          <div className="bg-green-50 rounded-lg p-2 text-center">
                            <p className="text-xl font-bold text-green-600 mb-0.5">{viewLead.kids || '0'}</p>
                            <p className="text-xs font-medium text-green-600">Kids</p>
                          </div>
                          <div className="bg-purple-50 rounded-lg p-2 text-center">
                            <p className="text-xl font-bold text-purple-600 mb-0.5">{viewLead.persons || '0'}</p>
                      ...
                      <div className="bg-white rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
                        ...
                        <div className="p-3">
                          <div className="space-y-2.5">
                            <div>
                              <p className="text-xs font-medium text-gray-500 mb-0.5">Package Name</p>
                            ...
                            <div className="bg-green-50 rounded-lg p-2">
                              <p className="text-xs font-medium text-green-600 mb-0.5">Package Price</p>
                              <p className="text-xl font-bold text-green-600">₹{viewLead.assignedPackage.price}</p>
                            </div>
                          </div>
                        </div>
                      </div>
