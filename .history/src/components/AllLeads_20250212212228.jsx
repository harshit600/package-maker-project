...
const AllLeads = () => {
    ...
    try {
      ...
      switch (method) {
        case "whatsapp":
          ...
          window.open(`https://wa.me/${selectedLead.mobile}?text=${whatsappMessage}`);
  ...
  const handleDeleteLead = async (leadId) => {
    ...
    try {
      ...
      const response = await fetch(`${config.API_HOST}/api/leads/delete-lead/${leadId}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${token}`,
  ...
  const handleUpdateLead = async (leadId, updatedData) => {
    try {
      ...
      const response = await fetch(`${config.API_HOST}/api/leads/update-lead/${leadId}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${token}`,
    ...
    <div className="p-3 bg-white relative">
      ...
      {isEditPanelOpen && (
        <>
          ...
          {/* Side Panel */}
          <div className="fixed inset-y-0 right-0 w-3/4 bg-white shadow-xl z-50 transform transition-transform duration-300 ease-in-out">
            <div className="h-full flex flex-col">
              {/* Header */}
              <div className="px-6 py-4 bg-[#2d2d44] text-white">
              ...
              <div className="border-b border-gray-200">
                <nav className="flex px-6" aria-label="Tabs">
                  <button
                    onClick={() => setActiveTab("leadInformation")}
                    className={`${
                      activeTab === "leadInformation"
                  ...
                  <button
                    onClick={() => setActiveTab("packageCustomize")}
                    className={`${
                      activeTab === "packageCustomize"
                        ? "border-blue-500 text-blue-600"
                        : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      ...
                      <div className="bg-white p-4 rounded-lg shadow border border-gray-200">
                          ...
                          <div>
                            <label className="block text-sm font-medium text-gray-700">From</label>
                              <input
                                ...
                                onChange={(e) => setSelectedLead({...selectedLead, from: e.target.value})}
                            ...
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) => setSelectedLead({...selectedLead, destination: e.target.value})}
                                className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                              />
                            </div>
                            <div>
                              ...
                              <input
                                type="date"
                                value={selectedLead.travelDate ? new Date(selectedLead.travelDate).toISOString().split('T')[0] : ''}
                        ...
                        <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
                          <h3 className="text-lg font-semibold text-gray-900 mb-4">Duration & Guests</h3>
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) => setSelectedLead({...selectedLead, days: e.target.value})}
                                className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                              />
                            </div>
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) => setSelectedLead({...selectedLead, nights: e.target.value})}
                                className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                              />
                            </div>
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) => setSelectedLead({...selectedLead, adults: e.target.value})}
                                className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                              />
                            </div>
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) => setSelectedLead({...selectedLead, kids: e.target.value})}
                                className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                              />
                            </div>
                          </div>
                          ...
                          <div className="space-y-4">
                            <div>
                              ...
                              <select
                                ...
                                onChange={(e) => setSelectedLead({...selectedLead, packageType: e.target.value})}
                                className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                              >
                            ...
                            <div>
                              ...
                              <select
                                ...
                                onChange={(e) => setSelectedLead({...selectedLead, packageCategory: e.target.value})}
                                className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                              >
                            ...
                            <div>
                              <label className="block text-sm font-medium text-gray-700">Meal Plans</label>
                              <select
                                value={selectedLead.mealPlans}
                                onChange={(e) => setSelectedLead({...selectedLead, mealPlans: e.target.value})}
                                className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                              >
                          ...
                          <div className="space-y-4">
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) => setSelectedLead({...selectedLead, noOfRooms: e.target.value})}
                                className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                              />
                            </div>
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) => setSelectedLead({...selectedLead, extraBeds: e.target.value})}
                                className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                              />
                            </div>
                          </div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                        ...
                        <div className="p-4 grid grid-cols-2 gap-4">
                          ...
                          <div>
                            <label className="block text-sm font-medium text-gray-700">Mobile</label>
                            <p className="mt-1 text-sm text-gray-900">{selectedLead?.mobile || 'N/A'}</p>
                          </div>
                          <div>
                            <label className="block text-sm font-medium text-gray-700">Package Type</label>
                            <p className="mt-1 text-sm text-gray-900">{selectedLead?.packageType || 'N/A'}</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                        <div className="px-4 py-3 bg-gray-50 border-b border-gray-200">
                          <h3 className="text-lg font-medium text-gray-900">Travel Details</h3>
                        </div>
                        <div className="p-4 grid grid-cols-2 gap-4">
                          <div>
                            <label className="block text-sm font-medium text-gray-700">From</label>
                            <p className="mt-1 text-sm text-gray-900">{selectedLead?.from || 'N/A'}</p>
                          </div>
                          <div>
                            <label className="block text-sm font-medium text-gray-700">Destination</label>
                            <p className="mt-1 text-sm text-gray-900">{selectedLead?.destination || 'N/A'}</p>
                          </div>
                          <div>
                            <label className="block text-sm font-medium text-gray-700">Travel Date</label>
                          ...
                          <div>
                            ...
                            <p className="mt-1 text-sm text-gray-900">
                              {selectedLead?.days ? `${selectedLead.days} Days, ${selectedLead.nights} Nights` : 'N/A'}
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                        ...
                        <div className="p-4 grid grid-cols-3 gap-4">
                          <div className="bg-blue-50 p-3 rounded-lg text-center">
                            <label className="block text-sm font-medium text-blue-700">Adults</label>
                            <p className="mt-1 text-2xl font-semibold text-blue-700">{selectedLead?.adults || '0'}</p>
                          </div>
                          <div className="bg-green-50 p-3 rounded-lg text-center">
                            <label className="block text-sm font-medium text-green-700">Kids</label>
                            <p className="mt-1 text-2xl font-semibold text-green-700">{selectedLead?.kids || '0'}</p>
                          </div>
                          <div className="bg-purple-50 p-3 rounded-lg text-center">
                            <label className="block text-sm font-medium text-purple-700">Total Guests</label>
                      ...
                      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                        ...
                        <div className="p-4 grid grid-cols-2 gap-4">
                          <div>
                            <label className="block text-sm font-medium text-gray-700">Package Category</label>
                            <p className="mt-1 text-sm text-gray-900">{selectedLead?.packageCategory || 'N/A'}</p>
                          </div>
                          <div>
                            <label className="block text-sm font-medium text-gray-700">Meal Plans</label>
                            <p className="mt-1 text-sm text-gray-900">{selectedLead?.mealPlans || 'N/A'}</p>
                          </div>
                          <div>
                            <label className="block text-sm font-medium text-gray-700">Number of Rooms</label>
                            <p className="mt-1 text-sm text-gray-900">{selectedLead?.noOfRooms || 'N/A'}</p>
                          </div>
                          <div>
                            <label className="block text-sm font-medium text-gray-700">Extra Beds</label>
                            <p className="mt-1 text-sm text-gray-900">{selectedLead?.extraBeds || 'N/A'}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <button 
                    onClick={async () => {
                      try {
                        ...
                        if (success) {  // Check if the update was successful
