                        ...
                        <div className="flex items-center justify-between mb-6">
                          <div className="flex items-center space-x-4">
                            ...
                            <div className="flex items-center space-x-2 text-gray-600">
                              <span>{selectedLead?.days || 0} Days</span>
                              <span>•</span>
                              <span>{selectedLead?.transfers || 0} Transfers</span>
                              <span>•</span>
                              <span>{selectedLead?.hotels || 0} Hotels</span>
                            </div>
                          </div>
                          <div className="text-right">
                            <div className="text-sm text-gray-500">Package Price</div>
                            <div className="text-2xl font-bold text-gray-900">₹{selectedLead?.price || 0}</div>
                          </div>
                        </div>

                        {/* Package customization form */}
                        {/* Add your package customization form here */}
                      </div>
                    </div>
                  </div>
                )}
                    ...
                    <div className="max-w-3xl mx-auto">
                      <div className="bg-white shadow-lg rounded-xl overflow-hidden">
                        <div className="px-8 py-6 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
                          ...
                          <p className="mt-2 text-blue-100">Choose your preferred method to share the package details</p>
                        </div>
                        ...
                        <div className="p-8">
                          <div className="grid grid-cols-3 gap-6">
                            ...
                            <ShareButton
                              ...
                              isLoading={isSharing && sharingMethod === 'whatsapp'}
                            />
                            <ShareButton
                              method="email"
                              icon="email-icon"
                              ...
                              isLoading={isSharing && sharingMethod === 'email'}
                            />
                            <ShareButton
                              method="sms"
                              icon="sms-icon"
                              ...
                              isLoading={isSharing && sharingMethod === 'sms'}
                            />
                          </div>
                        </div>
                      </div>
