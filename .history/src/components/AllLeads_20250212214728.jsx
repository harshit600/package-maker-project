...
const AllLeads = () => {
  ...
  const fetchPackages = async () => {
    try {
      ...
      // Filter packages where destination exactly matches
      const filteredPackages = data.filter((pkg) => {
        ...
        const packageDest = (pkg.destination || "").toLowerCase().trim();

        // Only return packages where destination matches exactly
        return packageDest === searchTerm;
      });
