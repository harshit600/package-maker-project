  ...
  const fetchPackages = async () => {
    try {
      ...
      const filteredPackages = data.filter((pkg) => {
        ...
        const searchTerm = selectedLead.destination.toLowerCase().trim();
        const packageName = (pkg.packageName || "").toLowerCase().trim();

        // Return packages where destination appears in the package name
