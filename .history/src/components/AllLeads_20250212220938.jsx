...
const AllLeads = () => {
  ...
  const fetchPackages = async (lead) => {
    try {
      ...
      // Log all packages received
      console.log("All packages received:", data);

      // Filter packages where lead destination appears in package.packageName
                            ...
                            <div className="p-4">
                              ...
                              <div className="space-y-3">
                                <div className="flex justify-between items-center">
                                  ...
                                  <span className="font-medium">
                                    {pkg.package?.duration || "N/A"} Days
                                  </span>
                                </div>
                                <div className="flex justify-between items-center">
                                  <span className="text-sm text-gray-600">Price</span>
                                  <span className="text-lg font-bold text-green-600">
                                    ₹{pkg.finalCosting?.finalPrices?.grandTotal || "N/A"}
                                  </span>
                                </div>
