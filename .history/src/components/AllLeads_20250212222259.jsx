...
// Add this CSS to your AllLeads.css file
const tabStyles = `
  .tabs-container {
    background: white;
    border-radius: 8px;
...
const TabIcon = ({ icon, isActive }) => (
  <span className={`tab-icon ${isActive ? 'text-purple-600' : 'text-gray-500'}`}>
    {icon}
  </span>
);
      ...
      {isEditPanelOpen && (
        <div className="tabs-container">
          ...
          <div className="tabs-header">
            <div
              className={`tab-item ${activeTab === 'leadDetails' ? 'active' : ''}`}
              onClick={() => setActiveTab('leadDetails')}
            >
              <TabIcon 
                icon={<i className="fas fa-user-circle"/>} 
                isActive={activeTab === 'leadDetails'}
              />
              Lead Details
            </div>
            <div
              className={`tab-item ${activeTab === 'viewPackage' ? 'active' : ''}`}
              onClick={() => setActiveTab('viewPackage')}
            >
              <TabIcon 
                icon={<i className="fas fa-star"/>} 
                isActive={activeTab === 'viewPackage'}
              />
              View Package
            </div>
            <div
              className={`tab-item ${activeTab === 'sendPackage' ? 'active' : ''}`}
              onClick={() => setActiveTab('sendPackage')}
            >
              <TabIcon 
                icon={<i className="fas fa-location-dot"/>} 
                isActive={activeTab === 'sendPackage'}
              />
              Send Package
            </div>
          </div>
