...
import { FaPhone, FaStar, FaMapMarkerAlt, FaUser, FaBox, FaPaperPlane, FaHistory } from "react-icons/fa";
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-end">
          <div className="w-1/3 bg-white h-full overflow-y-auto">
            ...
            <div className={tabStyles.container}>
              ...
              >
                <FaBox className={tabStyles.icon} />
              ...
              >
                <FaPaperPlane className={tabStyles.icon} />
              ...
              >
                <FaHistory className={tabStyles.icon} />
                <span>History</span>
              </div>
            </div>
