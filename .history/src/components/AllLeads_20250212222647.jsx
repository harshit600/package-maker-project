...
import { FaPhone, FaStar, FaMapMarkerAlt, FaUser } from 'react-icons/fa';
...
const AllLeads = () => {
  ...
  const tabStyles = {
    container: `flex border-b mb-4`,
    tab: `flex items-center px-6 py-3 cursor-pointer`,
    activeTab: `text-purple-600 border-b-2 border-purple-600`,
            ...
            <div className={tabStyles.container}>
              <div
                className={`${tabStyles.tab} ${
                  activeTab === "leadDetails" ? tabStyles.activeTab : tabStyles.inactiveTab
                }`}
                onClick={() => setActiveTab("leadDetails")}
              >
                <FaPhone className={tabStyles.icon} />
                <span>RECENTS</span>
              </div>

              <div
                className={`${tabStyles.tab} ${
                  activeTab === "viewPackage" ? tabStyles.activeTab : tabStyles.inactiveTab
                }`}
                onClick={() => setActiveTab("viewPackage")}
              >
                <FaStar className={tabStyles.icon} />
                <span>FAVORITES</span>
              </div>

              <div
                className={`${tabStyles.tab} ${
                  activeTab === "sendPackage" ? tabStyles.activeTab : tabStyles.inactiveTab
                }`}
                onClick={() => setActiveTab("sendPackage")}
              >
                <FaMapMarkerAlt className={tabStyles.icon} />
                <span>NEARBY</span>
              </div>
              ...
              >
                <FaUser className={tabStyles.icon} />
                <span>SAVED</span>
              </div>
            </div>
