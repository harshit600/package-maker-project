                  ...
                  <div className="p-6 bg-white relative">
                    <div className="space-y-6">
                      ...
                      <div className="mb-4 p-2 bg-gray-100 rounded">
                        <p>Available Packages: {availablePackages?.length || 0}</p>
                        <p>Selected Lead Destination: {selectedLead?.destination || "None"}</p>
                      </div>

                      {/* Lead Destination Info */}
                      <div className="bg-blue-50 p-4 rounded-lg mb-4">
                        <h3 className="text-lg font-semibold text-blue-900 mb-2">Selected Destination</h3>
                        <p className="text-blue-700">{selectedLead?.destination || "No destination selected"}</p>
                      </div>
                          ...
                          <tbody className="bg-white divide-y divide-gray-200">
                            {Array.isArray(availablePackages) && availablePackages.length > 0 ? (
                              availablePackages.map((pkg, index) => (
                                <tr key={pkg._id || index} className="hover:bg-gray-50">
                    ...
                    <div
                      className={`fixed inset-y-0 right-0 w-1/3 bg-white shadow-xl transform transition-transform duration-300 ease-in-out z-50 ${
                          ...
                          {selectedPackage && (
                            <div className="space-y-6">
                              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                                <h3 className="text-lg font-semibold mb-4">{selectedPackage.package?.packageName}</h3>
                                <div className="space-y-4">
                                  <div>
                                  ...
                                  <div>
                                    ...
                                    <p className="text-lg font-medium text-green-600">
                                      ₹{selectedPackage.finalCosting?.finalPrices?.grandTotal}
                                    </p>
                                  </div>
                                </div>
                              </div>
