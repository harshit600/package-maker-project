              ...
              <div className="flex-1 overflow-y-auto">
                ...
                {activeTab === "viewPackage" && (
                  <div className="p-6 bg-white relative">
                    ...
                    <div
                      className={`fixed inset-y-0 right-0 w-2/5 bg-white shadow-xl transform transition-transform duration-300 ease-in-out z-50 ${
                      ...
                      <div className="h-full flex flex-col">
                                  ...
                                  <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                                    ...
                                    <div className="space-y-4">
                                      <div>
                                        ...
                                        <p className="text-base font-medium">{selectedPackage.package?.packageType}</p>
                                      </div>
                                      <div>
                                    ...
                                    <div className="space-y-6">
                                      <div className="grid grid-cols-2 gap-4">
                                        <div className="bg-gray-50 rounded-lg p-4">
                                          ...
                                          <p className="text-xl font-semibold text-gray-900">₹{selectedPackage.finalCosting?.baseTotal}</p>
                                        </div>
                                        <div className="bg-gray-50 rounded-lg p-4">
                                          <p className="text-sm text-gray-500">Tax Amount</p>
                                          <p className="text-xl font-semibold text-gray-900">₹{selectedPackage.finalCosting?.taxAmount}</p>
                                        </div>
                                      </div>
                                      <div className="border-t pt-4">
                                        <div className="bg-green-50 rounded-lg p-4">
                                          <p className="text-sm text-green-600">Grand Total</p>
                                          <p className="text-2xl font-bold text-green-600">₹{selectedPackage.finalCosting?.grandTotal}</p>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                        ...
                        <div className="p-4 bg-gray-50 border-t border-gray-200">
                          <button
                            onClick={async () => {
                              try {
                                const success = await handleUpdateLead(selectedLead._id, {
                                  ...selectedLead,
