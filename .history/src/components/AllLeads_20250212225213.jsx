                              ...
                              {packageInfoTab === "package" && (
                                <div className="space-y-6">
                                  <div className="bg-gradient-to-br from-[rgb(45,45,68)] to-[rgb(55,55,88)] rounded-xl p-8 text-white shadow-xl">
                                    <h3 className="text-2xl font-bold mb-4">{selectedPackage.package?.packageName}</h3>
                                    <div className="grid grid-cols-3 gap-4">
                                      <div className="bg-white/10 rounded-lg p-4">
                                        <p className="text-sm opacity-75">Duration</p>
                                        <p className="text-lg font-medium">{selectedPackage.package?.duration} Days</p>
                                      </div>
                                      <div className="bg-white/10 rounded-lg p-4">
                                        <p className="text-sm opacity-75">Category</p>
                                        <p className="text-lg font-medium">{selectedPackage.package?.packageCategory}</p>
                                      </div>
                                      <div className="bg-white/10 rounded-lg p-4">
                                        <p className="text-sm opacity-75">Package Type</p>
                                        <p className="text-lg font-medium">{selectedPackage.package?.packageType}</p>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                                    ...
                                    <div className="grid grid-cols-2 gap-6">
                                      <div>
                                        ...
                                        <p className="text-base font-medium">{selectedPackage.package?.pickupLocation}</p>
                                      </div>
                                      <div>
                                        <p className="text-sm text-gray-500">Drop Location</p>
                                        <p className="text-base font-medium">{selectedPackage.package?.dropLocation}</p>
                                      </div>
                                      <div>
                                        <p className="text-sm text-gray-500">Start Date</p>
                                        <p className="text-base font-medium">
                                          {selectedPackage.package?.startDate ? new Date(selectedPackage.package.startDate).toLocaleDateString() : 'N/A'}
                                        </p>
                                      </div>
                                      <div>
                                        <p className="text-sm text-gray-500">End Date</p>
                                        <p className="text-base font-medium">
                                          {selectedPackage.package?.endDate ? new Date(selectedPackage.package.endDate).toLocaleDateString() : 'N/A'}
                                        </p>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  {/* Package Inclusions */}
                                  <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                                    <h4 className="text-lg font-semibold text-gray-900 mb-4">Package Inclusions</h4>
                                    <div className="space-y-4">
                                      {selectedPackage.package?.inclusions?.map((inclusion, index) => (
                                  ...
                                  {/* Package Exclusions */}
                                  <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                                    <h4 className="text-lg font-semibold text-gray-900 mb-4">Package Exclusions</h4>
                                    <div className="space-y-4">
                                      {selectedPackage.package?.exclusions?.map((exclusion, index) => (
                                        <div key={index} className="flex items-start gap-2">
                                  ...
                                  <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                                    ...
                                    <div className="space-y-6">
                                      {selectedPackage.package?.itinerary?.map((day, index) => (
                                        <div key={index} className="border-b border-gray-200 pb-6 last:border-0 last:pb-0">
                                          <h5 className="font-medium text-blue-600 mb-2">Day {index + 1}</h5>
                                ...
                                <div className="space-y-6">
                                  <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                                    <div className="flex items-center gap-3 mb-6">
                                      <span className="p-2 bg-gray-100 rounded-lg text-[rgb(45,45,68)] text-xl">🚗</span>
                                      <h4 className="text-lg font-semibold text-[rgb(45,45,68)]">Cab Details</h4>
                                    </div>
                                    {Object.entries(selectedPackage.cabs?.travelPrices?.selectedCabs || {}).map(([cabType, cabs]) => (
                                      <div key={cabType} className="mb-6">
                                        <h5 className="font-semibold text-lg text-gray-800 mb-4">{cabType}</h5>
                                        <div className="grid grid-cols-2 gap-4">
                                          {cabs.map((cab, index) => (
                                            <div key={index} className="border border-gray-200 rounded-lg p-4">
                                              <div className="flex justify-between items-center mb-2">
                                                <h6 className="font-medium text-gray-700">{cab.cabName}</h6>
                                                <span className="text-green-600 font-semibold">₹{cab.prices?.onSeasonPrice}</span>
                                              </div>
                                              <div className="space-y-2">
                                                <p className="text-sm text-gray-500">Seating: {cab.seatingCapacity}</p>
                                                <p className="text-sm text-gray-500">AC: {cab.ac ? "Yes" : "No"}</p>
                                                <p className="text-sm text-gray-500">Luggage Capacity: {cab.luggageCapacity}</p>
                                                {cab.amenities && (
                                                  <div className="pt-2">
                                    ...
                                    <div className="flex items-center justify-between mb-6">
                                      ...
                                      <div className="flex gap-4">
                                        <div className="px-4 py-2 bg-white/10 rounded-lg backdrop-blur-sm">
                                          <span className="text-sm font-medium">Total Nights: </span>
                                          <span className="font-mono">{selectedPackage?.hotels?.totalNights || "0"}</span>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                  {Object.entries(selectedPackage?.hotels || {}).map(([location, hotelInfo]) => (
                                    <div key={location} className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                                      <h4 className="text-lg font-semibold text-gray-900 mb-4">{location}</h4>
                                      <div className="grid grid-cols-2 gap-6">
                                        <div>
                                          <p className="text-sm text-gray-500">Hotel Name</p>
                                          <p className="text-base font-medium">{hotelInfo.hotelName}</p>
                                        </div>
                                        <div>
                                          <p className="text-sm text-gray-500">Room Type</p>
                                          <p className="text-base font-medium">{hotelInfo.roomType}</p>
                                        </div>
                                        <div>
                                          <p className="text-sm text-gray-500">Check In</p>
                                          <p className="text-base font-medium">
                                            {hotelInfo.checkIn ? new Date(hotelInfo.checkIn).toLocaleDateString() : 'N/A'}
                                          </p>
                                        </div>
                                        <div>
                                          <p className="text-sm text-gray-500">Check Out</p>
                                          <p className="text-base font-medium">
                                            {hotelInfo.checkOut ? new Date(hotelInfo.checkOut).toLocaleDateString() : 'N/A'}
                                          </p>
                                        </div>
                                      </div>
                                      {hotelInfo.amenities && (
                              ...
                              {packageInfoTab === "costing" && (
                                <div className="space-y-6">
                                  <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                                    <div className="flex items-center gap-3 mb-6">
                                      <span className="p-2 bg-gray-100 rounded-lg text-[rgb(45,45,68)] text-xl">💰</span>
                                      <h4 className="text-lg font-semibold text-[rgb(45,45,68)]">Final Costing Details</h4>
                                    </div>
                                    ...
                                    <div className="space-y-6">
                                      <div className="grid grid-cols-3 gap-4">
                                        <div className="bg-gray-50 rounded-lg p-4">
                                          ...
                                          <p className="text-xl font-semibold text-gray-900">
                                            ₹{selectedPackage.finalCosting?.breakdown?.hotelCost || 0}
                                          </p>
                                        </div>
                                        <div className="bg-gray-50 rounded-lg p-4">
                                          <p className="text-sm text-gray-500">Transport Cost</p>
                                          <p className="text-xl font-semibold text-gray-900">
                                            ₹{selectedPackage.finalCosting?.breakdown?.transportCost || 0}
                                          </p>
                                        </div>
                                        <div className="bg-gray-50 rounded-lg p-4">
                                          <p className="text-sm text-gray-500">Activities Cost</p>
                                          <p className="text-xl font-semibold text-gray-900">
                                            ₹{selectedPackage.finalCosting?.breakdown?.activitiesTotalCost || 0}
                                          </p>
                                        </div>
                                      </div>
                                      ...
                                      <div className="border-t border-gray-200 pt-4">
                                        <div className="bg-blue-50 rounded-lg p-4">
                                          <p className="text-sm text-blue-600">Base Total</p>
                                      ...
                                      {/* Margins */}
                                      <div className="border-t border-gray-200 pt-4">
                                        <h5 className="text-lg font-semibold text-gray-900 mb-4">Margins</h5>
                                        <div className="grid grid-cols-3 gap-4">
                                          <div className="bg-gray-50 rounded-lg p-4">
                                            <p className="text-sm text-gray-500">B2B Margin</p>
                                            <p className="text-lg font-medium text-gray-900">
                                              {selectedPackage.finalCosting?.margins?.b2b || 0}%
                                            </p>
                                          </div>
                                          <div className="bg-gray-50 rounded-lg p-4">
                                            <p className="text-sm text-gray-500">Internal Margin</p>
                                            <p className="text-lg font-medium text-gray-900">
                                              {selectedPackage.finalCosting?.margins?.internal || 0}%
                                            </p>
                                          </div>
                                          <div className="bg-gray-50 rounded-lg p-4">
                                            <p className="text-sm text-gray-500">Website Margin</p>
                                            <p className="text-lg font-medium text-gray-900">
                                              {selectedPackage.finalCosting?.margins?.website || 0}%
                                            </p>
                                          </div>
                                        </div>
                                      </div>
                                      ...
                                      {/* Final Prices */}
                                      <div className="border-t border-gray-200 pt-4">
                                        <h5 className="text-lg font-semibold text-gray-900 mb-4">Final Prices</h5>
                                        <div className="grid grid-cols-3 gap-4">
                                          <div className="bg-green-50 rounded-lg p-4">
                                            <p className="text-sm text-green-600">B2B Price</p>
                                            <p className="text-xl font-bold text-green-600">
                                              ₹{selectedPackage.finalCosting?.finalPrices?.b2b || 0}
                                            </p>
                                          </div>
                                          <div className="bg-green-50 rounded-lg p-4">
                                            <p className="text-sm text-green-600">Internal Price</p>
                                            <p className="text-xl font-bold text-green-600">
                                              ₹{selectedPackage.finalCosting?.finalPrices?.internal || 0}
                                            </p>
                                          </div>
                                          <div className="bg-green-50 rounded-lg p-4">
                                            <p className="text-sm text-green-600">Website Price</p>
                                            <p className="text-xl font-bold text-green-600">
                                              ₹{selectedPackage.finalCosting?.finalPrices?.website || 0}
                                            </p>
                                          </div>
                                        </div>
                                      </div>
                                      ...
                                      <div className="border-t border-gray-200 pt-4">
                                        <div className="bg-green-50 rounded-lg p-4">
                                          ...
                                          <p className="text-3xl font-bold text-green-600">
                                            ₹{selectedPackage.finalCosting?.grandTotal || 0}
                                          </p>
                                        </div>
                                      </div>
                                    </div>
