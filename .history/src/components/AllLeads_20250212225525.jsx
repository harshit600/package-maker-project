                            ...
                            <>
                              ...
                              {packageInfoTab === "package" && (
                                <div className="space-y-6">
                                  ...
                                  {/* Detailed Itinerary */}
                                  <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                                    <h4 className="text-lg font-semibold text-gray-900 mb-4">Day-wise Itinerary</h4>
                                    <div className="space-y-6">
                                      {selectedPackage.package?.itinerary?.map((day, index) => (
                                        <div key={index} className="relative pl-8 pb-6 last:pb-0">
                                          ...
                                          <div className="absolute left-0 top-0 h-full">
                                            ...
                                            {index !== selectedPackage.package.itinerary.length - 1 && (
                                              <div className="absolute top-4 left-2 w-[1px] h-[calc(100%-16px)] bg-blue-200"></div>
                                            )}
                                          </div>
                                          
                                          <div className="bg-gray-50 rounded-lg p-4">
                                            <h5 className="text-lg font-semibold text-blue-600 mb-2">Day {index + 1}</h5>
                                            <div className="space-y-4">
                                              {day.title && (
                                  ...
                                  {selectedPackage.package?.termsAndConditions && (
                                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                                      <h4 className="text-lg font-semibold text-gray-900 mb-4">Terms & Conditions</h4>
                                      <div className="space-y-3">
                                        {selectedPackage.package.termsAndConditions.map((term, index) => (
                                  ...
                                  {/* Cancellation Policy */}
                                  {selectedPackage.package?.cancellationPolicy && (
                                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                                      <h4 className="text-lg font-semibold text-gray-900 mb-4">Cancellation Policy</h4>
                                      <div className="space-y-4">
                                        {selectedPackage.package.cancellationPolicy.map((policy, index) => (
