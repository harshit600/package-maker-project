                                  ...
                                  <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                                        ...
                                        <div className="border-b border-gray-200 pb-4 mb-4">
                                          <div className="flex items-center justify-between mb-4">
                                            ...
                                            <div className="flex items-center gap-2 text-sm text-gray-600">
                                              <span>Distance: {day.selectedItinerary?.distance} km</span>
                                              <span>•</span>
                                              <span>Duration: {day.selectedItinerary?.totalHours} hours</span>
                                            </div>
                                          </div>
                                            ...
                                            {Object.entries(selectedPackage.cabs?.travelPrices?.selectedCabs || {}).map(([cabType, cabs]) => (
                                              cabs.map((cab, cabIndex) => (
                                                <div 
                                                  ...
                                                  className="relative border border-gray-200 rounded-lg p-4 hover:border-blue-500 transition-colors"
                                                >
                                                  <input
                                                    type="radio"
                                                    name={`cab-day-${day.day}`}
                                                    id={`cab-${day.day}-${cabType}-${cabIndex}`}
                                                    className="absolute right-4 top-4 h-4 w-4 text-blue-600 focus:ring-blue-500"
                                                    onChange={() => {
                                                      // Handle cab selection for this day
                                                  ...
                                                  <div className="flex items-start gap-4">
                                                    <div className="flex-1">
                                                      ...
                                                      <div className="space-y-1 text-sm text-gray-600">
                                                        <p>Type: {cabType}</p>
                                                        <p>Seating: {cab.seatingCapacity} persons</p>
                                                        <p>AC: {cab.ac ? "Yes" : "No"}</p>
                                                        {cab.luggageCapacity && (
                                                          <p>Luggage: {cab.luggageCapacity}</p>
                                                        )}
                                                      </div>
                                    ...
                                    <div className="mt-8 border-t border-gray-200 pt-6">
                                      <div className="flex justify-between items-center">
                                        <h5 className="text-lg font-semibold text-gray-900">Total Cab Cost</h5>
