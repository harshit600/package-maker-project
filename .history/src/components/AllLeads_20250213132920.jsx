                                      ...
                                      <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                          ...
                                          <p className="text-white/80">
                                            Choose your perfect ride for each
                                            day
                                          </p>
                                        </div>
                                      </div>
                                            ...
                                            {Object.entries(
                                              ...
                                              cabs.map((cab, cabIndex) => (
                                                <label
                                                  ...
                                                  ${
                                                    day.selectedCab?.type ===
                                                      cabType &&
                                                    day.selectedCab?.cabName ===
                                                      cab.cabName
                                    ...
                                    <div className="flex items-center justify-between">
                                      ...
                                      <div className="text-right">
                                        <p className="text-3xl font-bold text-green-600">
                                          ₹
                                          {selectedPackage.package?.itineraryDays?.reduce(
                                            (total, day) => {
                                              return (
                                                total +
                                                (day.selectedCab?.prices
                                                  ?.onSeasonPrice || 0)
                                              );
                                            },
                                            0
