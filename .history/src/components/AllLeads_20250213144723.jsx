                        ...
                        <div className="flex-1 overflow-y-auto p-6">
                          {selectedPackage && (
                            <>
                              ...
                              {packageInfoTab === "cab" && (
                                <div className="p-4">
                                  <h2 className="text-xl font-bold mb-4">Cab Selection</h2>
                                  
                                  {/* Debug Info */}
                                  <div className="bg-gray-100 p-4 mb-4 rounded">
                                    <p>Number of Days: {selectedPackage.package?.itineraryDays?.length || 0}</p>
                                    <p>Has Cabs: {selectedPackage.cabs ? 'Yes' : 'No'}</p>
                                    <pre className="mt-2 text-sm">
                                      {JSON.stringify(selectedPackage.cabs?.travelPrices?.selectedCabs, null, 2)}
                                    </pre>
                                  </div>
                                          ...
                                          <div key={type} className="mb-4">
                                            ...
                                            {cabs.map((cab, i) => (
                                              <div key={i} className="border p-2 mt-2">
                                                <p>{cab.cabName} - ₹{cab.prices?.onSeasonPrice}</p>
                                              </div>
                                            ))}
                                          </div>
                                        ))}
