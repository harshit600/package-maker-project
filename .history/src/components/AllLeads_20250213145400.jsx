                              ...
                              {packageInfoTab === "cab" && (
                                <div className="space-y-6">
                                  <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                                    <div className="mb-4">
                                      <h4 className="text-xl font-semibold text-gray-900">Change Transfer</h4>
                                      <p className="text-gray-500 text-sm mt-1">Changes would be reflected to whole itinerary</p>
                                    </div>
                                      ...
                                      {Object.entries(
                                        ...
                                        <div key={cabType} className="space-y-4">
                                          {cabs.map((cab, index) => (
                                            <div
                                              key={index}
                                              className={`bg-[#F8FBFF] border rounded-lg overflow-hidden ${
                                            ...
                                            >
                                              <div className="flex items-start gap-4 p-4">
                                                ...
                                                <div className="flex items-center gap-3">
                                                  ...
                                                  />
                                                  <div className="w-24 h-20 bg-white rounded-lg border border-gray-200 flex items-center justify-center p-2">
                                                    <img
                                                      src={cab.image || '/car-placeholder.png'}
                                                      alt={cab.cabName}
                                                ...
                                                <div className="flex-1">
                                                  <div className="flex items-start justify-between">
                                                    <div>
                                                      <h5 className="text-gray-900 font-medium">
                                                        {cab.cabName}
                                                        <span className="text-gray-500 text-sm ml-1">(or Similar)</span>
                                                      </h5>
                                                      <p className="text-gray-500 text-sm">
                                                        Private Transfer/{cab.cabType || 'Tempo Traveller'}/
                                                        {cab.ac ? 'AC' : 'Non AC'}
                                                      </p>
                                                    </div>
                                                    <div className="flex items-center gap-2">
                                                  ...
                                                  {/* Facilities */}
                                                  <div className="mt-3">
                                                    <p className="text-sm text-gray-700 mb-1">Facilities:</p>
                                                    <div className="flex items-center gap-4">
                                                      <div className="flex items-center gap-1">
                                                        <svg className="w-4 h-4 text-gray-500" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                                                        </svg>
                                                        <span className="text-sm text-gray-700">{cab.seatingCapacity} seater</span>
                                                      </div>
                                                      <div className="flex items-center gap-1">
                                                        <svg className="w-4 h-4 text-gray-500" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                                      ...
                                                      <div className="flex items-center gap-1">
                                                        ...
                                                        <span className="text-sm text-gray-700">{cab.luggageCapacity} luggage bags</span>
                                                      </div>
                                                    </div>
                                                  </div>
                                                ...
                                                <div className="text-right min-w-[120px]">
                                                  ...
                                                  {selectedPackage.selectedCab?.cabName !== cab.cabName && (
                                                    <button
                                                      ...
                                                      className="mt-2 w-full px-4 py-2 bg-blue-500 text-white text-sm font-medium rounded hover:bg-blue-600 transition-colors"
                                                    >
                                                      SELECT
                                                    </button>
                                                  )}
