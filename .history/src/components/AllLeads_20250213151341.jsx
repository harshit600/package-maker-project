                                ...
                                {selectedPackage?.package?.itineraryDays?.map((day, index) => (
                                  <div key={index} className="relative pl-8 pb-8 last:pb-0">
                                    ...
                                    <div className="absolute left-0 top-0 h-full">
                                      ...
                                      {index !== selectedPackage.package.itineraryDays.length - 1 && (
                                      ...
                                      <div className="bg-gray-50 rounded-lg p-4">
                                        <div className="flex items-center justify-between">
                                          <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                              <p className="text-sm font-medium text-gray-900">Private Transfer</p>
                                              <p className="text-xs text-gray-500">
                                                {selectedPackage?.selectedCab?.seatingCapacity} Seater • Luggage
                                              </p>
                                            </div>
                                          </div>
                                          <button 
                                            ...
                                            <div className="flex justify-between items-start">
                                              <div>
                                                <h5 className="font-medium text-gray-900 mb-1">
                                                  Check-In At {selectedPackage.hotels[day.day].hotelName}
                                                </h5>
                                                <div className="flex items-center gap-2 text-sm text-gray-500">
                                                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                                                  </svg>
                                                  {selectedPackage.hotels[day.day].location}
                                                </div>
                                              </div>
                                              <button 
                                            ...
                                            <div className="mt-4 grid grid-cols-2 gap-4">
                                              <div>
                                                ...
                                                <p className="font-medium">
                                                  {new Date(selectedPackage.hotels[day.day].checkIn).toLocaleDateString()}
                                                </p>
                                              </div>
                                              <div>
                                                <p className="text-sm text-gray-500">Check Out</p>
                                                <p className="font-medium">
                                                  {new Date(selectedPackage.hotels[day.day].checkOut).toLocaleDateString()}
                                                </p>
                                              </div>
                                              <div>
                                                <p className="text-sm text-gray-500">Room Type</p>
                                                <p className="font-medium">{selectedPackage.hotels[day.day].roomType}</p>
                                              </div>
                                              <div>
                                                <p className="text-sm text-gray-500">Meal Plan</p>
                                                <p className="font-medium">{selectedPackage.hotels[day.day].mealPlan}</p>
                                              </div>
                                            </div>
                                          </div>
                                        </div>
