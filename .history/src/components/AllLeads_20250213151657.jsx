              ...
              <div className="flex-1 overflow-y-auto">
                ...
                {activeTab === "viewPackage" && (
                  <div className="p-6 bg-white relative">
                    ...
                    <div className={`fixed inset-y-0 right-0 w-[90%] bg-white shadow-xl transform transition-transform duration-300 ease-in-out z-50 ${
                      ...
                      <div className="h-full flex flex-col">
                        ...
                        <div className="bg-[rgb(45,45,68)] text-white">
                          <div className="px-6 py-4 flex justify-between items-center">
                            <h2 className="text-xl font-semibold">
                              {packageInfoTab === "cab" ? "Change Transfer" : "Package Details"}
                            </h2>
                            <button onClick={() => setIsPackageInfoOpen(false)} className="text-white hover:text-gray-200">
                        ...
                        <div className="flex-1 overflow-y-auto">
                          {packageInfoTab === "cab" ? (
                            <div className="p-6">
                              <div className="mb-4">
                                <h3 className="text-lg font-medium text-gray-900">Shimla - Manali</h3>
                                <p className="text-sm text-gray-500 italic">Changes would be reflected to whole itinerary</p>
                              </div>
                              ...
                              <div className="space-y-4">
                                ...
                                <div className="border rounded-lg overflow-hidden bg-blue-50">
                                    ...
                                    <div className="flex gap-4">
                                      ...
                                      <div>
                                        <div className="flex items-center gap-2">
                                          <h4 className="text-lg font-medium">Tempo Traveller, Winger</h4>
                                          <span className="text-sm text-gray-500">(or Similar)</span>
                                        </div>
                                        <p className="text-sm text-gray-600">Private Transfer/Tempo Traveller/Winger-Non AC</p>
                                        ...
                                        <div className="mt-2">
                                          ...
                                          <div className="flex items-center gap-4 mt-1">
                                            <div className="flex items-center gap-1">
                                              ...
                                              <span className="text-sm">16 seater</span>
                                            </div>
                                            <div className="flex items-center gap-1">
                                              <svg className="w-4 h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z" />
                                              </svg>
                                              <span className="text-sm">10 luggage bags</span>
                                            </div>
                                            <div className="flex items-center gap-1">
                                              <svg className="w-4 h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  ...
                                  <div className="px-4 py-2 bg-blue-100">
                                    <p className="text-sm text-blue-800">Intercity Transfer; 14 Sightseeing Transfers Included</p>
                                  </div>
                                </div>
                                ...
                                {[
                                  ...
                                  <div key={index} className="border rounded-lg overflow-hidden">
                                    <div className="p-4 flex justify-between items-start">
                                      <div className="flex gap-4">
                                        <div className="w-24 h-24 bg-gray-100 rounded-lg p-2">
                                          <img 
                                            src={`/${cab.name.toLowerCase().replace(' ', '-')}.png`}
                                            alt={cab.name}
                                            className="w-full h-full object-contain"
                                          />
                                        </div>
                                        <div>
                                          <div className="flex items-center gap-2">
                                            <h4 className="text-lg font-medium">{cab.name}</h4>
                                            <span className="text-sm text-gray-500">(or Similar)</span>
                                          </div>
                                          ...
                                          <div className="mt-2">
                                            ...
                                            <div className="flex items-center gap-4 mt-1">
                                              <div className="flex items-center gap-1">
                                                ...
                                                <span className="text-sm">{cab.seats} seater</span>
                                              </div>
                                              {cab.hasAC && (
                                                <div className="flex items-center gap-1">
                                                  <svg className="w-4 h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                              ...
                                              <div className="flex items-center gap-1">
                                                ...
                                                <span className="text-sm">{cab.luggage} luggage bags</span>
                                              </div>
                                              <div className="flex items-center gap-1">
                                                <svg className="w-4 h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                  <path d="M4.5 12.5l6-6m-6 6l6 6m-6-6h14" />
                                      ...
                                      <div className="flex flex-col items-end gap-2">
                                        <div className="text-right">
                                          <span className="text-lg font-semibold">-₹{cab.price}</span>
                                    ...
                                    <div className="px-4 py-2 bg-gray-50">
                                      <p className="text-sm text-gray-600">Intercity Transfer; 14 Sightseeing Transfers Included</p>
                                    </div>
                                  </div>
                                ))}
                              </div>
