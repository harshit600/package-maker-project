                                          ...
                                          <div className="bg-gray-50 rounded-lg p-4">
                                            <div className="flex items-center justify-between">
                                              <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                  <p className="text-sm font-medium text-gray-900">{selectedCab.name}</p>
                                                  <p className="text-xs text-gray-500">
                                                    {selectedCab.seats} Seater • {selectedCab.hasAC ? 'AC' : 'Non AC'}
                                                  </p>
                                                </div>
                                              </div>
                                              <button 
                                            ...
                                            <div className="space-y-4">
                                              {[
                                                ...
                                                <div 
                                                  key={cab.name} 
                                                  className={`border rounded-lg overflow-hidden ${
                                                    selectedCab.name === cab.name ? 'bg-blue-50 border-blue-200' : 'bg-white'
                                                  }`}
                                                >
                                                  <div className="p-4 flex justify-between items-start">
                                                    <div className="flex gap-4">
                                                  ...
                                                  <div className={`px-4 py-2 ${selectedCab.name === cab.name ? 'bg-blue-100' : 'bg-gray-50'}`}>
                                                    <p className={`text-sm ${selectedCab.name === cab.name ? 'text-blue-800' : 'text-gray-600'}`}>
