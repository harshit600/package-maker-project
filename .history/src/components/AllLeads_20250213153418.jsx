...
const AllLeads = () => {
  ...
  const fetchCabs = async () => {
    try {
      ...
      setSelectedCab(data.result.find(cab => cab.cabName.toLowerCase().includes('swift')) || data.result[0]);
    } catch (error) {
                                      ...
                                      <div>
                                        <div className="flex items-center gap-2">
                                          ...
                                          <span className="text-sm text-gray-500">
                                            ({selectedCab?.cabSeatingCapacity} • {selectedCab?.cabLuggage})
                                          </span>
                                        </div>
                                        <p className="text-sm text-gray-600">
                                  ...
                                  (day, index) => (
                                    ...
                                    >
                                      ...
                                      <div className="space-y-4">
                                        ...
                                        {/* Transfer Details - Only show for Day 1 */}
                                        {day.day === 1 && (
                                          <div className="bg-gray-50 rounded-lg p-4">
                                            <div className="flex items-center justify-between">
                                              <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                  <p className="text-sm font-medium text-gray-900">{selectedCab?.cabName}</p>
                                              ...
                                              <div className="space-y-4">
                                                {cabs.map((cab) => (
                                                  <div 
                                                    key={cab._id} 
                                                    className={`border rounded-lg overflow-hidden ${
                                                      selectedCab?._id === cab._id ? 'bg-blue-50 border-blue-200' : 'bg-white'
                                                    }`}
                                                  >
                                                    <div className="p-4 flex justify-between items-start">
                                                      <div className="flex gap-4">
                                                        ...
                                                        <div>
                                                          <div className="flex items-center gap-2">
                                                            <h4 className="text-lg font-medium">{cab.cabName}</h4>
                                                          ...
                                                          <div className="mt-2">
                                                            ...
                                                            <div className="flex items-center gap-4 mt-1">
                                                              <div className="flex items-center gap-1">
                                                                ...
                                                                <span className="text-sm">{cab.cabSeatingCapacity}</span>
                                                              </div>
                                                              <div className="flex items-center gap-1">
                                                                <svg className="w-4 h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                  <path d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z" />
                                                                </svg>
                                                                <span className="text-sm">{cab.cabLuggage}</span>
                                                              </div>
                                                            </div>
                                                          </div>
                                                        </div>
                                                    ...
                                                    <div className={`px-4 py-2 ${selectedCab?._id === cab._id ? 'bg-blue-100' : 'bg-gray-50'}`}>
                                                      <p className={`text-sm ${selectedCab?._id === cab._id ? 'text-blue-800' : 'text-gray-600'}`}>
