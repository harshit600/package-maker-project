                                              ...
                                              <div className="mt-4 bg-gray-50 rounded-lg p-4">
                                                <div className="flex items-start gap-4">
                                                  ...
                                                  <div className="flex-1">
                                                    <h4 className="text-lg font-medium text-gray-900">Private Transfer</h4>
                                                    ...
                                                    <p className="mt-1 text-sm text-gray-500">Intercity Transfer</p>
                                                  </div>
                                                </div>
                                              </div>
                                              ...
                                              <div className="space-y-4">
                                                {cabs.map((cab) => (
                                                  <div 
                                                    key={cab._id} 
                                                    className={`border rounded-lg overflow-hidden ${
                                                      selectedCab?._id === cab._id ? 'border-blue-200' : 'border-gray-200'
                                                    }`}
                                                  >
                                                    <div className="p-4">
                                                      <div className="flex gap-4">
