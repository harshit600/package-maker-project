                                    ...
                                    >
                                      ...
                                      <div className="space-y-4">
                                            ...
                                            <div className="px-4 py-3">
                                              <div className="flex items-center justify-between">
                                                <div className="flex items-center gap-2">
                                                  ...
                                                  <span className="text-gray-600">New Delhi to Shimla</span>
                                                </div>
                                                <div className="flex items-center gap-2">
                                                  <button 
                                                    onClick={() => setPackageInfoTab("cab")}
                                              ...
                                              <div className="mt-4 bg-gray-50 rounded-lg p-4">
                                                <div className="flex items-start gap-4">
                                                  ...
                                                  <div className="flex-1">
                                                    <h4 className="text-lg font-medium text-gray-900">{selectedCab?.cabName}</h4>
                                                    <div className="mt-1 flex items-center gap-2 text-gray-600">
                                                      <span>{selectedCab?.cabSeatingCapacity} seater</span>
                                                      <span>|</span>
                                                      <span>{selectedCab?.cabLuggage} luggage bags</span>
                                                      <span>|</span>
                                                      <span>First Aid</span>
                                                    </div>
                                        ...
                                        {packageInfoTab === "cab" && (
                                          <div className="p-6">
                                            <div className="mb-6">
                                              <h3 className="text-xl font-semibold text-gray-900">New Delhi to Shimla</h3>
                                              <p className="text-sm text-gray-500 mt-1">Changes would be reflected to whole itinerary</p>
                                            </div>
                                              ...
                                              <div className="space-y-4">
                                                {cabs.map((cab) => (
                                                  <div 
                                                    key={cab._id} 
                                                    className={`border rounded-lg overflow-hidden ${
                                                      selectedCabForBooking?._id === cab._id ? 'border-blue-200' : 'border-gray-200'
                                                    }`}
                                                  >
                                                    <div className="p-4">
                                                      <div className="flex gap-4">
                                                        ...
                                                        <div className="flex-1">
                                                          <div className="flex items-center justify-between">
                                                            <div>
                                                              <h4 className="text-lg font-medium text-gray-900">{cab.cabName}</h4>
                                                              <p className="text-sm text-gray-600">{cab.cabType}</p>
                                                            </div>
                                                            <div className="flex items-center gap-3">
                                                              {selectedCabForBooking?._id === cab._id ? (
                                                                <div className="flex items-center">
                                                                  <button
                                                                    onClick={() => setCabQuantity(Math.max(1, cabQuantity - 1))}
                                                                  ...
                                                                  <button
                                                                    onClick={() => setCabQuantity(Math.min(10, cabQuantity + 1))}
                                                          ...
                                                          <div className="mt-3">
                                                            <div className="flex items-center gap-4">
                                                              <div className="flex items-center gap-1">
                                                                ...
                                                                <span className="text-sm text-gray-600">{cab.cabSeatingCapacity} seater</span>
                                                              </div>
                                                              <div className="flex items-center gap-1">
                                                                <svg className="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                  <path d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z" />
                                                                </svg>
                                                                <span className="text-sm text-gray-600">{cab.cabLuggage} luggage bags</span>
                                                              </div>
                                                            </div>
                                                          </div>
                                                          ...
                                                          {selectedCabForBooking?._id === cab._id && (
                                                            <div className="mt-4 flex items-center justify-between border-t pt-4">
                                                              <div>
                                                                <p className="text-sm text-gray-600">Total Amount ({cabQuantity} vehicles)</p>
                                                                <p className="text-lg font-semibold text-gray-900">
                                                                  ₹{(cab.price * cabQuantity).toLocaleString()}
                                                                </p>
                                                              </div>
                                                              <div className="flex gap-2">
                                                                ...
                                                                <button
                                                                  onClick={() => {
                                                                    setSelectedCab({ ...cab, quantity: cabQuantity });
                                                                    setPackageInfoTab("package");
                                                                  }}
                                                    ...
                                                    <div className="px-4 py-2 bg-gray-50 border-t border-gray-200">
                                                      <p className="text-sm text-gray-600">
                                                        Intercity Transfer; 14 Sightseeing Transfers Included
                                                      </p>
                                                    </div>
                                                  </div>
                                                ))}
