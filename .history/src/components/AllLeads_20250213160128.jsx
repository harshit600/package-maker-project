                                          ...
                                          <div className="border-t border-gray-200 py-4">
                                            <div className="flex items-center justify-between px-4">
                                              <div className="flex items-center gap-2">
                                                ...
                                                <span className="font-medium text-gray-900">{selectedHotel.hotelType}</span>
                                                <span className="text-gray-500">•</span>
                                                <span className="text-gray-600">{selectedHotel.nights} Nights</span>
                                                <span className="text-gray-500">•</span>
                                                <span className="text-gray-600">In {selectedHotel.city}</span>
                                              </div>
                                              <button 
                                              ...
                                              <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                                                <div className="relative">
                                                  ...
                                                  <div className="absolute top-3 left-3 bg-white/90 backdrop-blur-sm rounded px-2 py-1">
                                                    <div className="flex items-center gap-1">
                                                      <span className="text-green-600 font-medium">{selectedHotel.rating}</span>
                                                ...
                                                <div className="p-4">
                                                  <div className="flex justify-between items-start">
                                                    ...
                                                    <div className="flex items-center">
                                                      {[...Array(5)].map((_, i) => (
                                                        <svg 
                                                          key={i}
                                                          className={`w-4 h-4 ${i < selectedHotel.starRating ? 'text-yellow-400' : 'text-gray-300'}`}
                                                          fill="currentColor"
                                                          viewBox="0 0 20 20"
                                                        >
                                                  ...
                                                  <div className="mt-4 flex items-center gap-4">
                                                    <div className="flex items-center gap-2">
                                                      ...
                                                      <span className="text-sm text-gray-600">
                                                        {selectedHotel.distanceFromCenter} to city center
                                                      </span>
                                                    </div>
                                                    {selectedHotel.includedMeals?.includes('Breakfast') && (
                                                      <div className="flex items-center gap-2">
                                                        <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                  ...
                                                  <div className="mt-4">
                                                    <h4 className="text-sm font-medium text-gray-900">{selectedHotel.roomType}</h4>
                                                    {selectedHotel.otherRoomTypes?.length > 0 && (
                                                      <button 
