                                  ...
                                  (day, index) => (
                                    ...
                                    >
                                      ...
                                      <div className="space-y-4">
                                        ...
                                        {/* Hotel Section */}
                                        {viewLead?.assignedPackage?.hotels && Object.entries(viewLead.assignedPackage.hotels).map(([key, hotel]) => (
                                          <div key={hotel.hotelInfo.id} className="border-t border-gray-200 py-4">
                                            <div className="flex items-center justify-between px-4">
                                              <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-gray-600">{hotel.hotelInfo.nights || '2'} Nights</span>
                                                <span className="text-gray-500">•</span>
                                                <span className="text-gray-600">In {hotel.hotelInfo.city}</span>
                                              </div>
                                              <button 
                                                onClick={() => setPackageInfoTab("hotel")}
                                                className="text-blue-500 text-sm font-medium hover:text-blue-600"
                                              >
                                                CHANGE
                                              </button>
                                            ...
                                            <div className="mt-4 px-4">
                                              <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                                                <div className="relative">
                                                  <img 
                                                    src={hotel.hotelInfo.images?.[0]} 
                                                    alt={hotel.hotelInfo.name}
                                                    className="w-full h-48 object-cover"
                                                  />
                                                  {hotel.hotelInfo.rating && (
                                                    <div className="absolute top-3 left-3 bg-white/90 backdrop-blur-sm rounded px-2 py-1">
                                                      <div className="flex items-center gap-1">
                                                        <span className="text-green-600 font-medium">{hotel.hotelInfo.rating}</span>
                                                ...
                                                <div className="p-4">
                                                  <div className="flex justify-between items-start">
                                                    ...
                                                    <div className="flex items-center">
                                                      {[...Array(5)].map((_, i) => (
                                                        <svg 
                                                          key={i}
                                                          className={`w-4 h-4 ${i < (hotel.hotelInfo.starRating || 3) ? 'text-yellow-400' : 'text-gray-300'}`}
                                                          fill="currentColor"
                                                          viewBox="0 0 20 20"
                                                        >
                                                  ...
                                                  <div className="mt-4 flex items-center gap-4">
                                                    {hotel.hotelInfo.distanceFromCenter && (
                                                      <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="text-sm text-gray-600">
                                                          {hotel.hotelInfo.distanceFromCenter} to city center
                                                        </span>
                                                      </div>
                                                    )}
                                                    {hotel.hotelInfo.meals?.includes('Breakfast') && (
                                                      <div className="flex items-center gap-2">
                                                        <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                  ...
                                                  <div className="mt-4">
                                                    <h4 className="text-sm font-medium text-gray-900">{hotel.roomInfo.name}</h4>
                                                    {hotel.roomInfo.price && (
                                                      <p className="text-sm text-gray-600 mt-1">
                                                        ₹{hotel.roomInfo.price} per night
                                                      </p>
                                                    )}
                                                    <button 
                                                      onClick={() => setPackageInfoTab("rooms")}
