                                  ...
                                  <div key={index} className="relative pl-8 pb-8 last:pb-0">
                                    ...
                                    <div className="absolute left-0 top-0 h-full">
                                      ...
                                      {index !== selectedPackage.package.itineraryDays.length - 1 && (
                                        <div className="absolute top-4 left-2 w-[1px] h-[calc(100%-16px)] bg-gray-200" />
                                      )}
                                    </div>
                                    ...
                                    <div className="space-y-4">
                                      ...
                                      {/* Hotel Section */}
                                      {day.selectedItinerary?.hotels?.map((hotel, index) => (
                                        <div key={index} className="border-t border-gray-200 py-4">
                                          <div className="flex items-center justify-between px-4">
                                            ...
                                            <button
                                              onClick={() => handleChangeHotel(day.day, hotel)}
                                              className="text-blue-500 text-sm font-medium hover:text-blue-600"
                                            >
                                              CHANGE
                                            </button>
                                              ...
                                              <div className="p-4">
                                                ...
                                                <div className="mt-4">
                                                  <h4 className="text-sm font-medium text-gray-900">
                                                    {hotel.roomType || "Valley-view Majestic Room"}
                                                  </h4>
                                                  {hotel.otherRoomTypes?.length > 0 && (
                                                    <button
                                                      onClick={() => handleChangeRoom(day.day, hotel)}
