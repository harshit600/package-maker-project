                                  ...
                                  <div key={index} className="mb-8 last:mb-0">
                                    ...
                                    <div className="flex justify-between items-center mb-4">
                                      <div className="flex items-center gap-2">
                                        ...
                                        <h4 className="text-lg font-medium">{day.selectedItinerary?.itineraryTitle}</h4>
                                      </div>
                                      <span className="text-sm text-gray-500">
                                        {/* Add actual date logic here */}
                                        27th Feb 25
                                      </span>
                                    </div>
                                    ...
                                    {/* Stay Details - Similar to your existing hotel section */}
                                    <div className="mt-6">
                                      <div className="flex items-start gap-4">
                                        <div className="flex-shrink-0">
                                          <svg className="w-6 h-6 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div className="flex-grow">
                                          <h5 className="font-medium mb-2">Check-In At Standard Hotel In Manali</h5>
                                          {/* Add your existing hotel details here */}
                                        </div>
                                      </div>
                                    </div>
