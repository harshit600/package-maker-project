                                ...
                                {selectedPackage?.package?.itineraryDays?.map((day, index) => (
                                  <div key={index} className="mb-8 last:mb-0">
                                    ...
                                    <div className="flex justify-between items-center mb-4">
                                      <div className="flex items-center gap-2">
                                        <span className="bg-orange-500 text-white px-2 py-1 rounded-md text-sm">DAY {day.day}</span>
                                        <h4 className="text-lg font-medium">
                                          {day.selectedItinerary?.itineraryTitle || `Day ${day.day} Activities`}
                                        </h4>
                                      </div>
                                      <span className="text-sm text-gray-500">
                                        {/* You might want to add actual date calculation logic here */}
                                        27th Feb 25
                                      </span>
                                    </div>
                                        ...
                                        <div className="flex items-start gap-4">
                                          ...
                                          <div className="flex-grow">
                                            <div className="flex justify-between items-start mb-2">
                                              <div>
                                                <p className="font-medium">Private Transfer</p>
                                                <div className="text-sm text-gray-600 mt-1">
                                                  <span className="mr-2">Seater • Luggage</span>
                                                </div>
                                              </div>
                                              <button 
                                            ...
                                            <div className="mt-4 bg-gray-50 rounded-lg p-4">
                                              <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                  <h5 className="font-medium">{selectedCab?.cabName || "Vehicle Name"}</h5>
                                                  <div className="flex items-center gap-4 mt-1 text-sm text-gray-600">
                                                    <div className="flex items-center gap-1">
                                                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" />
                                                      </svg>
                                                      <span>{selectedCab?.cabSeatingCapacity || "4"} seater</span>
                                                    </div>
                                                    <div className="flex items-center gap-1">
                                                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z" />
                                                      </svg>
                                                      <span>{selectedCab?.cabLuggage || "3"} luggage</span>
                                                    </div>
                                                    {selectedCab?.hasAC && (
                                                      <div className="flex items-center gap-1">
                                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                          ...
                                          <div className="flex-grow">
                                            <div className="flex justify-between items-start">
                                              <h5 className="font-medium mb-2">
                                                Check-In At {day.selectedHotel?.hotelName || 'Standard Hotel'} In {day.selectedHotel?.location || 'Manali'}
                                              </h5>
                                              <button 
                                                onClick={() => handleChangeHotel(day.day, day.selectedHotel)}
                                                className="text-orange-500 text-sm font-medium hover:text-orange-600"
                                              >
                                                CHANGE HOTEL
                                              </button>
                                            ...
                                            <div className="mt-4 border rounded-lg overflow-hidden">
                                              <div className="flex">
                                                <div className="w-1/4">
                                                  <img 
                                                    src={day.selectedHotel?.hotelImages?.[0] || 'default-hotel-image.jpg'} 
                                                    alt={day.selectedHotel?.hotelName}
                                                ...
                                                <div className="p-4 flex-1">
                                                  <div className="flex justify-between items-start">
                                                    <div>
                                                      <h6 className="font-medium">{day.selectedHotel?.hotelName}</h6>
                                                      <p className="text-sm text-gray-600 mt-1">{day.selectedHotel?.location}</p>
                                                    </div>
                                                    <div className="text-right">
                                                      <div className="text-sm text-gray-600">Check In</div>
                                                      <div className="font-medium">3N</div>
                                                    </div>
                                                  </div>
                                                  ...
                                                  <div className="mt-4 flex justify-between items-center">
                                                    <div>
                                                      ...
                                                      <p className="font-medium">{day.selectedHotel?.roomType || 'Deluxe Room'}</p>
                                                    </div>
                                                    <button 
                                                      onClick={() => handleChangeRoom(day.day, day.selectedHotel)}
                                                      className="text-orange-500 text-sm font-medium hover:text-orange-600"
                                                    >
                                                      CHANGE ROOM
                                                    </button>
                                                  ...
                                                  <div className="mt-4">
                                                    ...
                                                    <div className="flex items-center gap-2 mt-1">
                                                      <span className="bg-green-100 text-green-800 text-xs px-2 py-1 rounded">
                                                        {day.selectedHotel?.mealPlan || 'Breakfast Included'}
                                                      </span>
                                                    </div>
                                                  </div>
                                                </div>
                                    ...
                                    {/* Itinerary Description and Activities */}
                                    <div className="mt-6">
                                      <div className="text-gray-600">
                                        <p className="mb-4">{day.selectedItinerary?.description}</p>
                                        
                                        {/* Activities List */}
                                        {day.selectedItinerary?.activities?.length > 0 && (
                                          <div className="mt-4">
                                            <h6 className="font-medium text-gray-900 mb-2">Today's Activities:</h6>
                                        ...
                                        {/* Included Services */}
                                        {day.selectedItinerary?.includedServices?.length > 0 && (
                                          <div className="mt-4">
                                            <h6 className="font-medium text-gray-900 mb-2">Included Services:</h6>
                                            <div className="flex flex-wrap gap-2">
                                              {day.selectedItinerary.includedServices.map((service, idx) => (
