                          ...
                          {packageInfoTab === "cab" ? (
                            ...
                            <div className="space-y-6">
                              ...
                              <div className="bg-white p-6">
                                <h3 className="text-lg font-semibold text-gray-900 mb-6">TRIP ITINERARY</h3>
                                  ...
                                  <div key={index} className="mb-8 last:mb-0">
                                    ...
                                    <div className="flex justify-between items-center mb-4">
                                      <div className="flex items-center gap-2">
                                        ...
                                        <h4 className="text-lg font-medium">{day.title || `Day ${day.day}`}</h4>
                                      </div>
                                      <span className="text-sm text-gray-500">27th Feb 25</span>
                                    </div>

                                    {/* Transfer Details - Only show on Day 1 */}
                                    {day.day === 1 && selectedPackage?.cabs?.travelPrices && (
                                      <div className="mb-6">
                                          ...
                                          <div className="flex-grow">
                                            ...
                                            <div className="mt-4 bg-gray-50 rounded-lg p-4">
                                              <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                  <h5 className="font-medium">{selectedPackage?.cabs?.travelPrices?.cabName || "Vehicle Name"}</h5>
                                                  <div className="flex items-center gap-4 mt-1 text-sm text-gray-600">
                                                    <div className="flex items-center gap-1">
                                                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" />
                                                      </svg>
                                                      <span>{selectedPackage?.cabs?.travelPrices?.seater || "4"} seater</span>
                                                    </div>
                                                    <div className="flex items-center gap-1">
                                                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z" />
                                                      </svg>
                                                      <span>{selectedPackage?.cabs?.travelPrices?.luggage || "3"} luggage</span>
                                                    </div>
                                                  </div>
                                                </div>
                                              </div>
                                    ...
                                    {selectedPackage?.activities?.map((activity, actIndex) => (
                                      activity.day === day.day && (
                                        <div key={actIndex} className="mt-6 text-gray-600">
                                        ...
                                        <div className="flex items-start gap-4">
                                          ...
                                          <div className="flex-grow">
                                            <h5 className="font-medium mb-2">
                                              Stay at {selectedPackage.hotels[day.day].hotelName}
                                            </h5>
                                            <p className="text-sm text-gray-600">
                                              {selectedPackage.hotels[day.day].roomType} • {selectedPackage.hotels[day.day].mealPlan}
                                            </p>
                                          </div>
                                        </div>
                                      </div>
