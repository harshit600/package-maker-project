                                  ...
                                  <div key={index} className="mb-8 last:mb-0">
                                    ...
                                    <div className="flex justify-between items-center mb-4">
                                      <div className="flex items-center gap-2">
                                        ...
                                        <h4 className="text-lg font-medium">
                                          {day.selectedItinerary?.itineraryTitle || `Day ${day.day} - ${selectedPackage?.package?.packageName}`}
                                        </h4>
                                      </div>
                                            ...
                                            <div className="flex justify-between items-start mb-2">
                                              <div>
                                                ...
                                                <div className="text-sm text-gray-600 mt-1">
                                                  <span className="mr-2">From: {selectedPackage?.package?.pickupLocation || 'Pickup Location'}</span>
                                                  <span>To: {selectedPackage?.package?.dropLocation || 'Drop Location'}</span>
                                                </div>
                                              </div>
                                              <button 
                                    ...
                                    {day.selectedItinerary && (
                                      <div className="mt-6 text-gray-600">
                                        <div className="space-y-4">
                                          {/* Description */}
                                          <p>{day.selectedItinerary.description}</p>
                                          
                                          {/* Activities */}
                                          {day.selectedItinerary.activities && day.selectedItinerary.activities.length > 0 && (
                                            <div className="pl-4">
                                              <h6 className="text-gray-900 font-medium mb-2">Today's Activities:</h6>
                                          ...
                                          {/* Included Services */}
                                          {day.selectedItinerary.includedServices && day.selectedItinerary.includedServices.length > 0 && (
                                            <div>
                                              <h6 className="text-gray-900 font-medium mb-2">Included Services:</h6>
