                                  ...
                                  <div key={index} className="mb-8 last:mb-0">
                                    ...
                                    <div className="flex justify-between items-center mb-4">
                                      <div className="flex items-center gap-2">
                                        ...
                                        <h4 className="text-lg font-medium">
                                          {day.selectedItinerary?.itineraryTitle || `${selectedPackage?.package?.packageName} - Day ${day.day}`}
                                        </h4>
                                      </div>
                                      <span className="text-sm text-gray-500">27th Feb 25</span>
                                    </div>
                                            ...
                                            <div className="flex justify-between items-start mb-2">
                                              <div>
                                                ...
                                                <div className="text-sm text-gray-600 mt-1">
                                                  <span className="mr-2">From: {selectedPackage?.package?.pickupLocation}</span>
                                                  <span>To: {selectedPackage?.package?.dropLocation}</span>
                                                </div>
                                              </div>
                                              <button 
                                            ...
                                            <div className="mt-4 bg-gray-50 rounded-lg p-4">
                                              <div className="flex items-center gap-4">
                                                <div className="w-20 h-20 bg-white rounded-lg p-2 flex items-center justify-center">
                                                  {selectedPackage?.cabs?.travelPrices?.cabImage ? (
                                                    <img 
                                                      src={selectedPackage.cabs.travelPrices.cabImage} 
                                                      alt="Vehicle"
                                                      className="w-full h-full object-contain"
                                                    />
                                                  ) : (
                                                ...
                                                <div>
                                                  <h5 className="font-medium">Private Vehicle</h5>
                                          ...
                                          <div className="flex-grow">
                                            <div className="flex justify-between items-start">
                                              <h5 className="font-medium mb-2">
                                                {selectedPackage.hotels[day.day].hotelInfo.name}
                                              </h5>
                                              <button 
                                                onClick={() => handleChangeHotel(day.day)}
                                                className="text-orange-500 text-sm font-medium hover:text-orange-600"
                                              >
                                                CHANGE HOTEL
                                              </button>
                                            ...
                                            <div className="mt-4 bg-gray-50 rounded-lg overflow-hidden">
                                              <div className="flex">
                                                <div className="w-1/4">
                                                  {selectedPackage.hotels[day.day].hotelInfo.photosAndVideos?.images?.[0] && (
                                                    <img 
                                                      src={selectedPackage.hotels[day.day].hotelInfo.photosAndVideos.images[0]} 
                                                ...
                                                <div className="p-4 flex-1">
                                                  <p className="text-sm text-gray-600">
                                                    {selectedPackage.hotels[day.day].hotelInfo.location.address}
                                                  </p>
                                                  <div className="mt-2">
                                                    <p className="text-sm font-medium">Room Type:</p>
                                                    <p className="text-sm text-gray-600">{selectedPackage.hotels[day.day].roomInfo.name}</p>
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
                                    ...
                                    {day.selectedItinerary && (
                                      <div className="mt-6 text-gray-600">
                                        <p>{day.selectedItinerary.itineraryDescription}</p>
