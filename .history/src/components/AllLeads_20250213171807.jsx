...
const AllLeads = () => {
  ...
  const fetchCabs = async () => {
    try {
      ...
      const swiftDzire = processedCabs.find(cab => 
                                                ...
                                                <div className="flex items-center gap-4">
                                                  ...
                                                  <div className="flex-1">
                                                    <div className="flex justify-between items-start">
                                                      <h5 className="font-medium">{selectedCab?.cabName || 'Swift Dzire'}</h5>
                                                      <div className="text-right">
                                                        <p className="text-sm text-gray-500">Price per km</p>
                                                        <p className="font-medium text-green-600">₹{selectedCab?.pricePerKm || 0}</p>
                                                      </div>
                                                    </div>
                                                    <div className="flex items-center gap-4 mt-2 text-sm text-gray-600">
                                                      <div className="flex items-center gap-1">
                                                        ...
                                                        <span>{selectedCab?.seatingCapacity || 4} Seater</span>
                                                      </div>
                                                      <div className="flex items-center gap-1">
                                                        <svg
                                                          className="w-4 h-4"
                                                        ...
                                                        <span>{selectedCab?.luggageCapacity || 3} Luggage</span>
                                                      </div>
                                                      {selectedCab?.hasAC && (
                                                        <div className="flex items-center gap-1">
                                                          <svg
                                                    ...
                                                    {selectedPackage?.package?.distance && (
                                                      <div className="mt-3 pt-3 border-t border-gray-200">
                                                        <div className="flex justify-between items-center">
                                                          <div className="text-sm text-gray-600">
                                                            Total Distance: {selectedPackage.package.distance} km
                                                          </div>
                                                          <div>
                                                            <p className="text-sm text-gray-500">Total Price</p>
                                                            <p className="font-medium text-green-600">
                                                              ₹{selectedCab?.totalPrice || 0}
                                                            </p>
                                                          </div>
                                                        </div>
                                                      </div>
