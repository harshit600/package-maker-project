...
const AllLeads = () => {
  ...
  // Modify handleDeleteLead to set the lead to delete
  ...
  const confirmDeleteLead = async () => {
    if (leadToDelete) {
      try {
        await deleteLead(leadToDelete); // Call your existing delete function
  ...
  // Add this function to handle lead update
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded shadow-lg">
            ...
            <div className="flex justify-end mt-4">
              <button onClick={cancelDelete} className="mr-2 px-4 py-2 bg-gray-300 rounded">Cancel</button>
              <button onClick={confirmDeleteLead} className="px-4 py-2 bg-red-600 text-white rounded">Delete</button>
            </div>
          </div>
        </div>
      )}
