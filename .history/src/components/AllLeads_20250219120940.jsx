...
const AllLeads = () => {
  ...
  const getHotelsForCity = (itineraryText) => {
    ...
    if (itineraryText.toLowerCase().includes('shimla')) {
      const shimlaHotels = allHotels.filter(hotel => 
        hotel.location?.city?.toLowerCase() === 'shimla'
      );
