...
const AllLeads = () => {
  ...
  // Modify the getHotelsForCity function to format the hotel data
  const getHotelsForCity = (cityName) => {
    ...
    // Map the hotels to a more usable format
    return cityHotels.map(hotel => ({
      id: hotel._id,
      name: hotel.basicInfo.propertyName,
      description: hotel.basicInfo.propertyDescription,
      starRating: hotel.basicInfo.hotelStarRating,
      contact: {
        email: hotel.basicInfo.email,
        mobile: hotel.basicInfo.mobile,
        landline: hotel.basicInfo.landline
      },
      images: hotel.photosAndVideos?.images || [],
      builtYear: hotel.basicInfo.propertyBuiltYear,
      bookingSince: hotel.basicInfo.bookingSinceYear
    }));
  };
                                                    ...
                                                    <div className="flex-1 p-4">
                                                      ...
                                                      <div className="mt-4 grid grid-cols-2 gap-4 text-sm">
                                                        <div>
                                                          ...
                                                          <p className="text-gray-900">{hotel.contact.email}</p>
                                                          <p className="text-gray-900">Mobile: {hotel.contact.mobile}</p>
                                                        </div>
                                                        <div>
                                                          <p className="text-gray-500">Property Info:</p>
                                                          <p className="text-gray-900">Built in {hotel.builtYear}</p>
                                                          <p className="text-gray-900">Booking since {hotel.bookingSince}</p>
                                                        </div>
                                                      </div>
                                                      ...
                                                      <div className="mt-4 flex justify-end space-x-2">
                                                        ...
                                                        <button
                                                          ...
                                                          className="inline-flex items-center px-3 py-1.5 bg-blue-600 text-white hover:bg-blue-700 rounded-md text-sm font-medium"
                                                        >
                                                          View Details
                                                        </button>
                                                      </div>
