              ...
              <div className="px-4 py-6 bg-gray-50 sm:px-6">
                <div className="flex items-start justify-between space-x-3">
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Choose a vehicle for your transfer</p>
                  </div>
                  <button
                    onClick={() => setShowCabsPanel(false)}
                          ...
                          <div className="flex">
                            ...
                            <div className="flex-1 p-4">
                              <div className="flex justify-between">
                                <div>
                                  <h3 className="text-lg font-medium text-gray-900">{cab.cabName}</h3>
                                ...
                                <div className="text-right">
                                  ...
                                  <p className="text-lg font-semibold text-green-600">₹{cab.pricePerKm}</p>
                                </div>
                              </div>
