...
const AllLeads = () => {
  ...
  const fetchCabs = async () => {
    ...
    try {
      console.log('Fetching cabs from:', `${config.API_HOST}/api/cabs/getallcabs`);
      ...
      if (data.success) {
        ...
        console.log('Available cabs set to:', data.data);
      } else {
                ...
                <div className="flex items-start justify-between space-x-3">
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                      {isLoadingCabs ? 'Loading vehicles...' : 
                            ...
                            <div className="w-40 h-32 flex-shrink-0">
                              {cab.cabImage ? (
                                <img
                                  ...
                                  className="w-full h-full object-cover"
                                  onError={(e) => {
                                    console.log('Image failed to load:', cab.cabImage);
                                ...
                                <div>
                                  ...
                                  <div className="mt-1 flex items-center space-x-4 text-sm text-gray-500">
                                    <span className="flex items-center">
                                      ...
                                      {cab.seatingCapacity || 'N/A'} Seater
                                    </span>
                                    {cab.hasAC && (
                                      <span className="flex items-center">
                                        <svg
