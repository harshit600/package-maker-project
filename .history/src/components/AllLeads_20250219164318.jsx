...
const AllLeads = () => {
  ...
  const handleSelectCab = (cab) => {
    ...
    // Add any additional logic you need when a cab is selected
    console.log('Selected cab:', cab, 'Quantity:', quantity);
  };
                            ...
                            <div className="flex-1 p-4">
                              ...
                              <div className="mt-4 flex items-center space-x-4">
                                ...
                                <div className="flex items-center border rounded-md">
                                  <button
                                    onClick={() => handleQuantityChange(cab._id, (cabQuantities[cab._id] || 1) - 1)}
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => handleQuantityChange(cab._id, parseInt(e.target.value) || 1)}
                              ...
                              <button
                                onClick={() => {
                                  console.log('Selecting cab:', cab, 'Quantity:', cabQuantities[cab._id] || 1);
                                  handleSelectCab({
                                    ...cab,
                              ...
                              >
                                Select {cabQuantities[cab._id] || 1} Vehicle{(cabQuantities[cab._id] || 1) > 1 ? 's' : ''}
                              </button>
                            </div>
                          </div>
                        </div>
