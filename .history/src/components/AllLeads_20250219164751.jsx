        ...
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-1">
            <div className="flex justify-between items-start">
                ...
                <div className="mt-1 space-y-1">
                  ...
                  <div className="flex items-center space-x-4 text-sm text-gray-600">
                    <span className="flex items-center">
                      ...
                      {selectedCabForDay.cabSeatingCapacity}
                    </span>
                    <span className="flex items-center">
                      <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z" />
                      </svg>
                      {selectedCabForDay.cabLuggage}
                    </span>
                  </div>
                  <p className="text-sm text-gray-600">
                    Quantity: {selectedCabForDay.quantity || 1}
                  </p>
                </div>
              </div>
              ...
              <button
                onClick={() => handleChangeClick(day.day)}
                                      ...
                                      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                                        <div className="p-4">
                                          ...
                                          <div className="mt-4">
                                            ...
                                            {/* Show selected cab details or prompt to select */}
                                            {selectedPackage?.cabs?.[day.day] ? (
                                              renderSelectedCabDetails(day)
                                            ) : (
                                              <div className="text-sm text-gray-500">
                                                No vehicle selected for this day
                                              </div>
                                            )}
                                          </div>
