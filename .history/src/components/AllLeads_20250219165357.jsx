      ...
      {selectedCab && showSelectedCabDetails && (
        <div className="mt-4 bg-white rounded-lg shadow-sm border p-4">
          <div className="flex justify-between items-start mb-4">
            <h3 className="text-lg font-semibold text-gray-900">Selected Vehicle Details</h3>
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="aspect-w-16 aspect-h-9 rounded-lg overflow-hidden">
                {selectedCab.cabImages && selectedCab.cabImages[0] ? (
                  <img
                    ...
                    className="w-full h-full object-cover"
                    onError={(e) => {
                      console.log('Image failed to load:', selectedCab.cabImages[0]);
                      e.target.onerror = null;
            ...
            <div className="space-y-4">
              <div>
                <h4 className="text-xl font-semibold text-gray-900">{selectedCab.cabName}</h4>
                <p className="text-gray-500">{selectedCab.cabType}</p>
              </div>

              <div className="grid grid-cols-2 gap-4">
                <div className="bg-gray-50 p-3 rounded-lg">
                  <span className="text-sm text-gray-500">Seating Capacity</span>
                  <p className="font-medium">{selectedCab.cabSeatingCapacity}</p>
                </div>
                <div className="bg-gray-50 p-3 rounded-lg">
                  <span className="text-sm text-gray-500">Luggage Space</span>
                  <p className="font-medium">{selectedCab.cabLuggage}</p>
                </div>
              </div>
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <div className="flex justify-between items-center">
                  <div>
                    <span className="text-sm text-blue-600">Selected Quantity</span>
                    <p className="text-lg font-semibold text-blue-900">
                      {selectedCab.quantity} Vehicle{selectedCab.quantity > 1 ? 's' : ''}
                    </p>
                  </div>
                  <button
                    onClick={() => {
                      setShowCabsPanel(true);
                      setShowSelectedCabDetails(false);
                    }}
              ...
              <div className="border-t pt-4 mt-4">
                <h5 className="font-medium mb-2">Vehicle Features:</h5>
              ...
              <div className="border-t pt-4 mt-4">
                ...
                <div className="flex items-center space-x-3">
                  <button
                    onClick={() => handleQuantityChange(selectedCab._id, (selectedCab.quantity || 1) - 1)}
