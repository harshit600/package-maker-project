            ...
            {hotels.map((hotel) => (
              ...
              >
                ...
                <div className="relative h-48">
                  {hotel.photosAndVideos && hotel.photosAndVideos.images && hotel.photosAndVideos.images.length > 0 ? (
                    <img
                      src={hotel.photosAndVideos.images[0]}
                      alt={hotel.basicInfo.propertyName}
                      className="w-full h-full object-cover"
                      onError={(e) => {
                        console.log('Image failed to load:', hotel.photosAndVideos.images[0]);
    ...
    <div className="p-3 bg-white relative">
      ...
      {selectedHotel && (
        <div className="mt-4 bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="mb-6">
            <div className="relative h-64 rounded-lg overflow-hidden">
              {selectedHotel.photosAndVideos && selectedHotel.photosAndVideos.images && selectedHotel.photosAndVideos.images.length > 0 ? (
                <img
                  src={selectedHotel.photosAndVideos.images[0]}
                  alt={selectedHotel.basicInfo.propertyName}
                  className="w-full h-full object-cover"
                  onError={(e) => {
                    console.log('Image failed to load:', selectedHotel.photosAndVideos.images[0]);
                    e.target.onerror = null;
                    e.target.src = '/default-hotel.png';
                  }}
                />
