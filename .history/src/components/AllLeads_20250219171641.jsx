...
const AllLeads = () => {
  ...
  const [selectedDayForHotelChange, setSelectedDayForHotelChange] = useState(null);
        ...
        <div className="mt-4 bg-white rounded-lg shadow-lg p-6">
          <div className="flex justify-between items-start mb-6">
            ...
            <div className="flex space-x-2">
              <button
                onClick={() => handleChangeHotel(selectedDay)}
          ...
          <div className="fixed inset-y-0 right-0 max-w-2xl w-full bg-white shadow-xl">
            <div className="h-full flex flex-col">
              ...
              <div className="px-4 py-6 bg-gray-50 sm:px-6">
                <div className="flex items-start justify-between space-x-3">
                  <div>
                    <h2 className="text-lg font-medium text-gray-900">Select New Hotel</h2>
                    <p className="text-sm text-gray-500 mt-1">
