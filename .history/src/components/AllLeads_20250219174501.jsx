          ...
          <div className="flex justify-between">
            <div>
              <h3 className="text-lg font-medium text-gray-900">
                {hotel?.basicInfo?.propertyName || 'Hotel Name Not Available'}
              </h3>
              <p className="text-sm text-gray-500">
                {hotel?.basicInfo?.hotelStarRating || 'Rating Not Available'}
              </p>
              <p className="mt-1 text-sm text-gray-600 line-clamp-2">
                {hotel?.basicInfo?.propertyDescription || 'No description available'}
              </p>
            </div>
          </div>
      ...
      <div className="flex justify-between items-start mb-6">
        <div>
          <h3 className="text-xl font-bold text-gray-900">
            {selectedHotel?.basicInfo?.propertyName || 'Hotel Name Not Available'}
          </h3>
          <p className="text-sm text-gray-500 mt-1">
            {selectedHotel?.basicInfo?.hotelStarRating || 'Rating Not Available'}
          </p>
        </div>
        ...
        <div className="mt-4 flex space-x-2 overflow-x-auto">
          {selectedHotel.photosAndVideos.images.map((image, index) => (
            <div key={index} className="flex-shrink-0 w-20 h-20">
              <img
                src={image}
                alt={`${selectedHotel.basicInfo.propertyName} view ${index + 1}`}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <p className="text-gray-600 mb-4">
            {selectedHotel?.basicInfo?.propertyDescription || 'No description available'}
          </p>
          <div className="flex items-center mb-4">
            <span className="text-sm font-medium text-gray-500 mr-2">Rating:</span>
            <span className="text-sm font-semibold">
              {selectedHotel?.basicInfo?.hotelStarRating || 'Not Available'}
            </span>
          </div>
        </div>
            ...
            >
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth="2"
                  d="M12 4v16m8-8H4m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"
                />
              </svg>
            </button>
          </div>
