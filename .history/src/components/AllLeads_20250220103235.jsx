            ...
            <div className="h-full flex flex-col">
              ...
              <div className="flex-1 overflow-y-auto">
                <div className="px-4 py-6 space-y-4">
                  {hotels?.map((hotel) => {
                    // Get hotel info either from basicInfo or direct properties
                    const hotelName = hotel?.basicInfo?.propertyName || hotel?.propertyName || "Hotel Name Not Available";
                    const hotelRating = hotel?.basicInfo?.hotelStarRating || hotel?.hotelStarRating || "Rating Not Available";
                    const hotelDescription = hotel?.basicInfo?.propertyDescription || hotel?.propertyDescription || "No description available";
                    const hotelImages = hotel?.photosAndVideos?.images || hotel?.images || [];
