                        ...
                        <div className="flex">
                          ...
                          <div className="w-40 h-32 flex-shrink-0">
                            {hotel?.photosAndVideos?.images?.[0] ? (
                              <img
                                src={hotel.photosAndVideos.images[0]}
                                alt={hotel?.basicInfo?.propertyName || 'Hotel'}
                                className="w-full h-full object-cover"
                                onError={(e) => {
                                  e.target.onerror = null;
                                  e.target.src = "/default-hotel.png";
                          ...
                          <div className="flex-1 p-4">
                            <div className="flex justify-between">
                              <div>
                                <h3 className="text-lg font-medium text-gray-900">
                                  {hotel?.basicInfo?.propertyName || hotel?.propertyName || "Hotel Name Not Available"}
                                </h3>
                                <p className="text-sm text-gray-500">
                                  {hotel?.basicInfo?.hotelStarRating || hotel?.hotelStarRating || "Rating Not Available"}
                                </p>
                                <p className="mt-1 text-sm text-gray-600 line-clamp-2">
                                  {hotel?.basicInfo?.propertyDescription || hotel?.propertyDescription || "No description available"}
                                </p>
                              </div>
                            </div>
