                              ...
                              <div className="relative w-full h-full">
                                ...
                                {hotel.photosAndVideos.images.length > 1 && (
                                  <div className="absolute bottom-2 right-2 bg-black bg-opacity-60 text-white text-xs px-2 py-1 rounded">
                                    +{hotel.photosAndVideos.images.length - 1} more
                                  </div>
                                )}
                              </div>
                            ) : (
                            ...
                            <div className="flex justify-between">
                              <div>
                                ...
                                <div className="mt-3 flex flex-wrap gap-2">
                                  {hotel.basicInfo.amenities?.slice(0, 4).map((amenity, index) => (
                                    <span
                                      key={index}
                                  ...
                                  {hotel.basicInfo.amenities?.length > 4 && (
                                    <span className="text-xs text-blue-600">
                                      +{hotel.basicInfo.amenities.length - 4} more
                                    </span>
                                  )}
                                </div>
                                  ...
                                  <div className="flex items-center gap-4">
                                    <div>
                                      ...
                                      <p className="text-lg font-semibold text-green-600">
                                        ₹{hotel.basicInfo.startingPrice || 'Price on request'}
                                      </p>
                                    </div>
