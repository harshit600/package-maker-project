            ...
            <div className="flex justify-between">
              <div>
                ...
                <div className="mt-3 grid grid-cols-2 gap-2 text-sm text-gray-500">
                  <div>
                    <span className="font-medium">Built:</span> {hotel.basicInfo.propertyBuiltYear}
                  </div>
                  <div>
                    <span className="font-medium">Booking Since:</span> {hotel.basicInfo.bookingSinceYear}
                  </div>
                  <div>
                    <span className="font-medium">Contact:</span> {hotel.basicInfo.mobile}
                  </div>
                  <div>
                    <span className="font-medium">Email:</span> {hotel.basicInfo.email}
                  </div>
                </div>
              </div>
            </div>
