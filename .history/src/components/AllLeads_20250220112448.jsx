                        ...
                        <div className="flex-1 overflow-y-auto">
                          {packageInfoTab === "package" && (
                            <div className="p-6 space-y-6">
                                ...
                                {selectedPackage?.package?.itineraryDays?.map(
                                  (day, index) => (
                                    <div key={index} className="mb-8 last:mb-0">
                                      ...
                                      {/* Hotel Section - Integrated directly under description */}
                                      {day.selectedItinerary?.cityName && (
                                        <div className="mt-4 bg-gray-50 rounded-lg p-4">
                                          <div className="flex justify-between items-center mb-4">
                                            ...
                                            <button
                                              onClick={() =>
                                                handleHotelChangeClick(day.day)
                                              }
                                          ...
                                          {selectedPackage?.hotels?.[day.day] ? (
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                              {hotelsByCity[day.selectedItinerary.cityName.toLowerCase()]?.map((hotel) => (
                                                <div key={hotel._id} className="bg-white rounded-lg border border-gray-200 p-4">
                                                  <div className="flex gap-4">
                                                    {/* Hotel Image */}
                                                    <div className="w-32 h-24 flex-shrink-0">
                                                      {hotel.photosAndVideos?.images?.[0] ? (
                              ...
                              {/* Add this section to display hotels */}
                              <div className="bg-white rounded-lg border border-gray-200">
                                <div className="px-4 py-3 border-b border-gray-200">
                                  <h3 className="text-lg font-semibold text-gray-900">
                                    Available Hotels
                                ...
                                <div className="p-4">
                                  {selectedPackage?.package?.itineraryDays?.map(
                                    (day, index) => {
                                      const cityName =
                                        day.selectedItinerary?.cityName;
                                      const hotels = cityName
                                        ? hotelsByCity[cityName.toLowerCase()]
                                        : [];

                                      console.log(
                                        `Hotels for day ${index + 1}:`,
                                        hotels
                                      );
