                                    ...
                                    <div key={index} className="mb-8 last:mb-0">
                                      ...
                                      <div className="flex justify-between items-center mb-6 bg-white p-4 rounded-lg shadow-sm">
                                        ...
                                        <div className="text-right">
                                          <span className="text-sm font-medium text-gray-500">27th Feb 25</span>
                                        </div>
                                      </div>
                                            ...
                                            <div className="p-4 flex justify-between items-center">
                                              <div className="flex items-center gap-2">
                                                ...
                                                <h5 className="text-lg font-semibold text-gray-900">
                                                  Stay in {day.selectedItinerary.cityName}
                                                </h5>
                                              </div>
                                              <button
                                          ...
                                          <div className="p-4">
                                            {selectedPackage?.hotels?.[day.day] ? (
                                              ...
                                              <div className="bg-blue-50 border border-blue-100 rounded-lg p-4">
                                                <div className="flex gap-6">
                                                  ...
                                                  <div className="w-40 h-32 flex-shrink-0 rounded-lg overflow-hidden">
                                                    {selectedPackage.hotels[day.day].photosAndVideos?.images?.[0] ? (
                                                      <img
                                                        src={selectedPackage.hotels[day.day].photosAndVideos.images[0]}
                                                        alt={selectedPackage.hotels[day.day].basicInfo.propertyName}
                                                        className="w-full h-full object-cover"
                                                        onError={(e) => {
                                                          e.target.src = "/default-hotel.png";
                                                        }}
                                                  ...
                                                  <div className="flex-1">
                                                    <div className="flex justify-between items-start">
                                                      <div>
                                                        <h6 className="text-lg font-semibold text-gray-900">
                                                          {selectedPackage.hotels[day.day].basicInfo.propertyName}
                                                        </h6>
                                                        <div className="flex items-center gap-2 mt-1">
                                                          <span className="px-2 py-1 bg-yellow-100 text-yellow-800 text-xs font-medium rounded">
                                                            {selectedPackage.hotels[day.day].basicInfo.hotelStarRating}
                                                          </span>
                                                    ...
                                                    <p className="text-sm text-gray-600 mt-3 line-clamp-2">
                                                      {selectedPackage.hotels[day.day].basicInfo.propertyDescription}
                                                    </p>
                                                  </div>
                                                </div>
                                              </div>
                                              ...
                                              <div className="text-center py-6 bg-gray-50 rounded-lg">
                                                ...
                                                <h3 className="mt-2 text-sm font-medium text-gray-900">No hotel selected</h3>
                                                <p className="mt-1 text-sm text-gray-500">Choose a hotel for your stay</p>
                                                <div className="mt-6">
                                                  <button
                                                    onClick={() => handleHotelChangeClick(day.day)}
                                          ...
                                          <div className="p-4">
                                            {selectedCab ? (
                                                  ...
                                                  <div className="flex-1">
                                                    ...
                                                    <div className="mt-3 grid grid-cols-2 gap-4 text-sm text-gray-600">
                                                      <div className="flex items-center gap-1">
                                                        ...
                                                        <span>Seats: {selectedCab.cabSeatingCapacity}</span>
                                                      </div>
                                                      <div className="flex items-center gap-1">
                                                        <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" 
                                                        ...
                                                        <span>Luggage: {selectedCab.cabLuggage}</span>
                                                      </div>
                                                    </div>
                                                    {selectedCab.quantity > 1 && (
                                                      <div className="mt-2 text-sm text-blue-600 font-medium">
                                                        {selectedCab.quantity} vehicles selected
                                                      </div>
                                                    )}
                                                  </div>
                                                </div>
                                              ...
                                              <div className="text-center py-6 bg-gray-50 rounded-lg">
                                                ...
                                                <h3 className="mt-2 text-sm font-medium text-gray-900">No vehicle selected</h3>
                                                <p className="mt-1 text-sm text-gray-500">Choose a vehicle for your entire trip</p>
                                                <div className="mt-6">
                                                  <button
                                                    onClick={() => setShowCabsPanel(true)}
                                                    className="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700"
                                                    ...
                                                    <div className="flex-1">
                                                      ...
                                                      <div className="mt-3 grid grid-cols-2 gap-4 text-sm text-gray-600">
                                                        <div className="flex items-center gap-1">
                                                          ...
                                                          <span>
                                                            Seats: {selectedCab.cabSeatingCapacity}
                                                          </span>
                                                        </div>
                                                        <div className="flex items-center gap-1">
                                                          <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="p-4">
                                  <div className="space-y-4">
                                    ...
                                    <div className="flex justify-between items-center py-2 border-b">
                                      ...
                                      <span className="font-medium">
                                        ₹{selectedPackage?.finalCosting?.hotelPrices?.total || 0}
                                      </span>
                                    </div>
                                    ...
                                    <div className="flex justify-between items-center py-2 border-b">
                                      ...
                                      <span className="font-medium">
                                        ₹{selectedPackage?.finalCosting?.transferPrices?.total || 0}
                                      </span>
                                    </div>
                                    ...
                                    <div className="flex justify-between items-center py-2 border-b">
                                      ...
                                      <span className="font-medium">
                                        ₹{selectedPackage?.finalCosting?.activityPrices?.total || 0}
                                      </span>
                                    </div>
                                    ...
                                    <div className="flex justify-between items-center py-2 border-b">
                                      ...
                                      <span className="font-medium">
                                        ₹{selectedPackage?.finalCosting?.taxes || 0}
                                      </span>
                                    </div>
                                    ...
                                    <div className="flex justify-between items-center py-3 bg-gray-50 px-4 rounded-lg mt-4">
                                      ...
                                      <span className="font-semibold text-lg text-blue-600">
                                        ₹{selectedPackage?.finalCosting?.finalPrices?.grandTotal || 0}
                                      </span>
                                    </div>
                                  </div>
                                    ...
                                    <div className="space-y-2">
                                      <div className="flex justify-between items-center">
                                        <span className="text-blue-700">
                                          Adult Cost (x{selectedLead?.adults || 1})
                                        </span>
                                        <span className="font-medium text-blue-900">
                                          ₹{selectedPackage?.finalCosting?.finalPrices?.adultPrice || 0}
                                        </span>
                                      </div>
                                      {selectedLead?.kids > 0 && (
                                        <div className="flex justify-between items-center">
                                          ...
                                          <span className="font-medium text-blue-900">
                                            ₹{selectedPackage?.finalCosting?.finalPrices?.childPrice || 0}
                                          </span>
                                        </div>
                                      )}
                                    </div>
