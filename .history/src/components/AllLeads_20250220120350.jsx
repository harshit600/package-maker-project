                                ...
                                {selectedPackage?.package?.itineraryDays?.map(
                                  (day, index) => (
                                    <div key={index} className="mb-8 last:mb-0">
                                      ...
                                      {/* Hotel Section with enhanced styling */}
                                      {day.selectedItinerary?.cityName && (
                                          ...
                                          <div className="p-4">
                                            {selectedPackage?.hotels?.[day.day] ? (
                                                ...
                                                <div className="flex gap-6">
                                                  ...
                                                  <div className="flex-1">
                                                    ...
                                                    <div className="mt-3 flex items-center gap-4 text-sm text-gray-500">
                                                      {selectedPackage.hotels[day.day].basicInfo.email && (
                                              ...
                                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                {hotelsByCity[day.selectedItinerary.cityName.toLowerCase()]?.map((hotel) => (
                                                  <div key={hotel._id} 
                                                    className="border border-gray-200 rounded-lg overflow-hidden hover:border-blue-300 hover:shadow-md transition-all duration-200"
                                                  >
