                                  ...
                                  (day, index) => {
                                    ...
                                    useEffect(() => {
                                      if (day?.selectedItinerary?.cityName) {
                                        fetchHotelsByCity(day.selectedItinerary.cityName);
                                      }
                                    ...
                                    return (
                                      <div key={index} className="mb-8 last:mb-0">
                                          ...
                                          <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                              <h4 className="text-lg font-semibold text-gray-900">
                                                {day?.selectedItinerary?.cityName || "City Not Selected"}
                                              </h4>
                                              <p className="text-sm text-gray-500">
                                                {day?.selectedItinerary?.description || "No description available"}
                                              </p>
                                            </div>
                                          </div>
                                          
                                          {/* Add button to show hotels for this city */}
                                          <button
                                        ...
                                        {/* Show hotels for this day when expanded */}
