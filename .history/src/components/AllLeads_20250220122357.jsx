                          ...
                          {packageInfoTab === "package" && (
                            <div className="p-6 space-y-6">
                              ...
                              <div className="bg-white p-6">
                                ...
                                {/* Fetch hotels for all cities when package changes */}
                                {useEffect(() => {
                                  if (selectedPackage?.package?.itineraryDays) {
                                    const cities = selectedPackage.package.itineraryDays
                                      .map(day => day?.selectedItinerary?.cityName)
                                      .filter(Boolean);
                                    
                                    // Fetch hotels for unique cities
