                                      ...
                                      <div className="flex items-start space-x-4">
                                        ...
                                        <div className="flex-1">
                                          <h4 className="text-lg font-medium text-gray-900">
                                            {day.selectedItinerary?.cityName || `Day ${day.day}`}
                                          </h4>
                                          
                                          {/* Itinerary Details */}
                                          <div className="mt-2 text-gray-600">
                                            <p>{day.selectedItinerary?.itineraryTitle}</p>
                                            <p className="mt-1 text-sm">{day.selectedItinerary?.itineraryDescription}</p>
                                          </div>
                                          ...
                                          <div className="mt-3 grid grid-cols-2 gap-4">
                                            {day.selectedItinerary?.included && (
                                              <div>
                                                <h5 className="text-sm font-medium text-green-600 mb-1">Included:</h5>
                                                <ul className="text-sm text-gray-600">
                                                  {day.selectedItinerary.included.map((item, idx) => (
                                            ...
                                            {day.selectedItinerary?.notIncluded && (
                                              <div>
                                                <h5 className="text-sm font-medium text-red-600 mb-1">Not Included:</h5>
                                                <ul className="text-sm text-gray-600">
                                                  {day.selectedItinerary.notIncluded.map((item, idx) => (
                                                    <li key={idx} className="flex items-center">
