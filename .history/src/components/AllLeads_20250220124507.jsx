                            ...
                            <div className="p-6 space-y-6">
                              ...
                              <div className="bg-white p-6">
                                ...
                                {selectedPackage?.package?.itineraryDays?.map(
                                  (day, index) => {
                                    // Call fetchHotelsByCity when rendering each day
                                    const cityName =
                                      ...
                                      >
                                        ...
                                        <div className="flex justify-between items-center mb-6 bg-white p-4 rounded-lg shadow-sm">
                                            ...
                                            <div>
                                              ...
                                              <p className="text-sm text-gray-500 mt-1">
                                                <span className="inline-flex items-center">
                                                  ...
                                                  {day.selectedItinerary?.cityName || (day.day === 1 ? 'Delhi' : 'Shimla')}
                                                </span>
                                              </p>
                                            </div>
                                          </div>
                                          <div className="text-right">
                                            <span className="text-sm font-medium text-gray-500">
                                              {/* Add dynamic date handling if needed */}
                                        ...
                                        <div className="bg-gray-50 p-6 rounded-lg">
                                          <div className="prose max-w-none">
                                            {day.day === 1 ? (
                                              <>
                                                <h5 className="text-lg font-medium mb-3">Delhi to Shimla Journey</h5>
                                                <p className="text-gray-600 mb-4">
                                                  Begin your exciting journey from Delhi to Shimla. After breakfast, depart from Delhi 
                                                  and embark on a scenic drive through the winding roads of the Himalayas. En route, 
                                                  you'll witness breathtaking landscapes and picturesque villages.
                                                </p>
                                                <div className="space-y-3">
                                                  <div className="flex items-start">
                                                    ...
                                                    <p className="ml-3 text-gray-600">
                                                      <strong>Morning:</strong> Departure from Delhi after breakfast. Start your journey 
                                                      towards Shimla through the scenic highway.
                                                    </p>
                                                  </div>
                                                  <div className="flex items-start">
                                                    <div className="flex-shrink-0 w-5 h-5 mt-1">
                                                    ...
                                                    <p className="ml-3 text-gray-600">
                                                      <strong>Afternoon:</strong> Lunch break at a handpicked restaurant. Continue your 
                                                      journey through the beautiful Himalayan terrain.
                                                    </p>
                                                  </div>
                                                  <div className="flex items-start">
                                                    <div className="flex-shrink-0 w-5 h-5 mt-1">
                                                    ...
                                                    <p className="ml-3 text-gray-600">
                                                      <strong>Evening:</strong> Arrive in Shimla. Check-in to your hotel and enjoy the evening 
                                                      at leisure. Take a short walk on the famous Mall Road if time permits.
                                                    </p>
                                                  </div>
                                                </div>
                                              </>
                                              ...
                                              <>
                                                <h5 className="text-lg font-medium mb-3">Exploring Shimla</h5>
                                                <p className="text-gray-600 mb-4">
                                                  Discover the colonial charm and natural beauty of Shimla. Today's itinerary includes 
                                                  visits to famous landmarks and enjoying the scenic beauty of this hill station.
                                                </p>
                                                <div className="space-y-3">
                                                  <div className="flex items-start">
                                                    <div className="flex-shrink-0 w-5 h-5 mt-1">
                                                    ...
                                                    <p className="ml-3 text-gray-600">
                                                      <strong>Morning:</strong> Visit the historic Christ Church and enjoy a walk on the Ridge. 
                                                      Explore the Victorian architecture of this beautiful city.
                                                    </p>
                                                  </div>
                                                  <div className="flex items-start">
