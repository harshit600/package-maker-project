...
const AllLeads = () => {
  ...
  // Add this state for storing itinerary data
                              ...
                              <div className="bg-white p-6">
                                ...
                                {isLoadingItinerary ? (
                                  ...
                                  selectedPackage?.package?.itineraryDays?.map((day, index) => {
                                    const dayItinerary = itineraryData?.find(
                                      (item) => item._id === day.selectedItinerary?._id
                                    );
                                      ...
                                      <div key={index} className="mb-8 last:mb-0">
                                          ...
                                          <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                              <h4 className="text-xl font-semibold text-gray-900">
                                                {dayItinerary?.title || `Day ${day.day}`}
                                              </h4>
                                              <p className="text-sm text-gray-500 mt-1">
                                                <span className="inline-flex items-center">
                                                  ...
                                                  {dayItinerary?.destination || day.selectedItinerary?.cityName}
                                                </span>
                                              </p>
                                            </div>
                                          </div>
                                        ...
                                        <div className="bg-gray-50 rounded-lg p-6">
                                          ...
                                          {dayItinerary?.description && (
                                            <div className="mb-6">
                                              <h5 className="text-lg font-medium text-gray-900 mb-3">Overview</h5>
                                          ...
                                          {/* Included Services */}
                                          {dayItinerary?.includedServices && dayItinerary.includedServices.length > 0 && (
                                            <div className="mt-6">
                                              <h5 className="text-lg font-medium text-gray-900 mb-3">
                                                Included Services
                                              </h5>
                                              <ul className="grid grid-cols-1 md:grid-cols-2 gap-2">
                                                {dayItinerary.includedServices.map((service, idx) => (
                                          ...
                                          {dayItinerary?.notes && (
                                            <div className="mt-6 bg-yellow-50 border border-yellow-100 rounded-lg p-4">
                                              ...
                                              <p className="text-sm text-yellow-700">{dayItinerary.notes}</p>
                                            </div>
                                          )}
                                        </div>
                                      </div>
