                              ...
                              <div className="bg-white p-6">
                                ...
                                {selectedPackage?.package?.itineraryDays?.map(
                                  (day, index) => {
                                    ...
                                    // Fetch itinerary details if not already loaded
                                    useEffect(() => {
                                      if (day.selectedItinerary?._id && !itineraryDetails[day.selectedItinerary._id]) {
                                        fetchItineraryDetails(day.selectedItinerary._id);
                                      }
                                    ...
                                    return (
                                      ...
                                      >
                                        ...
                                        {/* Add the itinerary description section */}
                                        {currentItinerary && (
                                          <div className="mt-4 space-y-6 bg-white rounded-lg p-6 shadow-sm">
                                            ...
                                            {/* Included Services */}
                                            {currentItinerary.includedServices && currentItinerary.includedServices.length > 0 && (
                                              <div className="border-t border-gray-200 pt-4">
                                                <h4 className="text-lg font-medium text-gray-900 mb-3">
                                                  Included Services
                                                </h4>
                                                <ul className="grid grid-cols-2 gap-2">
                                                  {currentItinerary.includedServices.map((service, idx) => (
