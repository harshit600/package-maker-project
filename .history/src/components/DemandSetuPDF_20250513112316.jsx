      ...
      <Page size="A4" style={pdfStyles.container}>
          ...
          {packageSummary?.package?.itineraryDays?.map((day, index) => (
            <View key={index} style={{ marginBottom: 16 }}>
              <Text style={pdfStyles.dayTitle}>
                Day {index + 1}: {day.selectedItinerary.cityName}
              </Text>
        ...
        <View style={pdfStyles.costSection}>
          ...
          <View style={pdfStyles.totalRow}>
            <Text style={[pdfStyles.costLabel, { fontWeight: "bold" }]}>
              Total Amount
            </Text>
            <Text style={[pdfStyles.costValue, { fontSize: 14 }]}>
              ₹ {finalTotal || 0}
            </Text>
          </View>
        </View>
