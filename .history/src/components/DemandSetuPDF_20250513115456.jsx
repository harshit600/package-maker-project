  ...
  return (
    <Document>
            ...
            <View style={{
              ...
              <View style={{ 
                ...
                <View style={{ flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 6 }}>
                  <Icons.Phone style={{ width: 14, height: 14, color: "#FFFFFF" }} />
                  <Text style={{ color: "#FFFFFF", fontSize: 12 }}>+91 98765 43210</Text>
                </View>
                <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
                  <Icons.Email style={{ width: 14, height: 14, color: "#FFFFFF" }} />
                  <Text style={{ color: "#FFFFFF", fontSize: 12 }}>info@demandsetutours.com</Text>
                </View>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
              ...
              <View style={{ flex: 0.6 }}>
                <View style={{ marginBottom: 12 }}>
                  ...
                  <Text style={{ 
                    ...
                    {selectedLead?.name || "Guest"}'s Journey
                  </Text>
                  <Text style={{ color: "#E2E8F0", fontSize: 16, marginTop: 4 }}>
                    to {packageSummary.package?.packageName || "Amazing Destination"}
                  </Text>
                </View>
                ...
                <View style={{ flexDirection: "row", gap: 16, marginTop: 16 }}>
                  <View style={{ 
                    ...
                    <Icons.Calendar style={{ width: 16, height: 16, color: "#FFFFFF" }} />
                  ...
                  <View style={{ 
                    ...
                    <Icons.User style={{ width: 16, height: 16, color: "#FFFFFF" }} />
                    <Text style={{ color: "#FFFFFF", fontSize: 12 }}>
                      {selectedLead?.adults || "2"} Adults, {selectedLead?.kids || "0"} Kids
                    </Text>
                  </View>
                  ...
                  <View style={{ 
                    ...
                    <Icons.Calendar style={{ width: 16, height: 16, color: "#FFFFFF" }} />
                    <Text style={{ color: "#FFFFFF", fontSize: 12 }}>
                      {selectedLead?.travelDate ? new Date(selectedLead.travelDate).toLocaleDateString() : "Flexible"}
                    </Text>
                  </View>
                </View>
              </View>
              ...
              <View style={{ 
                ...
                <View style={{ 
                  ...
                  <Icons.Info style={{ width: 12, height: 12, color: "#64748B" }} />
      ...
      >
        ...
        >
          {packageSummary.package?.images?.map((image, index) => (
            <View
              key={index}
              style={{
                width: "48%",
        ...
        <View style={{ marginBottom: 20 }}>
          ...
          <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
            {packageSummary.package?.itinerary?.map((day, index) => (
              <View
                key={index}
                style={{
                  width: "48%",
        ...
        <View style={{ marginBottom: 20 }}>
          ...
          <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
            {packageSummary.package?.exclusions?.map((exclusion, index) => (
              <View
                key={index}
                style={{
                  width: "48%",
        ...
        <View style={{ marginBottom: 20 }}>
          ...
          <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
            {packageSummary.package?.terms?.map((term, index) => (
              <View
                key={index}
                style={{
                  width: "48%",
        ...
        <View style={{ marginBottom: 20 }}>
          ...
          <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
            {packageSummary.package?.cancellationPolicy?.map((policy, index) => (
              <View
                key={index}
                style={{
                  width: "48%",
