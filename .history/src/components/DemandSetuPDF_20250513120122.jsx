          ...
          <View style={{
            ...
            <View style={{
              ...
              <View style={{
                ...
                <View style={{
                  ...
                  <Icons.Phone style={{ width: 12, height: 12, color: "#FFFFFF" }} />
                ...
                <View style={{
                  ...
                  <Icons.Email style={{ width: 12, height: 12, color: "#FFFFFF" }} />
                  <Text style={{ color: "#FFFFFF", fontSize: 10 }}>
            ...
            <View style={{
              ...
              <Text style={{
                ...
                {packageSummary.package?.packageName || "Wonderful Journey"}
              </Text>
              ...
              <View style={{
                ...
                <View style={{
                  ...
                  <Icons.Calendar style={{ width: 14, height: 14, color: "#FFFFFF" }} />
                ...
                <View style={{
                  ...
                  <Icons.Location style={{ width: 14, height: 14, color: "#FFFFFF" }} />
                  <Text style={{ color: "#FFFFFF", fontSize: 12 }}>
                    {packageSummary.package?.destinations?.length || "Multiple"} Destinations
                  </Text>
                </View>
                ...
                <View style={{
                  ...
                  <Icons.Group style={{ width: 14, height: 14, color: "#FFFFFF" }} />
                  <Text style={{ color: "#FFFFFF", fontSize: 12 }}>
                    {selectedLead?.adults || 0} Adults & {selectedLead?.kids || 0} Children
                  </Text>
                </View>
              </View>
            </View>
            ...
            <View style={{
              ...
              <View style={{
                ...
                <Text style={{
                  ...
                  {(selectedLead?.name || "G")[0].toUpperCase()}
                </Text>
              </View>
              <View>
                <Text style={{
                ...
                <Text style={{
                  ...
                  Travel Date: {selectedLead?.travelDate ? new Date(selectedLead.travelDate).toLocaleDateString() : "Not specified"}
                </Text>
              </View>
            </View>
