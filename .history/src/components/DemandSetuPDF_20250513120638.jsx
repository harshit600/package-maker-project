        ...
        >
          ...
          <View style={{
            ...
            <View style={{
              ...
              <Text style={{ fontSize: 24, fontWeight: "bold", color: "#FFFFFF", marginTop: 4 }}>
                {packageSummary.package?.packageName || "Wonderful Package"}
              </Text>
              <View style={{ flexDirection: "row", gap: 16, marginTop: 8 }}>
                <View style={{ flexDirection: "row", alignItems: "center", gap: 4 }}>
                  <Icons.Calendar style={{ width: 14, height: 14, color: "#E2E8F0" }} />
                  <Text style={{ fontSize: 12, color: "#E2E8F0" }}>
                    {packageSummary.package?.duration || "5N/6D"}
                  </Text>
                </View>
                <View style={{ flexDirection: "row", alignItems: "center", gap: 4 }}>
                  <Icons.Location style={{ width: 14, height: 14, color: "#E2E8F0" }} />
                  <Text style={{ fontSize: 12, color: "#E2E8F0" }}>
                    {packageSummary.package?.destination || "Beautiful Destination"}
                  </Text>
                </View>
              </View>
            </View>
            ...
            <View style={{
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={{ fontSize: 14, fontWeight: "bold", color: "#1E293B" }}>
                  {selectedLead?.travelDate ? new Date(selectedLead.travelDate).toLocaleDateString() : "TBD"}
                </Text>
              </View>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={{ fontSize: 14, fontWeight: "bold", color: "#2d2d44" }}>
