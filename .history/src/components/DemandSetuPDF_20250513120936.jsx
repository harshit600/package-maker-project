          ...
          >
            ...
            >
              ...
              <View style={{ flexDirection: "row", gap: 16, marginTop: 8 }}>
                ...
                >
                  <Icons.Calendar
                    style={{ width: 14, height: 14, color: "#E2E8F0" }}
                  />
                  <Text style={{ fontSize: 12, color: "#E2E8F0" }}>
                ...
                >
                  ...
                  />
                  <Text style={{ fontSize: 12, color: "#E2E8F0" }}>
                    {packageSummary.package?.destination ||
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text
                  style={{ fontSize: 14, fontWeight: "bold", color: "#1E293B" }}
                >
                  {selectedLead?.adults || 0} Adults, {selectedLead?.kids || 0}{" "}
                  Children
                </Text>
              </View>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text
                  style={{ fontSize: 14, fontWeight: "bold", color: "#2d2d44" }}
                >
                  ₹{" "}
                  {showMargin
