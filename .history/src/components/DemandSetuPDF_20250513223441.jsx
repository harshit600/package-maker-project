...
// Create a simple Icons object since the original icons are missing
const Icons = {
  Email: () => <Text>📧</Text>,
  User: () => <Text>👤</Text>,
  Profile: () => <Text>👤</Text>,
...
// Create a single Icons object with all icon components
const Icons = {
  Email: () => (
  ...
  Instagram: () => <Text>ig</Text>,
  Twitter: () => <Text>tw</Text>,
  // ... keep all the other SVG-based icon components ...
};
    ...
    <Document>
      ...
      >
        ...
        >
            ...
            <View style={pdfStyles.brandSection}>
              <View style={pdfStyles.brandInfo}>
                <Text style={pdfStyles.contactText}>
                  Demand Setu Tours and Travels Pvt. Ltd.
                </Text>
                <Image
                  style={{ marginTop: 5, width: 70, height: 20 }}
                  source="https://plutotours.com/offers/dslogo.png"
                />
              </View>
            </View>
          ...
          >
            ...
            >
              ...
              <View>
                ...
                >
                  Booking Information & Travel Preferences
                </Text>
              </View>
            </View>
            ...
            <View style={{ padding: 20, gap: 20 }}>
              ...
              >
                ...
                >
                  <Icons.Profile
                    style={{ width: 16, height: 16, color: "#2d2d44" }}
                  />
                  <Text
                    style={{
                      fontSize: 14,
                ...
                <View style={{ gap: 12 }}>
                  ...
                  >
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      >
                        {selectedLead?.alternatePhone || "N/A"}
                      </Text>
                    </View>
                  </View>
                </View>
          ...
          <View style={pdfStyles.headerDivider} />
          {/* Enhanced Journey Overview with Creative Design */}
          <View
            style={{
              marginTop: 12,
              marginBottom: 16,
          ...
          >
            ...
            {/* Cities Timeline with Creative Design */}
            <View
              style={{
                padding: 20,
                backgroundColor: "#FFFFFF",
            ...
            {/* Hotels Section with Creative Cards */}
            <View
              style={{
                padding: 20,
                gap: 20,
            ...
            >
                      ...
                      <View style={{ flex: 1 }}>
                        ...
                        >
                          ...
                          >
                            {[
                              ...Array(
                                parseInt(hotel.basicInfo?.hotelStarRating) || 0
                              ),
                            ].map((_, i) => (
                              <Icons.Star
                                key={i}
              ...
              {/* Transport Card with Creative Design */}
              <View
                style={{
                  backgroundColor: "#FFFFFF",
                  borderRadius: 16,
            ...
            {/* Journey Stats with Creative Design */}
            <View
              style={{
                padding: 20,
                backgroundColor: "#F8FAFC",
            ...
            >
              {[
                ...
                },
                {
                  icon: Icons.Calendar,
                  label: "Total Days",
                  value: packageSummary.package?.itineraryDays?.length,
                  color: "#34D399",
                },
                {
                  icon: Icons.Distance,
                  label: "Distance",
                  value: `${packageSummary.package?.itineraryDays?.reduce(
    ...
    <View style={pdfStyles.bankGrid}>
      ...
      <View style={pdfStyles.bankCard}>
        ...
        <View style={pdfStyles.bankDetail}>
          ...
          <Text style={pdfStyles.bankValue}>PUNB008940</Text>
        </View>
        <View style={pdfStyles.bankDetail}>
          <Text style={pdfStyles.bankLabel}>A/C Type:</Text>
      ...
      <View style={pdfStyles.bankCard}>
        ...
        <View style={pdfStyles.bankDetail}>
          <Text style={pdfStyles.bankLabel}>A/C No:</Text>
          <Text style={pdfStyles.bankValue}>50200092955</Text>
        </View>
        <View style={pdfStyles.bankDetail}>
          <Text style={pdfStyles.bankLabel}>A/C Name:</Text>
          <Text style={pdfStyles.bankValue}>DEMAND SETU</Text>
...
const CompanyFooter = () => (
  ...
  >
    ...
    >
      © {new Date().getFullYear()} DemandSetu Tours & Travels. All rights
      reserved.
    </Text>
  </View>
);
