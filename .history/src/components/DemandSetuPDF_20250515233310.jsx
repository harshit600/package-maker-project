              ...
              <View style={{
                ...
                <View style={{ gap: 12 }}>
                  <View style={{
                    ...
                    <Text style={{ flex: 1, fontSize: 12, color: '#64748B' }}>Full Name</Text>
                    <Text style={{ flex: 2, fontSize: 12, color: '#1E293B', fontWeight: '500' }}>
                  ...
                  <View style={{
                    ...
                    <Text style={{ flex: 1, fontSize: 12, color: '#64748B' }}>Contact</Text>
                    <Text style={{ flex: 2, fontSize: 12, color: '#1E293B', fontWeight: '500' }}>
                  ...
                  <View style={{
                    ...
                    <Text style={{ flex: 1, fontSize: 12, color: '#64748B' }}>Email</Text>
                    <Text style={{ flex: 2, fontSize: 12, color: '#1E293B', fontWeight: '500' }}>
              ...
              <View style={{
                ...
                <View style={{
                  ...
                  <View style={{
                    ...
                    <Text style={{ fontSize: 24, fontWeight: 'bold', color: '#2d2d44' }}>
