                      ...
                      return (
                        <View key={index} style={{
                          ...
                          <View style={{
                            ...
                            <Icons.Location style={{ width: 12, height: 12, color: "#2d2d44" }} />
                            <Text style={{
                              fontSize: 14,
                              color: "#2d2d44",
                              fontWeight: "500",
                      ...
                      <View style={{
                        ...
                        <View style={{ flex: 1 }}>
                          ...
                          <Text style={{
                            ...
                            Day {String(index + 1).padStart(2, "0")} - {dayData.itineraryTitle}
                          </Text>
                        </View>
                        <View style={{
                          backgroundColor: "#2d2d44",
                      ...
                      <View style={{ padding: 16 }}>
                        ...
                        {dayData.activities && dayData.activities.length > 0 && (
                          <View style={{
                            ...
                            <View style={{
                              ...
                              <Icons.Activity style={{ width: 16, height: 16, color: "#2d2d44" }} />
                              <Text style={{
                                fontSize: 14,
                                fontWeight: "bold",
                                color: "#1E293B",
                        ...
                        {dayData.meals && (
                          <View style={{
                            ...
                            <Icons.Meals style={{ width: 16, height: 16, color: "#059669" }} />
                            <Text style={{
                              fontSize: 14,
                              color: "#059669",
                              fontWeight: "500",
