        ...
        <div className="bg-white rounded-xl shadow-lg p-4 w-full">
          <div className="flex justify-between items-center mb-4 w-full">
            ...
            <Button
              ...
              variant="primary"
              className="hover:shadow-lg transition-all duration-200 px-3 py-1.5 bg-[rgb(45,45,68)]"
            />
          </div>
          ...
          <Modal.Footer className="border-t border-slate-200 p-3">
            <div className="flex gap-2">
              ...
              <Button
                ...
                className="px-3 py-1.5 hover:shadow-lg transition-all duration-200 bg-[rgb(45,45,68)]"
              />
            </div>
          </Modal.Footer>
        </Modal>
