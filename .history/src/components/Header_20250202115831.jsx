...
export default function Header() {
  ...
  return (
    <header className="w-full bg-gradient-to-r from-[#1a1b2e] to-[#2d2d44] shadow-lg">
                ...
                {localUser ? (
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-400">
                      ({localUser.userType === "B2B sale" ? "B2B Sales Representative" : localUser.userType || "Regular User"})
                    </span>
                  </div>
                ) : (
