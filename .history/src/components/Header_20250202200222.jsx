                ...
                {localUser ? (
                  <>
                    ...
                    <button
                      ...
                      className="flex items-center space-x-2 px-4 py-2 text-sm font-medium text-gray-100 bg-gray-700/30 rounded-lg hover:bg-gray-700/50 hover:text-blue-300 transition-all duration-200 backdrop-blur-sm"
                    >
                      Logout
                    </button>
                  </>
