...
const PackageCreation = ({ initialData, isEditing, editId }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!packagePlaces || packagePlaces.length === 0 || 
    ...
    try {
      ...
      if (data.success) {
        ...
        const errorMessage = data.message || 'Failed to save package. Please check the form and try again.';
        console.error("Error saving package:", errorMessage);
        alert(errorMessage);
      }
    } catch (error) {
