...
const PackageCreation = ({ initialData, isEditing, editId }) => {
                  ...
                  <div className="mt-4 bg-gray-50 rounded-lg p-4 border border-gray-200">
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        {itineraryDays[index].selectedItinerary.activities && (
                          <div className="mt-3">
                            ...
                            <ul className="list-disc pl-4 text-sm text-gray-600">
                              {itineraryDays[index].selectedItinerary.activities.map((activity, idx) => (
                      ...
                      <div className="space-y-2">
                        ...
                        {itineraryDays[index].selectedItinerary.specialNotes && (
                          <div className="mt-3 p-3 bg-yellow-50 rounded-lg">
                            <h6 className="font-medium text-yellow-800 mb-1">Special Notes:</h6>
  ...
  const handlePlaceSelection = (index, selectedPlace) => {
    ...
    // Try to generate sequence after place selection
    const sequence = generateItinerarySequence();
    if (sequence.length > 0) {
      console.log("Sequence generated after place selection");
      initializeItineraryDays();
    }
  };
