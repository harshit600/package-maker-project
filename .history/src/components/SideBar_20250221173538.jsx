  ...
  return (
    ...
    >
      <div className="h-full px-4 py-6 overflow-y-auto bg-[#2d2d44] text-gray-200">
        ...
        {userData ? (
          <div className="mb-6 text-center p-4 bg-white/10 backdrop-blur-md rounded-lg">
            <div className="w-16 h-16 mx-auto mb-3 rounded-full bg-[#fff] flex items-center justify-center backdrop-blur-sm">
            ...
            <span className="inline-block mt-2 px-3 py-1 text-xs font-medium text-blue-900 bg-[#fff] rounded-full backdrop-blur-sm">
