  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        const response = await fetch(`${process.env.REACT_APP_API_URL || 'https://pluto-hotel-server-15c83810c41c.herokuapp.com'}/api/maker/get-maker`, {
          headers: {
        ...
        const currentUserData = users.find((user) => user._id === localUser._id);
