                ...
                {userData?.userType !== "For B2B Sale" && (
                  <>
                    ...
                    >
                      ...
                      <span className="font-medium">Create Packages</span>
                    </div>
                    ...
                    >
                      ...
                      <span className="font-medium">Cab Manager</span>
                    </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-700/30">
          {currentUser && !isLoggedOut && (
            <button
              ...
              className="w-full px-4 py-2 text-sm font-medium text-gray-300 bg-gray-700/30 rounded-lg hover:bg-gray-700/50 hover:text-blue-300 transition-all duration-200 backdrop-blur-sm flex items-center justify-center gap-2"
            >
              <svg
                className="w-5 h-5"
                fill="none"
