...
const SightseeingSlider = ({ isOpen, onClose, selectedDay, sightseeing, onSightseeingSelect }) => {
  ...
  const handleSightSelect = (sight) => {
    ...
    if (isSelected) {
      ...
      updatedSights = [...selectedSights, { ...sight, dayNumber: selectedDay?.day }];
    }
                  ...
                  <div className="bg-[rgb(45,45,68)] px-6 py-4 text-white">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-300 mt-1">Day {selectedDay?.day}</p>
                      </div>
                          ...
                          >
                            <div className="flex gap-4">
                              <div className="w-24 h-24 flex-shrink-0">
                                <img
                                  src={sight.images?.[0] || "https://placehold.co/100x100?text=Sight"}
                                  alt={sight.placeName}
                                  className="w-full h-full object-cover rounded-lg"
                                  onError={(e) => {
                                    e.target.onerror = null;
                                    e.target.src = "https://placehold.co/100x100?text=Sight";
                                  }}
                                />
                              </div>
                              <div className="flex-1">
                                <h3 className="text-lg font-semibold text-gray-900">{sight.placeName}</h3>
