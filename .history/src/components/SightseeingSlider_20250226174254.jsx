...
const SightseeingSlider = ({
  ...
  const handleSightSelect = useCallback((sight) => {
    console.log('handleSightSelect called with:', sight); // Debug log 1

    if (!selectedDay || !onSightseeingSelect) {
      console.log('Missing selectedDay or onSightseeingSelect:', { selectedDay, onSightseeingSelect }); // Debug log 2
      return;
    }
    ...
    const sightWithDay = {
      ...
      quantity: 1,
      price: sight.price || 0,
      imageUrl: sight.images?.[0] || "https://placehold.co/100x100?text=Sight"
    };
                      ...
                      >
                        <div className="flex justify-between items-start">
                          ...
                          <div className="text-right">
                            <p className="text-lg font-bold">₹{sight.price || 0}</p>
                            <button
