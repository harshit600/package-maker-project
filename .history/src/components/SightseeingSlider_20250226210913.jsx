                ...
                <div className="h-full flex flex-col bg-white shadow-xl">
                  ...
                  <div className="bg-[#2D2D44] px-6 py-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <h2 className="text-xl text-white font-medium">Add Sightseeing</h2>
                        <p className="text-sm text-gray-300">Day {selectedDay?.day}</p>
                      </div>
                      <button
                        onClick={onClose}
                  ...
                  <div className="flex-1 bg-white overflow-y-auto">
                    <div className="p-4">
                      {sightseeing?.map((sight) => (
                        <div key={sight._id} className="mb-4 bg-gray-100 rounded-lg">
