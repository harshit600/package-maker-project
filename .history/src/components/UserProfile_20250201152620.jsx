...
import { FaUser, FaEnvelope, FaPhone, FaMapMarkerAlt, FaUserTag, FaVenusMars } from "react-icons/fa";
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <div className="bg-white rounded-b-2xl shadow-sm p-6">
          <h2 className="text-xl font-semibold mb-6 text-gray-900">Profile Details</h2>
