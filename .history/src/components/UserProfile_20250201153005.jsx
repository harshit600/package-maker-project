...
const UserProfile = () => {
  ...
  if (error || !userData) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <p className="text-red-500">Error loading profile: {error || "No user data found"}</p>
      </div>
    );
  }
  ...
  const profileFields = [
    {
      ...
      label: "Full Name",
      value: `${userData.firstName || ""} ${userData.lastName || ""}`.trim() || "Not provided",
    },
    {
          ...
          <div className="mt-8">
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              ...
              <p className="text-sm text-blue-800 mt-2">
                Status:{" "}
                <span className={userData.publish === "Yes" ? "text-green-600" : "text-red-600"}>
