  ...
  <Document>
    <Page size="A4" style={pdfStyles.page}>
      ...
      <View style={pdfStyles.section}>
        <Text style={pdfStyles.quoteText}>
          {packageSummary.package?.description || 
           "Fall in love with the enchanting state that is Ladakh! Get a glimpse of the rich history of the region at Leh Palace and Diskit Monastery. Enjoy a tour of Nubra Valley and visit the incredible Chang La Pass."}
        </Text>
      </View>
      ...
      <View style={pdfStyles.section}>
        ...
        {packageSummary.hotels?.map((hotel, index) => (
          <View key={index} style={pdfStyles.hotelCard}>
            <Text style={pdfStyles.hotelName}>{hotel.name}</Text>
            <Text style={pdfStyles.hotelLocation}>{hotel.location}</Text>
            <Text style={pdfStyles.hotelDuration}>{hotel.nights} Nights</Text>
            <Text style={pdfStyles.roomType}>{hotel.roomType}</Text>
            <Text style={pdfStyles.mealPlan}>Meal Plan: {hotel.mealPlan}</Text>
          </View>
        ))}
      </View>
      ...
      <View style={pdfStyles.section}>
        ...
        {packageSummary.activities?.map((activity, index) => (
          <View key={index} style={pdfStyles.activityCard}>
            <Text style={pdfStyles.activityName}>{activity.name}</Text>
            <Text style={pdfStyles.activityDuration}>
              Duration: {activity.duration}
            </Text>
            <Text style={pdfStyles.activityDescription}>
      ...
      <View style={pdfStyles.section}>
        <Text style={pdfStyles.sectionTitle}>Transfers</Text>
        {packageSummary.transfer?.details?.map((transfer, index) => (
          <View key={index} style={pdfStyles.transferCard}>
            <Text style={pdfStyles.transferType}>
              {transfer.type} - {transfer.vehicleType}
            </Text>
            <Text style={pdfStyles.transferRoute}>
      ...
      <View style={pdfStyles.section}>
        ...
        <View style={pdfStyles.row}>
          <Text style={pdfStyles.label}>Hotel Charges</Text>
          <Text style={pdfStyles.value}>
            ₹{packageSummary.totals?.hotelCost || 0}
          </Text>
        </View>
        <View style={pdfStyles.row}>
          <Text style={pdfStyles.label}>Transfer Charges</Text>
          <Text style={pdfStyles.value}>
            ₹{packageSummary.totals?.transferCost || 0}
          </Text>
        </View>
        <View style={pdfStyles.row}>
          <Text style={pdfStyles.label}>Activity Charges</Text>
          <Text style={pdfStyles.value}>
        ...
        {showMargin && (
          <View style={pdfStyles.row}>
            ...
            <Text style={pdfStyles.value}>₹{marginAmount.toFixed(2)}</Text>
          </View>
        )}
      </View>
      ...
      <View style={pdfStyles.inclusionSection}>
        <Text style={pdfStyles.inclusionHeader}>Package Inclusions</Text>
        {packageSummary.package?.inclusions?.map((inclusion, index) => (
          <View key={index} style={pdfStyles.inclusionItem}>
            <Text style={pdfStyles.inclusionBullet}>•</Text>
            <Text style={pdfStyles.inclusionText}>{inclusion}</Text>
          </View>
        ))}
      </View>
      ...
      <View style={pdfStyles.footer}>
        <Text style={pdfStyles.footerText}>
          Generated on {new Date().toLocaleDateString()} by {companyName}
        </Text>
        <Text style={pdfStyles.footerText}>
          For queries, contact: {packageSummary.agent?.phone || "XXXXXXXXXX"}
        </Text>
      </View>
