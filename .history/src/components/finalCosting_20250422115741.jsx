    ...
    <Page size="A4" style={pdfStyles.page}>
      <View style={pdfStyles.header}>
        <View style={pdfStyles.headerLeft}>
          <Text style={pdfStyles.customerName}>Customer's trip to</Text>
          <Text style={pdfStyles.destinationText}>Ladakh</Text>
          ...
          <View style={pdfStyles.packageMeta}>
            ...
            <Text style={pdfStyles.packageTitle}>Best of Ladakh Package</Text>
          </View>

          <View style={pdfStyles.stayDetails}>
            <Text style={pdfStyles.stayItem}>2N Leh</Text>
            <Text style={pdfStyles.stayItem}>•</Text>
            <Text style={pdfStyles.stayItem}>1N Nubra Valley</Text>
            <Text style={pdfStyles.stayItem}>•</Text>
            <Text style={pdfStyles.stayItem}>1N Pangong</Text>
            <Text style={pdfStyles.stayItem}>•</Text>
            <Text style={pdfStyles.stayItem}>1N Leh</Text>
          </View>
        </View>
      ...
      <View style={pdfStyles.quotation}>
        ...
        <View style={pdfStyles.curatedBy}>
          ...
          <Text style={pdfStyles.agentName}>Travel Expert Name</Text>
          <Text style={pdfStyles.contactInfo}>Call: +91 XXXXXXXXXX</Text>
          <Text style={pdfStyles.contactInfo}>Email: expert@example.com</Text>
        </View>
      </View>
      ...
      <View style={pdfStyles.highlightsSection}>
        ...
        <View style={pdfStyles.highlightsGrid}>
          ...
          <View style={pdfStyles.highlightItem}>
            <Text>6 Activities</Text>
          </View>
          <View style={pdfStyles.highlightItem}>
            <Text>6 Transfers</Text>
          </View>
        </View>
      </View>
