    ...
    <Page size="A4" style={pdfStyles.page}>
      ...
      <View style={pdfStyles.mainHeader}>
        <View style={pdfStyles.headerLeft}>
          ...
          <Text style={pdfStyles.packageDuration}>
            {packageSummary.package?.duration} • Customizable • {packageSummary.package?.packageType}
          </Text>
          
          {/* Places Coverage */}
          <Text style={pdfStyles.placesCoverage}>
            {packageSummary.package?.packagePlaces?.map(place => 
              `${place.nights}N ${place.placeCover}`
            ).join(' • ')}
          </Text>
        </View>
      ...
      <View style={pdfStyles.quoteBox}>
        <Text style={pdfStyles.quoteText}>
          Experience the beauty of {packageSummary.package?.packageName} with our customized package. 
          Discover local culture, enjoy comfortable stays, and create unforgettable memories.
        </Text>
      </View>
