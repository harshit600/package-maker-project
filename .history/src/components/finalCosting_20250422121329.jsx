  ...
  <Document>
    <Page size="A4" style={pdfStyles.page}>
      ...
      <View style={pdfStyles.contentSection}>
        {/* Contents Section */}
        <View style={pdfStyles.contentsBox}>
          <Text style={pdfStyles.contentsTitle}>Contents</Text>
          <View style={pdfStyles.contentsList}>
            <View style={pdfStyles.contentsItem}>
              <Text style={pdfStyles.contentsNumber}>1</Text>
              <Text style={pdfStyles.contentsText}>Your Itinerary</Text>
            </View>
            <View style={pdfStyles.contentsItem}>
              <Text style={pdfStyles.contentsNumber}>2</Text>
              <Text style={pdfStyles.contentsText}>Day Wise Details</Text>
            </View>
            <View style={pdfStyles.contentsItem}>
              <Text style={pdfStyles.contentsNumber}>3</Text>
              <Text style={pdfStyles.contentsText}>How To Book</Text>
            </View>
            <View style={pdfStyles.contentsItem}>
              <Text style={pdfStyles.contentsNumber}>4</Text>
              <Text style={pdfStyles.contentsText}>Cancellation & Date Change Policies</Text>
            </View>
          </View>
        </View>

        {/* Agent Info Box */}
        <View style={pdfStyles.agentInfoBox}>
          <Text style={pdfStyles.curatedByText}>Curated by</Text>
          <Text style={pdfStyles.agentName}>{packageSummary.package?.agentName || "Travel Expert"}</Text>
          <Text style={pdfStyles.agentContact}>
            Call: {packageSummary.package?.agentPhone || "Contact Number"}
          </Text>
          <Text style={pdfStyles.agentEmail}>
            Email: {packageSummary.package?.agentEmail || "contact@email.com"}
          </Text>
        ...
        <View style={pdfStyles.highlightsContainer}>
          <View style={pdfStyles.highlightItem}>
            <View style={pdfStyles.highlightIcon}>
              <Icons.Flight />
            </View>
          ...
          <View style={pdfStyles.highlightItem}>
            ...
            <Text style={pdfStyles.highlightText}>
              {packageSummary.transfer ? "6 Transfers" : "0 Transfers"}
            </Text>
          </View>
        ...
        <View style={pdfStyles.ctaBox}>
          <View style={pdfStyles.ctaContent}>
            <View style={pdfStyles.ctaIcon}>
              {/* Add your suitcase icon here */}
            </View>
            <Text style={pdfStyles.ctaTitle}>Now, Plan Your Trips with {companyName}</Text>
            <View style={pdfStyles.ctaFeatures}>
              <Text style={pdfStyles.ctaFeatureText}>• Track quotations</Text>
              <Text style={pdfStyles.ctaFeatureText}>• Customize your quotes</Text>
              <Text style={pdfStyles.ctaFeatureText}>• Communicate in real-time</Text>
            </View>
          </View>
          <View style={pdfStyles.ctaButton}>
            <Text style={pdfStyles.ctaButtonText}>VIEW YOUR QUOTES</Text>
          </View>
        </View>

        {/* Total Cost Section */}
        <View style={pdfStyles.totalCostSection}>
          <Text style={pdfStyles.totalCostTitle}>Total Cost Including Tax</Text>
          <Text style={pdfStyles.totalCostNote}>
            Note: Package price, payment schedule and cancellation policy are tentative and subject to change. 
            Package price, payment schedule and cancellation policy as shown on the Package Review Page prior to the payment will be final.
          </Text>
          <View style={pdfStyles.priceDisplay}>
            <Text style={pdfStyles.priceSymbol}>₹</Text>
            ...
            <Text style={pdfStyles.priceNote}>
              For {packageSummary.package?.numberOfAdults || 1} Adults
            </Text>
          </View>
