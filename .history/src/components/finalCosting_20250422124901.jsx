        ...
        <View style={pdfStyles.headerLeft}>
          ...
          <View style={pdfStyles.packageInfoRow}>
            ...
            <Text style={pdfStyles.packageTypeText}>
              Best of {packageSummary.package?.packageName || "Package"} Package
            </Text>
          </View>
      ...
      <View style={pdfStyles.contentSection}>
        ...
        <View style={pdfStyles.contentsBox}>
          ...
          <View style={pdfStyles.contentsList}>
            ...
            <View style={pdfStyles.contentsItem}>
              ...
              <Text style={pdfStyles.contentsText}>
        ...
        <View style={pdfStyles.agentInfoBox}>
          ...
          <Text style={pdfStyles.agentName}>
            {packageSummary.package?.agentName || "Travel Expert"}
          </Text>
        ...
        <View style={pdfStyles.ctaBox}>
          <View style={pdfStyles.ctaContent}>
            ...
            <View style={pdfStyles.ctaFeatures}>
              ...
              <Text style={pdfStyles.ctaFeatureText}>
