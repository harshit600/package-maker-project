  ...
  <Document>
    <Page size="A4" style={pdfStyles.page}>
      ...
      <View style={pdfStyles.mainContent}>
        {/* Contents Section */}
        <View style={pdfStyles.contentsSection}>
          <Text style={pdfStyles.sectionTitle}>Contents</Text>
          <View style={pdfStyles.contentsList}>
            <View style={pdfStyles.contentItem}>
              <View style={pdfStyles.contentNumber}>
                <Text style={pdfStyles.numberText}>1</Text>
              </View>
              <Text style={pdfStyles.contentLink}>Your Itinerary</Text>
            </View>
            <View style={pdfStyles.contentItem}>
              <View style={pdfStyles.contentNumber}>
                <Text style={pdfStyles.numberText}>2</Text>
              </View>
              <Text style={pdfStyles.contentLink}>Day Wise Details</Text>
            </View>
            <View style={pdfStyles.contentItem}>
              <View style={pdfStyles.contentNumber}>
                <Text style={pdfStyles.numberText}>3</Text>
              </View>
              <Text style={pdfStyles.contentLink}>How To Book</Text>
            </View>
            <View style={pdfStyles.contentItem}>
              <View style={pdfStyles.contentNumber}>
                <Text style={pdfStyles.numberText}>4</Text>
              </View>
              <Text style={pdfStyles.contentLink}>Cancellation & Date Change Policies</Text>
            </View>
          </View>
        </View>
        ...
        <View style={pdfStyles.agentBox}>
          ...
          <Text style={pdfStyles.agentName}>{packageSummary.package?.agentName}</Text>
          <Text style={pdfStyles.contactText}>Call: {packageSummary.package?.agentPhone}</Text>
          <Text style={pdfStyles.contactText}>Email: {packageSummary.package?.agentEmail}</Text>
        ...
        <View style={pdfStyles.highlightsContainer}>
          <View style={pdfStyles.highlightCard}>
            <Icons.Flight />
            <Text style={pdfStyles.highlightText}>{packageSummary.package?.flights || 2} Flights</Text>
          </View>
          <View style={pdfStyles.highlightCard}>
            <Icons.Hotel />
            <Text style={pdfStyles.highlightText}>{packageSummary.hotels?.length || 4} Hotels</Text>
          </View>
          <View style={pdfStyles.highlightCard}>
            <Icons.Activity />
            <Text style={pdfStyles.highlightText}>{packageSummary.activities?.length || 6} Activities</Text>
          </View>
          <View style={pdfStyles.highlightCard}>
            <Icons.Transfer />
            <Text style={pdfStyles.highlightText}>{packageSummary.transfers?.length || 6} Transfers</Text>
          </View>
          <View style={pdfStyles.highlightCard}>
            <Icons.Meals />
        ...
        <View style={pdfStyles.planTripsBox}>
          <View style={pdfStyles.planTripsContent}>
            <Icons.Suitcase />
            <Text style={pdfStyles.planTripsTitle}>Now, Plan Your Trips with {companyName}</Text>
            <View style={pdfStyles.planTripsList}>
              <Text style={pdfStyles.planTripsItem}>• Track quotations</Text>
              <Text style={pdfStyles.planTripsItem}>• Customize your quotes</Text>
              <Text style={pdfStyles.planTripsItem}>• Communicate in real-time</Text>
            </View>
          </View>
        ...
        <View style={pdfStyles.costSection}>
          ...
          <View style={pdfStyles.priceRow}>
            ...
            <Text style={pdfStyles.priceNote}>For {packageSummary.package?.numberOfAdults || 6} Adults</Text>
          </View>
