    ...
    <Page size="A4" style={pdfStyles.page}>
        ...
        <View style={pdfStyles.headerLeft}>
          ...
          <View style={pdfStyles.descriptionBox}>
            ...
            <Text style={pdfStyles.descriptionText}>
              {packageSummary.package?.packageDescription?.replace(/<[^>]*>/g, '') || 
      ...
      <View style={pdfStyles.mainContent}>
        ...
        <View style={pdfStyles.inclusionSection}>
          <Text style={pdfStyles.itineraryContent}>
            {packageSummary.package?.packageInclusions?.replace(/<[^>]*>/g, '') || "Package inclusions not specified"}
          </Text>
        </View>
        ...
        <View style={pdfStyles.inclusionSection}>
          <Text style={pdfStyles.itineraryContent}>
            {packageSummary.package?.packageExclusions?.replace(/<[^>]*>/g, '') || "Package exclusions not specified"}
          </Text>
        </View>
