      ...
      <View style={pdfStyles.mainContent}>
        ...
        <View style={pdfStyles.itinerarySection}>
          ...
          {packageSummary?.package?.itineraryDays?.map((day, index) => {
            ...
            console.log("Day Data:", dayData); // For debugging
              ...
              <View key={index}>
                ...
                <View style={pdfStyles.locationCard}>
                  ...
                  <View style={pdfStyles.dayContainer}>
                    ...
                    {packageSummary.transfer?.details && packageSummary.transfer.details.day === day.day && (
                      <View style={pdfStyles.transferContainer}>
                        <View style={pdfStyles.transferHeader}>
                          <Icons.Car />
                          <Text style={pdfStyles.transferTitle}>Transport Details</Text>
                        </View>
                        
                        <View style={pdfStyles.transferDetails}>
                          <View style={pdfStyles.transferDetail}>
                            <Text style={pdfStyles.transferLabel}>Vehicle: </Text>
                          ...
                          <View style={pdfStyles.transferDetail}>
                            <Text style={pdfStyles.transferLabel}>Type: </Text>
                            <Text style={pdfStyles.transferValue}>
                          ...
                          <View style={pdfStyles.transferDetail}>
                            <Text style={pdfStyles.transferLabel}>Seating: </Text>
                            <Text style={pdfStyles.transferValue}>
                              {packageSummary.transfer.details.cabSeatingCapacity} Seater
                            </Text>
                          </View>
                          ...
                          {packageSummary.transfer.details.hasAC && (
                            <>
                              <View style={pdfStyles.transferDivider} />
                              <View style={pdfStyles.transferDetail}>
                                <Text style={pdfStyles.transferValue}>AC</Text>
                              </View>
                            </>
                          )}
                        </View>
