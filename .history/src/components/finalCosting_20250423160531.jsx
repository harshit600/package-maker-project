      ...
      <View style={pdfStyles.mainContent}>
        ...
        <View style={pdfStyles.itinerarySection}>
          ...
          {packageSummary?.package?.itineraryDays?.map((day, index) => {
            ...
            const dayHotel = packageSummary.hotels.find(hotel => hotel.day === day.day);
              ...
              <View key={index}>
                ...
                <View style={pdfStyles.locationCard}>
                  ...
                  <View style={pdfStyles.dayContainer}>
                    ...
                    {dayHotel && (
                      <View style={pdfStyles.hotelContainer}>
                        <View style={pdfStyles.hotelHeader}>
                          <Icons.Hotel />
                          <Text style={pdfStyles.hotelTitle}>Hotel Details</Text>
                        </View>
                    ...
                    {packageSummary.hotels[index] && (
                      <View style={pdfStyles.hotelInfo}>
                        <Icons.Hotel />
                        <Text style={pdfStyles.hotelName}>
                          Stay at {packageSummary.hotels[index].hotelName}
                        </Text>
                      </View>
                    )}
