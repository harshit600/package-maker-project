                    ...
                    {dayHotel && (
                      <View style={pdfStyles.hotelContainer}>
                        <View style={pdfStyles.hotelHeader}>
                          <Icons.Hotel />
                          <Text style={pdfStyles.hotelTitle}>
                            Day {dayHotel.day} - Hotel Details
                          </Text>
                        </View>

                        <View style={pdfStyles.hotelDetails}>
                          {/* Property Photos Carousel */}
                          {dayHotel.propertyphoto && Array.isArray(dayHotel.propertyphoto) && dayHotel.propertyphoto.length > 0 && (
                            <View style={pdfStyles.propertyPhotosContainer}>
                              {/* Main Photo */}
                              <View style={pdfStyles.propertyMainPhotoContainer}>
                                <Image
                                  source={{ uri: dayHotel.propertyphoto[0] }}
                                  style={pdfStyles.propertyMainPhoto}
                                />
                              </View>
                              
                              {/* Thumbnail Grid */}
                              <View style={pdfStyles.propertyPhotoGrid}>
                                {dayHotel.propertyphoto.slice(1, 4).map((photoUrl, index) => (
                                  <View key={index} style={pdfStyles.thumbnailContainer}>
                                    <Image
                                      source={{ uri: photoUrl }}
                                      style={pdfStyles.propertyThumbnail}
                                    />
                                  </View>
                                ))}
                              </View>
                          ...
                          {/* Hotel Info */}
                          <Text style={pdfStyles.hotelPropertyName}>
                            {dayHotel.propertyName}
                          </Text>
                          
                          {/* Hotel Details Grid */}
                          <View style={pdfStyles.hotelInfoGrid}>
                            <View style={pdfStyles.hotelInfoItem}>
                              <Text style={pdfStyles.infoLabel}>Location</Text>
                              <Text style={pdfStyles.infoValue}>{dayHotel.cityName}</Text>
                            </View>

                            <View style={pdfStyles.hotelInfoItem}>
                              <Text style={pdfStyles.infoLabel}>Meal Plan</Text>
                              <Text style={pdfStyles.infoValue}>{dayHotel.mealPlan}</Text>
                            </View>

                            <View style={pdfStyles.hotelInfoItem}>
                              <Text style={pdfStyles.infoLabel}>Room Rate</Text>
                              <Text style={pdfStyles.infoValue}>₹{dayHotel.cost}/night</Text>
                            </View>

                            <View style={pdfStyles.hotelInfoItem}>
                              <Text style={pdfStyles.infoLabel}>Extra Adult Rate</Text>
                              <Text style={pdfStyles.infoValue}>₹{dayHotel.extraAdultRate}</Text>
                            </View>
                          </View>

                          {/* Room Details */}
                          {dayHotel.roomName && (
                            <View style={pdfStyles.roomDetailsContainer}>
                              <Text style={pdfStyles.roomTypeTitle}>
                                Room Type: {dayHotel.roomName}
                              </Text>
                              {dayHotel.roomimage && (
                                <View style={pdfStyles.roomImageContainer}>
                                  <Image
                                    source={{ uri: dayHotel.roomimage }}
                                    style={pdfStyles.roomImage}
                                  />
                                </View>
                              )}
                            </View>
