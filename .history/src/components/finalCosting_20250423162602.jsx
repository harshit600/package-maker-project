                      ...
                      <View style={pdfStyles.hotelContainer}>
                        ...
                        <View style={pdfStyles.locationHeader}>
                          ...
                          <Text style={pdfStyles.locationText}>
                            {dayHotel.cityName} - {packageSummary.package.cityArea[index]?.nights || "1"} Nights Stay
                          </Text>
                        </View>
                        ...
                        <View style={pdfStyles.hotelCard}>
                          ...
                          <View style={pdfStyles.hotelMainInfo}>
                            {/* Hotel Image */}
                            {dayHotel.propertyphoto && dayHotel.propertyphoto.length > 0 && (
                            ...
                            <View style={pdfStyles.hotelInfo}>
                              <View style={pdfStyles.hotelHeaderRow}>
                                <View style={pdfStyles.hotelTypeTag}>
                                  <Text style={pdfStyles.hotelTypeText}>Hotel</Text>
                                </View>
                                <View style={pdfStyles.ratingTag}>
                                  <Text style={pdfStyles.ratingText}>3.9/5</Text>
                                </View>
                              </View>

                              <Text style={pdfStyles.hotelName}>{dayHotel.propertyName}</Text>
                              <Text style={pdfStyles.hotelAddress}>{dayHotel.cityName}</Text>
                              <Text style={pdfStyles.distanceText}>4.8 km drive to nearest landmark</Text>

                              {/* Check-in/Check-out Info */}
                              <View style={pdfStyles.checkInOutContainer}>
                                <View style={pdfStyles.checkInOut}>
                                  <Text style={pdfStyles.checkLabel}>Check In:</Text>
                                  <Text style={pdfStyles.checkTime}>12 PM</Text>
                                </View>
                                <View style={pdfStyles.checkInOut}>
                                  <Text style={pdfStyles.checkLabel}>Check Out:</Text>
                                  <Text style={pdfStyles.checkTime}>12 PM</Text>
                                </View>
                              </View>
                            </View>
                          ...
                          <View style={pdfStyles.roomDetailsSection}>
                            <Text style={pdfStyles.roomTypeHeader}>
                              {dayHotel.roomName || "Deluxe Room"} x {packageSummary.package?.numberOfRooms || 2}
                            </Text>

                            <View style={pdfStyles.roomDetailsGrid}>
                              <View style={pdfStyles.roomDetailItem}>
                                <Text style={pdfStyles.detailLabel}>Meal Plan</Text>
                                <Text style={pdfStyles.detailValue}>{dayHotel.mealPlan}</Text>
                              </View>
                              <View style={pdfStyles.roomDetailItem}>
                                <Text style={pdfStyles.detailLabel}>Room Size</Text>
                                <Text style={pdfStyles.detailValue}>144 sq.ft</Text>
                              </View>
                              <View style={pdfStyles.roomDetailItem}>
                                <Text style={pdfStyles.detailLabel}>Bed Type</Text>
                                <Text style={pdfStyles.detailValue}>Double Bed</Text>
                              </View>
                            </View>

                            {/* Room Inclusions */}
                            <View style={pdfStyles.inclusionsSection}>
                              <Text style={pdfStyles.inclusionsHeader}>Room Inclusion:</Text>
                              <Text style={pdfStyles.inclusionsText}>
                                ✓ Complimentary Welcome Drinks & Amenities is provided. Drinks are served.
                              </Text>
                            </View>
                          </View>
                        </View>
