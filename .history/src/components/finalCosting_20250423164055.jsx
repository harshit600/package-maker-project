...
const pdfStyles = StyleSheet.create({
  ...
  timelineGradient: {
    ...
    top: 0,
    bottom: 0,
    backgroundColor: 'linear-gradient(90deg, #BBF7D0 0%, #FEF08A 50%, #FECACA 100%)',
  },
        ...
        <View style={pdfStyles.policySection}>
          ...
          <View style={pdfStyles.policyContainer}>
            <View style={pdfStyles.currentPolicyHeader}>
              <Text style={pdfStyles.currentPolicyText}>Your Current Policy</Text>
            </View>
            ...
            <View style={pdfStyles.policyTimelineContainer}>
              ...
              <Text style={pdfStyles.noChangeText}>Date Change is not allowed</Text>
            </View>
