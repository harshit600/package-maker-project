...
const PackagePDF = ({
  ...
  <Document>
    <Page size="A4" style={pdfStyles.page}>
      {/* Background Image - first element in the Page */}
      <View
        style={{
          position: "absolute",
          width: "100%",
      ...
      <View style={pdfStyles.headerContainer}>
        ...
        <View style={pdfStyles.headerLeft}>
          ...
          {/* Itinerary Breakdown - Using cityArea data */}
          <View style={pdfStyles.itineraryBreakdown}>
            {packageSummary.package?.cityArea?.map((place, index) => (
              <React.Fragment key={index}>
                <Text style={pdfStyles.stayText}>
                  {place.nights}N {place.city}
                </Text>
                {index < packageSummary.package.cityArea.length - 1 && (
          ...
          <View style={pdfStyles.descriptionBox}>
            ...
            <Text style={pdfStyles.descriptionText}>
              "Fall in love with the enchanting state! Get a glimpse of the rich
              history of the region. Enjoy a tour and visit the incredible
              locations."
            </Text>
          </View>
        </View>
      ...
      <View style={pdfStyles.mainContent}>
        ...
        <View style={pdfStyles.agentBox}>
          ...
          <Text style={pdfStyles.contactText}>
            Call: {packageSummary.package?.agentPhone || "+91 98765 43210"}
          </Text>
          <Text style={pdfStyles.contactText}>Email: info@plutotours.in</Text>
        ...
        <View style={pdfStyles.highlightsContainer}>
          ...
          <View style={pdfStyles.highlightCard}>
            <Icons.Transfer />
            <Text style={pdfStyles.highlightText}>
              {packageSummary.transfer ? "Transfers Included" : "No Transfers"}
            </Text>
          </View>
          <View style={pdfStyles.highlightCard}>
            <Icons.Meals />
            <Text style={pdfStyles.highlightText}>Meals Included</Text>
          </View>
        </View>

        {/* Itinerary Section */}
        <View style={pdfStyles.itinerarySection}>
          <Text style={pdfStyles.itineraryTitle}>Your Itinerary</Text>
          ...
          {packageSummary?.package?.itineraryDays?.map((day, index) => {
            ...
            // Console log for debugging hotels
            console.log("Day", day.day, "Hotel Details:", {
              dayHotel: packageSummary.hotels[index],
              allHotels: packageSummary.hotels,
              cityName: dayData.cityName,
            });

            return (
              <View key={index}>
                {/* Flight/Transfer info if it's day 1 */}
                {index === 0 && (
                  <View style={pdfStyles.flightInfo}>
                    <Icons.Transfer />
                    <Text style={pdfStyles.flightText}>
                      {`${packageSummary.package.dropLocation} to ${dayData.cityName}`}
                    </Text>
                  </View>
                )}

                {/* Location Card */}
                <View style={pdfStyles.locationCard}>
                  <View style={pdfStyles.locationHeader}>
                    <Icons.Globe />
                    <Text style={pdfStyles.locationTitle}>
                      {dayData.cityName} -{" "}
                      {packageSummary.package.cityArea[index]?.nights || ""}{" "}
                      Nights Stay
                    </Text>
                  </View>

                  <View style={pdfStyles.dayContainer}>
                    <Text style={pdfStyles.dayHeader}>
                      Day {day.day}: {dayData.itineraryTitle}
                    </Text>

                    {/* Hotel Details */}
                    {dayHotel && (
                      <View style={pdfStyles.hotelContainer}>
                        {/* Location Header */}
                        <View style={pdfStyles.locationHeader}>
                          <Icons.Location />
                        ...
                        {/* Hotel Card */}
                        <View style={pdfStyles.hotelCard}>
                          {/* Main Hotel Info Row */}
                          <View style={pdfStyles.hotelMainInfo}>
                            {/* Hotel Image */}
                            {dayHotel.propertyphoto &&
                              dayHotel.propertyphoto.length > 0 && (
                                <View style={pdfStyles.hotelImageContainer}>
                                  <Image
                                    src={dayHotel.propertyphoto[0]}
                                    style={pdfStyles.hotelImage}
                                  />
                                </View>
                              )}
                            ...
                            <View style={pdfStyles.hotelInfo}>
                              <View style={pdfStyles.hotelHeaderRow}>
                                <View style={pdfStyles.hotelTypeTag}>
                                  <Text style={pdfStyles.hotelTypeText}>
                                    Hotel
                                  </Text>
                                </View>
                                <View style={pdfStyles.ratingTag}>
                              ...
                              <Text style={pdfStyles.distanceText}>
                                4.8 km drive to nearest landmark
                              </Text>

                              {/* Check-in/Check-out Info */}
                              <View style={pdfStyles.checkInOutContainer}>
                                <View style={pdfStyles.checkInOut}>
                                  <Text style={pdfStyles.checkLabel}>
                                    Check In:
                                  </Text>
                                  <Text style={pdfStyles.checkTime}>12 PM</Text>
                                </View>
                                <View style={pdfStyles.checkInOut}>
                                  <Text style={pdfStyles.checkLabel}>
                                    Check Out:
                          ...
                          <View style={pdfStyles.roomDetailsSection}>
                            <Text style={pdfStyles.roomTypeHeader}>
                              {dayHotel.roomName || "Deluxe Room"} x{" "}
                              {packageSummary.package?.numberOfRooms || 2}
                            </Text>

                            <View style={pdfStyles.roomDetailsGrid}>
                              <View style={pdfStyles.roomDetailItem}>
                            ...
                            {/* Room Inclusions */}
                            <View style={pdfStyles.inclusionsSection}>
                              <Text style={pdfStyles.inclusionsHeader}>
                                Room Inclusion:
                              </Text>
                              <Text style={pdfStyles.inclusionsText}>
                                ✓ Complimentary Welcome Drinks & Amenities is
                                provided. Drinks are served.
                              </Text>
                            </View>
                          </View>
                        </View>
                    ...
                    {/* Transfer Details - Show if transfer exists and matches the day */}
                    {packageSummary.transfer?.details &&
                      packageSummary.transfer.details.day === day.day && (
                        <View style={pdfStyles.transferContainer}>
                          <View style={pdfStyles.transferHeader}>
                            <Icons.Car />
                            <Text style={pdfStyles.transferTitle}>
                              Transport Details
                            </Text>
                          </View>

                          <View style={pdfStyles.transferDetails}>
                            <View style={pdfStyles.transferDetail}>
                              <Text style={pdfStyles.transferLabel}>
                                Vehicle:{" "}
                              </Text>
                              <Text style={pdfStyles.transferValue}>
                                {packageSummary.transfer.details.cabName}
                              </Text>
                            </View>

                            <View style={pdfStyles.transferDivider} />
                            ...
                            {packageSummary.transfer.details.hasAC && (
                              <>
                                <View style={pdfStyles.transferDivider} />
                                <View style={pdfStyles.transferDetail}>
                                  <Text style={pdfStyles.transferValue}>
                    ...
                    <View style={pdfStyles.activityRow}>
                      <Icons.Activity />
                      <Text style={pdfStyles.activityText}>
                        {dayData.itineraryDescription?.replace(/<[^>]*>/g, "")}
                      </Text>
                    </View>

                    {/* City Areas Covered */}
                    {dayData.cityArea && dayData.cityArea.length > 0 && (
                      <View style={pdfStyles.cityAreasContainer}>
                        <Text style={pdfStyles.cityAreaTitle}>
                          Places Covered:
                        </Text>
                        {dayData.cityArea.map((area, areaIndex) => (
                          <View key={areaIndex} style={pdfStyles.cityAreaItem}>
                            <View style={pdfStyles.cityAreaBullet} />
                            <Text style={pdfStyles.cityAreaText}>{area}</Text>
                          </View>
                        ))}
                      </View>
                    )}

                    {/* Hotels from packageSummary.hotels if available */}

                    {/* Activities if any */}
                    {dayData.activities?.map((activity, actIndex) => (
                      <View key={actIndex} style={pdfStyles.activityRow}>
                        <Icons.Activity />
                        <Text style={pdfStyles.activityText}>{activity}</Text>
                      </View>
                    ))}

                    {/* Meals if included */}
                    {dayData.meals && (
                      <View style={pdfStyles.mealInfo}>
                        <Icons.Meals />
                        <Text style={pdfStyles.mealText}>
                          Meals: {dayData.meals}
                        </Text>
                      </View>
                    )}
                ...
                {/* Transfer to next location if not last day */}
                {index < packageSummary.package.itineraryDays.length - 1 && (
                  <View style={pdfStyles.transferInfo}>
                    <Icons.Transfer />
                    <Text style={pdfStyles.flightText}>
                      Transfer to{" "}
                      {
        ...
        {/* Inclusions Section */}
        <Text style={pdfStyles.sectionTitle}>Inclusions</Text>
        <View style={pdfStyles.inclusionSection}>
          <Text style={pdfStyles.itineraryContent}>
            {packageSummary.package?.packageInclusions?.replace(
              /<[^>]*>/g,
              ""
            ) || "Package inclusions not specified"}
          </Text>
        </View>

        {/* Exclusions Section */}
        <Text style={pdfStyles.sectionTitle}>Exclusions</Text>
        <View style={pdfStyles.inclusionSection}>
          <Text style={pdfStyles.itineraryContent}>
            {packageSummary.package?.packageExclusions?.replace(
              /<[^>]*>/g,
              ""
            ) || "Package exclusions not specified"}
          </Text>
        </View>
            ...
            <View style={pdfStyles.termsList}>
              ...
              <View style={pdfStyles.termsItem}>
                <Text style={pdfStyles.termsText}>
                  With reference to the current COVID Protocol, it is mandatory for all travellers to carry a negative RT-PCR Test report while entering some states/UTs. Please keep in mind that COVID guidelines of the state may require to and the approximate time required to get the report while booking the package. The duration to get the report might vary as there is only one centre in Ladakh. Therefore, it is recommended that you keep this mind while booking your return flight. For a hassle-free travel experience, we request you to consult with your Travel Expert.
                </Text>
              </View>
              ...
              <View style={pdfStyles.termsItem}>
                <Text style={pdfStyles.termsText}>
                  Standard check-in time at the hotel is normally 12:00 pm and check-out is 11:00 am. An early check-in or a late check-out is solely based on the discretion of the hotel.
                </Text>
              </View>
              ...
              <View style={pdfStyles.termsItem}>
                ...
                <Text style={pdfStyles.termsText}>
                  • All other terms & conditions as mentioned on our website will be included in the packages.
                </Text>
              </View>
              ...
              <View style={pdfStyles.termsItem}>
                <Text style={pdfStyles.termsText}>
                  If your flight involves a combination of different airlines, you may have to collect your luggage on arrival at the connecting hub and register it again while checking in for the onward journey to your destination.
                </Text>
              </View>
              ...
              <View style={pdfStyles.termsItem}>
                ...
                <Text style={pdfStyles.termsText}>
                  • MMT reserves the right to modify, postpone, or cancel any of the package due to unforeseen circumstances like strikes, riots, political unrest, bandhs, or any other disturbance.
                </Text>
              </View>
