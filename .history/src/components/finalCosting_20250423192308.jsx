              ...
              if (index === 0 || cityInfo.cityName !== packageSummary.package?.itineraryDays[index - 1].selectedItinerary.cityName) {
                ...
                return (
                  <React.Fragment key={index}>
                    <View style={pdfStyles.stayInfo}>
                      <Text style={pdfStyles.stayText}>
                        {daysInCity} {daysInCity > 1 ? 'Days' : 'Day'} in {cityInfo.cityName}
                      </Text>
                      {!isLastDayInCity && (
