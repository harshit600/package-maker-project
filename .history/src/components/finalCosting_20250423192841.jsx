    ...
    <Page size="A4" style={pdfStyles.page}>
      ...
      <View style={pdfStyles.headerContainer}>
        ...
        <View style={pdfStyles.headerLeft}>
          ...
          {/* Enhanced Itinerary Overview with reduced spacing and font sizes */}
          <View style={{
            ...
            <View style={{
              ...
              <Icons.Map style={{ width: 10, height: 10, color: '#2563EB' }} /> {/* reduced from 20x20 */}
              <Text style={{
                fontSize: 7, // reduced from 14
                fontWeight: 'bold',
                color: '#1E293B'
            ...
            <View style={{
              ...
              {packageSummary.package?.itineraryDays?.map((day, index) => {
                ...
                const isLastDayInCity = !nextDay || nextDay.selectedItinerary.cityName !== cityInfo.cityName;
                
                if (index === 0 || cityInfo.cityName !== packageSummary.package?.itineraryDays[index - 1].selectedItinerary.cityName) {
                    ...
                    <View key={index} style={{
                      ...
                      <View style={{ flex: 1 }}>
                        <Text style={{
                          ...
                          fontWeight: 'bold',
                          color: '#1E293B'
                        }}>{cityInfo.cityName}</Text>
                        <Text style={{
                          fontSize: 6, // reduced from 12
                          color: '#64748B'
                        }}>{daysInCity} {daysInCity > 1 ? 'Days' : 'Day'}</Text>
                      </View>
                      {!isLastDayInCity && (
                        <View style={{
                          position: 'absolute',
                          right: -6, // reduced from -12
                          top: '50%',
            ...
            {/* Journey Stats with reduced sizes */}
            <View style={{
              marginTop: 8, // reduced from 16
              flexDirection: 'row',
              justifyContent: 'space-around',
              ...
              <View style={{
                ...
                <Text style={{
                  ...
                  fontWeight: 'bold',
                  color: '#1E293B'
                }}>{new Set(packageSummary.package?.itineraryDays?.map(day => day.selectedItinerary.cityName)).size}</Text>
              </View>
              <View style={{
                alignItems: 'center'
              }}>
                ...
                <Text style={{
                  ...
                  fontWeight: 'bold',
                  color: '#1E293B'
                }}>{packageSummary.package?.itineraryDays?.length}</Text>
              </View>
              <View style={{
                alignItems: 'center'
              }}>
                ...
                <Text style={{
                  ...
                  fontWeight: 'bold',
                  color: '#1E293B'
                }}>{packageSummary.package?.itineraryDays?.reduce((acc, day) => acc + (day.selectedItinerary.distance || 0), 0)} km</Text>
              </View>
            </View>
          </View>
        </View>
