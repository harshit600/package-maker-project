...
// First, create a WatermarkedPage component at the top of your file
const WatermarkedPage = ({ children }) => (
...
// Then modify your PackagePDF component to use WatermarkedPage instead of Page
const PackagePDF = ({ packageSummary, showMargin, marginAmount, finalTotal, getCurrentMarginPercentage, companyName = "Pluto Tours and Travel" }) => (
  <Document>
    {/* First Page */}
    <WatermarkedPage>
    ...
    {/* Policy Page */}
    <WatermarkedPage>
      {/* Your existing policy page content */}
      <View style={pdfStyles.policySection}>
        {/* ... */}
      </View>
    </WatermarkedPage>
    ...
    <WatermarkedPage>
      {/* Your existing terms page content */}
      <View style={pdfStyles.termsSection}>
        {/* ... */}
      </View>
    </WatermarkedPage>
