        ...
        <View break>
          <View style={{
            ...
            <View style={{
              ...
              <Icons.Currency style={{ width: 16, height: 16, color: '#2563EB' }} />
              <Text style={{
                fontSize: 14,
                fontWeight: 'bold',
                color: '#1E293B'
              }}>Detailed Price Breakdown</Text>
            </View>
            ...
            <View style={{ marginBottom: 20 }}>
              ...
              {packageSummary.hotels.map((hotel, index) => (
                <View key={index} style={{
                  ...
                  <View style={{
                    ...
                    <Text style={{ fontSize: 10, color: '#1E293B', flex: 1 }}>
                  ...
                  <Text style={{ fontSize: 9, color: '#64748B' }}>
                    Day {hotel.day} • {hotel.mealPlan} • Extra Adult Rate: ₹{hotel.extraAdultRate}
                  </Text>
                </View>
              ))}
              ...
              <View style={{
                ...
                <Text style={{ fontSize: 11, fontWeight: 'bold', color: '#2563EB' }}>
                  ₹{packageSummary.totals.hotelCost}
                </Text>
              </View>
            </View>
            ...
            <View style={{ marginBottom: 20 }}>
              ...
              <View style={{
                ...
                <Text style={{ fontSize: 10, color: '#64748B' }}>
                  {packageSummary.transfer?.details || 'Standard Transfer'}
                </Text>
                <Text style={{ fontSize: 11, fontWeight: 'bold', color: '#2563EB', marginTop: 4 }}>
                  ₹{packageSummary.totals.transferCost}
                </Text>
              </View>
            </View>
            ...
            <View style={{ marginBottom: 20 }}>
              ...
              <View style={{
                ...
                <Text style={{ fontSize: 11, fontWeight: 'bold', color: '#2563EB' }}>
                  ₹{packageSummary.totals.activitiesCost}
                </Text>
              </View>
            </View>
            ...
            <View style={{
              ...
              <View style={{
                ...
                <Text style={{ fontSize: 11, color: '#64748B' }}>Base Total</Text>
