                    ...
                    {dayHotel && (
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            Night Stay at {dayHotel.propertyName}
                          </Text>
                        </View>
                        <Text
                          style={{
                        ...
                        >
                          {dayHotel.roomName} • {dayHotel.mealPlan}
                        </Text>
                      </View>
                    )}
          ...
          <View style={{
            ...
            <View style={{
              ...
              <Text style={{
                ...
                fontWeight: 'bold',
                color: '#1E293B'
              }}>Room Cost Details</Text>
            </View>

            {packageSummary.allHotels?.map((hotel, index) => (
              <View key={index} style={{
                ...
                <View style={{ gap: 6 }}>
                  <View style={{
                    ...
                    <Text style={{ fontSize: 10, color: '#64748B' }}>Room Rate</Text>
                  ...
                  <View style={{
                    ...
                    <Text style={{ fontSize: 10, color: '#64748B' }}>Extra Adult Rate</Text>
                    <Text style={{ fontSize: 10, fontWeight: 'bold', color: '#1E293B' }}>
                  ...
                  <View style={{
                    ...
                    <View style={{ flex: 1 }}>
                      <Text style={{ fontSize: 10, color: '#64748B' }}>Meal Plan</Text>
                      <Text style={{ fontSize: 9, color: '#64748B' }}>
                        {hotel.mealPlan === 'MAP' ? 'Modified American Plan (Breakfast + Dinner)' :
                         hotel.mealPlan === 'AP' ? 'American Plan (All Meals)' :
                         hotel.mealPlan === 'CP' ? 'Continental Plan (Breakfast)' : hotel.mealPlan}
                      </Text>
                    </View>
                  </View>
                </View>
            ...
            <View style={{
              ...
              <Text style={{
                ...
                fontWeight: 'bold',
                color: '#1E293B'
              }}>Total Room Cost</Text>
              <Text style={{
                fontSize: 12,
                fontWeight: 'bold',
                color: '#2563EB'
              }}>
                ₹{packageSummary.allHotels?.reduce((total, hotel) => total + Number(hotel.cost), 0)}
              </Text>
            </View>
          </View>
        </View>
