          ...
          <View style={{
              ...
              <View key={index} style={{
                ...
                <View style={{
                  ...
                  <Text style={{
                    ...
                    Day {hotel.day} - {hotel.propertyName}
                  </Text>
                  <Text style={{
                    fontSize: 12,
                    color: '#2563EB',
                ...
                <View style={{
                  ...
                  <View style={{ flex: 1 }}>
                    <Text style={{ fontSize: 10, color: '#64748B' }}>
                      <Text>Room Cost: </Text>
                      <Text style={{ fontWeight: 'bold', color: '#1E293B' }}>₹{hotel.cost}</Text>
                    </Text>
                    <Text style={{ fontSize: 10, color: '#64748B', marginTop: 2 }}>
                      <Text>Meal Plan: </Text>
                      <Text style={{ fontWeight: 'bold', color: '#1E293B' }}>{hotel.mealPlan}</Text>
                    </Text>
                  </View>
                  <Text style={{ fontSize: 10, color: '#64748B' }}>{hotel.cityName}</Text>
                </View>
              </View>
            ))}
            ...
            <View style={{
              ...
              <Text style={{
                ...
                fontWeight: 'bold',
                color: '#1E293B'
              }}>Total Hotel Cost</Text>
              <Text style={{
                fontSize: 12,
                fontWeight: 'bold',
                color: '#2563EB'
              }}>
                ₹{packageSummary.hotels.reduce((total, hotel) => total + Number(hotel.cost), 0)}
    </Page>
  </Document>
);
