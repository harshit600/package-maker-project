                        ...
                        <View style={{
                          ...
                          <View style={{ flex: 1 }}>
                            <Text style={{ fontSize: 9, color: '#64748B' }}>
                              <Text>Room Cost: </Text>
                              <Text style={{ fontWeight: 'bold', color: '#1E293B' }}>₹{dayHotel.cost}</Text>
                            </Text>
                            <Text style={{ fontSize: 9, color: '#64748B', marginTop: 2 }}>
                              <Text>Meal Plan: </Text>
                              <Text style={{ fontWeight: 'bold', color: '#1E293B' }}>
                                {dayHotel.mealPlan === 'MAP' ? 'Modified American Plan (Breakfast + Dinner)' :
                                 dayHotel.mealPlan === 'AP' ? 'American Plan (All Meals)' :
                                 dayHotel.mealPlan === 'CP' ? 'Continental Plan (Breakfast)' : 
                                 dayHotel.mealPlan}
                              </Text>
                            </Text>
                          </View>
