      ...
      <View style={pdfStyles.mainContent}>
        ...
        <View style={{
          ...
          <View style={{
            ...
            <Icons.Star style={{ width: 16, height: 16, color: '#2563EB' }} />
            <Text style={{
              fontSize: 14,
              fontWeight: 'bold',
              color: '#1E293B'
            }}>Trip Highlights</Text>
          </View>
          ...
          <View style={{ gap: 12 }}>
            ...
            <View style={{
              ...
              <View style={{
                ...
                <View style={{
                  ...
                  <Icons.Calendar style={{ width: 12, height: 12, color: '#2563EB' }} />
                  <Text style={{
                    fontSize: 10,
                    color: '#64748B'
                  }}>Duration</Text>
                ...
                <Text style={{
                  ...
                  fontWeight: 'bold',
                  color: '#1E293B'
                }}>{packageSummary.package?.itineraryDays?.length} Days</Text>
              </View>
              ...
              <View style={{
                ...
                <View style={{
                  ...
                  <Icons.Location style={{ width: 12, height: 12, color: '#2563EB' }} />
                  <Text style={{
                    fontSize: 10,
                    color: '#64748B'
                  }}>Cities</Text>
                ...
                <Text style={{
                  ...
                  fontWeight: 'bold',
                  color: '#1E293B'
                }}>{new Set(packageSummary.package?.itineraryDays?.map(day => day.selectedItinerary.cityName)).size} Destinations</Text>
              </View>
            </View>
            ...
            <View style={{
              ...
              <Text style={{
                ...
                color: '#64748B',
                marginBottom: 8
              }}>Key Experiences</Text>
              <View style={{ gap: 8 }}>
                {packageSummary.package?.itineraryDays?.map((day, index) => (
                  day.selectedItinerary.activities?.map((activity, actIndex) => (
                    <View key={`${index}-${actIndex}`} style={{
                      flexDirection: 'row',
                      alignItems: 'center',
                      gap: 8
                    }}>
              ...
              <View style={{
                ...
                {packageSummary.hotels?.map((hotel, index) => (
                  <View key={index} style={{
                    ...
                    <Icons.Hotel style={{ width: 10, height: 10, color: '#2563EB' }} />
                    <Text style={{
                      fontSize: 9,
                      color: '#2563EB'
                    }}>{hotel.basicInfo.hotelStarRating}</Text>
                  </View>
                ))}
              </View>
            </View>
            ...
            <View style={{
              ...
              <View style={{
                ...
                {['Meals', 'Transfers', 'Sightseeing', 'Hotels'].map((feature, index) => (
                  <View key={index} style={{
                    flexDirection: 'row',
                    alignItems: 'center',
                    gap: 4
                  }}>
                    <Icons.Check style={{ width: 10, height: 10, color: '#2563EB' }} />
                    <Text style={{
                      fontSize: 9,
                      color: '#1E293B'
                    }}>{feature}</Text>
