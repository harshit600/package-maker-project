          ...
          <View style={{
            ...
            <View style={{ gap: 12 }}>
              ...
              <View style={{
                ...
                <View style={{
                  ...
                  <Text style={{ fontSize: 11, color: '#1E293B' }}>
                    <Text style={{ fontWeight: 'bold' }}>{packageSummary.package?.itineraryDays?.length}</Text>
                    <Text> Days</Text>
                  </Text>
                </View>
                ...
                <View style={{
                  ...
                  <Text style={{ fontSize: 11, color: '#1E293B' }}>
                    <Text style={{ fontWeight: 'bold' }}>
                      {new Set(packageSummary.package?.itineraryDays?.map(day => day.selectedItinerary.cityName)).size}
                    </Text>
                    <Text> Cities</Text>
                  </Text>
                </View>
              ...
              <View style={{
                ...
                {['Hotels', 'Meals', 'Transfers', 'Activities'].map((feature, index) => (
                  <View key={index} style={{
                    alignItems: 'center',
                    gap: 4
                  }}>
                    <Icons.Check style={{ width: 12, height: 12, color: '#2563EB' }} />
                    <Text style={{ fontSize: 10, color: '#64748B' }}>{feature}</Text>
                  </View>
                ))}
              </View>
            </View>
