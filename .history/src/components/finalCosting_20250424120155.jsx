  ...
  <Document>
    <Page size="A4" style={pdfStyles.page}>
      ...
      <View style={pdfStyles.mainContent}>
        ...
        {/* Break to new page before Itinerary Section */}
        <View break>
        ...
        <View style={{
          ...
          <View style={{ padding: 16, gap: 12 }}>
            ...
            <View style={{
              ...
              <Icons.Hotel style={{ width: 14, height: 14, color: '#2563EB', marginTop: 2 }} />
            ...
            <View style={{
              ...
              <Icons.Food style={{ width: 14, height: 14, color: '#2563EB', marginTop: 2 }} />
              <Text style={{ flex: 1, fontSize: 11, color: '#1E293B' }}>
            ...
            <View style={{
              ...
              <Icons.Car style={{ width: 14, height: 14, color: '#2563EB', marginTop: 2 }} />
              <Text style={{ flex: 1, fontSize: 11, color: '#1E293B' }}>
            ...
            <View style={{
              ...
              <Icons.Activity style={{ width: 14, height: 14, color: '#2563EB', marginTop: 2 }} />
              <Text style={{ flex: 1, fontSize: 11, color: '#1E293B' }}>
            ...
            <View style={{
              ...
              <Icons.Document style={{ width: 14, height: 14, color: '#2563EB', marginTop: 2 }} />
              <Text style={{ flex: 1, fontSize: 11, color: '#1E293B' }}>
                ...
                <div className="bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-200 p-4">
                  <div className="flex justify-between items-center">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="text-gray-700 font-medium">Hotel Charges</h4>
                        <p className="text-xs text-gray-500">Accommodation costs</p>
                      </div>
                    </div>
                    <span className="text-lg font-semibold text-blue-600">₹{packageSummary?.totals?.hotelCost || 0}</span>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-200 p-4">
                  <div className="flex justify-between items-center">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="text-gray-700 font-medium">Transfer Charges</h4>
                        <p className="text-xs text-gray-500">Transportation costs</p>
                      </div>
                    </div>
                    <span className="text-lg font-semibold text-green-600">₹{packageSummary?.totals?.transferCost || 0}</span>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-200 p-4">
                  <div className="flex justify-between items-center">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="text-gray-700 font-medium">Activity Charges</h4>
                        <p className="text-xs text-gray-500">Entertainment & activities</p>
                      </div>
                    </div>
                    <span className="text-lg font-semibold text-purple-600">₹{packageSummary?.totals?.activitiesCost || 0}</span>
                  </div>
                </div>
                  ...
                  <div className="bg-yellow-50 rounded-xl border border-yellow-100 p-4">
                    <div className="flex justify-between items-center">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h4 className="text-gray-700 font-medium">Margin ({getCurrentMarginPercentage()}%)</h4>
                          <p className="text-xs text-gray-500">Additional profit margin</p>
                        </div>
                      </div>
                      <span className="text-lg font-semibold text-yellow-600">₹{marginAmount.toFixed(2)}</span>
                    </div>
                  </div>

                  {/* Send Link Button */}
                  {getCurrentMarginPercentage() >= getMinimumMargin(packageSummary?.totals?.grandTotal || 0) && !showWarning && (
                    <button
              ...
              <div className="mt-8 bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl p-6 text-white">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-sm text-blue-200">{showMargin && "(with Margin)"}</p>
                  </div>
                  <div className="text-right">
                    <span className="text-2xl font-bold">₹{showMargin ? finalTotal.toFixed(2) : packageSummary?.totals?.grandTotal || 0}</span>
