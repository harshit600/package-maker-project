        ...
        <div className="w-1/3 bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
          ...
          <div className="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-purple-50 to-white">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-800">Quote History</h3>
                <p className="text-sm text-gray-500">Previous quotations and their details</p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              {history.length === 0 ? (
                ...
                history
                  ...
                  .map((item, index) => (
                    <div key={index} className="bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-200 p-4 relative">
                      {/* Timestamp */}
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div className="bg-purple-50 rounded-lg p-3">
                          ...
                          <p className="text-sm font-semibold text-purple-700">{item.marginPercentage}%</p>
                        </div>
                      </div>

                      {/* Final Total */}
                      <div className="bg-blue-50 rounded-lg p-3 mb-4">
                        <p className="text-xs text-gray-500 mb-1">Final Total</p>
                        <p className="text-lg font-bold text-blue-700">₹{item.finalTotal.toFixed(2)}</p>
                      </div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <div className="flex flex-col gap-2 flex-grow">
                          ...
                          <PDFDownloadLink
                            document={<PackagePDF
                              packageSummary={{...item, package: packageSummary.package}}
                              showMargin={true}
                        ...
                        >
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                            <path fillRule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V7.414A2 2 0 0015.414 6L12 2.586A2 2 0 0010.586 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clipRule="evenodd" />
                          </svg>
                        </button>
