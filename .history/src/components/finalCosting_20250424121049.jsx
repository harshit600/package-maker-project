              ...
              {!hasConvertedHistory && (
                <div className="flex items-center space-x-4">
                  ...
                  <button
                    ...
                    className={`px-4 py-2 ${
                      showMargin ? 'bg-red-500 hover:bg-red-600' : 'bg-blue-600 hover:bg-blue-700'
                    } text-white rounded-lg transition-colors flex items-center gap-2 font-medium shadow-sm`}
                  >
                    {showMargin ? (
                      <>
