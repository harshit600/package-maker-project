    ...
    <>
      <div className="p-6 flex gap-6">
        ...
        <div className="flex-grow bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow overflow-hidden">
          {/* Header */}
          <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center" style={{ backgroundColor: '#2d2d44' }}>
            <div>
              <h3 className="text-xl font-semibold text-white">Cost Breakdown</h3>
              <p className="text-sm text-gray-300 mt-1">Detailed pricing information</p>
            </div>
            {!hasConvertedHistory && (
