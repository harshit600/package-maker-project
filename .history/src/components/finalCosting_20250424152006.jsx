        ...
        <View style={pdfStyles.headerLeft}>
          ...
          >
            ...
            <View style={{ flexDirection: "row", gap: 12 }}>
              {/* Hotels Summary */}
              <View style={{ flex: 1, backgroundColor: "#FFFFFF", borderRadius: 4, padding: 8, borderWidth: 1, borderColor: "#E2E8F0" }}>
                <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 6, gap: 4 }}>
                  <Icons.Hotel style={{ width: 12, height: 12, color: "#2563EB" }} />
                  <Text style={{ fontSize: 10, fontWeight: "bold", color: "#1E293B" }}>Hotels</Text>
                </View>
                {packageSummary.hotels?.map((hotel, index) => (
                  <View key={index} style={{ marginBottom: 4 }}>
                    <Text style={{ fontSize: 9, color: "#1E293B", fontWeight: "500" }}>
                      {hotel.propertyName}
                    </Text>
                    <Text style={{ fontSize: 8, color: "#64748B" }}>
                      {hotel.basicInfo?.hotelStarRating}★ • {hotel.mealPlan}
                    </Text>
                  </View>
                ))}
              </View>
              ...
              <View style={{ flex: 1, backgroundColor: "#FFFFFF", borderRadius: 4, padding: 8, borderWidth: 1, borderColor: "#E2E8F0" }}>
                <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 6, gap: 4 }}>
                  <Icons.Car style={{ width: 12, height: 12, color: "#2563EB" }} />
                  <Text style={{ fontSize: 10, fontWeight: "bold", color: "#1E293B" }}>Transport</Text>
                </View>
                <View>
                  <Text style={{ fontSize: 9, color: "#1E293B", fontWeight: "500" }}>
