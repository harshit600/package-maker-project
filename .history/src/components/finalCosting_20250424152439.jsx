        ...
        <View style={pdfStyles.headerLeft}>
          ...
          >
            ...
            <View style={{ gap: 12, marginTop: 16 }}>
                ...
                <View style={{ gap: 8 }}>
                  {packageSummary.hotels?.map((hotel, index) => (
                    <View key={index} style={{ 
                      ...
                      <Text style={{ fontSize: 11, color: "#1E293B", fontWeight: "600" }}>
                        {hotel.propertyName}
                      </Text>
                      <View style={{ flexDirection: "row", alignItems: "center", marginTop: 4, gap: 8 }}>
                        <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
                          <Icons.Star style={{ width: 10, height: 10, color: "#EAB308" }} />
                        ...
                        <View style={{ 
                          ...
                          <Text style={{ fontSize: 9, color: "#2563EB", fontWeight: "500" }}>
                            {hotel.mealPlan}
                          </Text>
                        </View>
                      </View>
              ...
              <View style={{ backgroundColor: "#FFFFFF", borderRadius: 8, padding: 12, borderWidth: 1, borderColor: "#E2E8F0" }}>
                <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 10, gap: 6 }}>
                  <View style={{ backgroundColor: "#ECFDF5", padding: 6, borderRadius: 6 }}>
                    <Icons.Car style={{ width: 16, height: 16, color: "#059669" }} />
                  </View>
                  <Text style={{ fontSize: 12, fontWeight: "bold", color: "#1E293B" }}>Transport Details</Text>
                </View>
                ...
                <View style={{ 
                  ...
                  {/* Vehicle Name */}
                  <Text style={{ fontSize: 11, color: "#1E293B", fontWeight: "600" }}>
                    {packageSummary.transfer?.details?.vehicleName || "Premium Vehicle"}
                  </Text>
                  
                  {/* Vehicle Type */}
                  <Text style={{ fontSize: 10, color: "#64748B", marginTop: 2 }}>
                    {packageSummary.transfer?.details?.vehicleType || "Standard Vehicle"}
                  </Text>
                  ...
                  <View style={{ flexDirection: "row", flexWrap: "wrap", gap: 6, marginTop: 6 }}>
                    ...
                    <View style={{ 
                      ...
                      <Icons.AC style={{ width: 10, height: 10, color: "#059669" }} />
                      <Text style={{ fontSize: 9, color: "#059669", fontWeight: "500" }}>
                        {packageSummary.transfer?.details?.vehicleCategory || "AC"}
                      </Text>
                    </View>
                    ...
                    <View style={{ 
                      ...
                      <Icons.Seat style={{ width: 10, height: 10, color: "#059669" }} />
                      <Text style={{ fontSize: 9, color: "#059669", fontWeight: "500" }}>
                        {packageSummary.transfer?.details?.seatingCapacity || "4"} Seater
                      </Text>
                    </View>
                    ...
                    <View style={{ 
                      ...
                      <Icons.Driver style={{ width: 10, height: 10, color: "#059669" }} />
                      <Text style={{ fontSize: 9, color: "#059669", fontWeight: "500" }}>
                        Professional Driver
                      </Text>
                    </View>
