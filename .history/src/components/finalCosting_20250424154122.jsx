  ...
  <Document>
    <Page size="A4" style={pdfStyles.page}>
      ...
      <View style={pdfStyles.mainContent}>
        {/* Break page before Travel Expert section with proper spacing */}
        <View break>
          <View style={{ marginTop: 40 }}>  {/* Added top margin for spacing */}
            ...
            >
              ...
              <View
                style={{
                  ...
                  opacity: 0.5,
                  zIndex: 1,  // Added zIndex to ensure proper layering
                }}
              />
            ...
            {/* Highlights Section with proper spacing */}
            <View style={{ marginTop: 30 }}>  {/* Added top margin */}
