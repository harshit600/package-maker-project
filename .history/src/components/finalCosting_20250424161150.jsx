...
// Update the PackagePDF component to include lead details
const PackagePDF = ({
  packageSummary,
  showMargin,
  marginAmount,
  ...
  <Document>
    <Page size="A4" style={pdfStyles.page}>
      ...
      <View style={{
          ...
          <View style={{ flex: 1, minWidth: 200 }}>
            <View style={{ marginBottom: 12 }}>
              ...
              <Text style={{
                ...
                {packageSummary.package?.customerName || "N/A"}
              </Text>
            </View>
            ...
            <View style={{ marginBottom: 12 }}>
              ...
              <Text style={{
                ...
                {packageSummary.package?.customerEmail || "N/A"}
              </Text>
            </View>
            ...
            <View style={{ marginBottom: 12 }}>
              ...
              <Text style={{
                ...
                {packageSummary.package?.customerPhone || "N/A"}
              </Text>
            </View>
          </View>
          ...
          <View style={{ flex: 1, minWidth: 200 }}>
            <View style={{ marginBottom: 12 }}>
              ...
              <Text style={{
                ...
                {packageSummary.package?.travelDates?.from ? 
                  `${new Date(packageSummary.package.travelDates.from).toLocaleDateString()} - ${new Date(packageSummary.package.travelDates.to).toLocaleDateString()}` 
                  : "Dates not specified"}
              </Text>
            </View>
            ...
            <View style={{ marginBottom: 12 }}>
              ...
              <Text style={{
                ...
                {`${packageSummary.package?.numberOfAdults || 0} Adults${packageSummary.package?.numberOfChildren ? ` + ${packageSummary.package.numberOfChildren} Children` : ''}`}
              </Text>
            </View>
            ...
            <View style={{ marginBottom: 12 }}>
              ...
              <Text style={{
                ...
                {packageSummary.package?.leadSource || "Direct"}
              </Text>
            </View>
          </View>
        </View>
        ...
        {/* Additional Notes */}
        {packageSummary.package?.additionalNotes && (
          <View style={{
            marginTop: 12,
            paddingTop: 12,
            borderTopWidth: 1,
