...
const FinalCosting = () => {
  ...
  useEffect(() => {
    ...
    const leadDetails = packageSummary?.package?.selectedLead;
    ...
    console.log("Lead Details:", {
      ...
      packageCategory: leadDetails?.packageCategory,
      destination: leadDetails?.destination,
      budget: leadDetails?.budget,
      nights: leadDetails?.nights,
      travelDate: leadDetails?.travelDate,
      adults: leadDetails?.adults,
      children: leadDetails?.children,
      infants: leadDetails?.infants,
      status: leadDetails?.status,
      converted: leadDetails?.converted
    });
  }, [packageSummary]);
