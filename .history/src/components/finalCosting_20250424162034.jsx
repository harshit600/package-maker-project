...
const FinalCosting = () => {
  ...
  // Add this useEffect to log the lead details
  useEffect(() => {
    console.log("Package Summary:", packageSummary);
    console.log("Lead Details:", packageSummary?.package?.selectedLead);
  }, [packageSummary]);

  useEffect(() => {
    // Log the full packageSummary first to see its structure
    console.log("Full Package Summary:", packageSummary);
    
    // Log the selected lead from the correct path
    console.log("Selected Lead:", packageSummary?.selectedLead);
    
    // Also try alternative paths where the lead data might be stored
    console.log("Package Lead:", packageSummary?.package?.lead);
    console.log("Direct Lead:", packageSummary?.lead);
  }, [packageSummary]);
