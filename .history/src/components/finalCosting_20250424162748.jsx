  ...
  <Document>
    <Page size="A4" style={pdfStyles.page}>
      <View style={pdfStyles.container}>
        {/* Add Lead Details Section at the top */}
        <View style={pdfStyles.leadDetailsSection}>
          <View style={pdfStyles.leadDetailsHeader}>
            <Text style={pdfStyles.leadDetailsTitle}>Lead Details</Text>
          </View>
          
          <View style={pdfStyles.leadDetailsGrid}>
            {/* Personal Information */}
            <View style={pdfStyles.leadDetailColumn}>
              <View style={pdfStyles.leadDetailItem}>
                <Text style={pdfStyles.leadDetailLabel}>Name:</Text>
                <Text style={pdfStyles.leadDetailValue}>{packageSummary?.package?.selectedLead?.name}</Text>
              </View>
              <View style={pdfStyles.leadDetailItem}>
                <Text style={pdfStyles.leadDetailLabel}>Email:</Text>
                <Text style={pdfStyles.leadDetailValue}>{packageSummary?.package?.selectedLead?.email}</Text>
              </View>
              <View style={pdfStyles.leadDetailItem}>
                <Text style={pdfStyles.leadDetailLabel}>Mobile:</Text>
                <Text style={pdfStyles.leadDetailValue}>{packageSummary?.package?.selectedLead?.mobile}</Text>
              </View>
            </View>
            ...
            <View style={pdfStyles.leadDetailColumn}>
              <View style={pdfStyles.leadDetailItem}>
                <Text style={pdfStyles.leadDetailLabel}>Destination:</Text>
                <Text style={pdfStyles.leadDetailValue}>{packageSummary?.package?.selectedLead?.destination}</Text>
              </View>
              <View style={pdfStyles.leadDetailItem}>
                <Text style={pdfStyles.leadDetailLabel}>Travel Date:</Text>
                <Text style={pdfStyles.leadDetailValue}>
                  {new Date(packageSummary?.package?.selectedLead?.travelDate).toLocaleDateString()}
                </Text>
              </View>
              <View style={pdfStyles.leadDetailItem}>
                <Text style={pdfStyles.leadDetailLabel}>Duration:</Text>
                <Text style={pdfStyles.leadDetailValue}>
                  {packageSummary?.package?.selectedLead?.nights} Nights / {packageSummary?.package?.selectedLead?.days} Days
                </Text>
              </View>
            </View>
            ...
            <View style={pdfStyles.leadDetailColumn}>
              <View style={pdfStyles.leadDetailItem}>
                <Text style={pdfStyles.leadDetailLabel}>Adults:</Text>
                <Text style={pdfStyles.leadDetailValue}>{packageSummary?.package?.selectedLead?.adults}</Text>
              </View>
              <View style={pdfStyles.leadDetailItem}>
                <Text style={pdfStyles.leadDetailLabel}>Children:</Text>
                <Text style={pdfStyles.leadDetailValue}>{packageSummary?.package?.selectedLead?.kids}</Text>
              </View>
              <View style={pdfStyles.leadDetailItem}>
                <Text style={pdfStyles.leadDetailLabel}>Extra Beds:</Text>
                <Text style={pdfStyles.leadDetailValue}>{packageSummary?.package?.selectedLead?.extraBeds}</Text>
              </View>
            </View>
            ...
            <View style={pdfStyles.leadDetailColumn}>
              <View style={pdfStyles.leadDetailItem}>
                <Text style={pdfStyles.leadDetailLabel}>Package Type:</Text>
                <Text style={pdfStyles.leadDetailValue}>{packageSummary?.package?.selectedLead?.packageType}</Text>
              </View>
              <View style={pdfStyles.leadDetailItem}>
                <Text style={pdfStyles.leadDetailLabel}>Category:</Text>
                <Text style={pdfStyles.leadDetailValue}>{packageSummary?.package?.selectedLead?.packageCategory}</Text>
              </View>
              <View style={pdfStyles.leadDetailItem}>
                <Text style={pdfStyles.leadDetailLabel}>Meal Plan:</Text>
                <Text style={pdfStyles.leadDetailValue}>{packageSummary?.package?.selectedLead?.mealPlans}</Text>
              </View>
            </View>
          </View>
        </View>
...
const FinalCosting = ({ selectedLead }) => {
  ...
  useEffect(() => {
    console.log("Selected Lead from Props:", selectedLead);
