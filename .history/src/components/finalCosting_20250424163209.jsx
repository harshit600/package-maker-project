...
const PackagePDF = ({
  ...
  <Document>
    <Page size="A4" style={pdfStyles.page}>
      ...
      <View break>
        <View style={pdfStyles.leadSection}>
          <Text style={pdfStyles.leadTitle}>Lead Details</Text>
          
          <View style={pdfStyles.leadGrid}>
            {/* Personal Information */}
            <View style={pdfStyles.leadColumn}>
              <View style={pdfStyles.leadItem}>
                <Text style={pdfStyles.leadLabel}>Name:</Text>
                <Text style={pdfStyles.leadValue}>{selectedLead?.name}</Text>
              </View>
              <View style={pdfStyles.leadItem}>
                <Text style={pdfStyles.leadLabel}>Email:</Text>
                <Text style={pdfStyles.leadValue}>{selectedLead?.email}</Text>
              </View>
              <View style={pdfStyles.leadItem}>
                <Text style={pdfStyles.leadLabel}>Mobile:</Text>
                <Text style={pdfStyles.leadValue}>{selectedLead?.mobile}</Text>
              </View>
            </View>
            ...
            <View style={pdfStyles.leadColumn}>
              <View style={pdfStyles.leadItem}>
                <Text style={pdfStyles.leadLabel}>Destination:</Text>
                <Text style={pdfStyles.leadValue}>{selectedLead?.destination}</Text>
              </View>
              <View style={pdfStyles.leadItem}>
                <Text style={pdfStyles.leadLabel}>Travel Date:</Text>
                <Text style={pdfStyles.leadValue}>
                  {new Date(selectedLead?.travelDate).toLocaleDateString()}
                </Text>
              </View>
              <View style={pdfStyles.leadItem}>
                <Text style={pdfStyles.leadLabel}>Duration:</Text>
                <Text style={pdfStyles.leadValue}>
                  {selectedLead?.nights} Nights / {selectedLead?.days} Days
                </Text>
              </View>
            </View>
            ...
            <View style={pdfStyles.leadColumn}>
              <View style={pdfStyles.leadItem}>
                <Text style={pdfStyles.leadLabel}>Package Type:</Text>
                <Text style={pdfStyles.leadValue}>{selectedLead?.packageType}</Text>
              </View>
              <View style={pdfStyles.leadItem}>
                <Text style={pdfStyles.leadLabel}>Category:</Text>
                <Text style={pdfStyles.leadValue}>{selectedLead?.packageCategory}</Text>
              </View>
              <View style={pdfStyles.leadItem}>
                <Text style={pdfStyles.leadLabel}>Meal Plan:</Text>
                <Text style={pdfStyles.leadValue}>{selectedLead?.mealPlans}</Text>
              </View>
            </View>
            ...
            <View style={pdfStyles.leadColumn}>
              <View style={pdfStyles.leadItem}>
                <Text style={pdfStyles.leadLabel}>Adults:</Text>
                <Text style={pdfStyles.leadValue}>{selectedLead?.adults}</Text>
              </View>
              <View style={pdfStyles.leadItem}>
                <Text style={pdfStyles.leadLabel}>Children:</Text>
                <Text style={pdfStyles.leadValue}>{selectedLead?.kids}</Text>
              </View>
              <View style={pdfStyles.leadItem}>
                <Text style={pdfStyles.leadLabel}>Total Rooms:</Text>
                <Text style={pdfStyles.leadValue}>{selectedLead?.noOfRooms}</Text>
              </View>
              <View style={pdfStyles.leadItem}>
                <Text style={pdfStyles.leadLabel}>Extra Beds:</Text>
                <Text style={pdfStyles.leadValue}>{selectedLead?.extraBeds}</Text>
              </View>
            </View>
          </View>
        </View>
