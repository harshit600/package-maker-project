  ...
  <Document>
    <Page size="A4" style={pdfStyles.page}>
        ...
        <View style={pdfStyles.headerLeft}>
          ...
          <View style={pdfStyles.leadDetailsSection}>
            ...
            <View style={{
              ...
              <Icons.User style={{ width: 16, height: 16, color: "#2563EB" }} />
              <Text style={{
                fontSize: 14,
                fontWeight: "bold",
                color: "#1E293B",
            ...
            <View style={pdfStyles.leadInfoBox}>
              <Text style={pdfStyles.leadSectionTitle}>Personal Information</Text>
              <View style={pdfStyles.leadInfoGrid}>
                <View style={pdfStyles.leadInfoItem}>
                  <Text style={pdfStyles.leadInfoLabel}>Name</Text>
                  <Text style={pdfStyles.leadInfoValue}>{selectedLead?.name || "N/A"}</Text>
                </View>
                <View style={pdfStyles.leadInfoItem}>
                  <Text style={pdfStyles.leadInfoLabel}>Email</Text>
                  <Text style={pdfStyles.leadInfoValue}>{selectedLead?.email || "N/A"}</Text>
                </View>
                <View style={pdfStyles.leadInfoItem}>
                  <Text style={pdfStyles.leadInfoLabel}>Mobile</Text>
                  <Text style={pdfStyles.leadInfoValue}>{selectedLead?.mobile || "N/A"}</Text>
                </View>
                <View style={pdfStyles.leadInfoItem}>
                  <Text style={pdfStyles.leadInfoLabel}>Source</Text>
                  <Text style={pdfStyles.leadInfoValue}>{selectedLead?.source || "N/A"}</Text>
                </View>
              </View>
            </View>
            ...
            {/* Travel Information */}
            <View style={pdfStyles.leadInfoBox}>
              <Text style={pdfStyles.leadSectionTitle}>Travel Information</Text>
              <View style={pdfStyles.leadInfoGrid}>
                <View style={pdfStyles.leadInfoItem}>
                  <Text style={pdfStyles.leadInfoLabel}>Destination</Text>
                  <Text style={pdfStyles.leadInfoValue}>{selectedLead?.destination || "N/A"}</Text>
                </View>
                <View style={pdfStyles.leadInfoItem}>
                  <Text style={pdfStyles.leadInfoLabel}>Travel Date</Text>
                  <Text style={pdfStyles.leadInfoValue}>
                    {selectedLead?.travelDate ? new Date(selectedLead.travelDate).toLocaleDateString() : "N/A"}
                  </Text>
                </View>
                <View style={pdfStyles.leadInfoItem}>
                  <Text style={pdfStyles.leadInfoLabel}>Duration</Text>
                  <Text style={pdfStyles.leadInfoValue}>{selectedLead?.nights || "0"} Nights / {selectedLead?.days || "0"} Days</Text>
                </View>
              </View>
            </View>
            ...
            {/* Guest Information */}
            <View style={pdfStyles.leadInfoBox}>
              <Text style={pdfStyles.leadSectionTitle}>Guest Information</Text>
              <View style={pdfStyles.leadInfoGrid}>
                <View style={pdfStyles.leadInfoItem}>
                  <Text style={pdfStyles.leadInfoLabel}>Adults</Text>
                  <Text style={pdfStyles.leadInfoValue}>{selectedLead?.adults || "0"}</Text>
                </View>
                <View style={pdfStyles.leadInfoItem}>
                  <Text style={pdfStyles.leadInfoLabel}>Children</Text>
                  <Text style={pdfStyles.leadInfoValue}>{selectedLead?.kids || "0"}</Text>
                </View>
                <View style={pdfStyles.leadInfoItem}>
                  <Text style={pdfStyles.leadInfoLabel}>Total Persons</Text>
                  <Text style={pdfStyles.leadInfoValue}>{selectedLead?.persons || "0"}</Text>
                </View>
                <View style={pdfStyles.leadInfoItem}>
                  <Text style={pdfStyles.leadInfoLabel}>Rooms</Text>
                  <Text style={pdfStyles.leadInfoValue}>{selectedLead?.noOfRooms || "0"}</Text>
                </View>
                <View style={pdfStyles.leadInfoItem}>
                  <Text style={pdfStyles.leadInfoLabel}>Extra Beds</Text>
                  <Text style={pdfStyles.leadInfoValue}>{selectedLead?.extraBeds || "0"}</Text>
                </View>
              </View>
            </View>
            ...
            {/* Package Information */}
            <View style={pdfStyles.leadInfoBox}>
              <Text style={pdfStyles.leadSectionTitle}>Package Information</Text>
              <View style={pdfStyles.leadInfoGrid}>
                <View style={pdfStyles.leadInfoItem}>
                  <Text style={pdfStyles.leadInfoLabel}>Package Type</Text>
                  <Text style={pdfStyles.leadInfoValue}>{selectedLead?.packageType || "N/A"}</Text>
                </View>
                <View style={pdfStyles.leadInfoItem}>
                  <Text style={pdfStyles.leadInfoLabel}>Category</Text>
                  <Text style={pdfStyles.leadInfoValue}>{selectedLead?.packageCategory || "N/A"}</Text>
                </View>
                <View style={pdfStyles.leadInfoItem}>
                  <Text style={pdfStyles.leadInfoLabel}>Meal Plan</Text>
                  <Text style={pdfStyles.leadInfoValue}>{selectedLead?.mealPlans || "N/A"}</Text>
                </View>
              </View>
            </View>
          </View>
              ...
              <View style={{ flex: 1 }}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      Total: ₹{packageSummary?.totals?.hotelCost || 0}
                    </Text>
                  </View>
              ...
              <View style={{ flex: 1 }}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      Total: ₹{packageSummary?.totals?.transferCost || 0}
                    </Text>
                  </View>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ₹{packageSummary.transfer?.details?.cost || 0}/day
                      </Text>
                    </View>
                    <Text
                      style={{
      ...
      <View style={pdfStyles.mainContent}>
        ...
        {/* Add this section after the Agent Info Box and before the Highlights Section */}
        <View style={pdfStyles.leadDetailsSection}>
          {/* Lead Details Header */}
          <View
            style={{
