            ...
            <View style={{
              ...
              <View style={{
                ...
                <View style={{ flex: 1, minWidth: 200 }}>
                  ...
                  <View style={{ gap: 4 }}>
                    <View style={{ flexDirection: "row", gap: 8 }}>
                      <Text style={{ fontSize: 9, color: "#64748B", width: 60 }}>Name:</Text>
                      <Text style={{ fontSize: 9, color: "#1E293B", flex: 1 }}>{selectedLead?.name || "N/A"}</Text>
                    </View>
                    <View style={{ flexDirection: "row", gap: 8 }}>
                      <Text style={{ fontSize: 9, color: "#64748B", width: 60 }}>Contact:</Text>
                      <Text style={{ fontSize: 9, color: "#1E293B", flex: 1 }}>{selectedLead?.mobile || "N/A"}</Text>
                    </View>
                    <View style={{ flexDirection: "row", gap: 8 }}>
                      <Text style={{ fontSize: 9, color: "#64748B", width: 60 }}>Email:</Text>
                      <Text style={{ fontSize: 9, color: "#1E293B", flex: 1 }}>{selectedLead?.email || "N/A"}</Text>
                    </View>
                  </View>
                </View>
                ...
                <View style={{ flex: 1, minWidth: 200 }}>
                  ...
                  <View style={{ gap: 4 }}>
                    <View style={{ flexDirection: "row", gap: 8 }}>
                      <Text style={{ fontSize: 9, color: "#64748B", width: 60 }}>Date:</Text>
                      <Text style={{ fontSize: 9, color: "#1E293B", flex: 1 }}>
                        {selectedLead?.travelDate ? new Date(selectedLead.travelDate).toLocaleDateString() : "N/A"}
                      </Text>
                    </View>
                    <View style={{ flexDirection: "row", gap: 8 }}>
                      <Text style={{ fontSize: 9, color: "#64748B", width: 60 }}>Duration:</Text>
                      <Text style={{ fontSize: 9, color: "#1E293B", flex: 1 }}>
                        {selectedLead?.nights || "0"} Nights / {selectedLead?.days || "0"} Days
                      </Text>
                    </View>
                    <View style={{ flexDirection: "row", gap: 8 }}>
                      <Text style={{ fontSize: 9, color: "#64748B", width: 60 }}>Package:</Text>
                      <Text style={{ fontSize: 9, color: "#1E293B", flex: 1 }}>{selectedLead?.packageType || "N/A"}</Text>
                    </View>
                  </View>
                </View>
                ...
                <View style={{ flex: 1, minWidth: 200 }}>
                  ...
                  <View style={{ flexDirection: "row", flexWrap: "wrap", gap: 12 }}>
                    <View style={{ flexDirection: "row", gap: 4, minWidth: 80 }}>
                      ...
                      <Text style={{ fontSize: 9, color: "#1E293B" }}>{selectedLead?.adults || "0"}</Text>
                    </View>
                    <View style={{ flexDirection: "row", gap: 4, minWidth: 80 }}>
                      <Text style={{ fontSize: 9, color: "#64748B" }}>Children:</Text>
                      <Text style={{ fontSize: 9, color: "#1E293B" }}>{selectedLead?.kids || "0"}</Text>
                    </View>
                    <View style={{ flexDirection: "row", gap: 4, minWidth: 80 }}>
                      <Text style={{ fontSize: 9, color: "#64748B" }}>Rooms:</Text>
                      <Text style={{ fontSize: 9, color: "#1E293B" }}>{selectedLead?.noOfRooms || "0"}</Text>
                    </View>
                  </View>
                </View>
              </View>
