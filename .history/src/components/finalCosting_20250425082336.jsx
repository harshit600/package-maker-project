...
const PackagePDF = ({
  ...
  <Document>
    <Page size="A4" style={pdfStyles.page}>
      ...
      {/* Header Section with Title and Total */}
      <View style={{ 
        flexDirection: "row", 
        justifyContent: "space-between", 
        alignItems: "flex-start",
        ...
        {/* Left side - Title */}
        <View>
          <Text style={{ fontSize: 24, color: "#1E293B", marginBottom: 8 }}>
            {selectedLead?.name}'s trip to
          </Text>
          <Text style={{ fontSize: 32, color: "#2563EB", fontWeight: "bold" }}>
            {packageSummary.package?.destination || "Sikkim"} Tour
          </Text>
          <View style={{ flexDirection: "row", gap: 10, marginTop: 10, alignItems: "center" }}>
            <Text style={{ fontSize: 14, color: "#64748B" }}>
              {packageSummary.package?.itineraryDays?.length || "5"}D/{(packageSummary.package?.itineraryDays?.length || 5) - 1}N
            </Text>
            <View style={{ 
              backgroundColor: "#000000", 
              paddingVertical: 2, 
            ...
            <Text style={{ fontSize: 14, color: "#64748B" }}>
              {selectedLead?.packageType || "Honeymoon"}
            </Text>
          </View>
        </View>
