      ...
      <View style={pdfStyles.mainContent}>
        ...
        <View style={pdfStyles.costBreakdownSection}>
          ...
          <View style={pdfStyles.sectionTitle}>
            <Icons.Calculator style={{ width: 16, height: 16, color: "#2563EB" }} />
          ...
          {/* Base Costs */}
          <View style={pdfStyles.costComponent}>
            <View style={[pdfStyles.rowBetween, pdfStyles.divider]}>
              <Text style={{ fontSize: 12, color: "#64748B" }}>Cost Component</Text>
            ...
            <View style={pdfStyles.rowBetween}>
              <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
                <Icons.Hotel style={{ width: 14, height: 14, color: "#2563EB" }} />
                <Text style={pdfStyles.costLabel}>Hotels ({packageSummary.hotels?.length || 0} Nights)</Text>
              </View>
              <Text style={pdfStyles.costValue}>₹{packageSummary.totals?.hotelCost || 0}</Text>
            </View>

            {/* Transport Cost */}
            <View style={pdfStyles.rowBetween}>
              <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
                <Icons.Car style={{ width: 14, height: 14, color: "#2563EB" }} />
                <Text style={pdfStyles.costLabel}>Transport</Text>
              </View>
              <Text style={pdfStyles.costValue}>₹{packageSummary.totals?.transferCost || 0}</Text>
            </View>

            {/* Activities Cost */}
            <View style={pdfStyles.rowBetween}>
              <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
                <Icons.Activity style={{ width: 14, height: 14, color: "#2563EB" }} />
                <Text style={pdfStyles.costLabel}>Activities</Text>
              </View>
              <Text style={pdfStyles.costValue}>₹{packageSummary.totals?.activitiesCost || 0}</Text>
            </View>
          </View>

          {/* Taxes Section */}
          <View style={[pdfStyles.costComponent, { marginTop: 12 }]}>
            <Text style={{ fontSize: 11, fontWeight: "500", color: "#4B5563", marginBottom: 8 }}>
            ...
            <View style={pdfStyles.rowBetween}>
              ...
              <Text style={{ fontSize: 11, color: "#111827" }}>
                ₹{((packageSummary.totals?.grandTotal || 0) * 0.05).toFixed(0)}
              </Text>
            </View>
          </View>
          ...
          <View style={pdfStyles.grandTotalSection}>
            <View style={pdfStyles.rowBetween}>
              <View>
                <Text style={{ fontSize: 14, fontWeight: "bold", color: "#1E293B" }}>Grand Total</Text>
          ...
          {/* Payment Note */}
          <View style={pdfStyles.paymentTerms}>
            <Text style={{ fontSize: 10, color: "#92400E", lineHeight: 1.4 }}>
              Note: Package price, payment schedule and cancellation policy are tentative and subject to change. 
              Package price, payment schedule and cancellation policy as shown on the Package Review Page prior 
              to the payment will be final.
            </Text>
          </View>
        </View>
        ...
        <View style={pdfStyles.costBreakdownSection}>
          ...
          {/* Base Costs */}
          <View style={pdfStyles.costComponent}>
            {/* ... rest of the cost breakdown content ... */}
          </View>
        </View>
      </View>
    </Page>
