        ...
        <View style={pdfStyles.costBreakdownSection}>
            ...
            <View style={pdfStyles.rowBetween}>
              ...
              >
                <Icons.Hotel
                  style={{ width: 14, height: 14, color: "#2563EB" }}
                />
                <Text style={pdfStyles.costLabel}>
                  Hotels ({packageSummary.hotels?.length || 0} Nights)
                </Text>
              </View>
              <Text style={pdfStyles.costValue}>
          ...
          <View style={pdfStyles.paymentTerms}>
            <Text style={{ fontSize: 10, color: "#92400E", lineHeight: 1.4 }}>
              ...
              tentative and subject to change. Package price, payment schedule
              and cancellation policy as shown on the Package Review Page prior
