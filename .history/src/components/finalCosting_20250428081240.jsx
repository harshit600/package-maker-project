  ...
  <Document>
    <Page size="A4" style={pdfStyles.page}>
      ...
      <View style={pdfStyles.mainContent}>
        ...
        <View style={[pdfStyles.costBreakdownSection, {
          backgroundColor: "#FFFFFF",
          padding: 24,
          borderRadius: 12,
          marginBottom: 30,
          ...
          <View style={{
            ...
            <Icons.Calculator style={{ width: 24, height: 24, color: "#4F46E5" }} />
            <View>
              <Text style={{ fontSize: 18, fontWeight: "bold", color: "#312E81" }}>
                Cost Breakdown
              </Text>
          ...
          <View style={{
            ...
            <View style={[pdfStyles.rowBetween, {
              ...
              <Text style={{ fontSize: 13, fontWeight: "500", color: "#475569" }}>Included Services</Text>
              <Text style={{ fontSize: 13, fontWeight: "500", color: "#475569" }}>Details</Text>
            </View>
            ...
            <View style={pdfStyles.rowBetween}>
              <View style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
                <View style={{
                  ...
                  <Icons.Hotel style={{ width: 16, height: 16, color: "#2563EB" }} />
                </View>
                <View>
                  <Text style={{ fontSize: 12, color: "#1E293B", fontWeight: "500" }}>Hotel Stays</Text>
                  <Text style={{ fontSize: 10, color: "#64748B" }}>
                    {packageSummary.hotels?.length || 0} Nights
                  </Text>
                </View>
              </View>
              <Text style={{ fontSize: 11, color: "#64748B" }}>As per itinerary</Text>
            </View>
            ...
            <View style={pdfStyles.rowBetween}>
              <View style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
                ...
                <View>
                  <Text style={{ fontSize: 12, color: "#1E293B", fontWeight: "500" }}>Transport</Text>
                  <Text style={{ fontSize: 10, color: "#64748B" }}>All transfers included</Text>
                </View>
              </View>
              <Text style={{ fontSize: 11, color: "#64748B" }}>Private vehicle</Text>
            </View>
            ...
            <View style={pdfStyles.rowBetween}>
              <View style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
                <View style={{
                  ...
                  <Icons.Activity style={{ width: 16, height: 16, color: "#DB2777" }} />
                </View>
                <View>
                  <Text style={{ fontSize: 12, color: "#1E293B", fontWeight: "500" }}>Activities</Text>
                  <Text style={{ fontSize: 10, color: "#64748B" }}>Sightseeing & Experiences</Text>
                </View>
              </View>
            ...
            <View style={{ gap: 10 }}>
              <View style={pdfStyles.rowBetween}>
                ...
                <Text style={{ fontSize: 12, color: "#1E293B" }}>
                  ₹{((packageSummary.totals?.activitiesCost || 0) * 0.05).toLocaleString()}
                </Text>
              </View>
            </View>
          </View>
          ...
          <View style={{
            ...
            <View style={pdfStyles.rowBetween}>
              ...
              <Text style={{ 
                ...
                ₹{((packageSummary.totals?.activitiesCost || 0) * 1.05).toLocaleString()}
              </Text>
            </View>
          </View>
          ...
          <View style={{
            ...
            <Text style={{ fontSize: 10, color: "#92400E", lineHeight: 1.5, marginTop: 8 }}>
              • 50% advance payment required to confirm booking{"\n"}
              • Balance payment due 15 days before travel date{"\n"}
              • Hotel and transport costs will be quoted separately{"\n"}
