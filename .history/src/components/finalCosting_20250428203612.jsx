  ...
  <Document>
    <Page size="A4" style={pdfStyles.page}>
            ...
            <View style={{ flex: 1, minWidth: 200 }}>
              ...
              <View style={{ flexDirection: "row", flexWrap: "wrap", gap: 12 }}>
                <View style={{ flexDirection: "row", gap: 4, minWidth: 80 }}>
                  <Text style={{ fontSize: 9, color: "#64748B" }}>Adults:</Text>
                ...
                <View style={{ flexDirection: "row", gap: 4, minWidth: 80 }}>
                  <Text style={{ fontSize: 9, color: "#64748B" }}>Rooms:</Text>
                  <Text style={{ fontSize: 9, color: "#1E293B" }}>
                ...
                >
                  ...
                  >
                    ...
                    {hotel.extraAdultRate && (
                      ...
                      >
                        • Extra Adult: ₹{hotel.extraAdultRate}
                      </Text>
                    )}
                  </View>
                </View>
              ...
              >
                ...
                <View style={{ flexDirection: "row", gap: 5, marginTop: 2 }}>
                  ...
                  >
                    ...
                    >
                      {packageSummary.transfer?.details?.seatingCapacity || "4"}{" "}
                      Seater
                    </Text>
                  </View>
                </View>
      ...
      <View style={pdfStyles.mainContent}>
        ...
        {/* Enhanced Itinerary Section - Remove break */}
        <View
          style={{
            marginTop: 20,
            marginBottom: 30,
        ...
        >
          ...
          >
            <Icons.Map style={{ width: 16, height: 16, color: "#2563EB" }} />
            <Text
              style={{
                fontSize: 14,
                fontWeight: "bold",
        ...
        {/* Replace the existing Total Cost Section with this */}
        <View
          style={[
            pdfStyles.costBreakdownSection,
            {
              backgroundColor: "#FFFFFF",
              padding: 24,
              borderRadius: 12,
        ...
        >
          ...
          >
            ...
            <View>
              <Text
                style={{ fontSize: 18, fontWeight: "bold", color: "#312E81" }}
              >
                Cost Breakdown
              </Text>
          ...
          >
              ...
              >
                ...
                <View>
                  ...
                  <Text style={{ fontSize: 10, color: "#64748B" }}>
                    {packageSummary.hotels?.length || 0} Nights
                  </Text>
                </View>
              </View>
            ...
            <View style={pdfStyles.rowBetween}>
              ...
              >
                ...
                >
                  <Icons.Activity
                    style={{ width: 16, height: 16, color: "#DB2777" }}
                  />
                </View>
                <View>
                  <Text
            ...
            <View style={{ gap: 10 }}>
              <View style={pdfStyles.rowBetween}>
                ...
                <Text style={{ fontSize: 12, color: "#1E293B" }}>
                  ₹
                  {(
                    (packageSummary.totals?.activitiesCost || 0) * 0.05
                  ).toLocaleString()}
                </Text>
              </View>
            </View>
          ...
          >
            <View style={pdfStyles.rowBetween}>
              <View>
                ...
                <Text style={{ fontSize: 10, color: "#C7D2FE", marginTop: 4 }}>
                  Including activities and taxes
                </Text>
              </View>
              <Text
                style={{
              ...
              >
                ₹
                {(
                  (packageSummary.totals?.activitiesCost || 0) * 1.05
                ).toLocaleString()}
              </Text>
            </View>
          </View>
          ...
          >
            ...
            >
              <Icons.Info style={{ width: 14, height: 14, color: "#92400E" }} />
              <Text
            ...
            >
              ...
              costs will be quoted separately{"\n"}• Prices are subject to
          ...
          <View style={pdfStyles.termsList}>
            ...
            <View style={pdfStyles.termsItem}>
              <Text style={pdfStyles.termsText}>
                ...
                for all travellers to carry a negative RT-PCR Test report while
                entering some states/UTs. Please keep in mind that COVID
                guidelines of the state may require to and the approximate time
                required to get the report while booking the package. The
            ...
            <View style={pdfStyles.termsItem}>
              <Text style={pdfStyles.termsText}>
                ...
                check-out is 11:00 am. An early check-in or a late check-out is
            ...
            <View style={pdfStyles.termsItem}>
              <Text style={pdfStyles.termsText}>
                ...
                disposal. For any paid activity which is non-operational due to
                any unforeseen reason, we will process refund & same should
            ...
            <View style={pdfStyles.termsItem}>
              ...
              <Text style={pdfStyles.termsText}>
                • All other terms & conditions as mentioned on our website will
            ...
            <View style={pdfStyles.termsItem}>
              <Text style={pdfStyles.termsText}>
                If your flight involves a combination of different airlines, you
                may have to collect your luggage on arrival at the connecting
                hub and register it again while checking in for the onward
            ...
            <View style={pdfStyles.termsItem}>
              ...
              <Text style={pdfStyles.termsText}>
                ...
                Please make sure you enter the correct age of passengers at the
                time of booking. Passengers furnishing incorrect age details may
                incur penalty at the time of travelling.
              </Text>
            </View>
            ...
            <View style={pdfStyles.termsItem}>
              ...
              <Text style={pdfStyles.termsText}>
                ...
                the package due to unforeseen circumstances like strikes, riots,
                political unrest, bandhs, or any other disturbance.
              </Text>
            </View>
            ...
            <View style={pdfStyles.termsItem}>
              ...
              <Text style={pdfStyles.termsText}>
                • Most of the hotels in Leh do not have escalators installed at
                the premises.
              </Text>
            </View>
          </View>
        ...
        <View style={{
          ...
          <View style={[pdfStyles.rowBetween, {
            ...
            <Text style={{ fontSize: 13, fontWeight: "500", color: "#475569" }}>Transport Details</Text>
          </View>
          ...
          <View style={{ gap: 12 }}>
            ...
            <View style={pdfStyles.rowBetween}>
              <View style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
                <View style={{
                  ...
                  <Icons.Car style={{ width: 16, height: 16, color: "#059669" }} />
                </View>
                <View>
                  <Text style={{ fontSize: 12, color: "#1E293B", fontWeight: "500" }}>Vehicle Type</Text>
                  <Text style={{ fontSize: 10, color: "#64748B" }}>
                    {packageSummary.transfer?.vehicleType || "SUV"} ({packageSummary.transfer?.seatingCapacity || "4+1"} Seater)
                  </Text>
                </View>
              </View>
            </View>
            ...
            {/* Vehicle Features */}
            <View style={{ gap: 8 }}>
              <Text style={{ fontSize: 11, color: "#475569", fontWeight: "500" }}>Vehicle Features:</Text>
              <View style={{ flexDirection: "row", flexWrap: "wrap", gap: 8 }}>
                {[
                  ...
                  <View key={index} style={{
                    ...
                    <Text style={{ fontSize: 9, color: "#475569" }}>{feature}</Text>
                  </View>
                ))}
              </View>
            </View>
            ...
            {/* Service Details */}
            <View style={{ gap: 8 }}>
              <Text style={{ fontSize: 11, color: "#475569", fontWeight: "500" }}>Service Includes:</Text>
              <View style={{ gap: 4 }}>
                <Text style={{ fontSize: 10, color: "#64748B" }}>• All transfers as per itinerary</Text>
                <Text style={{ fontSize: 10, color: "#64748B" }}>• Airport/Railway Station pickup and drop</Text>
                <Text style={{ fontSize: 10, color: "#64748B" }}>• Local sightseeing as mentioned in itinerary</Text>
                <Text style={{ fontSize: 10, color: "#64748B" }}>• Dedicated vehicle throughout the journey</Text>
                <Text style={{ fontSize: 10, color: "#64748B" }}>• Experienced driver with local knowledge</Text>
              </View>
            </View>

            {/* Important Notes */}
            <View style={{ gap: 8 }}>
              <Text style={{ fontSize: 11, color: "#475569", fontWeight: "500" }}>Important Notes:</Text>
              <View style={{ gap: 4 }}>
                <Text style={{ fontSize: 10, color: "#64748B" }}>• Toll taxes and parking charges included</Text>
                <Text style={{ fontSize: 10, color: "#64748B" }}>• Driver's accommodation and meals included</Text>
                <Text style={{ fontSize: 10, color: "#64748B" }}>• Fuel charges included for mentioned itinerary</Text>
                <Text style={{ fontSize: 10, color: "#64748B" }}>• Additional kilometers beyond itinerary will be charged extra</Text>
              </View>
            </View>
          </View>
        </View>
