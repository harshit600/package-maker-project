        ...
        >
          ...
          <View style={{ gap: 8 }}>
            {[
              ...
              "Any guide charges",
              "Any air / train fare",
              "Personal expenses such as drinks, laundry, phone calls, camera fees",
                        ...
                        <div className="flex flex-col gap-2 flex-grow">
                          ...
                          >
                            {({ blob, url, loading, error }) => (
                              <button 
                                disabled={loading}
                                className="flex items-center justify-center gap-1 px-3 py-1.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm w-full"
                              >
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  className="h-4 w-4"
                                ...
                                {loading ? "Loading..." : error ? "Error" : "Download as Pluto"}
                              </button>
                            )}
                          </PDFDownloadLink>
                          ...
                          >
                            {({ blob, url, loading, error }) => (
                              <button 
                                disabled={loading}
                                className="flex items-center justify-center gap-1 px-3 py-1.5 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors text-sm w-full"
                              >
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  className="h-4 w-4"
                                ...
                                {loading ? "Loading..." : error ? "Error" : "Download as Demand Setu"}
                              </button>
                            )}
                          </PDFDownloadLink>
