    ...
    <Page size="A4" style={pdfStyles.page}>
      ...
      <View style={pdfStyles.mainContent}>
        ...
        >
          ...
          >
            <Icons.Close style={{ width: 16, height: 16, color: "#EF4444" }} />
            <Text
              style={{
                fontSize: 14,
                fontWeight: "bold",
          ...
          <View style={{ padding: 16, gap: 12 }}>
            ...
            >
              ...
              />
              <Text style={{ flex: 1, fontSize: 11, color: "#1E293B" }}>
                Personal expenses such as drinks, laundry, phone call, camera
              </Text>
            </View>
          </View>
        </View>
...
export default FinalCosting;
        >
          ...
          >
            <Icons.Close style={{ width: 16, height: 16, color: "#DC2626" }} />
            <Text
              style={{
                fontSize: 14,
                fontWeight: "bold",
