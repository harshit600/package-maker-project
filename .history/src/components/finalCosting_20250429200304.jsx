...
const PackagePDF = ({
  ...
  <Document>
    <Page size="A4" style={{
      ...
      <Image
        src="https://www.himachal.exploreindia.in/wordpress/wp-content/uploads/2013/05/hp1.jpg"
        style={{
          position: 'absolute',
          top: 0,
          left: 0,
          ...
          width: '100%',
          height: '100%',
          opacity: 0.5,  // This creates a faded effect
          filter: 'blur(5px)',  // Note: blur might not work in react-pdf
        }}
      />
