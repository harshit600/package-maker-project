          ...
          >
            ...
            >
              ...
              <View style={pdfStyles.detailsSection}>
                <View style={pdfStyles.sectionSubHeader}>
                  <Text style={pdfStyles.subHeaderText}>Guest Information</Text>
                </View>
                <View style={pdfStyles.infoRow}>
                  <View style={pdfStyles.infoItem}>
                    <Text style={pdfStyles.infoLabel}>Adults</Text>
                    <Text style={pdfStyles.infoValue}>{selectedLead?.adults || "0"}</Text>
                  </View>
                  <View style={pdfStyles.infoItem}>
                    <Text style={pdfStyles.infoLabel}>Children</Text>
                    <Text style={pdfStyles.infoValue}>{selectedLead?.kids || "0"}</Text>
                  </View>
                  <View style={pdfStyles.infoItem}>
                    <Text style={pdfStyles.infoLabel}>Rooms</Text>
                    <Text style={pdfStyles.infoValue}>{selectedLead?.noOfRooms || "0"}</Text>
                  </View>
                </View>
              </View>
            </View>
