      ...
      >
        ...
        <View style={pdfStyles.mainContent}>
          ...
          >
            ...
            {/* Itinerary Days */}
            {packageSummary.package?.itineraryDays?.map((day, index) => {
              // Calculate the date for each day based on travel start date
              const startDate = new Date(selectedLead?.travelDate);
              ...
              return (
                <View key={index} style={{
                  borderBottomWidth: index !== packageSummary.package.itineraryDays.length - 1 ? 1 : 0,
                  borderBottomColor: "#E2E8F0",
                  padding: 16,
                }}>
