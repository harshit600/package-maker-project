...
const FinalCosting = ({ selectedLead }) => {
  ...
  const marginAmount = calculateMargin(
    packageData?.totals?.grandTotal || 0,
    activeMarginPercentage
  );
  const finalTotal = (packageData?.totals?.grandTotal || 0) + marginAmount;
  ...
  const getCurrentMarginPercentage = () => {
    ...
    const total = packageData?.totals?.grandTotal || 0;
    const firstQuoteMargin = margins.firstQuoteMargins;
  ...
  const handleSendLink = async () => {
    ...
    const historyItem = {
      timestamp,
      total: packageData?.totals?.grandTotal || 0,
      ...
      hotels: packageData.hotels,
      transfer: {
        details: packageData.transfer.details,
        totalCost: packageData.transfer.totalCost,
      },
      totals: {
        transferCost: packageData.totals.transferCost,
        hotelCost: packageData.totals.hotelCost,
        activitiesCost: packageData.totals.activitiesCost,
        grandTotal: packageData.totals.grandTotal,
      },
    };
  ...
  // Add this function to get dates for each day
            ...
            <div className="space-y-5">
                ...
                <div className="bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-200 p-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-lg font-semibold text-blue-600">
                      ₹{packageData?.totals?.hotelCost || 0}
                    </span>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-200 p-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-lg font-semibold text-green-600">
                      ₹{packageData?.totals?.transferCost || 0}
                    </span>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-200 p-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-lg font-semibold text-purple-600">
                      ₹{packageData?.totals?.activitiesCost || 0}
                    </span>
                  </div>
                </div>
              ...
              {showMargin && !hasConvertedHistory && (
                <div className="mt-6 space-y-4">
                  ...
                  {/* Send Link Button */}
                  {getCurrentMarginPercentage() >=
                    getMinimumMargin(packageData?.totals?.grandTotal || 0) &&
                    !showWarning && (
                      <button
          ...
          <div className="p-6">
            <div className="space-y-4">
              {history.length === 0 ? (
                ...
                history
                  .filter((item) => item.id === packageData.id)
                  .map((item, index) => (
                    <div
                      key={index}
