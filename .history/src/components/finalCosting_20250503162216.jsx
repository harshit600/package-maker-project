        ...
        <View style={pdfStyles.mainContent}>
          ...
          >
            <View style={pdfStyles.exclusionsHeader}>
              <Icons.Close />
              <Text style={pdfStyles.exclusionsTitle}>Package Inclusions</Text>
            </View>
            {/* Header */}
            <View
              style={{
...
const AccountDetails = () => (
  <View style={pdfStyles.accountDetailsSection}>
    <Text style={pdfStyles.accountDetailsHeader}>ACCOUNT DETAILS AND UP ID</Text>
    
    {/* SBI and HDFC Row */}
    <View style={pdfStyles.bankRow}>
      <View style={pdfStyles.bankColumn}>
        <Text style={pdfStyles.bankHeader}>STATE BANK OF INDIA A/C</Text>
        <Text style={pdfStyles.bankDetail}>NO.38207849663A/CNAME:-</Text>
        <Text style={pdfStyles.bankDetail}>PTWHOLIDAYSPVT.LTD.</Text>
        <Text style={pdfStyles.bankDetail}>BRANCH:-PANTHAGHATI-</Text>
        <Text style={pdfStyles.bankDetail}>SHIMLAIFSCCODE:-</Text>
        <Text style={pdfStyles.bankDetail}>SBIN0021763</Text>
      </View>
      <View style={pdfStyles.bankColumn}>
        <Text style={pdfStyles.bankHeader}>HDFCBANK</Text>
        <Text style={pdfStyles.bankDetail}>A/CNO.:-50200044011800</Text>
        <Text style={pdfStyles.bankDetail}>A/CNAME:-PTWHOLIDAYSPVTLTD</Text>
        <Text style={pdfStyles.bankDetail}>BRANCH:- MAHELI-SHIMLA</Text>
        <Text style={pdfStyles.bankDetail}>IFSCCODE:- HDFC0003612</Text>
        <Text style={pdfStyles.bankDetail}></Text>
      </View>
    </View>

    {/* ICICI and Bank of Baroda Row */}
    <View style={pdfStyles.bankRow}>
      <View style={pdfStyles.bankColumn}>
        <Text style={pdfStyles.bankHeader}>ICICIBANK</Text>
        <Text style={pdfStyles.bankDetail}>A/CNO 366805500120</Text>
        <Text style={pdfStyles.bankDetail}>A/CNAME:-PTWHOLIDAYSPVTLTD</Text>
        <Text style={pdfStyles.bankDetail}>BRANCH:-KASUMPATI-SHIMLA</Text>
        <Text style={pdfStyles.bankDetail}>IFSCCODE:-ICIC0003368</Text>
      </View>
      <View style={pdfStyles.bankColumn}>
        <Text style={pdfStyles.bankHeader}>BANKOFBARODA</Text>
        <Text style={pdfStyles.bankDetail}>A/CNO :-54140200000060</Text>
        <Text style={pdfStyles.bankDetail}>A/CNAME:-PTWHOLIDAYSPVTLTD</Text>
        <Text style={pdfStyles.bankDetail}>BRANCH:-BCS-SHIMLA</Text>
        <Text style={pdfStyles.bankDetail}>IFSCCODE:-BARB0NEWSIM</Text>
      </View>
    </View>
    ...
    <View style={pdfStyles.bankRow}>
      <View style={pdfStyles.bankColumn}>
        <Text style={pdfStyles.bankHeader}>GOOGLEPAY@PHONEPAY</Text>
        <Text style={pdfStyles.bankDetail}>80917-53823</Text>
      </View>
      <View style={pdfStyles.bankColumn}>
        <Text style={pdfStyles.bankHeader}>UPI ID</Text>
        <Text style={pdfStyles.bankDetail}>UpId:mdplutotours-2@okhdfcbank</Text>
        <Text style={pdfStyles.bankDetail}>UpId:981666196@sbi</Text>
      </View>
    </View>
    ...
    <View style={pdfStyles.contactSection}>
      <Text style={pdfStyles.contactText}>
        Thank you for considering Pluto tours World Holiday Pvt LtD. Tours for your upcoming Tour. If you want to change in your package please let us know.
      </Text>
      <Text style={pdfStyles.contactText}>Best regards,</Text>
      <Text style={pdfStyles.contactText}>Sunita</Text>
      <Text style={pdfStyles.contactText}>Contact: +91 7876504729</Text>
      <Text style={pdfStyles.contactText}>Email: sunitaplutotours02@gmail.com</Text>
      <Text style={pdfStyles.contactText}>Website: www.plutotours.in</Text>
    </View>
  </View>
);
