...
const AccountDetailsSection = () => (
  <View style={pdfStyles.accountDetailsSection}>
    <Text style={pdfStyles.accountDetailsHeader}>ACCOUNT DETAILS AND UPI ID</Text>
    
    {/* Bank Details Grid */}
    <View style={pdfStyles.bankDetailsContainer}>
      {/* First Row - SBI and HDFC */}
      ...
      <View style={pdfStyles.bankRow}>
        <Text style={pdfStyles.bankText}>NO.38207849663A/CNAME:-</Text>
        <Text style={pdfStyles.bankText}>A/CNO.:-50200044011800</Text>
      </View>

      <View style={pdfStyles.bankRow}>
        <Text style={pdfStyles.bankText}>PTWHOLIDAYSPVT.LTD.</Text>
        <Text style={pdfStyles.bankText}>A/CNAME:-PTWHOLIDAYSPVTLTD</Text>
      </View>

      <View style={pdfStyles.bankRow}>
        <Text style={pdfStyles.bankText}>BRANCH:-PANTHAGHATI-</Text>
        <Text style={pdfStyles.bankText}>BRANCH:- MAHELI–SHIMLA</Text>
      </View>

      <View style={pdfStyles.bankRow}>
        <Text style={pdfStyles.bankText}>SHIMLAIFSCCODE:-</Text>
        <Text style={pdfStyles.bankText}>IFSCCODE:- HDFC0003612</Text>
      </View>

      <View style={pdfStyles.bankRow}>
        <Text style={pdfStyles.bankText}>SBIN0021763</Text>
        <Text style={pdfStyles.bankText}></Text>
      </View>

      {/* Second Row - ICICI and Bank of Baroda */}
      <View style={pdfStyles.bankRow}>
      ...
      <View style={pdfStyles.bankRow}>
        <Text style={pdfStyles.bankText}>A/CNO.366805500120</Text>
        <Text style={pdfStyles.bankText}>A/CNO.:-54140200000060</Text>
      </View>
      ...
      <View style={pdfStyles.bankRow}>
        <Text style={pdfStyles.bankText}>BRANCH:-KASUMPATI-SHIMLA</Text>
        <Text style={pdfStyles.bankText}>BRANCH:-BCS–SHIMLA</Text>
      </View>

      <View style={pdfStyles.bankRow}>
        <Text style={pdfStyles.bankText}>IFSCCODE:-ICIC000368</Text>
        <Text style={pdfStyles.bankText}>IFSCCODE:-BARB0NEWSIM</Text>
      </View>

      {/* UPI Details */}
      <View style={pdfStyles.upiRow}>
        <Text style={pdfStyles.bankText}>GOOGLEPAY@PHONEPAY</Text>
        <Text style={pdfStyles.bankText}>UpiId:mdplutotours-2@okhdfcbank</Text>
      </View>

      <View style={pdfStyles.upiRow}>
        <Text style={pdfStyles.bankText}>80917-53823</Text>
        <Text style={pdfStyles.bankText}>UpiId:9816661968@sbi</Text>
      </View>
    </View>
  </View>
);
