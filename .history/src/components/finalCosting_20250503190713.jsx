                        ...
                        {dayHotel && (
                          <View style={pdfStyles.hotelCard}>
                            ...
                            <View style={pdfStyles.hotelHeader}>
                              <View style={pdfStyles.hotelHeaderLeft}>
                                <Icons.Hotel style={pdfStyles.hotelIcon} />
                                <Text style={pdfStyles.hotelHeaderTitle}>
                                  Night's Accommodation
                                </Text>
                              </View>
                              <View style={pdfStyles.hotelRatingBadge}>
                                <Icons.Star style={pdfStyles.starIcon} />
                                <Text style={pdfStyles.ratingText}>
                                  {dayHotel?.basicInfo?.hotelStarRating}★ Rated Property
                                </Text>
                              </View>
                            </View>

                            {/* Hotel Content */}
                            <View style={pdfStyles.hotelContent}>
                              {/* Hotel Name and Image Section */}
                              <View style={pdfStyles.hotelMainInfo}>
                                <Text style={pdfStyles.hotelName}>
                                  {dayHotel?.propertyName}
                                </Text>
                                <View style={pdfStyles.hotelAmenities}>
                                  {/* Room Type */}
                                  <View style={pdfStyles.amenityItem}>
                                    <Icons.Room style={pdfStyles.amenityIcon} />
                                    <Text style={pdfStyles.amenityText}>
                                      {dayHotel?.roomType || "Standard Room"}
                                    </Text>
                                  </View>

                                  {/* Meal Plan */}
                                  <View style={pdfStyles.amenityItem}>
                                    <Icons.Meals style={pdfStyles.amenityIcon} />
                                    <Text style={pdfStyles.amenityText}>
                                  ...
                                  {/* Check-in/Check-out */}
                                  <View style={pdfStyles.checkTimes}>
                                    <View style={pdfStyles.checkItem}>
                                      <Icons.CheckIn style={pdfStyles.timeIcon} />
                                      <View>
                                        <Text style={pdfStyles.checkLabel}>Check-in</Text>
                                        <Text style={pdfStyles.checkTime}>2:00 PM</Text>
                                      </View>
                                    </View>
                                    <View style={pdfStyles.checkItem}>
                                      <Icons.CheckOut style={pdfStyles.timeIcon} />
                                      <View>
                                        <Text style={pdfStyles.checkLabel}>Check-out</Text>
                                        <Text style={pdfStyles.checkTime}>11:00 AM</Text>
                                      </View>
                                    </View>
                                  </View>
                                </View>
                              ...
                              {/* Hotel Highlights */}
                              <View style={pdfStyles.hotelHighlights}>
                                <Text style={pdfStyles.highlightsTitle}>Hotel Highlights</Text>
                                <View style={pdfStyles.highlightsList}>
                                  {[
                                    "Free Wi-Fi",
                                    "Room Service",
                                    "Restaurant",
                              ...
                              {/* Hotel Policies */}
                              <View style={pdfStyles.hotelPolicies}>
                                <Text style={pdfStyles.policiesTitle}>Important Information</Text>
                                <View style={pdfStyles.policiesList}>
