    ...
    >
      ...
      >
        ...
        <View style={pdfStyles.mainContent}>
          ...
          {/* Day-wise Itinerary with Hotel Details */}
          <View style={pdfStyles.dayWiseSection}>
            {packageSummary.itinerary?.map((day, index) => (
              <View key={index} style={pdfStyles.dayCard}>
                {/* Day Header */}
                <View style={pdfStyles.dayHeader}>
                  <View style={pdfStyles.dayTitleContainer}>
                    <Icons.Calendar style={pdfStyles.dayIcon} />
                    <Text style={pdfStyles.dayTitle}>Day {index + 1}</Text>
                  </View>
                  <Text style={pdfStyles.dayDate}>
                ...
                <View style={pdfStyles.activitiesContainer}>
                  {day.activities?.map((activity, actIndex) => (
                    <View key={actIndex} style={pdfStyles.activityItem}>
                      ...
                      <Text style={pdfStyles.activityText}>{activity.name}</Text>
                    </View>
                  ))}
                </View>
                ...
                {packageSummary.hotels[index] && (
                  <View style={pdfStyles.hotelCard}>
                    <View style={pdfStyles.hotelHeader}>
                      <Text style={pdfStyles.hotelName}>
                        {packageSummary.hotels[index].propertyName || "Hotel Name"}
                      </Text>
                      <View style={pdfStyles.ratingContainer}>
                        <Icons.Star style={pdfStyles.starIcon} />
                        <Text style={pdfStyles.ratingText}>
                          {packageSummary.hotels[index].basicInfo?.hotelStarRating || "3"}★
                        </Text>
                      </View>
                    </View>
                    ...
                    <View style={pdfStyles.hotelDetails}>
                      <View style={pdfStyles.detailRow}>
                        <Icons.Room style={pdfStyles.detailIcon} />
                        <Text style={pdfStyles.detailText}>
                          Room Type: {packageSummary.hotels[index].roomType || "Standard Room"}
                        </Text>
                      </View>
                      ...
                      <View style={pdfStyles.detailRow}>
                        <Icons.Food style={pdfStyles.detailIcon} />
                        <Text style={pdfStyles.detailText}>
                          Meal Plan: {packageSummary.hotels[index].mealPlan || "CP (Breakfast)"}
                        </Text>
                      </View>
