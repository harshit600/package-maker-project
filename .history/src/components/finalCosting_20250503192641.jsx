  ...
  <Document>
    ...
    >
      ...
      >
        ...
        {/* Day-wise Itinerary with Hotels */}
        {packageSummary.itinerary?.map((day, index) => (
          <View key={index} style={pdfStyles.dayCard}>
            {/* Day Header */}
            ...
            <View style={pdfStyles.activitiesContainer}>
              {day.activities?.map((activity, actIndex) => (
                <View key={actIndex} style={pdfStyles.activityItem}>
                  <Icons.Activity style={pdfStyles.activityIcon} />
                  <Text style={pdfStyles.activityText}>{activity.description}</Text>
                </View>
              ))}
            </View>

            {/* Hotel Details for the day */}
            {day.hotel && (
              <View style={pdfStyles.hotelContainer}>
                <View style={pdfStyles.hotelHeader}>
                  <Icons.Hotel style={pdfStyles.hotelIcon} />
                  <Text style={pdfStyles.hotelHeaderText}>Night Stay</Text>
                  <View style={pdfStyles.hotelRating}>
                    <Icons.Star style={pdfStyles.starIcon} />
                    <Text style={pdfStyles.ratingText}>
                      {day.hotel.basicInfo?.hotelStarRating || "3"}★
                    </Text>
                  </View>
                </View>
                ...
                <View style={pdfStyles.hotelDetails}>
                  <Text style={pdfStyles.hotelName}>
                    {day.hotel.propertyName || "Hotel Name"}
                  </Text>
                  
                  <View style={pdfStyles.hotelInfoGrid}>
                    <View style={pdfStyles.infoItem}>
                      <Icons.Room style={pdfStyles.infoIcon} />
                      <Text style={pdfStyles.infoText}>
                        {day.hotel.roomType || "Standard Room"}
                      </Text>
                    </View>

                    <View style={pdfStyles.infoItem}>
                      <Icons.Food style={pdfStyles.infoIcon} />
                      <Text style={pdfStyles.infoText}>
                        {day.hotel.mealPlan || "CP (Breakfast)"}
                      </Text>
                    </View>

                    <View style={pdfStyles.infoItem}>
                      <Icons.Clock style={pdfStyles.infoIcon} />
                      <Text style={pdfStyles.infoText}>
                  ...
                  <View style={pdfStyles.amenitiesRow}>
                    {["Wi-Fi", "Restaurant", "Parking", "Room Service"].map((amenity, i) => (
                      <View key={i} style={pdfStyles.amenityTag}>
                        <Icons.Check style={pdfStyles.amenityIcon} />
        ...
        {/* Add these styles to your pdfStyles */}
        const pdfStyles = StyleSheet.create({
          // ... existing styles ...
