...
const PackagePDF = ({ packageSummary, showMargin, marginAmount, finalTotal, getCurrentMarginPercentage, companyName = "Pluto Tours and Travel", selectedLead }) => (
  <Document>
    <Page
      size="A4"
      style={{
        ...
        <View style={pdfStyles.mainContent}>
          ...
          >
            ...
            <View style={{ padding: 16, gap: 24 }}>
              {packageSummary?.package?.itineraryDays?.map((day, index) => {
                // Get the hotel for this day from packageSummary.hotels
                const dayHotel = packageSummary.hotels[index + 1];
                    ...
                    >
                      ...
                      <View style={{ padding: 16 }}>
                        ...
                        {dayHotel && (
                          ...
                          >
                            {/* Hotel Image - Try with different approaches */}
                            {dayHotel?.hotelInfo?.photosAndVideos
                              ?.images?.[0] && (
                              <Image
                                src={{
                                  uri: dayHotel.hotelInfo.photosAndVideos
                                    .images[0],
                                  method: "GET",
                                }}
                                style={{
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  {dayHotel?.basicInfo?.hotelStarRating || "3★"}{" "}
                                  Rated
                                </Text>
                              </View>
                            </View>
                            ...
                            <View style={{ padding: 12 }}>
                              ...
                              >
                                {dayHotel?.basicInfo?.propertyName}
                              </Text>
                              ...
                              >
                                {dayHotel?.basicInfo?.propertyDescription}
                              </Text>
...
const FinalCosting = ({ selectedLead }) => {
  ...
  console.log(
    "Hotel Image URL:",
    dayHotel?.hotelInfo?.photosAndVideos?.images?.[0]
  );
  useEffect(() => {
