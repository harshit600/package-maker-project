                    ...
                    >
                      ...
                      <View style={{ padding: 16 }}>
                        ...
                        {dayHotel && (
                          ...
                          >
                            {console.log("Hotel Image URL:", dayHotel.propertyphoto[0])}
                            
                            {/* Hotel Image - trying both property and room images */}
                            <View style={{ flexDirection: 'row', gap: 10 }}>
                              <Image
                                source={dayHotel.propertyphoto[0]}
                                style={{
                                  width: 200,
                                  height: 150,
                                }}
