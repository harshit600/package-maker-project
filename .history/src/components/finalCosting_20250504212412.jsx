                    ...
                    >
                      ...
                      <View style={{ padding: 16 }}>
                        ...
                        {dayHotel && (
                          ...
                          >
                            {/* Debug logs */}
                            {console.log("Full dayHotel object:", dayHotel)}
                            {console.log("propertyphoto array:", dayHotel?.propertyphoto)}
                            {console.log("First image URL:", dayHotel?.propertyphoto?.[0])}
