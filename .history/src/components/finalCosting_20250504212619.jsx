                    ...
                    >
                      ...
                      <View style={{ padding: 16 }}>
                        ...
                        {dayHotel && (
                          ...
                          >
                            {/* Debug logs */}
                            {console.log("Full packageSummary:", packageSummary)}
                            {console.log("packageDetails hotels:", packageSummary?.packageDetails?.hotels)}
                            
                            {/* Hotel Image */}
                            {packageSummary?.packageDetails?.hotels?.[0]?.propertyphoto && (
                              <Image
                                style={{
                                  width: "100%",
                                  height: 150,
                                ...
                                src={{
                                  uri: packageSummary.packageDetails.hotels[0].propertyphoto[0],
                                  headers: {
