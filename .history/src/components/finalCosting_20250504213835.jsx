                    ...
                    >
                      ...
                      <View style={{ padding: 16 }}>
                        ...
                        {dayHotel && (
                          ...
                          >
                            {/* Debug logs */}
                            {console.log("Complete Package Data:", selectedHistoryItem)}
                            {console.log("Package Details:", selectedHistoryItem?.packageDetails)}
                            
                            {/* Hotel Image */}
                            {selectedHistoryItem?.packageDetails?.hotels?.map((hotel, index) => {
                              if (hotel.day === dayHotel.day) {
                                return (
                                  <Image
                                    key={index}
                                    style={{
