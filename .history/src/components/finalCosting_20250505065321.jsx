...
const PackagePDF = ({
  ...
  <Document>
    ...
    >
                          ...
                          >
                            ...
                            {packageSummary?.hotels && (
                              <Image
                                ...
                                src={{
                                  uri: packageSummary.hotels[dayHotel.day - 1]
                                    ?.propertyphoto?.[0],
                                  headers: {
      ...
      {/* After your existing itinerary content, add a page break and account details */}
      <Page size="A4" style={pdfStyles.page}>
        <View style={pdfStyles.container}>
          <Text style={pdfStyles.sectionTitle}>ACCOUNT DETAILS AND UPI ID</Text>
          
          {/* Bank Account Details */}
          <View style={pdfStyles.accountSection}>
            <Text style={pdfStyles.accountTitle}>Bank Account Details:</Text>
            <View style={pdfStyles.accountDetails}>
              <Text>Account Name: Pluto Tours and Travel</Text>
              <Text>Account Number: XXXXXXXXXXXXX</Text>
              <Text>IFSC Code: XXXXXXXXX</Text>
              <Text>Bank Name: XXXXX Bank</Text>
              <Text>Branch: XXXXX Branch</Text>
            </View>
          </View>

          {/* UPI Details */}
          <View style={pdfStyles.accountSection}>
            <Text style={pdfStyles.accountTitle}>UPI Details:</Text>
            <View style={pdfStyles.accountDetails}>
              <Text>UPI ID: example@upi</Text>
              <Text>Phone Number: +91 XXXXXXXXXX</Text>
            </View>
          </View>
        </View>
      </Page>
