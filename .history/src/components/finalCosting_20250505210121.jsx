                      ...
                      <View style={{ padding: 16 }}>
                        ...
                        {dayHotel && (
                          ...
                          >
                            ...
                            {/* Hotel Image */}
                            {packageSummary?.hotels && dayHotel && (
                              <View style={{ width: "100%", height: 150, backgroundColor: "#F1F5F9" }}>
                                {packageSummary.hotels[dayHotel.day - 1]?.propertyPhotoBase64 ? (
                                  <Image
                                    style={{
                                      width: "100%",
                                      height: 150,
                                    }}
                                    src={packageSummary.hotels[dayHotel.day - 1]?.propertyPhotoBase64}
                                  />
                                ) : (
                                  <View style={{ 
                                    width: "100%", 
