        ...
        <View style={pdfStyles.mainContent}>
                      ...
                      <View style={{ padding: 16 }}>
                        ...
                        {dayHotel && (
                          ...
                          >
                            ...
                            {console.log("Current dayHotel:", dayHotel)}
                            ...
                            {packageSummary?.hotels && (
                              ...
                              >
                                {/* Use a placeholder image instead of trying to fetch */}
                                <Image
                                  style={{
                                    width: "100%",
                                    height: 150,
                                  ...
                                  src="data:image/png;base64,"
                                />
                              </View>
                            )}
                            ...
                            <View style={{ padding: 12 }}>
                              ...
                              <Text style={{ fontSize: 12, color: "#64748B" }}>
                                {dayHotel.cityName} - {dayHotel.roomName}
                              </Text>
                            </View>
                          </View>
                        )}
            ...
            <View style={{ padding: 16, gap: 12 }}>
              ...
              >
                ...
                <Text style={{ flex: 1, fontSize: 11, color: "#1E293B" }}>
                  {packageSummary.hotels?.length || 0} Hotels accommodation with{" "}
                  {packageSummary.package?.itineraryDays?.length || 0} days
                  itinerary
                </Text>
              </View>
          ...
          <View style={pdfStyles.exclusionsContainer}>
            ...
            <View style={pdfStyles.exclusionsHeader}>
              <Icons.Close />
              <Text style={pdfStyles.exclusionsTitle}>Package Exclusions</Text>
            </View>
          ...
          >
            ...
            >
              <Icons.Star style={{ width: 10, height: 10, color: "#2d2d44" }} />
              <Text
                style={{
                  fontSize: 8,
                  color: "#2d2d44",
          ...
          {/* Hotels Section */}
          <View style={pdfStyles.hotelsSection}>
            <View style={pdfStyles.sectionHeader}>
              <Icons.Hotel style={pdfStyles.headerIcon} />
            ...
            {packageSummary.hotels?.map((hotel, index) => (
              <View key={index} style={pdfStyles.hotelCard}>
                ...
                <View style={pdfStyles.hotelHeader}>
                  <Text style={pdfStyles.hotelName}>
                    {hotel.propertyName || "Hotel Name"}
                  </Text>
                  <View style={pdfStyles.ratingContainer}>
                    <Icons.Star style={pdfStyles.starIcon} />
                    <Text style={pdfStyles.ratingText}>
                      {hotel.basicInfo?.hotelStarRating || "3"}★
                    </Text>
                  </View>
                </View>

                {/* Hotel Details */}
                <View style={pdfStyles.hotelDetails}>
                  {/* Room Type */}
                  <View style={pdfStyles.detailRow}>
                    <Icons.Room style={pdfStyles.detailIcon} />
                  ...
                  {/* Meal Plan */}
                  <View style={pdfStyles.detailRow}>
                    <Icons.Food style={pdfStyles.detailIcon} />
                    <Text style={pdfStyles.detailText}>
                      Meal Plan: {hotel.mealPlan || "CP (Breakfast)"}
                    </Text>
                  </View>

                  {/* Check-in/Check-out */}
                  <View style={pdfStyles.detailRow}>
                    <Icons.Clock style={pdfStyles.detailIcon} />
                    <Text style={pdfStyles.detailText}>
                ...
                {/* Amenities */}
                <View style={pdfStyles.amenitiesSection}>
                  <Text style={pdfStyles.amenitiesTitle}>Key Amenities</Text>
                  <View style={pdfStyles.amenitiesGrid}>
                    {["Wi-Fi", "Restaurant", "Parking", "Room Service"].map(
                      (amenity, i) => (
                        <View key={i} style={pdfStyles.amenityItem}>
                          <Icons.Check style={pdfStyles.checkIcon} />
                          <Text style={pdfStyles.amenityText}>{amenity}</Text>
                        </View>
                      )
                    )}
                  </View>
  ...
  <View style={pdfStyles.accountDetailsSection}>
    ...
    <View style={pdfStyles.bankGrid}>
      ...
      <View style={pdfStyles.bankCard}>
        ...
        <View style={pdfStyles.bankDetail}>
          ...
          <Text style={pdfStyles.bankValue}>PTWHOLIDAYSPVT.LTD.</Text>
        </View>
        <View style={pdfStyles.bankDetail}>
      ...
      <View style={pdfStyles.bankCard}>
        ...
        <View style={pdfStyles.bankDetail}>
          <Text style={pdfStyles.bankLabel}>A/C Name:</Text>
          <Text style={pdfStyles.bankValue}>PTWHOLIDAYSPVTLTD</Text>
        </View>
        <View style={pdfStyles.bankDetail}>
          <Text style={pdfStyles.bankLabel}>Branch:</Text>
    ...
    <View style={pdfStyles.upiSection}>
      <View style={pdfStyles.upiCard}>
        <Text style={pdfStyles.upiTitle}>GOOGLEPAY@PHONEPAY</Text>
                        ...
                        <div className="flex flex-col gap-2 flex-grow">
                          ...
                          <button
                            onClick={async () => {
                              try {
                                const response = await fetch(
                                  `${config.API_HOST}/api/finalcosting/update-entire/${item._id}`,
                                  {
                                    method: "PUT",
                                    headers: {
                                      "Content-Type": "application/json",
