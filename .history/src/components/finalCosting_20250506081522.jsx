        ...
        <View style={pdfStyles.topHeader}>
          <View style={pdfStyles.brandSection}>
            <View style={pdfStyles.brandInfo}>
              <Image
                src="https://res.cloudinary.com/dcp1ev1uk/image/upload/v1724223770/logo_easm3q.png"
                style={{
                  width: "100%",
                  height: 30,
                  objectFit: "cover",
                        ...
                        {dayHotel && (
                          ...
                          >
                            ...
                            {dayHotel.propertyphoto &&
                              dayHotel.propertyphoto[0] && (
                                <Image
                                  src="https://firebasestorage.googleapis.com/v0/b/mern-estate-1b3d0.appspot.com/o/property-images%2Fjamla%20inn%20hotel%20manali.jpg?alt=media&token=f9f9c323-0f83-42e5-b70c-cc6ccd7633a5"
                                  style={{
                                    width: "100%",
                                    height: 150,
                                    objectFit: "cover",
