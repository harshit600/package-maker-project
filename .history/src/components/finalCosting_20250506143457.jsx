...
const pdfSections = {
  ...
  async drawFooter(page, fonts, { width, height }) {
    ...
    // Website and address
    page.drawText("www.plutotravels.com | 123 Travel Street, Tourism City, TC 12345", {
      x: 50,
      y: footerY - 5,
      size: 10,
      font: fonts.regular,
...
const createPDF = async (packageData) => {
  ...
  // Draw customer info
  currentY = await pdfSections.drawCustomerInfo(page, fonts, currentY, packageData.customer);

  // Draw package details
  currentY = await pdfSections.drawPackageDetails(page, fonts, currentY, packageData);

  // Draw itinerary
  currentY = await pdfSections.drawItinerary(page, fonts, currentY, packageData.itinerary);
  ...
  // Draw cost breakdown
  currentY = await pdfSections.drawCostBreakdown(page, fonts, currentY, packageData.costs);
