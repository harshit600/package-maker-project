  ...
  <Document>
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', gap: 12, marginVertical: 20, marginHorizontal: 20 }}>
          {/* Image Box 1 */}
          <View style={{ 
            flex: 1,
            height: 200,
            ...
            <Image
              source={packageSummary.package?.images?.[0] || "https://placehold.co/600x400"}
              style={{
                width: '100%',
                height: '100%',
                objectFit: 'cover'
          ...
          <View style={{ 
            ...
            <Image
              source={packageSummary.package?.images?.[1] || "https://placehold.co/600x400"}
              style={{
                width: '100%',
                height: '100%',
                objectFit: 'cover'
          ...
          <View style={{ 
            ...
            <Image
              source={packageSummary.package?.images?.[2] || "https://placehold.co/600x400"}
              style={{
                width: '100%',
                height: '100%',
                objectFit: 'cover'
