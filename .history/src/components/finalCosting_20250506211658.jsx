    ...
    >
      ...
      >
        ...
        <View style={pdfStyles.mainContent}>
          {/* Break to new page before Journey Overview */}
          <Text break />
          ...
          >
            ...
            >
              <View style={{ flexDirection: "row", alignItems: "center", gap: 12 }}>
                ...
                >
                  <Icons.Map style={{ width: 24, height: 24, color: "#FFFFFF" }} />
                </View>
                <View>
                  <Text style={{ fontSize: 24, fontWeight: "bold", color: "#FFFFFF" }}>
                    Your Journey Itinerary
                  </Text>
                  <Text style={{ fontSize: 14, color: "#E2E8F0", marginTop: 2 }}>
                    {packageSummary?.package?.itineraryDays?.length} Days of Adventure
                  </Text>
                </View>
              </View>
            </View>
