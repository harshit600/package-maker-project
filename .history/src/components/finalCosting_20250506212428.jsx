...
const CompanyFooter = () => (
  <View style={{
    ...
    <View style={{
      ...
      <Image
        src="/path/to/your/logo.png" // Replace with your company logo
        style={{
          width: 50,
          height: 50,
          marginRight: 15,
    ...
    <View style={{
      ...
      <View style={{
        ...
        <Icons.Location style={{ width: 16, height: 16, color: '#FFFFFF', marginRight: 8 }} />
        <Text style={{
          color: '#FFFFFF',
          fontSize: 10,
        }}>
      ...
      <View style={{
        ...
        <Icons.Phone style={{ width: 16, height: 16, color: '#FFFFFF', marginRight: 8 }} />
        <Text style={{
          color: '#FFFFFF',
          fontSize: 10,
        }}>
      ...
      <View style={{
        ...
        <Icons.Globe style={{ width: 16, height: 16, color: '#FFFFFF', marginRight: 8 }} />
        <Text style={{
          color: '#FFFFFF',
          fontSize: 10,
        }}>
