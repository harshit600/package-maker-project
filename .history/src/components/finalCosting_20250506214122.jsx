...
const AccountDetailsSection = () => (
  <View style={pdfStyles.accountDetailsSection}>
    ...
    <View style={pdfStyles.headerContainer}>
      <View style={pdfStyles.headerIconContainer}>
        <Icons.CreditCard style={{ width: 24, height: 24, color: "#FFFFFF" }} />
      </View>
      <Text style={pdfStyles.accountDetailsHeader}>PAYMENT INFORMATION</Text>
    </View>

    {/* Bank Grid Section with Modern Cards */}
    <View style={pdfStyles.bankGrid}>
      {/* SBI Section */}
      <View style={pdfStyles.bankCard}>
        <View style={pdfStyles.bankLogoContainer}>
          <Text style={pdfStyles.bankLogoText}>SBI</Text>
        </View>
        <Text style={pdfStyles.bankName}>STATE BANK OF INDIA</Text>
        <View style={pdfStyles.bankDetailsContainer}>
          <View style={pdfStyles.bankDetail}>
            <View style={pdfStyles.detailIconContainer}>
              <Icons.Hash style={{ width: 12, height: 12, color: "#4F46E5" }} />
            </View>
            <View>
              <Text style={pdfStyles.bankLabel}>Account Number</Text>
              <Text style={pdfStyles.bankValue}>38207849663</Text>
            </View>
          </View>
          <View style={pdfStyles.bankDetail}>
            <View style={pdfStyles.detailIconContainer}>
              <Icons.User style={{ width: 12, height: 12, color: "#4F46E5" }} />
            </View>
            <View>
              <Text style={pdfStyles.bankLabel}>Account Name</Text>
          ...
          <View style={pdfStyles.bankDetail}>
            <View style={pdfStyles.detailIconContainer}>
              <Icons.Location
                style={{ width: 12, height: 12, color: "#4F46E5" }}
              />
            </View>
            <View>
          ...
          <View style={pdfStyles.bankDetail}>
            <View style={pdfStyles.detailIconContainer}>
              <Icons.Key style={{ width: 12, height: 12, color: "#4F46E5" }} />
            </View>
            <View>
        ...
        <View style={pdfStyles.bankCardDecoration} />
      </View>

      {/* Similar structure for other banks... */}
    </View>

    {/* Modern UPI Section */}
    <View style={pdfStyles.upiSection}>
      <View style={pdfStyles.upiHeader}>
        <Icons.Smartphone style={{ width: 20, height: 20, color: "#2d2d44" }} />
        <Text style={pdfStyles.upiHeaderText}>Digital Payment Options</Text>
      </View>

      <View style={pdfStyles.upiCardsContainer}>
        <View style={pdfStyles.upiCard}>
          <View style={pdfStyles.upiIconContainer}>
          ...
          <View style={pdfStyles.qrPlaceholder}>
            <Icons.QrCode style={{ width: 40, height: 40, color: "#4F46E5" }} />
          </View>
        </View>

        <View style={pdfStyles.upiCard}>
          <View
            style={[pdfStyles.upiIconContainer, { backgroundColor: "#4F46E5" }]}
          >
            <Icons.Link style={{ width: 16, height: 16, color: "#FFFFFF" }} />
          </View>
          <View>
            <Text style={pdfStyles.upiTitle}>UPI ID</Text>
            <Text style={pdfStyles.upiValue}>mdplutotours-2@okhdfcbank</Text>
            <Text style={pdfStyles.upiValue}>981666196@sbi</Text>
          </View>
        </View>
      </View>
    </View>
