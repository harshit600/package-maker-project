    ...
    <Document>
      <Page>
        <View style={pdfStyles.container}>
          ...
          <View
            style={{
              backgroundColor: colorTheme === "orange" ? "#EA580C" : "rgb(45 45 68)",
              padding: 24,
              borderRadius: 12,
              marginBottom: 24,
            }}
          >
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
              <View>
                ...
                <Text style={{ fontSize: 12, color: "#E2E8F0", marginTop: 4 }}>
            ...
            <View style={{ marginTop: 16 }}>
              <Text style={{ fontSize: 14, color: "#E2E8F0" }}>PACKAGE TITLE</Text>
              <Text style={{ fontSize: 20, fontWeight: "bold", color: "#FFFFFF", marginTop: 4 }}>
            ...
            <View
              style={{
                marginTop: 16,
                padding: 16,
                backgroundColor: colorTheme === "orange" ? "#FFEDD5" : "rgba(255, 255, 255, 0.1)",
                borderRadius: 8,
              }}
            >
              <View style={{ flexDirection: "row", gap: 48 }}>
                {/* Customer Info */}
                <View style={{ flex: 1 }}>
                  <Text style={{ fontSize: 12, color: colorTheme === "orange" ? "#EA580C" : "#E2E8F0" }}>
                    CUSTOMER NAME
                  </Text>
                  <Text
                    style={{
                      fontSize: 16,
                      fontWeight: "bold",
                      color: colorTheme === "orange" ? "#C2410C" : "#FFFFFF",
                      marginTop: 4,
                    }}
                  >
            ...
            >
              ...
              >
                <Text
                  style={{
                    fontSize: 9,
                    color: colorTheme === "orange" ? "#FFEDD5" : "#64748B",
                  }}
                >
                  Total Cities
                </Text>
                <Text
                  style={{
                    fontSize: 11,
                    fontWeight: "bold",
                    color: colorTheme === "orange" ? "#FFFFFF" : "#1E293B",
                  }}
                >
              ...
              {/* Continue with other stats using the same color pattern */}
            </View>
          </View>

          {/* Rest of your PDF content */}
          {/* We can continue with the next sections in subsequent steps */}
        </View>
      </Page>
    </Document>
  );
