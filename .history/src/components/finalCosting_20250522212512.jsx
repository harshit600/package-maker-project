   ...
   <div className="bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-200 p-4">
              ...
              {showMargin && !hasConvertedHistory && (
                <div className="mt-6 space-y-4">
                  <div className={`bg-${showDiscount ? 'green' : 'yellow'}-50 rounded-xl border border-${showDiscount ? 'green' : 'yellow'}-100 p-4`}>
                    <div className="flex justify-between items-center">
                      <div className="flex items-center gap-3">
                        <div className={`p-2 bg-${showDiscount ? 'green' : 'yellow'}-100 rounded-lg`}>
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className={`h-6 w-6 text-${showDiscount ? 'green' : 'yellow'}-600`}
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                          >
