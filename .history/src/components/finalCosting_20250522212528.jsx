                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500">
                            {showDiscount ? 'Applied discount' : 'Additional profit margin'}
                          </p>
                        </div>
                      </div>
                      <span className={`text-lg font-semibold text-${showDiscount ? 'green' : 'yellow'}-600`}>
                        ₹{showDiscount ? discountAmount.toFixed(2) : marginAmount.toFixed(2)}
                      </span>
                    </div>
                  </div>
