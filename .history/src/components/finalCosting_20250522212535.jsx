...
const PackagePDF = ({
  ...
  <Text style={pdfStyles.cityAreaContainer}>
    {day.selectedItinerary?.cityArea?.map((area, index) => {
      ...
      return (
        <View key={index} style={pdfStyles.cityAreaItem}>
          {/* Location Icon */}
          <Icons.Location style={pdfStyles.cityAreaIcon} />
          ...
          {index < day.selectedItinerary.cityArea.length - 1 && (
...
const FinalCosting = ({ selectedLead }) => {
  ...
  useEffect(() => {
    const fetchMarginData = async () => {
      try {
        ...
        const matchingStateMargin = data?.data?.find(margin => 
          (margin.state || '').toLowerCase() === packageState
        );
  ...
  const discountAmount = showDiscount ? calculateDiscount(
    packageSummary?.totals?.grandTotal || 0,
  ...
  const handleCustomMarginSubmit = () => {
    ...
    if (marginValue < minimumMargin) {
      alert(`Margin cannot be less than ${minimumMargin}% for this package value`);
      return;
    }
  ...
  const handleCustomDiscountSubmit = () => {
    ...
    if (discountValue > maximumDiscount) {
      alert(`Discount cannot be more than ${maximumDiscount}% for this package value`);
      return;
    }
  ...
  return (
    <>
      <div className="p-6 flex gap-6">
        ...
        <div className="flex-grow bg-white rounded-xl border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
          {/* Enhanced Header */}
          <div className="px-8 py-6 border-b border-gray-200 bg-gradient-to-r from-[#2d2d44] to-[#3d3d5c]">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-gray-300 text-sm flex items-center gap-2">
                  ...
                  Detailed pricing information with complete breakdown
                </p>
              </div>
              
              {/* Existing buttons wrapped in enhanced container */}
              <div className="flex items-center gap-4">
                {!hasConvertedHistory && (
                  <div className="flex items-center gap-3">
                    {showCustomMargin && (
                      <div className="flex items-center gap-2 bg-white/10 p-2 rounded-lg">
                        {/* Existing margin/discount toggle and inputs with enhanced styling */}
                        ...
                        <input
                          type="number"
                          value={showDiscount ? customDiscountPercentage : customMarginPercentage}
                          onChange={(e) => 
                            showDiscount 
                              ? setCustomDiscountPercentage(e.target.value)
                              : setCustomMarginPercentage(e.target.value)
                          }
                          className="w-24 px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder="Enter %"
                        />
                        
                        <button
                          onClick={showDiscount ? handleCustomDiscountSubmit : handleCustomMarginSubmit}
                          className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-all duration-200 shadow-md hover:shadow-lg font-medium"
                        >
                          Apply
                        </button>
                      </div>
          ...
          <div className="p-8">
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Hotel Costs Card */}
                <div className="bg-white rounded-xl border border-gray-100 shadow-md hover:shadow-lg transition-all duration-300 p-6 transform hover:-translate-y-1">
                  <div className="flex justify-between items-start">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="text-lg font-semibold text-gray-800 mb-1">Hotel Charges</h4>
                        <p className="text-sm text-gray-500">Accommodation costs for your stay</p>
                      </div>
                    </div>
                    <span className="text-xl font-bold text-blue-600">
                      ₹{packageSummary?.totals?.hotelCost?.toLocaleString() || 0}
                    </span>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl border border-gray-100 shadow-md hover:shadow-lg transition-all duration-300 p-6 transform hover:-translate-y-1">
                  <div className="flex justify-between items-start">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="text-lg font-semibold text-gray-800 mb-1">Transfer Charges</h4>
                        <p className="text-sm text-gray-500">All transportation expenses</p>
                      </div>
                    </div>
                    <span className="text-xl font-bold text-green-600">
                      ₹{packageSummary?.totals?.transferCost?.toLocaleString() || 0}
                    </span>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl border border-gray-100 shadow-md hover:shadow-lg transition-all duration-300 p-6 transform hover:-translate-y-1">
                  <div className="flex justify-between items-start">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="text-lg font-semibold text-gray-800 mb-1">Activity Charges</h4>
                        <p className="text-sm text-gray-500">Entertainment & experiences</p>
                      </div>
                    </div>
                    <span className="text-xl font-bold text-purple-600">
                      ₹{packageSummary?.totals?.activitiesCost?.toLocaleString() || 0}
                    </span>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl border border-gray-100 shadow-md hover:shadow-lg transition-all duration-300 p-6 transform hover:-translate-y-1">
                  <div className="flex justify-between items-start">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="text-lg font-semibold text-gray-800 mb-1">Taxes & Fees</h4>
                        <p className="text-sm text-gray-500">Additional charges & taxes</p>
                      </div>
                    </div>
              ...
              {/* Margin Section with enhanced styling */}
              {showMargin && !hasConvertedHistory && (
                <div className="mt-8">
                  <div className={`bg-${showDiscount ? 'green' : 'amber'}-50 rounded-xl border border-${showDiscount ? 'green' : 'amber'}-100 p-6`}>
                    <div className="flex justify-between items-center">
                      <div className="flex items-center gap-4">
                        <div className={`p-3 bg-${showDiscount ? 'green' : 'amber'}-100 rounded-xl`}>
                          <svg xmlns="http://www.w3.org/2000/svg" className={`h-8 w-8 text-${showDiscount ? 'green' : 'amber'}-600`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                          </svg>
                        </div>
                        <div>
                          <h4 className="text-lg font-semibold text-gray-800">
                            {showDiscount ? `Discount (${activeDiscountPercentage}%)` : `Margin (${getCurrentMarginPercentage()}%)`}
                          </h4>
                          <p className="text-sm text-gray-500">
                            {showDiscount ? 'Applied discount amount' : 'Additional profit margin'}
                          </p>
                        </div>
                      </div>
                      <span className={`text-2xl font-bold text-${showDiscount ? 'green' : 'amber'}-600`}>
                        ₹{(showDiscount ? discountAmount : marginAmount).toLocaleString(undefined, {maximumFractionDigits: 2})}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-8">
                <div className="bg-gradient-to-r from-[#2d2d44] to-[#3d3d5c] rounded-xl p-8 text-white shadow-xl">
                  <div className="flex justify-between items-center">
                    <div>
                      <h4 className="text-2xl font-bold text-white mb-2">Grand Total</h4>
                      <p className="text-gray-300">
                        {showMargin && `(Including ${showDiscount ? 'Discount' : 'Margin'})`}
                      </p>
                    </div>
                    <div className="text-right">
                      <span className="text-3xl font-bold">
                        ₹{(showMargin ? finalTotal : packageSummary?.totals?.grandTotal || 0).toLocaleString(undefined, {maximumFractionDigits: 2})}
                      </span>
                      <p className="text-sm text-gray-300 mt-1">Total package cost</p>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    >
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <div className="flex flex-col gap-2 flex-grow">
                          ...
                          >
                            {({ loading }) => (
                              <button className="flex items-center justify-center gap-1 px-3 py-1.5 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors text-sm w-full">
                                {loading
                                  ? "Loading..."
