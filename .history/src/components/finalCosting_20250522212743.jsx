    ...
    <>
      <div className="p-6 flex gap-6">
        ...
        <div className="flex-grow bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow overflow-hidden">
          {/* Enhanced Header */}
          <div className="relative overflow-hidden" style={{ backgroundColor: "#2d2d44" }}>
            {/* Background Pattern */}
            ...
            <div className="px-8 py-6 relative">
              <div className="flex justify-between items-center">
                <div className="flex items-start gap-4">
                  ...
                  {/* Title and Subtitle */}
                  <div>
                    <h3 className="text-2xl font-bold text-white">Cost Breakdown</h3>
                    <div className="flex items-center gap-2 mt-1">
                      <span className="inline-block w-2 h-2 bg-green-400 rounded-full"></span>
                      <p className="text-gray-300 text-sm">Detailed pricing information</p>
                    </div>
                  </div>
                </div>
                ...
                {!hasConvertedHistory && (
                  <div className="flex items-center gap-3">
                    {showCustomMargin && (
                      <div className="flex items-center gap-2 bg-white/10 p-1.5 rounded-lg backdrop-blur-sm">
                        ...
                        <input
                          ...
                          onChange={(e) => showDiscount ? setCustomDiscountPercentage(e.target.value) : setCustomMarginPercentage(e.target.value)}
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-white/10 hover:bg-white/20 text-white rounded-lg transition-all flex items-center gap-2 backdrop-blur-sm"
                    >
                      {showMargin ? (
                        <>
