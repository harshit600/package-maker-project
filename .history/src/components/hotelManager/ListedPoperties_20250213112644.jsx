    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-bold text-gray-800">Here you canmanage all hotels Your Properties</h1>
          <Link to="/add-property">
            <button className="px-6 py-2 bg-[rgb(45,45,68)] text-white rounded-lg hover:bg-opacity-80 transition-all duration-200 flex items-center gap-2">
