            ...
            >
              <div className="p-4">
                <div className="flex gap-6">
                  ...
                  <div className="relative group min-w-[400px] flex gap-2">
                    {/* Main Image */}
                    <div className="relative h-[300px] w-[400px] overflow-hidden rounded-lg">
                      <img
                        src={property?.photosAndVideos?.images?.[activeImageIndex[property._id] || 0]}
                        className="h-full w-full object-cover"
                        alt={`${property?.basicInfo?.propertyName} - Main`}
                      />
                    </div>

                    {/* Thumbnail Column */}
                    <div className="flex flex-col gap-2 w-[100px]">
                      {property?.photosAndVideos?.images?.slice(0, 4).map((image, index) => (
                        <div 
                          key={index}
                          ...
                          className={`relative h-[72px] cursor-pointer rounded-lg overflow-hidden ${
