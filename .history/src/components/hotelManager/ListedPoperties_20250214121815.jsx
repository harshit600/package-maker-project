                ...
                {property?.photosAndVideos?.images
                  ...
                  .map((img, i) => (
                    <img
                      key={i}
                      src={img}
                      className="w-16 h-12 object-cover rounded shadow-sm hover:opacity-90 transition-opacity cursor-pointer"
                      alt={`thumbnail-${i}`}
                    />
                  ))}
                <div className="w-16 h-12 bg-gray-800 rounded flex items-center justify-center text-white text-sm cursor-pointer hover:bg-gray-700 transition-colors">
                  View All
                </div>
              </div>
            </div>
