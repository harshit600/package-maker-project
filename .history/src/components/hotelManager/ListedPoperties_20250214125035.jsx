            ...
            <div className="flex-grow px-6 py-1">
              ...
              <div className="flex gap-6 mt-4">
                {(() => {
                  ...
                  ['mandatory', 'basicFacilities', 'generalServices', 'foodAndDrink', 
                   'healthAndWellness', 'security', 'petEssentials'].forEach(checkCategory);
                      ...
                      <span className="w-8 h-8 flex items-center justify-center bg-blue-50 rounded-full">
                        ...
                        {amenity === "Air Conditioning" && (
                          <svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9.25 4.75h5.5a2 2 0 012 2v10.5a2 2 0 01-2 2h-5.5a2 2 0 01-2-2V6.75a2 2 0 012-2z M7.75 8.75h8.5 M7.75 12h8.5 M7.75 15.25h8.5" />
                          </svg>
                        )}
                        {amenity === "Parking" && (
                          <svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.25 4.75h7.5a2 2 0 012 2v10.5a2 2 0 01-2 2h-7.5a2 2 0 01-2-2V6.75a2 2 0 012-2z M12 8.75v4.5 M10 11h4" />
                          </svg>
                        )}
                        {amenity === "Laundry" && (
                          <svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4.75a7.25 7.25 0 100 14.5 7.25 7.25 0 000-14.5z M12 8.75v6.5" />
                          </svg>
                        )}
                        {amenity === "CCTV" && (
                          <svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.75 8.75l3.5-3.5 M19.25 12h-3.5 M15.75 15.25l3.5 3.5 M12 19.25v-3.5 M8.25 15.25l-3.5 3.5 M4.75 12h3.5 M8.25 8.75l-3.5-3.5 M12 4.75v3.5" />
                          </svg>
                        )}
                        {amenity === "Gym" && (
                          <svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6.75 4.75h10.5a2 2 0 012 2v10.5a2 2 0 01-2 2H6.75a2 2 0 01-2-2V6.75a2 2 0 012-2z M12 8.75v6.5 M8.75 12h6.5" />
                          </svg>
                        )}
                        {/* Default icon for other amenities */}
                        {!["Air Conditioning", "Parking", "Laundry", "CCTV", "Gym"].includes(amenity) && (
                          <svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-right">
                ...
                <div className="flex items-end gap-1 mt-1">
                  <span className="text-3xl font-bold text-gray-900">
                    ₹{property?.pricing?.baseRoomPrice || "1,999"}
                  </span>
