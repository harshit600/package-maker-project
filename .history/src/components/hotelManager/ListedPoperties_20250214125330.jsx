        ...
        >
          <div className="flex p-4">
            ...
            <div className="flex-grow px-6 py-1">
              ...
              {/* Room Details Section - Enhanced Design */}
              <div className="mt-6 border-t border-gray-100 pt-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-sm text-gray-500">
                    Total Rooms: {property?.rooms?.data?.reduce((acc, room) => acc + parseInt(room.roomCount || 0), 0)}
                  </span>
                </div>
                ...
                <div className="space-y-4">
                  {property?.rooms?.data?.map((room, index) => (
                    <div 
                      key={index} 
                      className="bg-white border border-gray-100 rounded-xl p-4 hover:shadow-lg transition-all duration-300"
                    >
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          ...
                          <div className="flex gap-4 mt-3">
                            {['King Bed', 'Sea View', 'Free WiFi', 'Room Service'].map((feature, i) => (
                        ...
                        <div className="text-right">
                          <div className="flex flex-col items-end">
                            ...
                            <div className="text-2xl font-bold text-gray-900">
                              ₹{room.roomPrice || property?.pricing?.baseRoomPrice}
                            </div>
                            <div className="text-sm text-gray-500 mt-1">+₹299 taxes & fees</div>
                          </div>
                          <button className="mt-3 w-full bg-blue-600 text-white py-2 px-4 rounded-lg font-medium hover:bg-blue-700 transition-colors flex items-center justify-center gap-2">
                            <span>Book Now</span>
                            <svg 
                              className="w-4 h-4" 
                              fill="none" 
