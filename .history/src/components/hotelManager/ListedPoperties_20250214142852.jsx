          ...
          <div className="flex p-4">
            ...
            <div className="w-56 flex flex-col items-end justify-between border-l border-gray-300 pl-6">
              <div className="flex gap-2">
                <Link
                  to={`/update/${slugify(property?.basicInfo?.propertyName)}/${property._id}`}
                >
                ...
                <Link
                  to={`/property/${slugify(property?.basicInfo?.propertyName)}/${property._id}`}
                >
              ...
              <div className="text-right">
                ...
                <div className="flex items-end gap-1 mt-1">
                  <span className="text-3xl font-bold text-gray-900">
                    ₹{Math.min(...(property?.rooms?.data?.map((room) => parseInt(room.baseRate)) || [0]))}
                  </span>
