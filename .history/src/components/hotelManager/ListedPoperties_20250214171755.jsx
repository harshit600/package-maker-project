          ...
          <div className="flex p-4">
                  ...
                  <img
                    ...
                    className={`w-16 h-12 object-cover rounded shadow-sm cursor-pointer transition-all ${
                      i === (currentImageIndexes[property._id] || 0)
                        ? "ring-2 ring-[rgb(45,45,68/var(--tw-bg-opacity,1))]"
                        : "hover:opacity-80"
                    }`}
                    alt={`thumbnail-${i}`}
            ...
            <div className="flex-grow px-6 py-1">
              ...
              <div className="flex gap-6 mt-4">
                {(() => {
                  ...
                  return enabledAmenities.slice(0, 5).map((amenity, i) => (
                    ...
                    >
                      <span className="w-8 h-8 flex items-center justify-center bg-[rgb(45,45,68/var(--tw-bg-opacity,1))] rounded-full">
                        {/* Icon mapping based on amenity name */}
                        {amenity === "Air Conditioning" && (
                          <svg
                            className="w-5 h-5 text-[rgb(45,45,68/var(--tw-bg-opacity,1))]"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
                  ...
                  {property?.rooms?.data?.map((room, index) => (
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-2">
                          <span className="px-1 py-0.5 bg-[rgb(45,45,68/var(--tw-bg-opacity,1))] text-white text-sm font-medium rounded-full">
              ...
              <div className="mt-4 flex gap-3">
                <span className="px-3 py-1 bg-[rgb(45,45,68/var(--tw-bg-opacity,1))] text-[rgb(45,45,68/var(--tw-bg-opacity,1))] rounded-full text-sm font-medium border border-[rgb(45,45,68/var(--tw-bg-opacity,1))]">
                  Free Cancellation
                </span>
                <span className="px-3 py-1 bg-[rgb(45,45,68/var(--tw-bg-opacity,1))] text-[rgb(45,45,68/var(--tw-bg-opacity,1))] rounded-full text-sm font-medium border border-[rgb(45,45,68/var(--tw-bg-opacity,1))]">
                  Breakfast Included
            ...
            <div className="w-56 flex flex-col items-end justify-between border-l border-gray-300 pl-6">
              <div className="flex gap-2">
                ...
                >
                  <div className="p-2 rounded-full hover:bg-[rgb(45,45,68/var(--tw-bg-opacity,1))]/10 group transition-colors">
                    <PencilSquareIcon className="w-5 h-5 text-[rgb(45,45,68/var(--tw-bg-opacity,1))] group-hover:text-[rgb(45,45,68/var(--tw-bg-opacity,1))]" />
                  </div>
                </Link>
                <div
