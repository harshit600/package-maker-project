...
function ListedProperites({
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        );/get-packagemaker-hotels-by-city/:cityName
  ...
  return (
    <div className="relative">
      {/* Add a wrapper div with padding-top to account for the fixed filter height */}
      <div className="p-2 max-w-7xl mx-auto bg-gray-50">
                  ...
                  <div className="text-right">
                    ...
                    <div className="mt-2">
                      <span className="text-lg font-semibold text-gray-800 bg-blue-100 px-2 py-1 rounded-full">
                        {property?.rooms?.data?.[0]?.roomType ||
                          "Standard Room"}
                      </span>
                    </div>
        ...
        <Pagination
          totalProperties={getFilteredProperties().length}
