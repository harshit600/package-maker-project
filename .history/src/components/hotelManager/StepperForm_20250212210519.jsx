...
const tabStyles = {
  wrapper:
    "relative flex overflow-x-auto border-b border-gray-200 mt-5 mb-8 scrollbar-hide",
  progressBar:
    "absolute bottom-0 left-0 h-1 bg-blue-500 transition-all duration-300",
  tab: `
  ...
  connector:
    "absolute right-0 top-1/2 -translate-y-1/2 w-8 h-[2px] bg-gray-200",
};
          ...
          >
            <div
              className={`
                ...
                ${
                  activeStep >= index
                    ? tabStyles.iconActive
                    : tabStyles.iconInactive
                }
              `}
            >
              {index < activeStep ? (
