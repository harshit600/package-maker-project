...
const tabStyles = {
  wrapper: `
    relative flex overflow-x-auto mt-5 mb-8 
    scrollbar-hide bg-white rounded-xl shadow-md
  ...
  `,
  tab: `
    relative flex items-center gap-3 px-6 py-5
  ...
  `,
  iconActive: `
    bg-gradient-to-br shadow-lg transform scale-110
  `,
  iconInactive: `
    bg-gray-100
  `,
            ...
            >
              <div className={tabStyles.tabContent}>
                <div className={`
                  ...
                  ${isActive ? `${tabStyles.iconActive} from-${step.color}-500 to-${step.color}-600 text-white` : ''}
