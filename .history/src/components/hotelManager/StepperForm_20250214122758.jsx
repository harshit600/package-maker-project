...
const steps = [
  { 
    name: "Basic Info", 
    icon: <i className="fas fa-home text-sm" /> 
  },
  { 
    name: "Location", 
    icon: <i className="fas fa-map-marker-alt text-sm" /> 
  },
  { 
    name: "Amenities", 
    icon: <i className="fas fa-concierge-bell text-sm" /> 
  },
  { 
    name: "Rooms", 
    icon: <i className="fas fa-bed text-sm" /> 
  },
  { 
    name: "Photos and videos", 
    icon: <i className="fas fa-images text-sm" /> 
  },
  { 
    name: "Policies", 
    icon: <i className="fas fa-file-alt text-sm" /> 
  },
  { 
    name: "Finance & legal", 
    icon: <i className="fas fa-money-bill text-sm" /> 
  },
];
      ...
      <div className="w-full max-w-6xl mx-auto pb-8">
        <div className="flex overflow-x-auto border-b border-gray-200 mt-5 space-x-2">
          {steps.map((step, index) => (
            <button
              key={step.name}
              className={`flex items-center px-4 py-2 border-b-2 font-medium text-sm whitespace-nowrap transition-colors duration-200
                ${
                  activeStep === index
            ...
            >
              <div className={`flex items-center justify-center rounded-full w-8 h-8 mr-2
