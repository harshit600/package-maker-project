...
const steps = [
  {
    name: "Basic Info",
    icon: <i className="fas fa-home text-lg" />,
  },
  {
    name: "Location",
    icon: <i className="fas fa-map-marker-alt text-lg" />,
  },
  {
    name: "Amenities",
    icon: <i className="fas fa-concierge-bell text-lg" />,
  },
  {
    name: "Rooms",
    icon: <i className="fas fa-bed text-lg" />,
  },
  {
    name: "Photos and videos",
    icon: <i className="fas fa-images text-lg" />,
  },
  {
    name: "Policies",
    icon: <i className="fas fa-file-alt text-lg" />,
  },
  {
    name: "Finance & legal",
    icon: <i className="fas fa-money-bill text-lg" />,
  },
];
  ...
  return (
    <>
      <div className="w-full max-w-6xl mx-auto pb-8">
        <div className="w-full overflow-x-auto bg-white shadow-[0_-4px_12px_rgba(0,0,0,0.1)] rounded-t-xl">
          <div className="flex justify-between items-center px-6 py-3 min-w-max">
            {steps.map((step, index) => (
              <button
                key={step.name}
                onClick={() => handleStepChange(index)}
                className={`flex flex-col items-center min-w-[80px] px-3 gap-1 transition-colors duration-200
                  ${
                    activeStep === index
                      ? "text-blue-500"
