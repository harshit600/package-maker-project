                ...
                .map((amenity) => {
                  ...
                  return (
                    <div key={amenity.value} className="relative group">
                      ...
                      <div
                        className={`absolute inset-0 rounded-lg border-2 border-transparent transition-all duration-200 pointer-events-none
                        ${
                          isSelected
        ...
        <button
          onClick={async () => {
            try {
              ...
              onSaveSuccess(); // Call this after successful save to switch tabs
            } catch (error) {
