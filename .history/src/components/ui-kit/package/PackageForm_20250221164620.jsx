            ...
            <Row className="items-center">
              ...
              <Col>
                <div className="flex items-center space-x-2 mt-6">
                  <span className={`text-sm text-gray-600 flex items-center ${!place.transfer ? 'text-blue-600 opacity-100' : 'opacity-50'}`}>
                    <svg 
                      xmlns="http://www.w3.org/2000/svg" 
                      className={`h-5 w-5 mr-1 ${!place.transfer ? 'text-blue-600' : 'text-gray-400'}`}
                      fill="none" 
                      viewBox="0 0 24 24" 
                      stroke="currentColor"
                    >
