            ...
            <Row className="items-center">
              ...
              <Col>
                <div className="flex items-center space-x-2 mt-6">
                  <span className={`text-sm text-gray-600 flex items-center ${!place.transfer ? 'text-orange-500 opacity-100' : 'opacity-50'}`}>
                    <svg 
                      xmlns="http://www.w3.org/2000/svg" 
                      className={`h-5 w-5 mr-1 ${!place.transfer ? 'text-orange-500' : 'text-gray-400'}`}
                  ...
                  />
                  <span className={`text-sm text-gray-600 flex items-center ${place.transfer ? 'text-gray-900 opacity-100' : 'opacity-50'}`}>
                    <svg 
                      xmlns="http://www.w3.org/2000/svg" 
                      className={`h-5 w-5 mr-1 ${place.transfer ? 'text-gray-900' : 'text-gray-400'}`}
                      fill={place.transfer ? "currentColor" : "none"}
                      viewBox="0 0 24 24" 
                      stroke="currentColor"
                    >
                  ...
                  <div className="relative group">
                    ...
                    <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 hidden group-hover:block w-48 px-4 py-2 bg-gray-900 text-white text-sm rounded-lg">
                      {place.transfer ? "Night transfer between locations" : "Day transfer between locations"}
