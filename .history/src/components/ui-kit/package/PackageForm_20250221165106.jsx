                ...
                <div className="flex items-center space-x-2 mt-6">
                  <span
                    className={`text-sm text-gray-600 flex items-center ${
                      !place.transfer ? "text-orange-500 opacity-100" : "opacity-50"
                    }`}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span
                    className={`text-sm text-gray-600 flex items-center ${
                      place.transfer ? "text-gray-900 opacity-100" : "opacity-50"
                    }`}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    Night {place.transfer && <span className="ml-1 text-blue-600">(Night Travel)</span>}
                  </span>
