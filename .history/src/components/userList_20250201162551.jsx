...
const UserList = () => {
  ...
  const handleBlockUser = async (userId, currentStatus) => {
    try {
      ...
      const response = await fetch(`${config.API_HOST}/api/maker/update-status/${userId}`, {
        method: 'PUT',
        headers: {
            ...
            {filteredUsers.map((user) => (
              ...
              >
                ...
                <td className="py-4 px-6">
                  ...
                  >
                    {user.status || (user.publish === 'Yes' ? 'Active' : 'Inactive')}
                  </span>
                </td>
                <td className="py-4 px-6">
                  <div className="flex gap-3">
                  ...
                  <div className="flex gap-3">
                    <span
                      className={`px-4 py-1.5 rounded-full text-sm font-medium ${
                        (selectedUser.userType || "User") === "Admin"
                          ? "bg-indigo-50 text-indigo-700 ring-1 ring-indigo-600/20"
                          : (selectedUser.userType || "User") === "Manager"
                          ? "bg-purple-50 text-purple-700 ring-1 ring-purple-600/20"
                          : "bg-blue-50 text-blue-700 ring-1 ring-blue-600/20"
                      }`}
                    >
                    ...
                    >
                      {selectedUser.status || (selectedUser.publish === 'Yes' ? 'Active' : 'Inactive')}
                    </span>
                  </div>
                </div>
              </div>
