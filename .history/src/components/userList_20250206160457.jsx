...
const UserList = () => {
  ...
  const filteredUsers = users.filter((user) => {
    const matchesType = userTypeFilter === "All" || (user.userType || "User") === userTypeFilter;
    const fullName = `${user.firstName} ${user.lastName}`.toLowerCase();
    const matchesName = fullName.includes(nameFilter.toLowerCase());
    const matchesMobile = user.contactNo?.toLowerCase().includes(mobileFilter.toLowerCase());
