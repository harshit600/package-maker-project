          ...
          <Table className="itentable" hover>
            <thead>
              <tr style={{ background: '#f8f9fa', borderBottom: '1px solid #dee2e6' }}>
                <th style={{ padding: '15px', color: '#6b7280', fontWeight: '500' }}>City Name</th>
                <th style={{ padding: '15px', color: '#6b7280', fontWeight: '500' }}>City Area</th>
                <th style={{ padding: '15px', color: '#6b7280', fontWeight: '500' }}>Itinerary Title</th>
                <th style={{ padding: '15px', color: '#6b7280', fontWeight: '500' }}>Itinerary Description</th>
                <th style={{ padding: '15px', color: '#6b7280', fontWeight: '500' }}>Type</th>
                <th style={{ padding: '15px', color: '#6b7280', fontWeight: '500' }}>Total Hours</th>
                <th style={{ padding: '15px', color: '#6b7280', fontWeight: '500' }}>Distance</th>
                <th style={{ padding: '15px', color: '#6b7280', fontWeight: '500' }}>Status</th>
                <th style={{ padding: '15px', color: '#6b7280', fontWeight: '500' }}>Actions</th>
              </tr>
            </thead>
            <tbody>
              {currentPageData.map((item) => (
                ...
                >
                  <td style={{ padding: '15px', color: '#374151' }}>{item.cityName}</td>
                  <td style={{ padding: '15px', color: '#374151' }} className="woverflow ellipse">
                    {item.cityArea.join(", ")}
                  </td>
                  <td style={{ padding: '15px', color: '#374151' }}>{item.itineraryTitle}</td>
                  <td style={{ padding: '15px', color: '#374151' }} className="ellipse">
                    {item.itineraryDescription}
                  </td>
                  <td style={{ padding: '15px', color: '#374151' }}>{item.itineraryType}</td>
                  <td style={{ padding: '15px', color: '#374151' }}>{item.totalHours}</td>
                  <td style={{ padding: '15px', color: '#374151' }}>{item.distance}</td>
                  <td style={{ padding: '15px', color: '#374151' }}>{item.status}</td>
                  <td style={{ padding: '15px' }} className="flex text-end">
                    <span
