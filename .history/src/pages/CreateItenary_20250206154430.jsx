...
const ItineraryMaster = () => {
  ...
  const filteredResults = itineraryData.filter((item) => {
  ...
  useEffect(() => {
    ...
    setCurrentPageData(filteredResults.slice(startIndex, endIndex));
      ...
      <div className="itediv">
        ...
        >
          ...
          >
            ...
            >
              <path
                d="M4 4h16v2.5L14 13v7l-4-2v-5L4 6.5V4z"
                stroke="currentColor"
                strokeWidth="2"
                strokeLinecap="round"
        ...
        <div className="table-container">
          ...
          <div className="pagination mb-20 mt-10 text-center flex align-center justify-center">
            <Pagination>
              ...
              {Array.from(
                { length: Math.ceil(filteredResults.length / perPage) },
                (_, i) => (
                  <Pagination.Item
                    key={i + 1}
                    active={i + 1 === page}
              ...
              {filteredResults.length > perPage && (
                <Pagination.Next
                  onClick={() => handlePageChange(page + 1)}
                  disabled={
                    page === Math.ceil(filteredResults.length / perPage)
                  }
                />
              )}
            </Pagination>
