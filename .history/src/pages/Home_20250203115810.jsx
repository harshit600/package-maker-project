...
export default function Home() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        // Fetch packages from API using environment variable or direct URL
        const packagesResponse = await fetch(`${process.env.REACT_APP_API_URL || 'http://localhost:5000'}/api/packages/getpackages`);
