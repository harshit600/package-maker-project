...
import UserList from './UserList'; // Adjust the import path as necessary
      ...
      <div className="flex">
        ...
        <div className="w-1/2 pr-4">
          <div className="bg-white rounded-xl p-6 shadow-lg">
            <h2 className="text-2xl font-bold mb-4 text-gray-800">Available Packages</h2>
            {loading ? (
        ...
        <div className="w-1/2 pl-4">
          <UserList /> {/* This component should display the total users */}
        </div>
      </div>
    </div>
  );
