      ...
      <div className="flex flex-wrap justify-center gap-6 p-6 bg-gray-50">
        {isLoading ? (
          ...
          filteredPackages.map((pkg) => (
            <motion.div
              key={pkg._id}
              className="bg-white rounded-xl w-[380px] overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 relative cursor-pointer"
            ...
            >
              ...
              <div className="relative h-[200px]">
                ...
                <div className="absolute top-4 left-4">
                  <span className="bg-yellow-400 text-black px-3 py-0.5 rounded-sm text-sm font-medium">
                    FEATURED
                  </span>
                </div>

                {/* Category Tag - Science/Type */}
              ...
              <div className="p-4">
                ...
                <p className="text-gray-600 text-sm mb-4 line-clamp-2">
                  {pkg.description || `Explore the beautiful destination of ${pkg.packageName} with our carefully curated package.`}
                </p>

                {/* Admin Controls - Now at bottom */}
