...
const Packages = () => {
  ...
  const handleFilterChange = (e) => {
    ...
    const filtered = packages.filter(pkg => {
      ...
      const matchesDuration = !value || 
        (name === 'duration' ? pkg.duration.toString() === value : pkg.duration.toString() === filters.duration);
      ...
      return matchesPackageName && matchesDuration && matchesLocation && 
