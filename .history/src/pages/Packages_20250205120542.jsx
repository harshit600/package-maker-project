...
const Packages = () => {
  ...
  const handleSelectAll = (e) => {
    if (e.target.checked) {
      // Select all packages on the current page
  ...
  // Updated ImageSlider component to handle API image paths
      ...
      <div className="relative">
        {images.length > 0 && (
          <img
            ...
            src={`${config.API_HOST}/uploads/${images[currentIndex]}`} // Updated image path
        ...
        {images.length > 1 && ( // Only show navigation if there are multiple images
          <>
  ...
  return (
    <>
      <ToastContainer />
      {/* Updated Search Section with flex container */}
      <div className="p-4">
        <div className="inline-flex flex-wrap items-center gap-2 bg-white rounded-lg shadow p-3">
          {/* Date Range Inputs */}
          <input
            type="date"
            name="startDate"
            ...
            className="border border-gray-300 rounded px-3 py-1.5 text-sm focus:outline-none focus:border-blue-500 w-[140px]"
          />
          <input
            type="date"
            name="endDate"
          ...
          <select
            ...
            onChange={handleFilterChange}
            className="border border-gray-300 rounded px-3 py-1.5 text-sm w-[140px] focus:outline-none focus:border-blue-500"
          >
