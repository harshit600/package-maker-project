      ...
      <div className="flex flex-wrap justify-center gap-6 p-6 bg-gray-50">
        {isLoading ? (
          ...
          filteredPackages.map((pkg) => (
            <motion.div
              key={pkg._id}
              className="bg-white rounded-3xl w-[380px] overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 relative cursor-pointer"
            ...
            >
              ...
              <div className="relative h-[240px]">
                ...
                {/* Package Type Tag (replacing Featured Tag) */}
