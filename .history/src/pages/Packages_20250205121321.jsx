          ...
          <div className="flex flex-wrap items-center gap-2 w-full">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="bg-gray-200 text-gray-700 px-4 py-1.5 rounded text-sm hover:bg-gray-300 whitespace-nowrap"
              >
                Reset
              </button>
              <button 
                className="bg-[#2196F3] text-white px-4 py-1.5 rounded text-sm hover:bg-[#1976D2] whitespace-nowrap"
              >
                Export
              </button>
            </div>
