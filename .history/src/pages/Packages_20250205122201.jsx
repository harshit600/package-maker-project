          ...
          <div className="bg-white rounded-lg p-6 max-w-lg w-full mx-4">
            ...
            {selectedPackage && (
              <div>
                ...
                <p><strong>Location:</strong> {selectedPackage.pickupLocation}</p>
                <p><strong>Type:</strong> {selectedPackage.packageType}</p>
                <p><strong>Price:</strong> {new Intl.NumberFormat("en-IN", {
                  style: "currency",
                  currency: "INR",
                }).format(selectedPackage.initialAmount)}</p>
                <p><strong>Features:</strong> {selectedPackage.features.join(', ')}</p>
                <p><strong>Amenities:</strong> {selectedPackage.amenities.join(', ')}</p>
              </div>
            )}
