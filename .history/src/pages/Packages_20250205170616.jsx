...
const Packages = () => {
    ...
    const fetchPackages = async () => {
      try {
        ...
        const formattedData = data.map((pkg) => ({
          ...
          duration: pkg.duration, // Accessing duration directly
          pickupLocation: pkg.pickupLocation, // Accessing pickupLocation for location
          packageType: pkg.package.packageType, // Accessing packageType from the package object
          packageImages: pkg.packageImages, // Accessing packageImages directly
  ...
  const getUniqueDurations = () => {
    const durations = packages.map((pkg) => pkg.duration || 0); // Default to 0 if duration is undefined
            ...
            <tbody>
              {currentPackages.map((pkg, index) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 border-t">{pkg.dropLocation}</td>
                  <td className="px-4 py-3 border-t">
              ...
              <div>
                ...
                <p>
                  ...
                  {new Intl.NumberFormat("en-IN", {
                    style: "currency",
                    currency: "INR",
                  }).format(selectedPackage.baseTotal)}
                </p>
