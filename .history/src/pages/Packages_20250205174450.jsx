            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <p><span className="font-medium">Package Name:</span> {selectedPackage.package.packageName}</p>
                  <p><span className="font-medium">Package Type:</span> {selectedPackage.package.packageType}</p>
                  ...
                  <p><span className="font-medium">Pickup Location:</span> {selectedPackage.package.pickupLocation}</p>
                  <p><span className="font-medium">Drop Location:</span> {selectedPackage.package.dropLocation}</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div dangerouslySetInnerHTML={{ __html: selectedPackage.package.packageInclusions }} />
                </div>
                <div>
                  <h4 className="font-medium text-gray-700 mb-2">Exclusions</h4>
                  <div dangerouslySetInnerHTML={{ __html: selectedPackage.package.packageExclusions }} />
                </div>
              </div>
