            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div
                  dangerouslySetInnerHTML={{
                    __html: selectedPackage.package.packageDescription,
                  }}
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div
                    dangerouslySetInnerHTML={{
                      __html: selectedPackage.package.packageInclusions,
                    }}
                  />
                </div>
                <div>
                  ...
                  <div
                    dangerouslySetInnerHTML={{
                      __html: selectedPackage.package.packageExclusions,
                    }}
                  />
                </div>
              </div>
              ...
              {/* Amenities */}
              {selectedPackage.package.amenities &&
                selectedPackage.package.amenities.length > 0 && (
                  <div>
                    <h4 className="font-medium text-gray-700 mb-2">
                      Amenities
                    </h4>
                    <div className="flex flex-wrap gap-2">
                      {selectedPackage.package.amenities.map(
                        (amenity, index) => (
                          <span
                            key={index}
