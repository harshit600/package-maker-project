                        ...
                        <div className="border rounded-lg p-4">
                          ...
                          <div className="space-y-2">
                            <p>
                              ...
                              {selectedPackage.finalCosting.breakdown.hotelCost}
                            </p>
                            <p>
                              <span className="font-medium">
                                Transport Cost:
                        ...
                        <div className="border rounded-lg p-4">
                          ...
                          <div className="space-y-2">
                            <p>
                              ...
                              {selectedPackage.finalCosting.finalPrices.b2b}
                            </p>
                            <p>
                              <span className="font-medium">
                                Internal Price:
                            ...
                            <p>
                              ...
                              ₹
                              {selectedPackage.finalCosting.finalPrices.website}
                            </p>
                          </div>
                        </div>
                      </div>
