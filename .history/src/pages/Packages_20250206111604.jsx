                        ...
                        <div>
                          ...
                          <div className="space-y-2">
                            <p>
                              ...
                              {selectedPackage?.package?.packageName || 'N/A'}
                            </p>
                            <p>
                              <span className="font-medium">Type:</span>{" "}
                              {selectedPackage?.package?.packageType || 'N/A'}
                            </p>
                            <p>
                              <span className="font-medium">Category:</span>{" "}
                              {selectedPackage?.package?.packageCategory || 'N/A'}
                            </p>
                            <p>
                        ...
                        <div>
                          ...
                          <div className="space-y-2">
                            <p>
                              ...
                              {selectedPackage?.package?.pickupLocation || 'N/A'}
                            </p>
                            <p>
                              <span className="font-medium">Drop:</span>{" "}
                              {selectedPackage?.package?.dropLocation || 'N/A'}
                            </p>
                          </div>
                        </div>
                      </div>
                          ...
                          {selectedPackage?.package?.itineraryDays?.map((day, index) => (
                            ...
                            >
                              <h5 className="font-medium mb-2">
                                Day {day.day}:{" "}
                                {day.selectedItinerary?.itineraryTitle || 'N/A'}
                              </h5>
                              <p className="text-gray-600">
                                {day.selectedItinerary?.itineraryDescription || 'N/A'}
                              </p>
                            </div>
                        ...
                        {Object.entries(selectedPackage?.hotels || {}).map(
                          ([key, hotel]) => (
                            <div key={key} className="border rounded-lg p-4">
                              <h5 className="font-medium mb-2">{hotel.name || 'N/A'}</h5>
                          ...
                          {(selectedPackage?.sightseeing || []).map((sight, index) => (
                            <div key={index} className="border rounded-lg p-4">
                              ...
                              <p className="text-gray-600 mb-2">
                                {sight.description || 'No description available'}
                              </p>
                        ...
                        <div className="border rounded-lg p-4">
                          ...
                          <div className="space-y-2">
                            <p>
                              ...
                              {selectedPackage?.finalCosting?.breakdown?.hotelCost || 'N/A'}
                            </p>
                            <p>
                              <span className="font-medium">
                                Transport Cost:
                            ...
                            <p className="text-lg font-medium mt-4">
                              Total Base Cost: ₹
                              {selectedPackage?.finalCosting?.baseTotal || 'N/A'}
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="border rounded-lg p-4">
                          ...
                          <div className="space-y-2">
                            <p>
                              ...
                              {selectedPackage?.finalCosting?.finalPrices?.b2b || 'N/A'}
                            </p>
                            <p>
                              <span className="font-medium">
                                Internal Price:
                            ...
                            <p>
                              ...
                              ₹
                              {selectedPackage?.finalCosting?.finalPrices?.website || 'N/A'}
                            </p>
                          </div>
                        </div>
                      </div>
