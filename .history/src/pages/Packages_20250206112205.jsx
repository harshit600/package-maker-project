          ...
          {showPackageModal && selectedPackage && (
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
              <div className="bg-white rounded-xl w-full max-w-6xl max-h-[90vh] overflow-hidden shadow-2xl">
                ...
                <div className="border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
                  <div className="flex items-center justify-between p-4">
                    <h3 className="text-2xl font-semibold text-gray-800">
                      {selectedPackage?.package?.packageName || 'Package Details'}
                    </h3>
                    <button
                    ...
                    {[
                      ...
                      <button
                        ...
                        className={`
                          ...
                          ${activeTab === tab.id
                            ? 'bg-white text-blue-600 shadow-[0_0_10px_rgba(0,0,0,0.1)] relative before:absolute before:bottom-0 before:left-0 before:w-full before:h-0.5 before:bg-blue-600'
                ...
                <div className="p-6 overflow-y-auto bg-gradient-to-b from-white to-gray-50" style={{ maxHeight: 'calc(90vh - 150px)' }}>
                  {activeTab === 'package' && (
                    <div className="space-y-8">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                          <div className="flex items-center gap-3 mb-4">
                            <span className="p-2 bg-blue-100 rounded-lg text-blue-600 text-xl">📋</span>
                          ...
                          <div className="space-y-3">
                            {[
                              ...
                              ['Category', selectedPackage?.package?.packageCategory],
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                          <div className="flex items-center gap-3 mb-4">
                            <span className="p-2 bg-green-100 rounded-lg text-green-600 text-xl">📍</span>
                            <h4 className="text-lg font-semibold text-gray-900">Locations</h4>
                          </div>
                          <div className="space-y-3">
                            {[
                              ['Pickup', selectedPackage?.package?.pickupLocation],
                              ['Drop', selectedPackage?.package?.dropLocation],
                              ['Transfer', selectedPackage?.package?.pickupTransfer ? 'Yes' : 'No'],
                            ].map(([label, value]) => (
                              <div key={label} className="flex justify-between items-center py-2 border-b border-gray-100">
                                <span className="text-gray-600">{label}</span>
                                <span className="font-medium text-gray-900">{value || 'N/A'}</span>
                      ...
                      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <h4 className="text-lg font-semibold text-gray-900">Places Covered</h4>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          {selectedPackage?.package?.packagePlaces?.map((place, index) => (
                            <div key={index} className="bg-gray-50 rounded-lg p-4 border border-gray-100">
                              <h5 className="font-semibold text-gray-900 mb-2">{place.placeCover}</h5>
                              <div className="space-y-1 text-sm">
                                <p className="text-gray-600">Nights: <span className="text-gray-900 font-medium">{place.nights}</span></p>
                                <p className="text-gray-600">Transfer: <span className="text-gray-900 font-medium">{place.transfer ? 'Yes' : 'No'}</span></p>
                              </div>
                            </div>
                          ))}
                        </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                          <div className="flex items-center gap-3 mb-4">
                            <span className="p-2 bg-indigo-100 rounded-lg text-indigo-600 text-xl">🎨</span>
                            <h4 className="text-lg font-semibold text-gray-900">Themes</h4>
                          </div>
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                          <div className="flex items-center gap-3 mb-4">
                            <span className="p-2 bg-blue-100 rounded-lg text-blue-600 text-xl">🏷️</span>
                      ...
                      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                        <div className="flex items-center gap-3 mb-6">
                          <span className="p-2 bg-orange-100 rounded-lg text-orange-600 text-xl">📅</span>
                        ...
                        <div className="space-y-6">
                          {selectedPackage?.package?.itineraryDays?.map((day, index) => (
                            <div key={index} className="relative pl-8 pb-6">
                              ...
                              <div className="absolute left-[-8px] top-0 w-4 h-4 rounded-full bg-blue-500 border-4 border-white shadow"></div>
                              
                              <div className="bg-gray-50 rounded-lg p-4">
                                <h5 className="text-lg font-semibold text-gray-900 mb-2">
                                  Day {day.day}: {day.selectedItinerary?.itineraryTitle}
                                </h5>
                                <p className="text-blue-600 mb-2">📍 {day.selectedItinerary?.cityName}</p>
                                ...
                                <div className="flex gap-4 mt-3 text-sm text-gray-500">
                                  {day.selectedItinerary?.distance && (
                                    <span className="flex items-center gap-1">
                                      <span>🚗</span> {day.selectedItinerary.distance} km
                                    </span>
                                  )}
                                  {day.selectedItinerary?.totalHours && (
                                    <span className="flex items-center gap-1">
                                      <span>⏱️</span> {day.selectedItinerary.totalHours} hours
                                    </span>
                                  )}
                                </div>
                              </div>
