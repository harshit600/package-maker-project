          ...
          {showPackageModal && selectedPackage && (
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
              <div className="bg-white rounded-xl w-full max-w-6xl max-h-[90vh] overflow-hidden shadow-2xl">
                ...
                <div
                  className="p-6 overflow-y-auto bg-gradient-to-b from-white to-gray-50"
                  ...
                  {activeTab === "package" && (
                    <div className="space-y-8">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                          <div className="flex items-center gap-3 mb-4">
                            <span className="p-2 bg-green-100 rounded-lg text-green-600 text-xl">
                              📍
                            </span>
                            <h4 className="text-lg font-semibold text-gray-900">
                              Locations
                      ...
                      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                        <div className="flex items-center gap-3 mb-4">
                          <span className="p-2 bg-purple-100 rounded-lg text-purple-600 text-xl">
                            🗺️
                          </span>
                          <h4 className="text-lg font-semibold text-gray-900">
                            Places Covered
                      ...
                      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                        <div className="flex items-center gap-3 mb-6">
                          <span className="p-2 bg-orange-100 rounded-lg text-orange-600 text-xl">
                            📅
                          </span>
                          <h4 className="text-lg font-semibold text-gray-900">
                            Itinerary
