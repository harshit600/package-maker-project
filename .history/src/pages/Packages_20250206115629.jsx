                    ...
                    <div className="space-y-8">
                      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                        <div className="flex items-center gap-3 mb-6">
                          ...
                          <h4 className="text-lg font-semibold text-[rgb(45,45,68)]">Selected Vehicles</h4>
                        </div>
                        
                        {Object.entries(selectedPackage?.cabs?.travelPrices?.selectedCabs || {}).map(([cabType, cabs]) => (
                          <div key={cabType} className="mb-8">
                            <h5 className="text-lg font-medium text-[rgb(45,45,68)] mb-4">{cabType}</h5>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                              {cabs.map((cab, index) => (
                                <div key={index} className="bg-gray-50 rounded-xl overflow-hidden border border-gray-200">
                                  ...
                                  {/* Cab Details */}
                                  <div className="p-4">
                                    <h6 className="font-medium text-[rgb(45,45,68)] mb-2">{cab.cabName}</h6>
                                    <div className="space-y-2 text-sm">
                                      <p className="flex justify-between">
                                        <span className="text-gray-600">Type:</span>
                                        <span className="font-medium">{cab.cabType}</span>
                                      </p>
                                      <p className="flex justify-between">
                                      ...
                                      <p className="flex justify-between">
                                        <span className="text-gray-600">Luggage:</span>
                                          <span className="font-medium">{cab.luggage}</span>
                                      </p>
                                      <div className="pt-2 border-t border-gray-200 mt-2">
                                        <p className="flex justify-between text-[rgb(45,45,68)]">
                                          <span className="font-medium">Price:</span>
                                          <span className="font-bold">₹{cab.prices.onSeasonPrice}</span>
                                        </p>
                                      </div>
                                    </div>
                                  </div>
                  ...
                  {activeTab === "hotel" && (
                    <div className="space-y-8">
                      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                        <div className="flex items-center gap-3 mb-6">
                          <span className="p-2 bg-gray-100 rounded-lg text-[rgb(45,45,68)] text-xl">🏨</span>
                          <h4 className="text-lg font-semibold text-[rgb(45,45,68)]">Hotels</h4>
                        </div>
                        
                        <div className="grid grid-cols-1 gap-8">
                          {Object.values(selectedPackage?.hotels || {}).map((hotel, index) => (
                            <div key={index} className="bg-gray-50 rounded-xl overflow-hidden border border-gray-200">
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div className="md:col-span-2 p-6">
                                  <h5 className="text-xl font-semibold text-[rgb(45,45,68)] mb-4">{hotel.name}</h5>
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-3">
                                      <p className="flex justify-between">
                                        <span className="text-gray-600">Room Size:</span>
                                        <span className="font-medium">{hotel.details?.roomSize} sq ft</span>
                                      </p>
                                      <p className="flex justify-between">
                                        <span className="text-gray-600">Bed Type:</span>
                                        <span className="font-medium">{hotel.details?.bedType}</span>
                                      </p>
                                      <p className="flex justify-between">
                                        <span className="text-gray-600">View:</span>
                                        <span className="font-medium">{hotel.details?.roomView}</span>
                                      </p>
                                      <p className="flex justify-between">
                                        <span className="text-gray-600">Meal Plan:</span>
                                        <span className="font-medium">{hotel.meal}</span>
                                      </p>
                                    </div>
                                    
                                    {/* Amenities */}
                                    <div>
                                      <h6 className="font-medium text-[rgb(45,45,68)] mb-3">Amenities</h6>
                                  ...
                                  <div className="mt-6 pt-4 border-t border-gray-200">
                                    <div className="flex justify-between items-center">
                                      ...
                                      <span className="text-xl font-bold text-[rgb(45,45,68)]">₹{hotel.price}</span>
                                    </div>
                                  </div>
                                </div>
                              </div>
