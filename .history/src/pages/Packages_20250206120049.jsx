                      ...
                      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                        ...
                        {Object.entries(
                          ...
                          <div key={cabType} className="mb-8">
                            <h5 className="text-lg font-medium text-[rgb(45,45,68)] mb-4">
                              {cabType}
                            </h5>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                              {cabs.map((cab, index) => (
                                ...
                                >
                                  ...
                                  {/* Cab Details */}
                                  <div className="p-4">
                                    <h6 className="font-medium text-[rgb(45,45,68)] mb-2">
                                      {cab.cabName}
                                    </h6>
                                    <div className="space-y-2 text-sm">
                                      ...
                                      <div className="pt-2 border-t border-gray-200 mt-2">
                                        <p className="flex justify-between text-[rgb(45,45,68)]">
                                          <span className="font-medium">
                                            Price:
                                          </span>
                    ...
                    <div className="space-y-8">
                      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                        ...
                        <div className="grid grid-cols-1 gap-8">
                          {Object.values(selectedPackage?.hotels || {}).map(
                            (hotel, index) => (
                              <div
                                key={index}
                                className="bg-gray-50 rounded-xl overflow-hidden border border-gray-200"
                              >
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                  ...
                                  <div className="md:col-span-2 p-6">
                                    <h5 className="text-xl font-semibold text-[rgb(45,45,68)] mb-4">
                                      {hotel.name}
                                    </h5>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                      <div className="space-y-3">
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-[rgb(45,45,68)] to-[rgb(55,55,88)] rounded-xl p-8 text-white shadow-xl">
                        <div className="flex items-center justify-between mb-6">
                          ...
                          <div className="px-4 py-2 bg-white/10 rounded-lg backdrop-blur-sm">
                            ...
                            <span className="font-mono">{selectedPackage?._id?.slice(-6)}</span>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                          <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm">
                            ...
                            <div className="text-2xl font-bold">₹{selectedPackage?.finalCosting?.finalPrices?.b2b || '0'}</div>
                            <div className="text-white/40 text-sm">Per person</div>
                          </div>
                          <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm">
                            <div className="text-white/60 mb-2">Internal Price</div>
                            <div className="text-2xl font-bold">₹{selectedPackage?.finalCosting?.finalPrices?.internal || '0'}</div>
                            <div className="text-white/40 text-sm">Per person</div>
                          </div>
                          <div className="bg-gradient-to-r from-white/20 to-white/10 rounded-xl p-4 backdrop-blur-sm border border-white/10">
                            ...
                            <div className="text-3xl font-bold">₹{selectedPackage?.finalCosting?.finalPrices?.website || '0'}</div>
                            <div className="text-white/40 text-sm">Per person</div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                          ...
                          <div className="p-6 space-y-4">
                            {[
                              { label: 'Hotel Cost', value: selectedPackage?.finalCosting?.breakdown?.hotelCost, icon: '🏨' },
                              { label: 'Transport Cost', value: selectedPackage?.finalCosting?.breakdown?.transportCost, icon: '🚗' },
                              { label: 'Activities Cost', value: selectedPackage?.finalCosting?.breakdown?.activitiesTotalCost, icon: '🎯' },
                              { label: 'Additional Cost', value: selectedPackage?.finalCosting?.breakdown?.additionalCost, icon: '➕' },
                            ].map((item, index) => (
                              <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                ...
                                <span className="font-semibold text-[rgb(45,45,68)]">₹{item.value || '0'}</span>
                              </div>
                            ))}
                            <div className="pt-4 mt-4 border-t border-dashed border-gray-200">
                              <div className="flex items-center justify-between">
                                <span className="text-lg font-medium text-[rgb(45,45,68)]">Total Base Cost</span>
                                <span className="text-xl font-bold text-[rgb(45,45,68)]">
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                          <div className="bg-[rgb(45,45,68)] p-4 text-white">
                            <div className="flex items-center gap-3">
                              <span className="p-2 bg-white/10 rounded-lg text-xl">📊</span>
                              <h4 className="text-lg font-semibold">Markup & Taxes</h4>
                            </div>
                          </div>
                          <div className="p-6 space-y-4">
                            {/* Markup Details */}
                            <div className="space-y-3">
                              ...
                              <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                ...
                                <span className="font-semibold text-[rgb(45,45,68)]">
                                  ₹{selectedPackage?.finalCosting?.markupAmount || '0'}
                                </span>
                              </div>
                            </div>
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                                ...
                                <span className="font-semibold text-[rgb(45,45,68)]">
                                  ₹{selectedPackage?.finalCosting?.gstAmount || '0'}
                                </span>
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        <div className="bg-[rgb(45,45,68)] p-4 text-white">
                          <div className="flex items-center gap-3">
                            <span className="p-2 bg-white/10 rounded-lg text-xl">📝</span>
                            <h4 className="text-lg font-semibold">Payment Terms</h4>
                          </div>
                        </div>
                        <div className="p-6">
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="p-4 bg-gray-50 rounded-lg">
                              ...
                              <div className="text-lg font-semibold text-[rgb(45,45,68)]">50%</div>
                              <div className="text-sm text-gray-500">Due at booking</div>
                            </div>
                            <div className="p-4 bg-gray-50 rounded-lg">
                              <div className="text-sm text-gray-600 mb-1">Second Payment</div>
                              <div className="text-lg font-semibold text-[rgb(45,45,68)]">30%</div>
                              <div className="text-sm text-gray-500">Due before travel</div>
                            </div>
                            <div className="p-4 bg-gray-50 rounded-lg">
                              <div className="text-sm text-gray-600 mb-1">Final Payment</div>
                              <div className="text-lg font-semibold text-[rgb(45,45,68)]">20%</div>
                              <div className="text-sm text-gray-500">Due on arrival</div>
                            </div>
                          </div>
                        </div>
                      </div>
