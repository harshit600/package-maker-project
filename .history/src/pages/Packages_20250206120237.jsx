                  ...
                  {activeTab === "hotel" && (
                    <div className="space-y-8">
                        ...
                        <div className="flex items-center justify-between mb-6">
                          ...
                          <div className="flex gap-4">
                            ...
                            <div className="px-4 py-2 bg-white/10 rounded-lg backdrop-blur-sm">
                              ...
                              <span className="font-mono">{Object.keys(selectedPackage?.hotels || {}).length - 1}</span>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 gap-8">
                        {Object.entries(selectedPackage?.hotels || {}).map(([key, hotel], index) => (
                          key !== 'totalNights' && (
                            <div key={index} className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200 hover:shadow-xl transition-shadow">
                                ...
                                <div className="md:col-span-2 space-y-6">
                                  ...
                                  <div className="grid grid-cols-2 gap-4">
                                    <div className="bg-gray-50 rounded-xl p-4">
                                      <h6 className="text-sm text-gray-500 mb-2">Room Type</h6>
                                      <p className="font-medium text-[rgb(45,45,68)]">{hotel.details?.roomType || 'Standard'}</p>
                                    </div>
                                    <div className="bg-gray-50 rounded-xl p-4">
                                      <h6 className="text-sm text-gray-500 mb-2">Room Size</h6>
                                      <p className="font-medium text-[rgb(45,45,68)]">{hotel.details?.roomSize || 'N/A'} sq ft</p>
                                    </div>
                                    <div className="bg-gray-50 rounded-xl p-4">
                                      <h6 className="text-sm text-gray-500 mb-2">Bed Type</h6>
                                      <p className="font-medium text-[rgb(45,45,68)]">{hotel.details?.bedType || 'N/A'}</p>
                                    </div>
                                    <div className="bg-gray-50 rounded-xl p-4">
                                      <h6 className="text-sm text-gray-500 mb-2">View</h6>
                                      <p className="font-medium text-[rgb(45,45,68)]">{hotel.details?.roomView || 'City View'}</p>
                                    </div>
                                  </div>

                                  {/* Amenities */}
                                  <div>
                                    <h6 className="font-medium text-[rgb(45,45,68)] mb-4">Room Amenities</h6>
                                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                                      {Object.entries(hotel.details?.amenities || {}).map(([amenity, value]) => (
                                        value === "Yes" && (
                                          <div key={amenity} className="flex items-center gap-2 bg-gray-50 px-3 py-2 rounded-lg">
                                  ...
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t border-gray-200">
                                    <div>
                                      ...
                                      <div className="text-2xl font-bold text-[rgb(45,45,68)]">₹{hotel.price}</div>
                                      <div className="text-sm text-gray-500">{hotel.meal} included</div>
                                    </div>
                                    <div className="space-y-2">
                                      <div className="flex justify-between text-sm">
                                        <span className="text-gray-500">Check-in</span>
                                        <span className="font-medium text-[rgb(45,45,68)]">{hotel.checkIn || '2:00 PM'}</span>
                                      </div>
                                      <div className="flex justify-between text-sm">
                                        <span className="text-gray-500">Check-out</span>
                                        <span className="font-medium text-[rgb(45,45,68)]">{hotel.checkOut || '11:00 AM'}</span>
                                      </div>
                                      <div className="flex justify-between text-sm">
                              ...
                              <div className="border-t border-gray-200 p-6 bg-gray-50">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                  <div>
                                    <h6 className="font-medium text-[rgb(45,45,68)] mb-3">Location Highlights</h6>
                                    <div className="space-y-2">
                                      ...
                                      <p className="text-sm flex items-center gap-2">
                                        <span>🚗</span>
                                        <span>Distance from airport: {hotel.distanceFromAirport || 'N/A'}</span>
                                      </p>
                                      <p className="text-sm flex items-center gap-2">
                                        <span>🏛️</span>
                                        <span>Nearby landmarks available</span>
                                      </p>
                                    </div>
                                  </div>
                                  <div>
                                    <h6 className="font-medium text-[rgb(45,45,68)] mb-3">Hotel Policies</h6>
                                    <div className="space-y-2 text-sm">
                                      <p>• Passport, Government ID or Driver's license required</p>
                                      <p>• No pets allowed</p>
