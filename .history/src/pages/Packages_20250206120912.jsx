                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6">
                                  ...
                                  <div className="md:col-span-1 space-y-4">
                                    ...
                                    <div className="space-y-4">
                                      <h6 className="font-medium text-[rgb(45,45,68)]">Available Rooms</h6>
                                          ...
                                          >
                                            <div className="grid grid-cols-3 gap-4 p-4">
                                              ...
                                              <div className="col-span-2 flex flex-col justify-between">
                                                <div>
                                                  <h6 className="font-medium text-[rgb(45,45,68)]">{room.name}</h6>
                                                  <p className="text-sm text-gray-600 mt-1">Room ID: {room.id.slice(-6)}</p>
                                                </div>
                                                <div className="flex justify-between items-center mt-2">
                                                  <span className="text-sm text-gray-600">Price per night</span>
                                                  <span className="font-semibold text-[rgb(45,45,68)]">₹{room.price}</span>
                                                </div>
                                              </div>
                                            </div>
                                          </div>
          ...
          {selectedRoom && (
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
              <div className="bg-white rounded-xl w-full max-w-3xl overflow-hidden shadow-2xl">
                ...
                <div className="bg-[rgb(45,45,68)] p-4 text-white">
                  <div className="flex items-center justify-between">
                    <h4 className="text-lg font-semibold">{selectedRoom.name}</h4>
                    <button 
                ...
                <div className="p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      <div>
                        <h5 className="text-lg font-semibold text-[rgb(45,45,68)]">{selectedRoom.name}</h5>
                        <p className="text-sm text-gray-600 mt-1">Room ID: {selectedRoom.id}</p>
                      </div>

                      <div className="space-y-2">
                        <div className="flex justify-between items-center py-2 border-b border-gray-100">
                          <span className="text-gray-600">Price per night</span>
                          <span className="font-semibold text-[rgb(45,45,68)]">₹{selectedRoom.price}</span>
                        </div>
                        
                        {/* Add more room details here based on your data structure */}
                        <div className="flex justify-between items-center py-2 border-b border-gray-100">
                          <span className="text-gray-600">Room Size</span>
                          <span className="font-medium text-[rgb(45,45,68)]">{selectedRoom.size || 'N/A'}</span>
                        </div>
                        <div className="flex justify-between items-center py-2 border-b border-gray-100">
                          <span className="text-gray-600">Bed Type</span>
                          <span className="font-medium text-[rgb(45,45,68)]">{selectedRoom.bedType || 'N/A'}</span>
                        </div>
                        <div className="flex justify-between items-center py-2 border-b border-gray-100">
                          <span className="text-gray-600">View</span>
                          <span className="font-medium text-[rgb(45,45,68)]">{selectedRoom.view || 'N/A'}</span>
                        </div>
                      </div>

                      {/* Room Amenities */}
                      <div>
                        <h6 className="font-medium text-[rgb(45,45,68)] mb-3">Room Amenities</h6>
