                ...
                >
                  ...
                  {activeTab === "sightseeing" && (
                    <div className="space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-[rgb(45,45,68)] to-[rgb(55,55,88)] rounded-xl p-8 text-white shadow-xl">
                        <div className="flex items-center justify-between mb-6">
                          <h3 className="text-2xl font-bold">Sightseeing Places</h3>
                          <div className="px-4 py-2 bg-white/10 rounded-lg backdrop-blur-sm">
                            <span className="text-sm font-medium">Total Places: </span>
                            <span className="font-mono">{selectedPackage?.sightseeing?.length || 0}</span>
                          </div>
                        </div>
                      </div>
                      ...
                      {/* Sightseeing Grid */}
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {selectedPackage?.sightseeing?.map((place) => (
                          <div 
                            key={place._id}
                          ...
                          >
                            ...
                            <div className="aspect-video relative group">
                              ...
                              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                                <h4 className="text-white font-semibold text-lg">{place.placeName}</h4>
                                <p className="text-white/80 text-sm flex items-center gap-2">
                                  <span>📍</span> {place.city}, {place.stateName}
                                </p>
                              </div>
                            </div>
                            ...
                            <div className="p-4 space-y-4">
                              ...
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  <span className="px-3 py-1 bg-[rgb(45,45,68)]/10 rounded-full text-sm text-[rgb(45,45,68)]">
                                    Day {place.dayNumber}
                                  </span>
                                  {place.paid && (
                              ...
                              {/* Vehicle Costs */}
                              {Object.entries(place.cost || {}).some(([_, value]) => value) && (
                                <div className="pt-3 border-t border-gray-100">
                                  <h6 className="text-sm font-medium text-[rgb(45,45,68)] mb-2">
                                    Transport Costs
                                  </h6>
                                  <div className="grid grid-cols-3 gap-2">
                                    {Object.entries(place.cost).map(([vehicle, cost]) => 
                                      cost && (
                                        <div key={vehicle} className="text-center p-2 bg-gray-50 rounded-lg">
                                          <span className="text-xs text-gray-600 block">{vehicle}</span>
                                          <span className="font-medium text-[rgb(45,45,68)]">₹{cost}</span>
                                        </div>
                                      )
                                    )}
                                  </div>
                      ...
                      {(!selectedPackage?.sightseeing || selectedPackage.sightseeing.length === 0) && (
                        <div className="text-center py-12">
                          ...
                          <h3 className="text-lg font-medium text-gray-900 mb-2">No Sightseeing Places</h3>
                          <p className="text-gray-500">No sightseeing places have been added to this package yet.</p>
                        </div>
                      )}
                    </div>
                  )}
