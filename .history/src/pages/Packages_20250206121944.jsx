                    ...
                    <div className="space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-[rgb(45,45,68)] to-[rgb(55,55,88)] rounded-xl p-8 text-white shadow-xl">
                        <div className="flex items-center justify-between mb-6">
                          <div>
                            <h3 className="text-2xl font-bold mb-2">Transport Details</h3>
                            <p className="text-white/80">Selected vehicles for your journey</p>
                          </div>
                          <div className="flex gap-4">
                            <div className="px-4 py-2 bg-white/10 rounded-lg backdrop-blur-sm">
                              <span className="text-sm font-medium">Total Vehicles: </span>
                              <span className="font-mono">
                                {Object.values(selectedPackage?.cabs?.travelPrices?.selectedCabs || {}).flat().length}
                              </span>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="space-y-6">
                        {Object.entries(selectedPackage?.cabs?.travelPrices?.selectedCabs || {}).map(([cabType, cabs]) => (
                          <div key={cabType} className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
                            {/* Category Header */}
                            <div className="bg-[rgb(45,45,68)] p-4 text-white">
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                  <span className="p-2 bg-white/10 rounded-lg text-xl">🚗</span>
                                  <h4 className="text-lg font-semibold">{cabType}</h4>
                                </div>
                                <span className="px-3 py-1 bg-white/10 rounded-full text-sm">
                                  {cabs.length} {cabs.length === 1 ? 'Vehicle' : 'Vehicles'}
                                </span>
                              </div>
                            </div>
                            ...
                            <div className="p-6">
                              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {cabs.map((cab, index) => (
                                  <div key={index} className="group relative bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 border border-gray-200">
                                    {/* Cab Image */}
                                    <div className="aspect-[4/3] relative overflow-hidden bg-gray-100">
                                      {cab.imageUrl ? (
                                        ...
                                        <div className="w-full h-full flex items-center justify-center text-4xl">
                                          {cabType.includes('SUV') ? '🚙' : cabType.includes('Traveller') ? '🚐' : '🚗'}
                                        </div>
                                      )}
                                      {/* Price Badge */}
                                      <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full shadow-lg">
                                        <span className="text-[rgb(45,45,68)] font-semibold">₹{cab.prices.onSeasonPrice}</span>
                                      </div>
                                    </div>
                                    ...
                                    <div className="p-4 space-y-4">
                                      {/* Name and Type */}
                                      <div>
                                        <h5 className="text-lg font-semibold text-[rgb(45,45,68)] mb-1">{cab.cabName}</h5>
                                      ...
                                      <div className="grid grid-cols-2 gap-3 pt-3 border-t border-gray-100">
                                        <div className="flex items-center gap-2">
                                          ...
                                          <div>
                                            ...
                                            <p className="text-sm font-medium text-[rgb(45,45,68)]">{cab.seatingCapacity} Persons</p>
                                          </div>
                                        </div>
                                        <div className="flex items-center gap-2">
                                          <span className="p-1.5 bg-gray-100 rounded-lg">🧳</span>
                                          <div>
                                            ...
                                            <p className="text-sm font-medium text-[rgb(45,45,68)]">{cab.luggage}</p>
                                          </div>
                                        </div>
                                      </div>
                                      ...
                                      <div className="flex flex-wrap gap-2 pt-3 border-t border-gray-100">
                                        {cab.AC && (
                                          <span className="px-3 py-1 bg-blue-50 text-blue-700 rounded-full text-xs">AC</span>
                                        )}
                                        {cab.musicSystem && (
                                          <span className="px-3 py-1 bg-purple-50 text-purple-700 rounded-full text-xs">Music System</span>
                                        )}
                                        {cab.pushbackSeats && (
                                          <span className="px-3 py-1 bg-green-50 text-green-700 rounded-full text-xs">Pushback Seats</span>
                                        )}
                                      </div>
                                      ...
                                      <div className="pt-3 border-t border-gray-100">
                                        <div className="flex justify-between items-center text-sm">
                                          ...
                                          <span className="font-medium text-[rgb(45,45,68)]">₹{cab.prices.offSeasonPrice}</span>
                                        </div>
                                        <div className="flex justify-between items-center text-sm mt-1">
                                          <span className="text-gray-500">Peak Season</span>
                                          <span className="font-medium text-[rgb(45,45,68)]">₹{cab.prices.peakSeasonPrice}</span>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                      ...
                      {(!selectedPackage?.cabs?.travelPrices?.selectedCabs || 
                        Object.keys(selectedPackage?.cabs?.travelPrices?.selectedCabs).length === 0) && (
                        <div className="text-center py-12">
                          <div className="text-4xl mb-4">🚗</div>
                          <h3 className="text-lg font-medium text-gray-900 mb-2">No Vehicles Selected</h3>
                          <p className="text-gray-500">No vehicles have been added to this package yet.</p>
                        </div>
                      )}
                    </div>
                  )}
