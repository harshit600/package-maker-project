                    ...
                    <div className="space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-[rgb(45,45,68)] to-[rgb(55,55,88)] rounded-xl p-8 text-white shadow-xl">
                        <div className="flex items-center justify-between mb-6">
                          <div>
                            <h3 className="text-2xl font-bold mb-2">{selectedPackage?.package?.packageName || "Package Details"}</h3>
                            <p className="text-white/80">{selectedPackage?.package?.packageCategory} Package</p>
                          </div>
                          <div className="flex gap-4">
                            <div className="px-4 py-2 bg-white/10 rounded-lg backdrop-blur-sm">
                              <span className="text-sm font-medium">Duration: </span>
                              <span className="font-mono">{selectedPackage?.package?.duration || "N/A"}</span>
                            </div>
                            <div className="px-4 py-2 bg-white/10 rounded-lg backdrop-blur-sm">
                              <span className="text-sm font-medium">Status: </span>
                              <span className={`font-mono ${selectedPackage?.package?.status === 'Active' ? 'text-green-300' : 'text-yellow-300'}`}>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                          <div className="flex items-center gap-3 mb-4">
                            ...
                            <h4 className="text-lg font-semibold text-[rgb(45,45,68)]">Package Details</h4>
                          </div>
                              ...
                              <div key={index} className="bg-gray-50 rounded-lg p-4 border border-gray-100">
                                ...
                                <div className="space-y-1 text-sm">
                                  <p className="text-gray-600">
                                    Nights: <span className="text-gray-900 font-medium">{place.nights}</span>
                                  </p>
                                  <p className="text-gray-600">
                                    Transfer: <span className="text-gray-900 font-medium">{place.transfer ? "Yes" : "No"}</span>
                                  </p>
                                </div>
                              </div>
                            ))}
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {selectedPackage?.package?.themes?.map((theme, index) => (
                              <span key={index} className="px-4 py-2 bg-gray-100 text-[rgb(45,45,68)] rounded-full text-sm font-medium">
                                {theme}
                              </span>
                            ))}
                          </div>
                        ...
                        <div className="md:col-span-2 bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                          <div className="flex items-center gap-3 mb-6">
                            <span className="p-2 bg-gray-100 rounded-lg text-[rgb(45,45,68)] text-xl">📅</span>
                            <h4 className="text-lg font-semibold text-[rgb(45,45,68)]">Itinerary</h4>
                          </div>
