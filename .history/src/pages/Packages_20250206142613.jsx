            ...
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
              <div className="bg-white rounded-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl">
                <div className="bg-[rgb(45,45,68)] p-4 text-white sticky top-0 z-10">
                  <div className="flex items-center justify-between">
                    <h4 className="text-lg font-semibold">{selectedHotel.name}</h4>
                    <button
                ...
                <div className="p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      ...
                      {/* Location */}
                      <div className="space-y-2">
                        <h6 className="font-medium text-[rgb(45,45,68)]">Location</h6>
                        <p className="text-sm text-gray-600">
                          {typeof selectedHotel.location === 'object'
                            ? `${selectedHotel.location.address || ''}, ${selectedHotel.location.city || ''}, ${selectedHotel.location.state || ''}, ${selectedHotel.location.country || ''}`
                            : (selectedHotel.location || 'Location not specified')}
                        </p>
                      ...
                      {/* Room Details */}
                      <div className="space-y-2">
                        <h6 className="font-medium text-[rgb(45,45,68)]">Room Details</h6>
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div className="bg-gray-50 p-3 rounded-lg">
                            ...
                            <p className="font-medium text-[rgb(45,45,68)]">
                              {selectedHotel.details?.bedType || 'Not specified'}
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <p className="text-sm text-gray-500">{selectedHotel.meal} included</p>
                      </div>

                      {/* Amenities */}
                      {selectedHotel.details?.amenities && (
                        <div className="space-y-2">
                          <h6 className="font-medium text-[rgb(45,45,68)]">Amenities</h6>
                          <div className="grid grid-cols-2 gap-2">
                            {Object.entries(selectedHotel.details.amenities).map(
                              ([amenity, value]) =>
                                value === 'Yes' && (
                                  <div
                                    key={amenity}
