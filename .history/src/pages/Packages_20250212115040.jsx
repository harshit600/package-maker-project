  ...
  {showEditModal && editPackageData && (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl w-full max-w-6xl max-h-[90vh] overflow-hidden shadow-2xl">
        ...
        {/* Modal Content - Same structure as view modal */}
        <div
          className="p-6 overflow-y-auto"
          style={{ maxHeight: "calc(90vh - 150px)" }}
        >
          {/* Use the same content structure as the view modal, but make fields editable */}
          {/* You'll need to add form fields and handlers for each tab's content */}
          {/* This is where you'll implement the edit functionality */}
        </div>
