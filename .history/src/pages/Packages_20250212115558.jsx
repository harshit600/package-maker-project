      ...
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-xl w-full max-w-6xl max-h-[90vh] overflow-hidden shadow-2xl">
          ...
          <div className="p-6 overflow-y-auto" style={{ maxHeight: "calc(90vh - 150px)" }}>
            ...
            {activeTab === "cab" && (
              <div className="space-y-6">
                {/* Cab details editing form */}
                <h4 className="text-lg font-semibold">Cab Details</h4>
                {/* Add cab editing fields */}
              </div>
            )}

            {activeTab === "hotel" && (
              <div className="space-y-6">
                {/* Hotel details editing form */}
                <h4 className="text-lg font-semibold">Hotel Details</h4>
                {/* Add hotel editing fields */}
              </div>
            )}

            {activeTab === "sightseeing" && (
              <div className="space-y-6">
                {/* Sightseeing details editing form */}
                <h4 className="text-lg font-semibold">Sightseeing Details</h4>
                {/* Add sightseeing editing fields */}
              </div>
            )}

            {activeTab === "costing" && (
              <div className="space-y-6">
                {/* Costing details editing form */}
                <h4 className="text-lg font-semibold">Costing Details</h4>
                {/* Add costing editing fields */}
              </div>
            )}
          </div>
