              ...
              >
                {activeTab === "package" && (
                  <div className="space-y-8">
                    ...
                    {/* Places Covered */}
                    <div className="bg-gray-50 p-6 rounded-lg">
                      <h4 className="text-lg font-semibold mb-4">Places Covered</h4>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="bg-gray-50 p-6 rounded-lg">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {editPackageData?.package?.themes?.map((theme, index) => (
                            <div key={index} className="flex items-center gap-2">
                              <input
                                type="text"
                                value={theme}
                                onChange={(e) => {
                                  const updatedThemes = [...editPackageData.package.themes];
                              ...
                              <button
                                onClick={() => {
                                  const updatedThemes = editPackageData.package.themes.filter((_, i) => i !== index);
                                  setEditPackageData({
                                    ...editPackageData,
                                    package: {
                                      ...editPackageData.package,
                          ...
                          <button
                            onClick={() => {
                              setEditPackageData({
                                ...
                                package: {
                                  ...editPackageData.package,
                                  themes: [...(editPackageData.package.themes || []), ""],
                                },
                              });
                            }}
                          ...
                          {editPackageData?.package?.tags?.map((tag, index) => (
                            <div key={index} className="flex items-center gap-2">
                              <input
                                ...
                                value={tag}
                                onChange={(e) => {
                                  const updatedTags = [...editPackageData.package.tags];
                              ...
                              <button
                                onClick={() => {
                                  const updatedTags = editPackageData.package.tags.filter((_, i) => i !== index);
                                  setEditPackageData({
                                    ...editPackageData,
                                    package: {
                                      ...editPackageData.package,
                          ...
                          <button
                            onClick={() => {
                              setEditPackageData({
                                ...
                                package: {
                                  ...editPackageData.package,
                                  tags: [...(editPackageData.package.tags || []), ""],
                                },
                              });
                            }}
                            className="px-3 py-1 bg-blue-600 text-white rounded-md text-sm"
