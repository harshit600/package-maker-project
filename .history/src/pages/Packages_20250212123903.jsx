        ...
        <>
          ...
          {showEditModal && editPackageData && (
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
              ...
              {/* Modal Content */}
              <div className="p-6 overflow-y-auto bg-gray-50" style={{ maxHeight: "calc(90vh - 150px)" }}>
                {activeTab === "package" && (
                  <div className="space-y-6 max-w-6xl mx-auto">
                    {/* Package Summary Card */}
                    <div className="bg-gradient-to-r from-[rgb(45,45,68)] to-[rgb(65,65,98)] rounded-xl p-6 shadow-lg">
                      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div className="text-white">
                          <h3 className="text-2xl font-bold mb-2">
                            {editPackageData?.package?.packageName || "New Package"}
                          </h3>
                          <p className="text-gray-300">
                            {editPackageData?.package?.packageCategory || "Category"} Package
                          </p>
                        </div>
                        <div className="flex flex-wrap gap-3">
                          <div className="px-4 py-2 bg-white/10 rounded-lg backdrop-blur-sm text-white">
                            <span className="text-sm">Duration: </span>
                            <span className="font-mono">{editPackageData?.package?.duration || "N/A"}</span>
                          </div>
                          <div className="px-4 py-2 bg-white/10 rounded-lg backdrop-blur-sm text-white">
                            <span className="text-sm">Status: </span>
                            <span className="font-mono text-green-300">Active</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {/* Basic Details Card */}
                      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        <div className="p-4 bg-[rgb(45,45,68)] text-white">
                      ...
                      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div className="p-6 space-y-4">
                          <div>
                            ...
                            <input
                              type="text"
                              value={editPackageData?.package?.pickupLocation || ""}
                              onChange={(e) => {
                                setEditPackageData({
                                  ...editPackageData,
                                  package: {
                      ...
                      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden md:col-span-2">
                        <div className="p-4 bg-[rgb(45,45,68)] text-white">
                          <h4 className="text-lg font-semibold flex items-center gap-2">
                            <span className="text-xl">🗺️</span> Places Covered
                          </h4>
                        </div>
                        <div className="p-6">
                          <div className="space-y-4">
                            {editPackageData?.package?.packagePlaces?.map((place, index) => (
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                  <div>
                                    ...
                                    <input
                                      ...
                                      onChange={(e) => {
                                        const updatedPlaces = [...editPackageData.package.packagePlaces];
                                        updatedPlaces[index].placeCover = e.target.value;
                                        setEditPackageData({
                                          ...editPackageData,
                                          package: {
                                            ...editPackageData.package,
                                  ...
                                  <div>
                                    ...
                                    <input
                                      ...
                                      onChange={(e) => {
                                        const updatedPlaces = [...editPackageData.package.packagePlaces];
                                        updatedPlaces[index].nights = e.target.value;
                                        setEditPackageData({
                                          ...editPackageData,
                                          package: {
                                            ...editPackageData.package,
                                  ...
                                  <div className="flex items-center">
                                    <label className="flex items-center gap-2 cursor-pointer">
                                      <input
                                        ...
                                        onChange={(e) => {
                                          const updatedPlaces = [...editPackageData.package.packagePlaces];
                                          updatedPlaces[index].transfer = e.target.checked;
                                          setEditPackageData({
                                            ...editPackageData,
                                            package: {
                                              ...editPackageData.package,
                                      ...
                                      />
                                      <span className="text-sm text-gray-700">Include Transfer</span>
                                    </label>
                                  </div>
                                </div>
                              </div>
                              ...
                              onClick={() => {
                                setEditPackageData({
                                  ...
                                  package: {
                                    ...editPackageData.package,
                                    packagePlaces: [
                                      ...(editPackageData.package.packagePlaces || []),
                                      { placeCover: "", nights: 0, transfer: false },
                                    ],
                                  },
                                });
                              }}
                              className="mt-4 px-4 py-2 bg-[rgb(45,45,68)] text-white rounded-lg hover:bg-[rgb(55,55,88)] transition-colors flex items-center gap-2"
                            >
                              <span>Add Place</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="bg-gray-50 p-6 rounded-lg">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {editPackageData?.package?.tags?.map((tag, index) => (
                            <div
                              key={index}
                              className="flex items-center gap-2"
                            >
                              ...
                              <button
                                onClick={() => {
                                  const updatedTags =
                                    editPackageData.package.tags.filter(
                                      (_, i) => i !== index
                                    );
                                  setEditPackageData({
                                    ...editPackageData,
                ...
                {activeTab === "cab" && (
                  <div className="space-y-6">
                    <h4 className="text-lg font-semibold">Cab Details</h4>
                  </div>
                )}
                ...
                {activeTab === "costing" && (
                  <div className="space-y-6">
                    <h4 className="text-lg font-semibold">Costing Details</h4>
                  </div>
                )}
              </div>
