                    ...
                    <div className="space-y-6">
                      ...
                      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                        <div className="p-4 border-b border-gray-200 bg-gray-50">
                          <h4 className="text-lg font-semibold text-gray-800">Cab Details</h4>
                        </div>
                        <div className="p-6">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                              ...
                              <select
                                value={editPackageData?.cab?.cabType || ""}
                                onChange={(e) => {
                                  setEditPackageData({
                                    ...editPackageData,
                                    cab: {
                            ...
                            <div>
                              ...
                              <input
                                type="text"
                                value={editPackageData?.cab?.cabName || ""}
                                onChange={(e) => {
                                  setEditPackageData({
                                    ...editPackageData,
                                    cab: {
                        ...
                        <div className="p-6">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                              ...
                              <select
                                value={editPackageData?.cab?.transferType || ""}
                                onChange={(e) => {
                                  setEditPackageData({
                                    ...editPackageData,
                                    cab: {
                            ...
                            <div>
                              ...
                              <select
                                value={editPackageData?.cab?.transferCategory || ""}
                                onChange={(e) => {
                                  setEditPackageData({
                                    ...editPackageData,
                                    cab: {
                          ...
                          <div className="space-y-4">
                            <div className="flex items-center gap-4">
                              <label className="inline-flex items-center">
                                <input
                                  type="checkbox"
                                  checked={editPackageData?.cab?.includeDriver || false}
                                  onChange={(e) => {
                                    setEditPackageData({
                                      ...editPackageData,
                                      cab: {
                                ...
                                />
                                <span className="ml-2 text-sm text-gray-700">Include Driver</span>
                              </label>
                              <label className="inline-flex items-center">
                                <input
                                  type="checkbox"
                                  checked={editPackageData?.cab?.includeFuel || false}
                                  onChange={(e) => {
                                    setEditPackageData({
                                      ...editPackageData,
                                      cab: {
                                  ...
                                  className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                                />
                                <span className="ml-2 text-sm text-gray-700">Include Fuel</span>
                              </label>
                            </div>
                            <div>
                              <label className="block text-sm font-medium text-gray-700 mb-1">
                              ...
                              <textarea
                                value={editPackageData?.cab?.notes || ""}
                                onChange={(e) => {
                                  setEditPackageData({
                                    ...editPackageData,
                                    cab: {
                                ...
                                rows={4}
                                className="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                placeholder="Enter any additional notes about the cab service"
                              />
                            </div>
                          </div>
                        </div>
