                        ...
                        <div className="p-6">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                              ...
                              <select
                                value={
                                  editPackageData?.cab?.transferCategory || ""
                                }
                                onChange={(e) => {
                                  setEditPackageData({
                                    ...editPackageData,
                            ...
                            <div className="flex items-center gap-4">
                              <label className="inline-flex items-center">
                                <input
                                  type="checkbox"
                                  checked={
                                    editPackageData?.cab?.includeDriver || false
                                  }
                                  onChange={(e) => {
                                    setEditPackageData({
                                      ...editPackageData,
                              ...
                              <label className="inline-flex items-center">
                                <input
                                  type="checkbox"
                                  checked={
                                    editPackageData?.cab?.includeFuel || false
                                  }
                                  onChange={(e) => {
                                    setEditPackageData({
                                      ...editPackageData,
                          ...
                          <div className="p-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                              <div>
                                ...
                                <select
                                  value={
                                    editPackageData?.cab?.transferType || ""
                                  }
                                  onChange={(e) => {
                                    setEditPackageData({
                                      ...editPackageData,
                              ...
                              <div className="flex items-center gap-4">
                                <label className="inline-flex items-center">
                                  <input
                                    type="checkbox"
                                    checked={
                                      editPackageData?.cab?.includeDriver ||
                                      false
                                    }
                                    onChange={(e) => {
                                      setEditPackageData({
