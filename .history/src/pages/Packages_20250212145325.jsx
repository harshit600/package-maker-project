              ...
              <div className="bg-white rounded-xl w-full max-w-6xl max-h-[90vh] overflow-hidden shadow-2xl">
                ...
                <div className="p-6 overflow-y-auto" style={{ maxHeight: "calc(90vh - 150px)" }}>
                  ...
                  {activeTab === "cab" && (
                    <div className="space-y-6">
                      {/* Cab Details */}
                      {Object.entries(editPackageData?.cabs?.travelPrices?.selectedCabs || {}).map(
                        ([cabType, cabs], index) => (
                          <div key={index} className="border rounded-lg p-4">
                            <h4 className="font-medium mb-4">{cabType}</h4>
                            {cabs.map((cab, cabIndex) => (
                              <div key={cabIndex} className="grid grid-cols-3 gap-4 mb-4">
                                <div>
                                  <label className="block text-sm font-medium text-gray-700 mb-1">
                                    Cab Name
                                  </label>
                                  <input
                                    ...
                                    onChange={(e) => {
                                      ...
                                      updatedCabs.travelPrices.selectedCabs[cabType][cabIndex].cabName =
                                        e.target.value;
                                      setEditPackageData({
                                        ...editPackageData,
                                        cabs: updatedCabs,
