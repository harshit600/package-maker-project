        ...
        <>
          ...
          {showEditModal && editPackageData && (
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
              ...
              // ... continuing from the previous costing section ...

{/* Final Prices */}
<div className="border rounded-lg p-6">
  <h4 className="text-lg font-medium text-gray-900 mb-4">Final Prices</h4>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
    <div>
      <label className="block text-sm font-medium text-gray-700 mb-1">
        B2B Price
      ...
      <input
        type="number"
        value={editPackageData.finalCosting?.b2bPrice}
        onChange={(e) => {
          setEditPackageData({
            ...editPackageData,
            finalCosting: {
              ...editPackageData.finalCosting,
              b2bPrice: parseInt(e.target.value),
            },
          });
        }}
        className="w-full p-2 border rounded-md"
    ...
    <div>
      ...
      <input
        type="number"
        value={editPackageData.finalCosting?.b2cPrice}
        onChange={(e) => {
          setEditPackageData({
            ...editPackageData,
            finalCosting: {
              ...editPackageData.finalCosting,
              b2cPrice: parseInt(e.target.value),
            },
          });
        }}
        className="w-full p-2 border rounded-md"
    ...
    <div>
      ...
      <input
        type="number"
        value={editPackageData.finalCosting?.baseTotal}
        onChange={(e) => {
          setEditPackageData({
            ...editPackageData,
            finalCosting: {
              ...editPackageData.finalCosting,
              baseTotal: parseInt(e.target.value),
            },
          });
        }}
        className="w-full p-2 border rounded-md"
...
<div className="mt-6">
  ...
  <textarea
    value={editPackageData.finalCosting?.cancellationPolicy?.join('\n')}
    onChange={(e) => {
      setEditPackageData({
        ...editPackageData,
        finalCosting: {
          ...editPackageData.finalCosting,
          cancellationPolicy: e.target.value.split('\n').filter(item => item.trim()),
        },
      });
    }}
    rows={6}
      ...
      <>
        ...
        Save Changes
                  ...
                  <div className="sticky bottom-0 bg-white border-t mt-6 p-4 flex justify-end">
                    <Button
                      onClick={handleSaveChanges}
                      className="bg-[rgb(45,45,68)] text-white px-6 py-2 rounded-md hover:bg-opacity-90"
                    >
                      Save Changes
                    </Button>
                  </div>
