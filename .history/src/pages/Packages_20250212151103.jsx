...
const Packages = () => {
  ...
  const handleEditClick = () => {
    setEditPackageData(selectedPackage);
    setShowEditModal(true);
  };

  // Add this handler for saving changes
  const handleSaveChanges = async () => {
    try {
      setIsLoading(true);
      const response = await axios.put(
        `/api/packages/${editPackageData._id}`,
        editPackageData
      );
      if (response.data) {
                ...
                >
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <input
                            type="text"
                            value={editPackageData.packageCode}
                            onChange={(e) =>
                              setEditPackageData({
                                ...editPackageData,
                        ...
                        <div>
                          ...
                          <input
                            type="date"
                            value={editPackageData.validFrom}
                            onChange={(e) =>
                              setEditPackageData({
                                ...editPackageData,
                        ...
                        <div>
                          ...
                          <input
                            type="date"
                            value={editPackageData.validUntil}
                            onChange={(e) =>
                              setEditPackageData({
                                ...editPackageData,
                        ...
                        <div>
                          ...
                          <input
                            type="text"
                            value={editPackageData.destination}
                            onChange={(e) =>
                              setEditPackageData({
                                ...editPackageData,
                            ...
                            <div key={index} className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 border rounded-lg">
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    const updatedPlaces = [...editPackageData.packagePlaces];
                                    updatedPlaces[index] = {
                                      ...updatedPlaces[index],
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <button
                                  onClick={() => {
                                    const updatedPlaces = editPackageData.packagePlaces.filter(
                                      (_, i) => i !== index
                                    );
                                    setEditPackageData({
                                      ...editPackageData,
                            ...
                            onClick={() => {
                              setEditPackageData({
                                ...
                                packagePlaces: [
                                  ...
                                  { placeCover: "", nights: 1, transfer: false },
                                ],
                              });
                            }}
                        ...
                        <div className="flex flex-wrap gap-2">
                          {editPackageData.themes?.map((theme, index) => (
                            <div key={index} className="flex items-center bg-gray-100 rounded-full px-3 py-1">
                              ...
                              <button
                                onClick={() => {
                                  const updatedThemes = editPackageData.themes.filter(
                                    (_, i) => i !== index
                                  );
                                  setEditPackageData({
                                    ...editPackageData,
                          ...
                          <input
                            ...
                            onKeyDown={(e) => {
                              if (e.key === 'Enter' && e.target.value.trim()) {
                                setEditPackageData({
                                  ...editPackageData,
                                  themes: [...(editPackageData.themes || []), e.target.value.trim()],
                                });
                                e.target.value = '';
                              }
                            }}
                        ...
                        <div className="flex flex-wrap gap-2">
                          {editPackageData.tags?.map((tag, index) => (
                            <div key={index} className="flex items-center bg-gray-100 rounded-full px-3 py-1">
                              ...
                              <button
                                onClick={() => {
                                  const updatedTags = editPackageData.tags.filter(
                                    (_, i) => i !== index
                                  );
                                  setEditPackageData({
                                    ...editPackageData,
                          ...
                          <input
                            ...
                            onKeyDown={(e) => {
                              if (e.key === 'Enter' && e.target.value.trim()) {
                                setEditPackageData({
                                  ...editPackageData,
                                  tags: [...(editPackageData.tags || []), e.target.value.trim()],
                                });
                                e.target.value = '';
                              }
                            }}
                      ...
                      <div>
                        ...
                        <textarea
                          value={editPackageData.overview}
                          onChange={(e) =>
                            setEditPackageData({
                              ...editPackageData,
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          {editPackageData.highlights?.map((highlight, index) => (
                            <div key={index} className="flex gap-2">
                              <input
                                type="text"
                                value={highlight}
                                onChange={(e) => {
                                  const updatedHighlights = [...editPackageData.highlights];
                              ...
                              <button
                                onClick={() => {
                                  const updatedHighlights = editPackageData.highlights.filter(
                                    (_, i) => i !== index
                                  );
                                  setEditPackageData({
                                    ...editPackageData,
                  ...
                  {activeTab === "cab" && (
                    <div className="space-y-6">
                      ...
                      ).map(([cabType, cabs], index) => (
                        <div key={index} className="border rounded-lg p-4">
                          <h4 className="font-medium mb-4">{cabType}</h4>
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    ...
                                    updatedCabs.travelPrices.selectedCabs[
                                      cabType
                                    ][cabIndex].cabName = e.target.value;
                                    setEditPackageData({
                                      ...editPackageData,
                                      cabs: updatedCabs,
                                    });
                  ...
                  {activeTab === "hotel" && (
                    <div className="space-y-6">
                      {/* Hotel Details */}
                      {Object.entries(editPackageData?.hotels || {}).map(
                        ([key, hotel]) =>
                          key !== "totalNights" && (
                                ...
                                <div>
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => {
                                      ...
                                      updatedHotels[key].name = e.target.value;
                                      setEditPackageData({
                                        ...editPackageData,
