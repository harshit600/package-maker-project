                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <select
                            value={selectedPackage?.packageCategory || ""}
                            onChange={(e) =>
                              setEditPackageData({
                                ...editPackageData,
                        ...
                        <div>
                          ...
                          <input
                            type="date"
                            value={selectedPackage?.validFrom || ""}
                            onChange={(e) =>
                              setEditPackageData({
                                ...editPackageData,
                        ...
                        <div>
                          ...
                          <input
                            type="date"
                            value={selectedPackage?.validUntil || ""}
                            onChange={(e) =>
                              setEditPackageData({
                                ...editPackageData,
                      ...
                      <div>
                        ...
                        <div className="space-y-4">
                          {selectedPackage?.packagePlaces?.map((place, index) => (
                            <div key={index} className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 border rounded-lg">
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    const updatedPlaces = [...selectedPackage.packagePlaces];
                                    updatedPlaces[index] = {
                                      ...updatedPlaces[index],
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <button
                                  onClick={() => {
                                    const updatedPlaces = selectedPackage.packagePlaces.filter(
                                      (_, i) => i !== index
                                    );
                                    setEditPackageData({
                                      ...editPackageData,
                          ...
                          <button
                            type="button"
                            onClick={() => {
                              const currentPlaces = selectedPackage.packagePlaces || [];
                              setEditPackageData({
                                ...editPackageData,
                                packagePlaces: [
                                  ...currentPlaces,
                        ...
                        <div className="flex flex-wrap gap-2">
                          {selectedPackage?.themes?.map((theme, index) => (
                            <div key={index} className="flex items-center bg-gray-100 rounded-full px-3 py-1">
                              ...
                              <button
                                onClick={() => {
                                  const updatedThemes = selectedPackage.themes.filter(
                                    (_, i) => i !== index
                                  );
                                  setEditPackageData({
                                    ...editPackageData,
                          ...
                          <input
                            ...
                            onKeyDown={(e) => {
                              if (e.key === 'Enter' && e.target.value.trim()) {
                                const currentThemes = selectedPackage.themes || [];
                                setEditPackageData({
                                  ...editPackageData,
                                  themes: [...currentThemes, e.target.value.trim()],
                                });
                                e.target.value = '';
                              }
                            }}
                        ...
                        <div className="flex flex-wrap gap-2">
                          {selectedPackage?.tags?.map((tag, index) => (
                            <div key={index} className="flex items-center bg-gray-100 rounded-full px-3 py-1">
                              ...
                              <button
                                onClick={() => {
                                  const updatedTags = selectedPackage.tags.filter(
                                    (_, i) => i !== index
                                  );
                                  setEditPackageData({
                                    ...editPackageData,
                          ...
                          <input
                            ...
                            onKeyDown={(e) => {
                              if (e.key === 'Enter' && e.target.value.trim()) {
                                const currentTags = selectedPackage.tags || [];
                                setEditPackageData({
                                  ...editPackageData,
                                  tags: [...currentTags, e.target.value.trim()],
                                });
                                e.target.value = '';
                              }
                            }}
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          {selectedPackage?.highlights?.map((highlight, index) => (
                            <div key={index} className="flex gap-2">
                              <input
                                ...
                                value={highlight}
                                onChange={(e) => {
                                  const updatedHighlights = [...selectedPackage.highlights];
                              ...
                              <button
                                onClick={() => {
                                  const updatedHighlights = selectedPackage.highlights.filter(
                                    (_, i) => i !== index
                                  );
                                  setEditPackageData({
                                    ...editPackageData,
                          ...
                          <button
                            type="button"
                            onClick={() => {
                              const currentHighlights = selectedPackage.highlights || [];
                              setEditPackageData({
                                ...editPackageData,
