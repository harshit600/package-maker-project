...
const Packages = () => {
  ...
  const handleEditClick = (packageData) => {
    setEditPackageData(packageData); // Store the existing package data
  ...
  const handleUpdatePackage = async () => {
    try {
      setIsLoading(true);
      const response = await axios.put(`/api/packages/${editPackageData._id}`, editPackageData);
      if (response.data) {
        toast.success("Package updated successfully!");
        setShowEditModal(false);
        // Refresh the packages list
        fetchPackages(); // Make sure you have this function to refresh the list
      }
    } catch (error) {
            ...
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
              <div className="bg-white rounded-xl w-full max-w-6xl max-h-[90vh] overflow-hidden shadow-2xl">
                ...
                <div className="border-b border-gray-700 bg-[rgb(45,45,68)]">
                  <div className="flex items-center justify-between p-4">
                    <h3 className="text-2xl font-semibold text-white">
                      Edit Package: {editPackageData.packageName}
                    </h3>
                    <button
                  ...
                  {activeTab === "package" && (
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <div className="space-y-4">
                          {selectedPackage?.packagePlaces?.map(
                            (place, index) => (
                              <div
                                key={index}
                              ...
                              >
                                ...
                                <div className="flex items-center justify-between">
                                  ...
                                  <button
                                    onClick={() => {
                                      const updatedPlaces =
                                        selectedPackage.packagePlaces.filter(
                                          (_, i) => i !== index
                                        );
                                      setEditPackageData({
                                        ...editPackageData,
