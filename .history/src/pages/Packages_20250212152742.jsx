                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <input
                            type="date"
                            value={editPackageData.package?.startDate || ""}
                            onChange={(e) =>
                              setEditPackageData({
                                ...editPackageData,
                                package: {
                        ...
                        <div>
                          ...
                          <input
                            type="date"
                            value={editPackageData.package?.endDate || ""}
                            onChange={(e) =>
                              setEditPackageData({
                                ...editPackageData,
                                package: {
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                          {editPackageData.package?.packageImages?.map((image, index) => (
                            <div key={index} className="relative">
                              ...
                              <button
                                onClick={() => {
                                  const newImages = editPackageData.package.packageImages.filter(
                                    (_, i) => i !== index
                                  );
                                  setEditPackageData({
                                    ...editPackageData,
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          {editPackageData.package?.placesCovered?.map((place, index) => (
                            <div key={index} className="flex gap-2">
                              <input
                                type="text"
                                value={place}
                                onChange={(e) => {
                                  const newPlaces = [...editPackageData.package.placesCovered];
                              ...
                              <button
                                onClick={() => {
                                  const newPlaces = editPackageData.package.placesCovered.filter(
                                    (_, i) => i !== index
                                  );
                                  setEditPackageData({
                                    ...editPackageData,
                        ...
                        <div className="flex flex-wrap gap-2">
                          {editPackageData.package?.themes?.map((theme, index) => (
                            <div key={index} className="flex items-center bg-gray-100 rounded-full px-3 py-1">
                              ...
                              <button
                                onClick={() => {
                                  const newThemes = editPackageData.package.themes.filter(
                                    (_, i) => i !== index
                                  );
                                  setEditPackageData({
                                    ...editPackageData,
