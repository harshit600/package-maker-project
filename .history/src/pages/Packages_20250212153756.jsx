                  ...
                  {activeTab === "package" && (
                    <div className="space-y-6 p-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {/* Duration */}
                        {editPackageData.duration !== undefined && (
                          <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">
                              Duration
                            </label>
                        ...
                        {/* Only render fields that exist in the API response */}
                        {Object.entries(editPackageData).map(([key, value]) => {
                          // Skip fields that are already handled or shouldn't be displayed
                          if (['_id', 'packageName', 'packageType', 'duration'].includes(key)) return null;
                                ...
                                <div className="space-y-2">
                                      ...
                                      {key === 'placesCovered' ? (
                                        ...
                                        >
                                          ...
                                          {placesList.map((place) => (
                                            <option key={place._id} value={place.placeName}>
                                              {place.placeName}
                                            </option>
                                          ))}
                                        </select>
                                  ...
                                  <button
                                    ...
                                    onClick={() => {
                                      setEditPackageData({
                                        ...editPackageData,
                                        [key]: [...value, key === 'placesCovered' ? '' : ''],
                                      });
                                    }}
                                    className="flex items-center gap-2 px-4 py-2 bg-gray-100 text-gray-700 rounded-md hover:bg-gray-200"
                                  >
                                    <span>+</span> Add {key.replace(/([A-Z])/g, ' $1').toLowerCase()}
                                  </button>
                                </div>
                              ) : null}
                            </div>
