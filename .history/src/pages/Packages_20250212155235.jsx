...
const Packages = () => {
  ...
  const handleEditClick = async (packageId) => {
    try {
      ...
      const data = await response.json();
      console.log("Package Data:", data); // Let's see what we get
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-[rgb(45,45,68)] to-[rgb(55,55,88)] rounded-xl p-8 text-white shadow-xl">
                        <div className="flex items-center justify-between mb-6">
                          <div>
                            <h3 className="text-2xl font-bold mb-2">
                              {editPackageData.packageName || "Package Details"}
                            </h3>
                            <p className="text-white/80">
                              {editPackageData.packageCategory} Package
                            </p>
                          </div>
                          <div className="flex gap-4">
                            <div className="px-4 py-2 bg-white/10 rounded-lg backdrop-blur-sm">
                              <span className="text-sm font-medium">Current Duration: </span>
                              <span className="font-mono">{selectedPackage?.package?.duration}</span>
                            </div>
                            <div className="px-4 py-2 bg-white/10 rounded-lg backdrop-blur-sm">
                              ...
                              <input
                                ...
                                placeholder={selectedPackage?.package?.duration}
                                onChange={(e) => setEditPackageData({
                                  ...editPackageData,
                                  duration: e.target.value
                                })}
                                className="bg-transparent border-b border-white/30 text-white outline-none w-20"
                              />
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                          <div className="flex items-center gap-3 mb-4">
                            ...
                            <h4 className="text-lg font-semibold text-[rgb(45,45,68)]">Basic Details</h4>
                          </div>
                          <div className="space-y-4">
                            <div>
                              <label className="block text-sm text-gray-600 mb-1">
                                ...
                                <span className="text-gray-400 ml-2">
                                  (Current: {selectedPackage?.package?.packageName})
                                </span>
                              </label>
                              <input
                                type="text"
                                value={editPackageData.packageName || ""}
                                placeholder={selectedPackage?.package?.packageName}
                                onChange={(e) => setEditPackageData({
                                  ...editPackageData,
                                  packageName: e.target.value
                                })}
                                className="w-full p-2 border rounded-md focus:ring-2 focus:ring-[rgb(45,45,68)] focus:border-transparent"
                              />
                            </div>
                            <div>
                              <label className="block text-sm text-gray-600 mb-1">
                                Package Type
                                <span className="text-gray-400 ml-2">
                                  (Current: {selectedPackage?.package?.packageType})
                                </span>
                              </label>
                              <select
                                value={editPackageData.packageType || ""}
                                onChange={(e) => setEditPackageData({
                                  ...editPackageData,
                                ...
                                className="w-full p-2 border rounded-md focus:ring-2 focus:ring-[rgb(45,45,68)] focus:border-transparent"
                              >
                                <option value="">{selectedPackage?.package?.packageType}</option>
                            ...
                            <div>
                              <label className="block text-sm text-gray-600 mb-1">
                                Package Category
                                <span className="text-gray-400 ml-2">
                                  (Current: {selectedPackage?.package?.packageCategory})
                                </span>
                              </label>
                              <input
                                type="text"
                                value={editPackageData.packageCategory || ""}
                                placeholder={selectedPackage?.package?.packageCategory}
                                onChange={(e) => setEditPackageData({
                                  ...editPackageData,
                            ...
                            <div>
                              <label className="block text-sm text-gray-600 mb-1">
                                Status
                                <span className="text-gray-400 ml-2">
                                  (Current: {selectedPackage?.package?.status})
                                </span>
                              </label>
                              <select
                                value={editPackageData.status || selectedPackage?.package?.status}
                                onChange={(e) => setEditPackageData({
                                  ...editPackageData,
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                          <div className="flex items-center gap-3 mb-4">
                            <span className="p-2 bg-gray-100 rounded-lg text-[rgb(45,45,68)] text-xl">📍</span>
                            <h4 className="text-lg font-semibold text-[rgb(45,45,68)]">Locations</h4>
                          </div>
                          <div className="space-y-4">
                            <div>
                              <label className="block text-sm text-gray-600 mb-1">
                                Pickup Location
                                <span className="text-gray-400 ml-2">
                                  (Current: {selectedPackage?.package?.pickupLocation})
                                </span>
                              </label>
                              <input
                                type="text"
                                value={editPackageData.pickupLocation || ""}
                                placeholder={selectedPackage?.package?.pickupLocation}
                                onChange={(e) => setEditPackageData({
                                  ...editPackageData,
                            ...
                            <div>
                              <label className="block text-sm text-gray-600 mb-1">
                                Drop Location
                                <span className="text-gray-400 ml-2">
                                  (Current: {selectedPackage?.package?.dropLocation})
                                </span>
                              </label>
                              <input
                                type="text"
                                value={editPackageData.dropLocation || ""}
                                placeholder={selectedPackage?.package?.dropLocation}
                                onChange={(e) => setEditPackageData({
                                  ...editPackageData,
                            ...
                            <div className="flex items-center gap-2">
                              <input
                                type="checkbox"
                                checked={editPackageData.pickupTransfer ?? selectedPackage?.package?.pickupTransfer}
                                onChange={(e) => setEditPackageData({
                                  ...editPackageData,
                                  pickupTransfer: e.target.checked
                                })}
                                className="rounded text-[rgb(45,45,68)]"
                              />
                              <label className="text-sm text-gray-600">
                                Include Transfer
                                <span className="text-gray-400 ml-2">
                                  (Current: {selectedPackage?.package?.pickupTransfer ? "Yes" : "No"})
                                </span>
                              </label>
                            </div>
                          </div>
                        ...
                        <div className="md:col-span-2 bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                          <div className="flex items-center gap-3 mb-4">
                            <span className="p-2 bg-gray-100 rounded-lg text-[rgb(45,45,68)] text-xl">🗺️</span>
                            <h4 className="text-lg font-semibold text-[rgb(45,45,68)]">Places Covered</h4>
                          </div>
                          <div className="space-y-4">
                            {/* Show current places */}
                            <div className="mb-4 p-4 bg-gray-50 rounded-lg">
                              <h5 className="text-sm font-medium text-gray-600 mb-2">Current Places:</h5>
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                {selectedPackage?.package?.packagePlaces?.map((place, index) => (
                                  <div key={index} className="p-3 bg-white rounded-lg border border-gray-200">
                                    <p className="font-medium">{place.placeCover}</p>
                                    <p className="text-sm text-gray-500">Nights: {place.nights}</p>
                                  </div>
                                ))}
                              </div>
                            </div>
                            ...
                            {/* Edit places */}
                            {editPackageData.packagePlaces?.map((place, index) => (
                              <div key={index} className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-gray-50 rounded-lg">
                                <div>
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => {
                                      const newPlaces = [...editPackageData.packagePlaces];
                                      newPlaces[index] = { ...place, placeCover: e.target.value };
                                      setEditPackageData({
                                        ...editPackageData,
                                        packagePlaces: newPlaces
                                      });
                                    }}
                                    className="w-full p-2 border rounded-md focus:ring-2 focus:ring-[rgb(45,45,68)] focus:border-transparent"
                                  />
                                ...
                                <div>
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => {
                                      const newPlaces = [...editPackageData.packagePlaces];
                                      newPlaces[index] = { ...place, nights: parseInt(e.target.value) };
                                      setEditPackageData({
                                        ...editPackageData,
                                        packagePlaces: newPlaces
                                      });
                                ...
                                <div className="flex items-end">
                                  <button
                                    onClick={() => {
                                      const newPlaces = editPackageData.packagePlaces.filter((_, i) => i !== index);
                                      setEditPackageData({
                                        ...editPackageData,
                                        packagePlaces: newPlaces
                                      });
                            ...
                            <button
                              onClick={() => {
                                setEditPackageData({
                                  ...editPackageData,
                                  packagePlaces: [...(editPackageData.packagePlaces || []), { placeCover: "", nights: 0 }]
                                });
                              }}
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                          <div className="flex items-center gap-3 mb-4">
                            <span className="p-2 bg-gray-100 rounded-lg text-[rgb(45,45,68)] text-xl">🎨</span>
                            <h4 className="text-lg font-semibold text-[rgb(45,45,68)]">Themes</h4>
                          </div>
                          {/* Show current themes */}
                          <div className="mb-4 p-4 bg-gray-50 rounded-lg">
                            <h5 className="text-sm font-medium text-gray-600 mb-2">Current Themes:</h5>
                            <div className="flex flex-wrap gap-2">
                          ...
                          <div className="space-y-4">
                            {editPackageData.themes?.map((theme, index) => (
                              <div key={index} className="flex gap-2">
                                <input
                                  type="text"
                                  value={theme}
                                  onChange={(e) => {
                                    const newThemes = [...editPackageData.themes];
                                  ...
                                  className="flex-1 p-2 border rounded-md focus:ring-2 focus:ring-[rgb(45,45,68)] focus:border-transparent"
                                />
                                <button
                                  onClick={() => {
                                    const newThemes = editPackageData.themes.filter((_, i) => i !== index);
                                    setEditPackageData({
                                      ...editPackageData,
                                      themes: newThemes
                                    });
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                          <div className="flex items-center gap-3 mb-4">
                            <span className="p-2 bg-gray-100 rounded-lg text-[rgb(45,45,68)] text-xl">🏷️</span>
                            <h4 className="text-lg font-semibold text-[rgb(45,45,68)]">Tags</h4>
                          </div>
                          {/* Show current tags */}
                          <div className="mb-4 p-4 bg-gray-50 rounded-lg">
                            <h5 className="text-sm font-medium text-gray-600 mb-2">Current Tags:</h5>
                            <div className="flex flex-wrap gap-2">
                          ...
                          <div className="space-y-4">
                            {editPackageData.tags?.map((tag, index) => (
                              <div key={index} className="flex gap-2">
                                <input
                                  type="text"
                                  value={tag}
                                  onChange={(e) => {
                                    const newTags = [...editPackageData.tags];
                                ...
                                <button
                                  onClick={() => {
                                    const newTags = editPackageData.tags.filter((_, i) => i !== index);
                                    setEditPackageData({
                                      ...editPackageData,
                                      tags: newTags
                                    });
