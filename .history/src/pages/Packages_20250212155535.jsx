                    ...
                    <div className="space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-[rgb(45,45,68)] to-[rgb(55,55,88)] rounded-xl p-8 text-white shadow-xl">
                        <div className="flex items-center justify-between mb-6">
                          <div>
                            <h3 className="text-2xl font-bold mb-2">
                              {editPackageData.packageName || selectedPackage?.package?.packageName}
                            </h3>
                            <p className="text-white/80">
                              {editPackageData.packageCategory || selectedPackage?.package?.packageCategory} Package
                            </p>
                          </div>
                          <div className="flex gap-4">
                            <div className="px-4 py-2 bg-white/10 rounded-lg backdrop-blur-sm">
                              ...
                              <input
                                type="text"
                                value={editPackageData.duration || selectedPackage?.package?.duration || ""}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                          ...
                          <div className="space-y-4">
                            <div>
                              ...
                              <input
                                type="text"
                                value={editPackageData.packageName || selectedPackage?.package?.packageName || ""}
                                onChange={(e) => setEditPackageData({
                                  ...editPackageData,
                            ...
                            <div>
                              ...
                              <select
                                value={editPackageData.packageType || selectedPackage?.package?.packageType || ""}
                                onChange={(e) => setEditPackageData({
                                  ...editPackageData,
                            ...
                            <div>
                              <label className="block text-sm text-gray-600 mb-1">Package Category</label>
                              <input
                                type="text"
                                value={editPackageData.packageCategory || selectedPackage?.package?.packageCategory || ""}
                                onChange={(e) => setEditPackageData({
                                  ...editPackageData,
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                          ...
                          <div className="space-y-4">
                            <div>
                              ...
                              <input
                                type="text"
                                value={editPackageData.pickupLocation || selectedPackage?.package?.pickupLocation || ""}
                                onChange={(e) => setEditPackageData({
                                  ...editPackageData,
                            ...
                            <div>
                              ...
                              <input
                                type="text"
                                value={editPackageData.dropLocation || selectedPackage?.package?.dropLocation || ""}
                                onChange={(e) => setEditPackageData({
                                  ...editPackageData,
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              />
                              <label className="text-sm text-gray-600">Include Transfer</label>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="md:col-span-2 bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                          ...
                          <div className="space-y-4">
                            {(editPackageData.packagePlaces || selectedPackage?.package?.packagePlaces || []).map((place, index) => (
                              <div key={index} className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-gray-50 rounded-lg">
                                <div>
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => {
                                      const newPlaces = [...(editPackageData.packagePlaces || selectedPackage?.package?.packagePlaces)];
                                ...
                                <div className="flex items-end">
                                  <button
                                    onClick={() => {
                                      const newPlaces = (editPackageData.packagePlaces || selectedPackage?.package?.packagePlaces).filter((_, i) => i !== index);
                                      setEditPackageData({
                                        ...editPackageData,
                                        packagePlaces: newPlaces
                                      });
                            ...
                            <button
                              onClick={() => {
                                setEditPackageData({
                                  ...editPackageData,
                                  packagePlaces: [...(editPackageData.packagePlaces || selectedPackage?.package?.packagePlaces || []), { placeCover: "", nights: 0 }]
                                });
                              }}
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                          ...
                          <div className="space-y-4">
                            {(editPackageData.themes || selectedPackage?.package?.themes || []).map((theme, index) => (
                              <div key={index} className="flex gap-2">
                                <input
                                  type="text"
                                  value={theme}
                                  onChange={(e) => {
                                    const newThemes = [...(editPackageData.themes || selectedPackage?.package?.themes)];
                                ...
                                <button
                                  onClick={() => {
                                    const newThemes = (editPackageData.themes || selectedPackage?.package?.themes).filter((_, i) => i !== index);
                                    setEditPackageData({
                                      ...editPackageData,
                                      themes: newThemes
                                    });
                            ...
                            <button
                              onClick={() => {
                                setEditPackageData({
                                  ...editPackageData,
                                  themes: [...(editPackageData.themes || selectedPackage?.package?.themes || []), ""]
                                });
                              }}
                              className="flex items-center gap-2 px-4 py-2 bg-gray-100 text-gray-700 rounded-md hover:bg-gray-200"
                            >
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                          ...
                          <div className="space-y-4">
                            {(editPackageData.tags || selectedPackage?.package?.tags || []).map((tag, index) => (
                              <div key={index} className="flex gap-2">
                                <input
                                  type="text"
                                  value={tag}
                                  onChange={(e) => {
                                    const newTags = [...(editPackageData.tags || selectedPackage?.package?.tags)];
                                ...
                                <button
                                  onClick={() => {
                                    const newTags = (editPackageData.tags || selectedPackage?.package?.tags).filter((_, i) => i !== index);
                                    setEditPackageData({
                                      ...editPackageData,
                                      tags: newTags
                                    });
                            ...
                            <button
                              onClick={() => {
                                setEditPackageData({
                                  ...editPackageData,
                                  tags: [...(editPackageData.tags || selectedPackage?.package?.tags || []), ""]
                                });
                              }}
                              className="flex items-center gap-2 px-4 py-2 bg-gray-100 text-gray-700 rounded-md hover:bg-gray-200"
                            >
