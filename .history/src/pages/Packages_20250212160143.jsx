                  ...
                  {activeTab === "cab" && (
                    <div className="space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-[rgb(45,45,68)] to-[rgb(55,55,88)] rounded-xl p-8 text-white shadow-xl">
                        <div className="flex items-center justify-between mb-6">
                          <div>
                            <h3 className="text-2xl font-bold mb-2">Cab Details</h3>
                            <p className="text-white/80">Transport Information</p>
                          </div>
                          <div className="px-4 py-2 bg-white/10 rounded-lg backdrop-blur-sm">
                            <span className="text-sm font-medium">Total Vehicles: </span>
                            <span className="font-mono">
                              {editPackageData.cab?.vehicles?.length || selectedPackage?.cab?.vehicles?.length || 0}
                            </span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                          <div className="flex items-center gap-3 mb-4">
                            ...
                            <h4 className="text-lg font-semibold text-[rgb(45,45,68)]">Basic Transport Details</h4>
                          </div>
                          <div className="space-y-4">
                            <div>
                              <label className="block text-sm text-gray-600 mb-1">Transport Type</label>
                              <select
                                value={editPackageData.cab?.transportType || selectedPackage?.cab?.transportType || ""}
                            ...
                            <div>
                              <label className="block text-sm text-gray-600 mb-1">Transport Category</label>
                              <input
                                type="text"
                                value={editPackageData.cab?.transportCategory || selectedPackage?.cab?.transportCategory || ""}
                                onChange={(e) => setEditPackageData({
                                  ...editPackageData,
                                  cab: {
                                    ...(editPackageData.cab || {}),
                                    transportCategory: e.target.value
                                  }
                                })}
                                className="w-full p-2 border rounded-md focus:ring-2 focus:ring-[rgb(45,45,68)] focus:border-transparent"
                              />
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                          <div className="flex items-center gap-3 mb-4">
                            <span className="p-2 bg-gray-100 rounded-lg text-[rgb(45,45,68)] text-xl">🔄</span>
                            <h4 className="text-lg font-semibold text-[rgb(45,45,68)]">Transfer Details</h4>
                          </div>
                          <div className="space-y-4">
                            <div className="flex items-center gap-2">
                              <input
                                type="checkbox"
                                checked={editPackageData.cab?.airportTransfer ?? selectedPackage?.cab?.airportTransfer}
                                onChange={(e) => setEditPackageData({
                                  ...editPackageData,
                                  cab: {
                                    ...(editPackageData.cab || {}),
                              ...
                              />
                              <label className="text-sm text-gray-600">Airport Transfer Included</label>
                            </div>
                            <div className="flex items-center gap-2">
                              <input
                                type="checkbox"
                                checked={editPackageData.cab?.railwayTransfer ?? selectedPackage?.cab?.railwayTransfer}
                                onChange={(e) => setEditPackageData({
                                  ...editPackageData,
                                  cab: {
                                    ...(editPackageData.cab || {}),
                                    railwayTransfer: e.target.checked
                                  }
                                })}
                                className="rounded text-[rgb(45,45,68)]"
                              />
                              <label className="text-sm text-gray-600">Railway Transfer Included</label>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="md:col-span-2 bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                          <div className="flex items-center gap-3 mb-4">
                            <span className="p-2 bg-gray-100 rounded-lg text-[rgb(45,45,68)] text-xl">🚘</span>
                            <h4 className="text-lg font-semibold text-[rgb(45,45,68)]">Vehicles</h4>
                          </div>
                          <div className="space-y-4">
                            {(editPackageData.cab?.vehicles || selectedPackage?.cab?.vehicles || []).map((vehicle, index) => (
                              <div key={index} className="grid grid-cols-1 md:grid-cols-4 gap-4 p-4 bg-gray-50 rounded-lg">
                                <div>
                                  ...
                                  <input
                                    ...
                                    value={vehicle.type || ""}
                                    onChange={(e) => {
                                      const newVehicles = [...(editPackageData.cab?.vehicles || selectedPackage?.cab?.vehicles)];
                                ...
                                <div>
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => {
                                      const newVehicles = [...(editPackageData.cab?.vehicles || selectedPackage?.cab?.vehicles)];
                                      newVehicles[index] = { ...vehicle, seatingCapacity: e.target.value };
                                      setEditPackageData({
                                        ...editPackageData,
                                        cab: {
                                          ...(editPackageData.cab || {}),
                                ...
                                <div>
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => {
                                      const newVehicles = [...(editPackageData.cab?.vehicles || selectedPackage?.cab?.vehicles)];
                                      newVehicles[index] = { ...vehicle, pricePerDay: e.target.value };
                                      setEditPackageData({
                                        ...editPackageData,
                                        cab: {
                                          ...(editPackageData.cab || {}),
                                ...
                                <div className="flex items-end">
                                  <button
                                    onClick={() => {
                                      const newVehicles = (editPackageData.cab?.vehicles || selectedPackage?.cab?.vehicles).filter((_, i) => i !== index);
                                      setEditPackageData({
                                        ...editPackageData,
                                        cab: {
                                          ...(editPackageData.cab || {}),
                              ...
                              onClick={() => {
                                setEditPackageData({
                                  ...
                                  cab: {
                                    ...(editPackageData.cab || {}),
                                    vehicles: [
                                      ...(editPackageData.cab?.vehicles || selectedPackage?.cab?.vehicles || []),
                                      { type: "", seatingCapacity: "", pricePerDay: "" }
                                    ]
                                  }
                                });
                              }}
                        ...
                        <div className="md:col-span-2 bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                          <div className="flex items-center gap-3 mb-4">
                            <span className="p-2 bg-gray-100 rounded-lg text-[rgb(45,45,68)] text-xl">📝</span>
                            <h4 className="text-lg font-semibold text-[rgb(45,45,68)]">Additional Notes</h4>
                          </div>
                          <div>
                            <textarea
                              value={editPackageData.cab?.notes || selectedPackage?.cab?.notes || ""}
                              onChange={(e) => setEditPackageData({
                                ...editPackageData,
                                cab: {
                                  ...(editPackageData.cab || {}),
                              ...
                              rows={4}
                              className="w-full p-2 border rounded-md focus:ring-2 focus:ring-[rgb(45,45,68)] focus:border-transparent"
                              placeholder="Enter any additional notes about transport..."
                            />
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-[rgb(45,45,68)] to-[rgb(55,55,88)] rounded-xl p-8 text-white shadow-xl">
                        <div className="flex items-center justify-between mb-6">
                          <div>
                            <h3 className="text-2xl font-bold mb-2">
                              {editPackageData.packageName ||
                                selectedPackage?.package?.packageName}
                            </h3>
                            <p className="text-white/80">
                              {editPackageData.packageCategory ||
                                selectedPackage?.package?.packageCategory}{" "}
                              Package
                            </p>
                          </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <div className="space-y-4">
                            <div>
                              ...
                              <input
                                type="text"
                                value={
                                  editPackageData.pickupLocation ||
                                  selectedPackage?.package?.pickupLocation ||
                                  ""
                                }
                                onChange={(e) =>
                            ...
                            <div>
                              ...
                              <input
                                type="text"
                                value={
                                  editPackageData.dropLocation ||
                                  selectedPackage?.package?.dropLocation ||
                                  ""
                                }
                                onChange={(e) =>
                                  setEditPackageData({
                            ...
                            <div className="flex items-center gap-2">
                              <input
                                type="checkbox"
                                checked={
                                  editPackageData.pickupTransfer ??
                                  selectedPackage?.package?.pickupTransfer
                                }
                                onChange={(e) =>
                                  setEditPackageData({
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                          ...
                          <div className="space-y-4">
                            {(
                              ...
                              selectedPackage?.package?.themes ||
                              []
                            ).map((theme, index) => (
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                          ...
                          <div className="space-y-4">
                            {(
                              editPackageData.tags ||
                              selectedPackage?.package?.tags ||
                              []
                            ).map((tag, index) => (
                              <div key={index} className="flex gap-2">
                                <input
