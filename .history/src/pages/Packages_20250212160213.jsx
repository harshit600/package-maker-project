                    ...
                    <div className="space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-[rgb(45,45,68)] to-[rgb(55,55,88)] rounded-xl p-8 text-white shadow-xl">
                        <div className="flex items-center justify-between mb-6">
                          ...
                          <div className="px-4 py-2 bg-white/10 rounded-lg backdrop-blur-sm">
                            ...
                            <span className="font-mono">
                              {editPackageData.cab?.vehicles?.length ||
                                selectedPackage?.cab?.vehicles?.length ||
                                0}
                            </span>
                          </div>
                        </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                          ...
                          <div className="space-y-4">
                            <div>
                              ...
                              <select
                                value={
                                  editPackageData.cab?.transportType ||
                                  selectedPackage?.cab?.transportType ||
                                  ""
                                }
                                onChange={(e) =>
                                  setEditPackageData({
                            ...
                            <div>
                              ...
                              <input
                                type="text"
                                value={
                                  editPackageData.cab?.transportCategory ||
                                  selectedPackage?.cab?.transportCategory ||
                                  ""
                                }
                                onChange={(e) =>
                                  setEditPackageData({
                          ...
                          <div className="space-y-4">
                            <div className="flex items-center gap-2">
                              <input
                                type="checkbox"
                                checked={
                                  editPackageData.cab?.airportTransfer ??
                                  selectedPackage?.cab?.airportTransfer
                                }
                                onChange={(e) =>
                                  setEditPackageData({
                                    ...editPackageData,
                            ...
                            <div className="flex items-center gap-2">
                              <input
                                type="checkbox"
                                checked={
                                  editPackageData.cab?.railwayTransfer ??
                                  selectedPackage?.cab?.railwayTransfer
                                }
                                onChange={(e) =>
                                  setEditPackageData({
                                    ...editPackageData,
                        ...
                        <div className="md:col-span-2 bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                          ...
                          <div className="space-y-4">
                            {(
                              editPackageData.cab?.vehicles ||
                              selectedPackage?.cab?.vehicles ||
                              []
                            ).map((vehicle, index) => (
                              <div
                                key={index}
                        ...
                        <div className="md:col-span-2 bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                          ...
                          <div>
                            <textarea
                              value={
                                editPackageData.cab?.notes ||
                                selectedPackage?.cab?.notes ||
                                ""
                              }
                              onChange={(e) =>
                                setEditPackageData({
