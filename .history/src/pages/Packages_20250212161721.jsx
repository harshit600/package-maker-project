                    ...
                    <div className="space-y-8">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                          <div className="flex items-center gap-3 mb-4">
                            <span className="p-2 bg-gray-100 rounded-lg text-[rgb(45,45,68)] text-xl">🎨</span>
                            <h4 className="text-lg font-semibold text-[rgb(45,45,68)]">Themes & Tags</h4>
                          </div>
                          <div className="space-y-4">
                            <div>
                              <label className="block text-sm text-gray-600 mb-1">Themes (comma-separated)</label>
                              <input
                                type="text"
                                value={(editPackageData.themes || []).join(", ")}
                                onChange={(e) =>
                                  setEditPackageData({
                                    ...editPackageData,
                            ...
                            <div>
                              ...
                              <input
                                type="text"
                                value={(editPackageData.tags || []).join(", ")}
                                onChange={(e) =>
                                  setEditPackageData({
                                    ...editPackageData,
