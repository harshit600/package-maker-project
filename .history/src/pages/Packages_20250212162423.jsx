                      ...
                      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                        ...
                        <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <input
                              type="text"
                              value={editPackageData.package?.packageCategory || ""}
                              onChange={(e) =>
                                setEditPackageData({
                                  ...editPackageData,
                                  package: {
                      ...
                      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex items-center gap-2">
                            <input
                              type="checkbox"
                              checked={editPackageData.package?.pickupTransfer || false}
                              onChange={(e) =>
                                setEditPackageData({
                                  ...editPackageData,
                                  package: {
                            ...
                            />
                            <label className="text-sm text-gray-600">Include Pickup Transfer</label>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <input
                              type="text"
                              value={(editPackageData.package?.themes || []).join(", ")}
                              onChange={(e) =>
                                setEditPackageData({
                                  ...editPackageData,
                                  package: {
