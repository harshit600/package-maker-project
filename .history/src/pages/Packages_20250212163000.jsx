                    ...
                    <div className="space-y-8">
                      ...
                      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <button onClick={() => console.log('Current Cab Data:', editPackageData.cabs)} className="text-sm text-blue-600">
                            Debug Data
                          </button>
                        </div>
                        ...
                        <div className="space-y-6">
                          {editPackageData.cabs && Object.entries(editPackageData.cabs).map(([cabId, cabData], index) => (
                            <div key={cabId} className="border border-gray-200 rounded-lg p-4 space-y-4">
                              <div className="flex justify-between items-center">
                                <h5 className="font-semibold text-gray-800">Cab {index + 1}</h5>
                                <button
                                  onClick={() => {
                                    const updatedCabs = { ...editPackageData.cabs };
                                    delete updatedCabs[cabId];
                                    setEditPackageData({
                                      ...editPackageData,
                                      cabs: updatedCabs
                                    });
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                  <label className="block text-sm text-gray-600 mb-1">Vehicle Name</label>
                                  <input
                                    type="text"
                                    value={cabData.vehicleName || ""}
                                    onChange={(e) => {
                                      const updatedCabs = { ...editPackageData.cabs };
                                      updatedCabs[cabId] = {
                                        ...cabData,
                                ...
                                <div>
                                  ...
                                  <input
                                    type="number"
                                    value={cabData.pricePerDay || 0}
                                    onChange={(e) => {
                                      const updatedCabs = {
                                        ...editPackageData.cabs,
                                        travelPrices: {
                                          ...editPackageData.cabs.travelPrices,
                                          selectedCabs: {
                                            ...editPackageData.cabs.travelPrices
                                              .selectedCabs,
                                            [cabId]: {
