                        ...
                        <div className="space-y-6">
                          {Object.entries(editPackageData.cabs?.travelPrices?.selectedCabs || {}).map(([cabType, cabs]) => (
                            <div key={cabType} className="space-y-4">
                              <h5 className="font-semibold text-lg text-gray-800">{cabType}</h5>
                              {cabs.map((cab, index) => (
                                <div key={index} className="border border-gray-200 rounded-lg p-4 space-y-4">
                                  <div className="flex justify-between items-center">
                                    <h6 className="font-medium text-gray-700">{cab.cabName || `${cabType} ${index + 1}`}</h6>
                                    <button
                                      onClick={() => {
                                        const updatedCabs = { ...editPackageData.cabs };
                                        updatedCabs.travelPrices.selectedCabs[cabType] = cabs.filter((_, i) => i !== index);
                                        setEditPackageData({
                                          ...editPackageData,
                                          cabs: updatedCabs
                                        });
                                  ...
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                      <label className="block text-sm text-gray-600 mb-1">Cab Name</label>
                                      <input
                                        type="text"
                                        value={cab.cabName || ""}
                                        onChange={(e) => {
                                          const updatedCabs = { ...editPackageData.cabs };
                                          updatedCabs.travelPrices.selectedCabs[cabType][index] = {
                                            ...cab,
                                    ...
                                    <div>
                                      <label className="block text-sm text-gray-600 mb-1">On Season Price</label>
                                      <input
                                        type="number"
                                    ...
                                    <div>
                                      <label className="block text-sm text-gray-600 mb-1">Off Season Price</label>
                                      <input
                                        type="number"
                                    ...
                                    <div>
                                      <label className="block text-sm text-gray-600 mb-1">Luggage Capacity</label>
                                      <input
                                        type="text"
                                        value={cab.luggage || ""}
                                        onChange={(e) => {
                          ...
                          <button
                            onClick={() => {
                              ...
                              if (!updatedCabs.travelPrices.selectedCabs.Hatchback) {
