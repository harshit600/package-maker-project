                          ...
                          <div className="border-b pb-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <div>
                                ...
                                <input
                                  type="number"
                                  value={editPackageData.finalCosting?.hotelCost || 0}
                                  onChange={(e) => {
                                    ...
                                    setEditPackageData({
                                      ...
                                      finalCosting: {
                                        ...
                                        hotelCost: value,
                                        baseTotal: (editPackageData.finalCosting?.cabCost || 0) + 
                                                  value + 
                                                  (editPackageData.finalCosting?.sightseeingCost || 0)
                                      }
                                    });
                                  }}
                                  className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                              ...
                              <div>
                                <label className="block text-sm text-gray-600 mb-1">Cab Cost</label>
                                <input
                                  type="number"
                                  value={editPackageData.finalCosting?.cabCost || 0}
                                  onChange={(e) => {
                                    const value = parseFloat(e.target.value);
                                    setEditPackageData({
                                      ...editPackageData,
                                      finalCosting: {
                                        ...editPackageData.finalCosting,
                                        cabCost: value,
                                        baseTotal: (editPackageData.finalCosting?.hotelCost || 0) + 
                                                  value + 
                                                  (editPackageData.finalCosting?.sightseeingCost || 0)
                                      }
                                    });
                              ...
                              <div>
                                <label className="block text-sm text-gray-600 mb-1">Sightseeing Cost</label>
                                <input
                                  type="number"
                                  value={editPackageData.finalCosting?.sightseeingCost || 0}
                                  onChange={(e) => {
                                    const value = parseFloat(e.target.value);
                                    setEditPackageData({
                                      ...editPackageData,
