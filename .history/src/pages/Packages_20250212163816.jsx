                ...
                >
                  ...
                  {activeTab === "costing" && (
                    <div className="space-y-8">
                      {/* Final Costing Tab */}
                      <button 
                        onClick={() => console.log('Final Costing Data:', editPackageData.finalCosting)}
                      ...
                      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="border-b pb-6">
                            <h5 className="font-medium text-gray-700 mb-4">Base Costs</h5>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <div>
                                <label className="block text-sm text-gray-600 mb-1">Base Price</label>
                                <input
                                  type="number"
                                  value={editPackageData.finalCosting?.basePrice || 0}
                                  onChange={(e) => {
                                    ...
                                    setEditPackageData({
                                      ...
                                      finalCosting: {
                                        ...
                                        basePrice: value,
                                        baseTotal: value + 
                                                  (editPackageData.finalCosting?.additionalCharges || 0)
                                      }
                                    });
                                  }}
                              ...
                              <div>
                                <label className="block text-sm text-gray-600 mb-1">Additional Charges</label>
                                <input
                                  type="number"
                                  value={editPackageData.finalCosting?.additionalCharges || 0}
                                  onChange={(e) => {
                                    const value = parseFloat(e.target.value);
                                    setEditPackageData({
                                      ...editPackageData,
                                      finalCosting: {
                                        ...
                                        baseTotal: (editPackageData.finalCosting?.basePrice || 0) + value
                                      }
                                    });
                                  }}
                                  className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                              ...
                              <div>
                                <label className="block text-sm text-gray-600 mb-1">Base Total</label>
                                <input
                                  type="number"
                          ...
                          {/* Tax Section */}
                          <div className="border-b pb-6">
                            <h5 className="font-medium text-gray-700 mb-4">Tax Details</h5>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <div>
                                <label className="block text-sm text-gray-600 mb-1">Tax Percentage (%)</label>
                                <input
                                  type="number"
                                  value={editPackageData.finalCosting?.taxPercentage || 0}
                                  onChange={(e) => {
                              ...
                              <div>
                                ...
                                <input
                                  type="number"
                                  value={editPackageData.finalCosting?.taxAmount || 0}
                                  readOnly
                                  className="w-full p-2 bg-gray-50 border border-gray-300 rounded-lg text-gray-600"
                                />
                              </div>
                          ...
                          {/* Final Total Section */}
                          <div>
                            <h5 className="font-medium text-gray-700 mb-4">Final Total</h5>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <div>
                                <label className="block text-sm text-gray-600 mb-1">Grand Total</label>
                                <input
                                  type="number"
                                  value={editPackageData.finalCosting?.grandTotal || 0}
                                  readOnly
                              ...
                              <div>
                                <label className="block text-sm text-gray-600 mb-1">Per Person Cost</label>
                                <input
                                  type="number"
                                  value={editPackageData.finalCosting?.perPersonCost || 0}
                                  onChange={(e) => {
                                    const value = parseFloat(e.target.value);
                                    setEditPackageData({
                                      ...editPackageData,
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                              <label className="block text-sm text-gray-600 mb-1">Inclusions</label>
                              <textarea
                                value={editPackageData.finalCosting?.inclusions?.join('\n') || ''}
                                onChange={(e) => {
                                  setEditPackageData({
                                    ...editPackageData,
                                    finalCosting: {
                            ...
                            <div>
                              <label className="block text-sm text-gray-600 mb-1">Exclusions</label>
                              <textarea
                                value={editPackageData.finalCosting?.exclusions?.join('\n') || ''}
                                onChange={(e) => {
                                  setEditPackageData({
                                    ...editPackageData,
                                    finalCosting: {
                          ...
                          <div>
                            ...
                            <textarea
                              value={editPackageData.finalCosting?.termsAndConditions?.join('\n') || ''}
                              onChange={(e) => {
                                setEditPackageData({
                                  ...editPackageData,
                                  finalCosting: {
                      ...
                      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <div>
                                ...
                                <input
                                  type="number"
                                  value={
                                    editPackageData.finalCosting?.hotelCost || 0
                                  }
                                  onChange={(e) => {
                                    const value = parseFloat(e.target.value);
                                    setEditPackageData({
                              ...
                              <div>
                                ...
                                <input
                                  type="number"
                                  value={
                                    editPackageData.finalCosting?.cabCost || 0
                                  }
                                  onChange={(e) => {
                                    const value = parseFloat(e.target.value);
                                    setEditPackageData({
                          ...
                          <div>
                            ...
                            <textarea
                              value={editPackageData.finalCosting?.notes || ""}
                              onChange={(e) => {
                                setEditPackageData({
                                  ...editPackageData,
                                  finalCosting: {
                              ...
                              rows={4}
                              className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                              placeholder="Enter any additional notes about the costing..."
                            />
                          </div>
                        </div>
                      </div>
