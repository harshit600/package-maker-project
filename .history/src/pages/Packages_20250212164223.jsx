                      ...
                      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="border-b pb-6">
                            <h5 className="font-medium text-gray-700 mb-4">Cost Breakdown</h5>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                              <div>
                                <label className="block text-sm text-gray-600 mb-1">Hotel Cost</label>
                                <input
                                  type="number"
                                  value={editPackageData.finalCosting?.breakdown?.hotelCost || 0}
                                  onChange={(e) => {
                                    const hotelCost = parseFloat(e.target.value);
                                    const transportCost = parseFloat(editPackageData.finalCosting?.breakdown?.transportCost || 0);
                                    const activitiesTotalCost = parseFloat(editPackageData.finalCosting?.breakdown?.activitiesTotalCost || 0);
                                    const baseTotal = hotelCost + transportCost + activitiesTotalCost;
                              ...
                              <div>
                                ...
                                <input
                                  type="number"
                                  value={editPackageData.finalCosting?.breakdown?.transportCost || 0}
                                  onChange={(e) => {
                                    const transportCost = parseFloat(e.target.value);
                                    const hotelCost = parseFloat(editPackageData.finalCosting?.breakdown?.hotelCost || 0);
                                    const activitiesTotalCost = parseFloat(editPackageData.finalCosting?.breakdown?.activitiesTotalCost || 0);
                                    const baseTotal = hotelCost + transportCost + activitiesTotalCost;
                              ...
                              <div>
                                <label className="block text-sm text-gray-600 mb-1">Activities Total Cost</label>
                                <input
                                  type="number"
                                  value={editPackageData.finalCosting?.breakdown?.activitiesTotalCost || 0}
                                  onChange={(e) => {
                                    const activitiesTotalCost = parseFloat(e.target.value);
                                    const hotelCost = parseFloat(editPackageData.finalCosting?.breakdown?.hotelCost || 0);
                                    const transportCost = parseFloat(editPackageData.finalCosting?.breakdown?.transportCost || 0);
                                    const baseTotal = hotelCost + transportCost + activitiesTotalCost;
                          ...
                          {/* Base Total */}
                          <div className="border-b pb-6">
                            <h5 className="font-medium text-gray-700 mb-4">Base Total</h5>
                            <div className="w-full md:w-1/3">
                              <input
                                type="number"
                                value={editPackageData.finalCosting?.baseTotal || 0}
                                readOnly
                                className="w-full p-2 bg-gray-50 border border-gray-300 rounded-lg text-gray-600 font-semibold"
                              />
                            </div>
                          </div>
                          ...
                          {/* Margins Section */}
                          <div className="border-b pb-6">
                            <h5 className="font-medium text-gray-700 mb-4">Margins (%)</h5>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                              <div>
                                <label className="block text-sm text-gray-600 mb-1">B2B Margin</label>
                                <input
                                  type="number"
                                  value={editPackageData.finalCosting?.margins?.b2b || 0}
                                  onChange={(e) => {
                                    const b2bMargin = parseFloat(e.target.value);
                                    const baseTotal = editPackageData.finalCosting?.baseTotal || 0;
                                    const b2bPrice = baseTotal + (baseTotal * b2bMargin / 100);
                                    ...
                                    setEditPackageData({
                                      ...
                                      finalCosting: {
                                        ...
                                        finalPrices: {
                                          ...editPackageData.finalCosting?.finalPrices,
                                          b2b: b2bPrice
                                        }
                                      }
                                    });
                              ...
                              <div>
                                <label className="block text-sm text-gray-600 mb-1">Internal Margin</label>
                                <input
                                  type="number"
                                  value={editPackageData.finalCosting?.margins?.internal || 0}
                                  onChange={(e) => {
                                    const internalMargin = parseFloat(e.target.value);
                                    const baseTotal = editPackageData.finalCosting?.baseTotal || 0;
                                    const internalPrice = baseTotal + (baseTotal * internalMargin / 100);
                              ...
                              <div>
                                <label className="block text-sm text-gray-600 mb-1">Website Margin</label>
                                <input
                                  type="number"
                                  value={editPackageData.finalCosting?.margins?.website || 0}
                                  onChange={(e) => {
                                    const websiteMargin = parseFloat(e.target.value);
                                    const baseTotal = editPackageData.finalCosting?.baseTotal || 0;
                                    const websitePrice = baseTotal + (baseTotal * websiteMargin / 100);
                          ...
                          <div>
                            <h5 className="font-medium text-gray-700 mb-4">Final Prices</h5>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                              <div>
                                <label className="block text-sm text-gray-600 mb-1">B2B Price</label>
                                <input
                                  type="number"
                                  value={editPackageData.finalCosting?.finalPrices?.b2b || 0}
                                  readOnly
                                  className="w-full p-2 bg-gray-50 border border-gray-300 rounded-lg text-gray-600 font-semibold"
                                />
                              </div>
                              ...
                              <div>
                                <label className="block text-sm text-gray-600 mb-1">Internal Price</label>
                                <input
                                  type="number"
                                  value={editPackageData.finalCosting?.finalPrices?.internal || 0}
                                  readOnly
                                  className="w-full p-2 bg-gray-50 border border-gray-300 rounded-lg text-gray-600 font-semibold"
                                />
                              </div>
                              ...
                              <div>
                                <label className="block text-sm text-gray-600 mb-1">Website Price</label>
                                <input
                                  type="number"
                                  value={editPackageData.finalCosting?.finalPrices?.website || 0}
                                  readOnly
                                  className="w-full p-2 bg-gray-50 border border-gray-300 rounded-lg text-gray-600 font-semibold"
                                />
                              </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <div>
                                ...
                                <input
                                  type="number"
                                  value={
                                    editPackageData.finalCosting?.basePrice || 0
                                  }
                                  onChange={(e) => {
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    ...
                                    const baseTotal =
                                      editPackageData.finalCosting?.baseTotal ||
                                      0;
                                    const taxAmount =
                                      (baseTotal * taxPercentage) / 100;
                              ...
                              <div>
                                ...
                                <input
                                  type="number"
                                  value={
                                    editPackageData.finalCosting?.taxAmount || 0
                                  }
                                  readOnly
                                  className="w-full p-2 bg-gray-50 border border-gray-300 rounded-lg text-gray-600"
                                />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <div>
                                ...
                                <input
                                  type="number"
                                  value={
                                    editPackageData.finalCosting?.grandTotal ||
                                    0
                                  }
                                  readOnly
                                  className="w-full p-2 bg-gray-50 border border-gray-300 rounded-lg text-gray-600 font-semibold text-lg"
                                />
                              </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                              ...
                              <textarea
                                value={
                                  editPackageData.finalCosting?.inclusions?.join(
                                    "\n"
                                  ) || ""
                                }
                                onChange={(e) => {
                            ...
                            <div>
                              ...
                              <textarea
                                value={
                                  editPackageData.finalCosting?.exclusions?.join(
                                    "\n"
                                  ) || ""
                                }
                                onChange={(e) => {
                          ...
                          <div>
                            ...
                            <textarea
                              value={
                                editPackageData.finalCosting?.termsAndConditions?.join(
                                  "\n"
                                ) || ""
                              }
                              onChange={(e) => {
