...
const Packages = () => {
  ...
  const handleCostChange = (field, value) => {
    ...
    const newFinalPrices = calculateFinalPrices(newBaseTotal, editPackageData.finalCosting?.margins);
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) => handleCostChange('hotelCost', e.target.value)}
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) => handleCostChange('activitiesTotalCost', e.target.value)}
                                  className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                />
                              </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) => handleMarginChange('b2b', e.target.value)}
                                  className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                />
                              </div>
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) => handleMarginChange('internal', e.target.value)}
                                  className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                />
                              </div>
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) => handleMarginChange('website', e.target.value)}
                                  className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                />
                              </div>
                            </div>
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    ...
                                    const activitiesTotalCost = parseFloat(
                                      editPackageData.finalCosting?.breakdown
                                        ?.activitiesTotalCost || 0
                                    );
                                    const baseTotal =
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    ...
                                    const baseTotal =
                                      ...
                                      0;
                                    const b2bPrice =
                                      baseTotal + (baseTotal * b2bMargin) / 100;
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    const internalMargin = parseFloat(
                                      e.target.value
                                    );
                                    const baseTotal =
                                      editPackageData.finalCosting?.baseTotal ||
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    const websiteMargin = parseFloat(
                                      e.target.value
                                    );
                                    const baseTotal =
                                      editPackageData.finalCosting?.baseTotal ||
