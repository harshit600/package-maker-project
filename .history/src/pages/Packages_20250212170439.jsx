                    ...
                    <div className="space-y-8">
                      ...
                      <div className="bg-gradient-to-br from-[rgb(45,45,68)] to-[rgb(55,55,88)] rounded-xl p-8 text-white shadow-xl">
                        <div className="flex items-center justify-between mb-6">
                          ...
                          <div className="flex gap-4">
                            <div className="px-4 py-2 bg-white/10 rounded-lg backdrop-blur-sm">
                              <span className="text-sm font-medium">Total Nights:{" "}
                              </span>
                              <span className="font-mono">
                            ...
                            <div className="px-4 py-2 bg-white/10 rounded-lg backdrop-blur-sm">
                              <span className="text-sm font-medium">Total Hotels:{" "}
                              </span>
                              <span className="font-mono">
                                {Object.keys(selectedPackage?.hotels || {}).length}
                              </span>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="grid grid-cols-1 gap-8">
                        {Object.entries(selectedPackage?.hotels || {}).map(([key, hotelData]) => {
                          ...
                          return (
                            <div key={key} className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
                              ...
                              <div className="bg-[rgb(45,45,68)] p-4 text-white">
                                <div className="flex justify-between items-center">
                                  <div className="flex items-center gap-3">
                                    ...
                                    <h4 className="text-lg font-semibold">{hotel?.name || "Hotel Name"}</h4>
                                  </div>
                                  <div className="flex items-center gap-2">
                                    <span className="px-3 py-1 bg-white/10 rounded-full text-sm">
                              ...
                              <div className="p-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                  ...
                                  <div className="space-y-4">
                                    ...
                                    <div>
                                      ...
                                      <p className="text-sm text-gray-600">{hotel?.phone || "N/A"}</p>
                                    </div>
                                  </div>
                                ...
                                {/* Amenities */}
                                <div className="mt-6">
                                  <h5 className="font-medium text-gray-700 mb-4">Amenities</h5>
                                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                    {hotel?.amenities?.basicFacilities && 
                                      Object.entries(hotel.amenities.basicFacilities).map(([amenity, value]) => 
                                        value === "Yes" && (
                                          <div key={amenity} className="flex items-center gap-2 bg-gray-50 p-2 rounded-lg">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                              <div>
                                ...
                                <input
                                  ...
                                  onChange={(e) =>
                                    handleMarginChange("b2b", e.target.value)
                                  }
                                  className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                />
                              </div>
