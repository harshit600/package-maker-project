...
const Packages = () => {
  ...
  const calculateFinalPrices = (baseTotal, margins) => {
    return {
      b2b: baseTotal + (baseTotal * (margins?.b2b || 0)) / 100,
      internal: baseTotal + (baseTotal * (margins?.internal || 0)) / 100,
      website: baseTotal + (baseTotal * (margins?.website || 0)) / 100,
    };
  };
                                    ...
                                    onChange={(e) => {
                                      setEditPackageData({
                                        ...
                                        finalCosting: {
                                          ...
                                          breakdown: {
                                            ...editPackageData.finalCosting?.breakdown,
                                            activitiesTotalCost: Number(e.target.value)
                                          }
                                        }
                                      });
                                    }}
