...
const Packages = () => {
  ...
  const calculateFinalPrices = (baseTotal, margins) => {
    ...
    const internalPrice = baseTotal + (baseTotal * (margins?.internal || 0)) / 100;
    const websitePrice = baseTotal + (baseTotal * (margins?.website || 0)) / 100;
                                ...
                                {showEditModal ? (
                                  <input
                                    ...
                                    onChange={(e) => {
                                      ...
                                      const transportCost = editPackageData?.finalCosting?.breakdown?.transportCost || 0;
                                      const activitiesCost = editPackageData?.finalCosting?.breakdown?.activitiesTotalCost || 0;
                                      const baseTotal = hotelCost + transportCost + activitiesCost;
                                      const finalPrices = calculateFinalPrices(baseTotal, editPackageData?.finalCosting?.margins);
                              ...
                              <div>
                                ...
                                {showEditModal ? (
                                  <input
                                    ...
                                    onChange={(e) => {
                                      const transportCost = Number(e.target.value);
                                      const hotelCost = editPackageData?.finalCosting?.breakdown?.hotelCost || 0;
                                      const activitiesCost = editPackageData?.finalCosting?.breakdown?.activitiesTotalCost || 0;
                                      const baseTotal = hotelCost + transportCost + activitiesCost;
                                      const finalPrices = calculateFinalPrices(baseTotal, editPackageData?.finalCosting?.margins);
                              ...
                              <div>
                                ...
                                {showEditModal ? (
                                  <input
                                    ...
                                    onChange={(e) => {
                                      const activitiesCost = Number(e.target.value);
                                      const hotelCost = editPackageData?.finalCosting?.breakdown?.hotelCost || 0;
                                      const transportCost = editPackageData?.finalCosting?.breakdown?.transportCost || 0;
                                      const baseTotal = hotelCost + transportCost + activitiesCost;
                                      const finalPrices = calculateFinalPrices(baseTotal, editPackageData?.finalCosting?.margins);
                                ...
                                {showEditModal ? (
                                  <input
                                    ...
                                    onChange={(e) => {
                                      ...
                                      const finalPrices = calculateFinalPrices(baseTotal, margins);
                              ...
                              <div>
                                ...
                                {showEditModal ? (
                                  <input
                                    ...
                                    onChange={(e) => {
                                      const internalMargin = Number(e.target.value);
                                      const baseTotal = editPackageData?.finalCosting?.baseTotal || 0;
                                      const margins = {
                                        ...editPackageData?.finalCosting?.margins,
                              ...
                              <div>
                                ...
                                {showEditModal ? (
                                  <input
                                    ...
                                    onChange={(e) => {
                                      const websiteMargin = Number(e.target.value);
                                      const baseTotal = editPackageData?.finalCosting?.baseTotal || 0;
                                      const margins = {
                                        ...editPackageData?.finalCosting?.margins,
                          ...
                          <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                              <div>
                                ...
                                <div className="w-full p-2 bg-gray-50 border border-gray-200 rounded-lg text-gray-600">
                                  ₹{showEditModal 
                                    ? editPackageData?.finalCosting?.finalPrices?.b2b?.toFixed(2) || 0
                              ...
                              <div>
                                ...
                                <div className="w-full p-2 bg-gray-50 border border-gray-200 rounded-lg text-gray-600">
                                  ₹{showEditModal 
                                    ? editPackageData?.finalCosting?.finalPrices?.internal?.toFixed(2) || 0
                              ...
                              <div>
                                ...
                                <div className="w-full p-2 bg-gray-50 border border-gray-200 rounded-lg text-gray-600">
                                  ₹{showEditModal 
                                    ? editPackageData?.finalCosting?.finalPrices?.website?.toFixed(2) || 0
                                      ...
                                      setEditPackageData({
                                        ...
                                        finalCosting: {
                                          ...
                                          breakdown: {
                                            ...editPackageData.finalCosting
                                              ?.breakdown,
                                            hotelCost: Number(e.target.value),
                                          },
                                        },
                                      });
                                    }}
