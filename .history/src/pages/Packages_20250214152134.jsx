                  ...
                  {currentPackages.map((pkg, index) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 border-t font-medium">
                        <div className="max-h-12 overflow-hidden overflow-ellipsis whitespace-nowrap" title={pkg.packageName}>
                          {pkg.packageName.split(" ").slice(0, 6).join(" ") + (pkg.packageName.split(" ").length > 6 ? '...' : '')}
                        {pkg.packageName}
                      </td>
