                ...
                <tbody>
                  {currentPackages.map((pkg, index) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 border-t">
                        <div className="flex gap-2 group"> {/* Added group class for hover effect */}
                          <button
                            onClick={(e) => handleDeleteClick(e, pkg._id)}
                            className="text-red-600 hover:text-red-800 opacity-0 group-hover:opacity-100 transition-opacity duration-200" // Updated for hover effect
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className="h-5 w-5"
                          ...
                          <button
                            ...
                            className="text-green-600 hover:text-green-800 opacity-0 group-hover:opacity-100 transition-opacity duration-200" // Updated for hover effect
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className="h-5 w-5"
                          ...
                          <button
                            ...
                            className="text-blue-600 hover:text-blue-800 opacity-0 group-hover:opacity-100 transition-opacity duration-200" // Updated for hover effect
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className="h-5 w-5"
