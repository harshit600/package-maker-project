            ...
            <div className="mt-4 bg-white rounded-lg shadow overflow-x-auto">
              <table className="w-full min-w-[1000px]"> {/* Added min-width */}
                <thead className="bg-[#2c3e50] text-white">
                  <tr>
                    <th className="px-2 py-3 text-left w-[40px]"> {/* Reduced padding and fixed width */}
                      <input
                        type="checkbox"
                    ...
                    <th className="px-3 py-3 text-left w-[100px]"> {/* Adjusted width */}
                      <div className="flex items-center gap-1"> {/* Reduced gap */}
                        <span className="text-base">🖼️</span>
                        Image
                      </div>
                    </th>
                    <th className="px-3 py-3 text-left w-[200px]"> {/* Set width for package name */}
                ...
                {/* Update the corresponding td elements to match th padding */}
                <tbody>
                  {currentPackages.map((pkg, index) => (
                    <tr key={pkg._id} className={index % 2 === 0 ? "bg-white" : "bg-gray-50"}>
