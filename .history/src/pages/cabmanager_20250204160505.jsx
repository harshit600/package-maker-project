...
function CabManager() {
  ...
  const closeModal = () => {
    ...
    setImageUploadError(null); // Reset any upload errors
  };
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (!formData.cabName) errors.cabName = "Cab name is required";
      if (!formData.cabSeatingCapacity) errors.cabSeatingCapacity = "Seating capacity is required";
      if (!formData.cabLuggage) errors.cabLuggage = "Luggage capacity is required";
      if (formData.cabImages.length === 0) errors.cabImages = "At least one image is required";
      ...
      if (!response.ok) {
        throw new Error("Failed to create cab");
      }
      ...
      <Modal show={isModalOpen} closeModal={closeModal} title="Add Cab Type">
        <div className="flex flex-col gap-4">
          ...
          <div>
            ...
            />
            {validationErrors.cabType && (
              <p className="text-red-500 text-sm mt-1">{validationErrors.cabType}</p>
            )}
          </div>
          ...
          <div>
            <SimpleDropdown
              ...
              disabled={!formData.cabType}
            />
            {validationErrors.cabName && (
              <p className="text-red-500 text-sm mt-1">{validationErrors.cabName}</p>
            )}
          </div>

          {/* Image Upload */}
          <div>
            <Form.Group as={Col} id="cabImages">
              ...
              <div className="flex flex-col gap-3">
                ...
                {validationErrors.cabImages && (
                  <p className="text-red-500 text-sm">{validationErrors.cabImages}</p>
                )}
          ...
          <div>
            <SimpleDropdown
              ...
              onSelect={(selectedOption) =>
                handleDropDownChange("cabSeatingCapacity", selectedOption.value)
              }
              value={formData.cabSeatingCapacity}
            />
            {validationErrors.cabSeatingCapacity && (
              <p className="text-red-500 text-sm mt-1">{validationErrors.cabSeatingCapacity}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {validationErrors.cabLuggage && (
              <p className="text-red-500 text-sm mt-1">{validationErrors.cabLuggage}</p>
            )}
          </div>
