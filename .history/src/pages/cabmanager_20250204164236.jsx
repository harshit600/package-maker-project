...
function CabManager() {
  ...
  return (
    <div className="shadow-md min-h-full p-2 m-2">
      ...
      >
        <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-xl shadow-inner">
          <div className="grid grid-cols-2 gap-6 mb-8">
            <div className="space-y-2">
              ...
              <SimpleDropdown
                ...
                className="w-full border-2 border-gray-200 rounded-lg shadow-sm hover:border-indigo-300 transition-colors duration-200"
                onSelect={(selectedOption) =>
          ...
          <div className="mb-8">
            <Form.Group as={Col} id="cabImages" className="p-0 space-y-3">
              <Form.Label className="block text-sm font-semibold text-gray-800">
                Cab Images <span className="text-gray-500 text-xs">(Max 6 images)</span>
              </Form.Label>
              <div className="flex flex-col gap-4">
                ...
                />
                {imageUploadError && (
                  <p className="text-red-500 text-sm mt-1 bg-red-50 p-2 rounded-lg">
                    ⚠️ {imageUploadError}
                  </p>
                )}
                {uploading && (
                  <p className="text-indigo-600 text-sm mt-1 bg-indigo-50 p-2 rounded-lg">
          ...
          <div className="flex justify-end gap-4 pt-4 border-t border-gray-200">
            ...
            />
            <Button
              text={isEditing ? "Update Cab" : "Add Cab"}
