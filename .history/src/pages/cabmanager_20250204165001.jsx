        ...
        <div className="bg-white p-8 rounded-lg">
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                <label className="block text-sm text-gray-600 mb-2">Cab Type</label>
                <SimpleDropdown
                  options={[
                    { label: "Select Cab Type", value: "" },
                    { label: "Hatchback", value: "Hatchback" },
              ...
              <div>
                <label className="block text-sm text-gray-600 mb-2">Cab Name</label>
                <SimpleDropdown
                  options={carOptions[formData.cabType] || [
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                <label className="block text-sm text-gray-600 mb-2">Seating Capacity</label>
                <SimpleDropdown
                  options={Array.from({ length: 47 }, (_, index) => ({
                    label: `${index + 4} Seater`,
                    value: `${index + 4} Seater`,
                  }))}
                  className="w-full border border-gray-200 rounded-lg bg-white"
                  onSelect={(selectedOption) =>
              ...
              <div>
                <label className="block text-sm text-gray-600 mb-2">Luggage Capacity</label>
                <SimpleDropdown
                  options={[
                    { label: "Small Trunk (2 bags)", value: "Small Trunk" },
                    { label: "Medium Trunk (3-4 bags)", value: "Medium Trunk" },
            ...
            <div>
              <Form.Group as={Col} id="cabImages" className="p-0">
                <Form.Label className="block text-sm text-gray-600 mb-2">Cab Images</Form.Label>
