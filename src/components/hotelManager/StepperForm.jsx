...
export default function PropertyForm() {
  ...
  const patchFormData = async () => {
    ...
    try {
      const propertyTypes = ["hotel", "homeStays&Villas", "BnBs"];
      const response = await fetch(
      ...
      try {
        ...
        if (
          ...
          (propertyIdFromUrl == "hotel" ||
            propertyIdFromUrl == "homeStays&Villas" ||
            propertyIdFromUrl == "BnBs" )
        ) {
  ...
  return (
    <>
      <div className="mt-2 w-full max-w-6xl mx-auto pb-8">
