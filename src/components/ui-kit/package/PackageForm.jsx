                ...
                <Col>
                  <div className="relative">
                    ...
                    <Form.Control
                      ...
                      className={`w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 ${!isPackagePlacesEditable ? 'bg-gray-100' : ''}`}
                    />
                    {isDropdownOpen && searchResults.length > 0 && index === activeIndex && isPackagePlacesEditable && (
                ...
                <Col>
                  <div className="flex items-center space-x-2 mt-6">
                    ...
                    <Form.Check
                      ...
                      disabled={!isPackagePlacesEditable}
                      className={`focus:ring-blue-500 h-5 w-10 ${!isPackagePlacesEditable ? 'opacity-50' : ''}`}
                    />
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                disabled={uploading}
                className={`px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors flex items-center space-x-2 ${uploading ? 'opacity-50 cursor-not-allowed' : ''}`}
              >
                {uploading ? (
                  <>
