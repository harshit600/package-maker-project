      ...
      <div className="mt-2 bg-white rounded-xl shadow-sm p-6 border border-gray-200">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            {/* Add Custom Exclusions Button */}
            <div className="mt-4">
              <button
                type="button"
                onClick={() => {
                  const newExclusions = [...(formData.customExclusions || []), { name: '', description: '' }];
                  handleInputChange({ target: { name: 'customExclusions', value: newExclusions }});
                }}
            ...
            {/* Add Global Master Data Button */}
            <div className="mt-2">
              <button
                type="button"
                onClick={() => setShowGlobalMasterModal(true)}
              ...
              <div key={index} className="mt-4 p-4 border border-gray-200 rounded-lg">
                <div className="flex justify-between items-start mb-3">
                  <input
                    ...
                    onChange={(e) => {
                      const newExclusions = [...formData.customExclusions];
                      newExclusions[index].name = e.target.value;
                      handleInputChange({ target: { name: 'customExclusions', value: newExclusions }});
                    }}
                    className="w-full mr-4 px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
                  />
                  <button
                    type="button"
                    onClick={() => {
                      const newExclusions = formData.customExclusions.filter((_, i) => i !== index);
                      handleInputChange({ target: { name: 'customExclusions', value: newExclusions }});
                    }}
                ...
                <RichTextInput
                  ...
                  onChange={(value) => {
                    const newExclusions = [...formData.customExclusions];
                    newExclusions[index].description = value;
                    handleInputChange({ target: { name: 'customExclusions', value: newExclusions }});
                  }}
                />
              </div>
